...
# 1 "<command-line>" 2
# 1 "vmod_std_conversions.c"
# 30 "vmod_std_conversions.c"
# 1 "../../config.h" 1
# 31 "vmod_std_conversions.c" 2
...
vmod_duration(const struct vrt_ctx *ctx, VCL_STRING p, VCL_DURATION d)
{
 ...
 do { do { if (!((ctx) != ((void *)0))) { VAS_Fail(__func__, "vmod_std_conversions.c", 54, "(ctx) != NULL", VAS_ASSERT); } } while (0); do { if (!((ctx)->magic == 0x6bb8f0db)) { VAS_Fail(__func__, "vmod_std_conversions.c", 54, "(ctx)->magic == 0x6bb8f0db", VAS_ASSERT); } } while (0); } while (0);
 ...
 if ((sizeof (r) == sizeof (float) ? __isnanf (r) : sizeof (r) == sizeof (double) ? __isnan (r) : __isnanl (r)) || e == ((void *)0))
  return (d);

 while(((*__ctype_b_loc ())[(int) ((*e))] & (unsigned short int) _ISspace))
  e++;
...
vmod_integer(const struct vrt_ctx *ctx, VCL_STRING p, VCL_INT i)
{
 ...
 do { do { if (!((ctx) != ((void *)0))) { VAS_Fail(__func__, "vmod_std_conversions.c", 108, "(ctx) != NULL", VAS_ASSERT); } } while (0); do { if (!((ctx)->magic == 0x6bb8f0db)) { VAS_Fail(__func__, "vmod_std_conversions.c", 108, "(ctx)->magic == 0x6bb8f0db", VAS_ASSERT); } } while (0); } while (0);
...
{
 struct addrinfo hints, *res0 = ((void *)0);
 const struct addrinfo *res;
 int error;
 void *p;
 struct suckaddr *r;

 do { do { if (!((ctx) != ((void *)0))) { VAS_Fail(__func__, "vmod_std_conversions.c", 138, "(ctx) != NULL", VAS_ASSERT); } } while (0); do { if (!((ctx)->magic == 0x6bb8f0db)) { VAS_Fail(__func__, "vmod_std_conversions.c", 138, "(ctx)->magic == 0x6bb8f0db", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((d) != 0)) { VAS_Fail(__func__, "vmod_std_conversions.c", 139, "(d) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { if (!(VSA_Sane(d))) { VAS_Fail(__func__, "vmod_std_conversions.c", 140, "VSA_Sane(d)", VAS_ASSERT); } } while (0);
...
vmod_real(const struct vrt_ctx *ctx, VCL_STRING p, VCL_REAL d)
{
 ...
 do { do { if (!((ctx) != ((void *)0))) { VAS_Fail(__func__, "vmod_std_conversions.c", 177, "(ctx) != NULL", VAS_ASSERT); } } while (0); do { if (!((ctx)->magic == 0x6bb8f0db)) { VAS_Fail(__func__, "vmod_std_conversions.c", 177, "(ctx)->magic == 0x6bb8f0db", VAS_ASSERT); } } while (0); } while (0);
 ...
 if ((sizeof (r) == sizeof (float) ? __isnanf (r) : sizeof (r) == sizeof (double) ? __isnan (r) : __isnanl (r)))
  return (d);
...
VCL_INT
vmod_real2integer(const struct vrt_ctx *ctx, VCL_REAL r, VCL_INT i)
{
 do { do { if (!((ctx) != ((void *)0))) { VAS_Fail(__func__, "vmod_std_conversions.c", 193, "(ctx) != NULL", VAS_ASSERT); } } while (0); do { if (!((ctx)->magic == 0x6bb8f0db)) { VAS_Fail(__func__, "vmod_std_conversions.c", 193, "(ctx)->magic == 0x6bb8f0db", VAS_ASSERT); } } while (0); } while (0);

 if (!(sizeof (r) == sizeof (float) ? __finitef (r) : sizeof (r) == sizeof (double) ? __finite (r) : __finitel (r)))
  return (i);
 r = round(r);
 if (r > 9223372036854775807L || r < (-9223372036854775807L - 1L))
  return(i);
 return ((long)r);
}

VCL_TIME
vmod_real2time(const struct vrt_ctx *ctx, VCL_REAL r, VCL_TIME t)
{
 do { do { if (!((ctx) != ((void *)0))) { VAS_Fail(__func__, "vmod_std_conversions.c", 206, "(ctx) != NULL", VAS_ASSERT); } } while (0); do { if (!((ctx)->magic == 0x6bb8f0db)) { VAS_Fail(__func__, "vmod_std_conversions.c", 206, "(ctx)->magic == 0x6bb8f0db", VAS_ASSERT); } } while (0); } while (0);
...
VCL_INT
vmod_time2integer(const struct vrt_ctx *ctx, VCL_TIME t, VCL_INT i)
{
 do { do { if (!((ctx) != ((void *)0))) { VAS_Fail(__func__, "vmod_std_conversions.c", 217, "(ctx) != NULL", VAS_ASSERT); } } while (0); do { if (!((ctx)->magic == 0x6bb8f0db)) { VAS_Fail(__func__, "vmod_std_conversions.c", 217, "(ctx)->magic == 0x6bb8f0db", VAS_ASSERT); } } while (0); } while (0);

 if (!(sizeof (t) == sizeof (float) ? __finitef (t) : sizeof (t) == sizeof (double) ? __finite (t) : __finitel (t)))
  return (i);
 t = round(t);
 if (t > 9223372036854775807L || t < (-9223372036854775807L - 1L))
  return(i);
 return ((long)t);
}

VCL_REAL
vmod_time2real(const struct vrt_ctx *ctx, VCL_TIME t, VCL_REAL r)
{
 do { do { if (!((ctx) != ((void *)0))) { VAS_Fail(__func__, "vmod_std_conversions.c", 230, "(ctx) != NULL", VAS_ASSERT); } } while (0); do { if (!((ctx)->magic == 0x6bb8f0db)) { VAS_Fail(__func__, "vmod_std_conversions.c", 230, "(ctx)->magic == 0x6bb8f0db", VAS_ASSERT); } } while (0); } while (0);
...
vmod_time(const struct vrt_ctx *ctx, VCL_STRING p, VCL_TIME d)
{
 ...
 do { do { if (!((ctx) != ((void *)0))) { VAS_Fail(__func__, "vmod_std_conversions.c", 243, "(ctx) != NULL", VAS_ASSERT); } } while (0); do { if (!((ctx)->magic == 0x6bb8f0db)) { VAS_Fail(__func__, "vmod_std_conversions.c", 243, "(ctx)->magic == 0x6bb8f0db", VAS_ASSERT); } } while (0); } while (0);
