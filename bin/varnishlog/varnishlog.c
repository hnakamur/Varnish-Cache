...
openout(int append)
{
 ...
 do { do { if (!((LOG.w_arg) != 0)) { VAS_Fail(__func__, "varnishlog.c", 80, "(LOG.w_arg) != 0", VAS_ASSERT); } } while (0); } while (0);
 if (LOG.A_opt)
 ...
 if (LOG.fo == ((void *)0))
  VUT_Error(2, "Can't open output file (%s)",
      LOG.A_opt ? strerror((*__errno_location ())) : VSL_Error(VUT.vsl));
...
rotateout(void)
{
 ...
 do { do { if (!((LOG.w_arg) != 0)) { VAS_Fail(__func__, "varnishlog.c", 95, "(LOG.w_arg) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((LOG.fo) != 0)) { VAS_Fail(__func__, "varnishlog.c", 96, "(LOG.fo) != 0", VAS_ASSERT); } } while (0); } while (0);
 fclose(LOG.fo);
 openout(1);
 do { do { if (!((LOG.fo) != 0)) { VAS_Fail(__func__, "varnishlog.c", 99, "(LOG.fo) != 0", VAS_ASSERT); } } while (0); } while (0);
 return (0);
}
...
flushout(void)
{
 ...
 do { do { if (!((LOG.fo) != 0)) { VAS_Fail(__func__, "varnishlog.c", 107, "(LOG.fo) != 0", VAS_ASSERT); } } while (0); } while (0);
 if (fflush(LOG.fo))
  return (-5);
 return (0);
}
...
main(int argc, char * const *argv)
{
 ...
 while ((opt = getopt(argc, argv, vopt_optstring)) != -1) {
  ...
  case 'w':
   ...
   do { free(LOG.w_arg); if ((optarg) != ((void *)0)) { LOG.w_arg = (__extension__ (__builtin_constant_p (optarg) && ((size_t)(const void *)((optarg) + 1) - (size_t)(const void *)(optarg) == 1) ? (((const char *) (optarg))[0] == '\0' ? (char *) calloc ((size_t) 1, (size_t) 1) : ({ size_t __len = strlen (optarg) + 1; char *__retval = (char *) malloc (__len); if (__retval != ((void *)0)) __retval = (char *) memcpy (__retval, optarg, __len); __retval; })) : __strdup (optarg))); do { do { if (!(((LOG.w_arg)) != 0)) { VAS_Fail(__func__, "varnishlog.c", 143, "((LOG.w_arg)) != 0", VAS_ASSERT); } } while (0); } while (0); } else { LOG.w_arg = ((void *)0); } } while (0);
   break;
  default:
 ...
 if (LOG.w_arg) {
  openout(LOG.a_opt);
  do { do { if (!((LOG.fo) != 0)) { VAS_Fail(__func__, "varnishlog.c", 165, "(LOG.fo) != 0", VAS_ASSERT); } } while (0); } while (0);
  if (VUT.D_opt)
