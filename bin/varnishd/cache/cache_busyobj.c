...
# 1 "<command-line>" 2
# 1 "cache/cache_busyobj.c"
# 33 "cache/cache_busyobj.c"
# 1 "../../config.h" 1
# 34 "cache/cache_busyobj.c" 2
...
VBO_Init(void)
{
 ...
 do { do { if (!((vbopool) != 0)) { VAS_Fail(__func__, "cache/cache_busyobj.c", 54, "(vbopool) != 0", VAS_ASSERT); } } while (0); } while (0);
}
...
vbo_New(void)
{
 ...
 do { do { if (!((bo) != 0)) { VAS_Fail(__func__, "cache/cache_busyobj.c", 68, "(bo) != 0", VAS_MISSING); } } while (0); } while (0);
 bo->magic = 0x23b95567;
 bo->end = (char *)bo + sz;
 Lck__New(&bo->mtx, lck_busyobj, "lck_busyobj");
 do { do { if (!((pthread_cond_init(&bo->cond, ((void *)0))) == 0)) { VAS_Fail(__func__, "cache/cache_busyobj.c", 72, "(pthread_cond_init(&bo->cond, ((void *)0))) == 0", VAS_ASSERT); } } while (0); } while (0);
 return (bo);
}
...
vbo_Free(struct busyobj **bop)
{
 ...
 do { do { if (!((bop) != 0)) { VAS_Fail(__func__, "cache/cache_busyobj.c", 81, "(bop) != 0", VAS_ASSERT); } } while (0); } while (0);
 bo = *bop;
 *bop = ((void *)0);
 do { do { if (!((bo) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_busyobj.c", 84, "(bo) != NULL", VAS_ASSERT); } } while (0); do { if (!((bo)->magic == 0x23b95567)) { VAS_Fail(__func__, "cache/cache_busyobj.c", 84, "(bo)->magic == 0x23b95567", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((bo->htc) == 0)) { VAS_Fail(__func__, "cache/cache_busyobj.c", 85, "(bo->htc) == 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((bo->refcount) == 0)) { VAS_Fail(__func__, "cache/cache_busyobj.c", 86, "(bo->refcount) == 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((pthread_cond_destroy(&bo->cond)) == 0)) { VAS_Fail(__func__, "cache/cache_busyobj.c", 87, "(pthread_cond_destroy(&bo->cond)) == 0", VAS_ASSERT); } } while (0); } while (0);
 Lck_Delete(&bo->mtx);
 MPL_Free(vbopool, bo);
}
...
VBO_GetBusyObj(struct worker *wrk, const struct req *req)
{
 ...
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_busyobj.c", 100, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "cache/cache_busyobj.c", 100, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);

 bo = vbo_New();
 do { do { if (!((bo) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_busyobj.c", 103, "(bo) != NULL", VAS_ASSERT); } } while (0); do { if (!((bo)->magic == 0x23b95567)) { VAS_Fail(__func__, "cache/cache_busyobj.c", 103, "(bo)->magic == 0x23b95567", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((bo->refcount) == 0)) { VAS_Fail(__func__, "cache/cache_busyobj.c", 104, "(bo->refcount) == 0", VAS_ASSERT); } } while (0); } while (0);

 bo->refcount = 1;

 p = (void*)(bo + 1);
 p = (void*)(((uintptr_t)(p) + (sizeof(void *) - 1)) & ~(sizeof(void *) - 1));
 do { if (!(p < bo->end)) { VAS_Fail(__func__, "cache/cache_busyobj.c", 110, "p < bo->end", VAS_ASSERT); } } while (0);
 ...
 p += sz;
 p = (void*)(((uintptr_t)(p) + (sizeof(void *) - 1)) & ~(sizeof(void *) - 1));
 do { if (!(p < bo->end)) { VAS_Fail(__func__, "cache/cache_busyobj.c", 118, "p < bo->end", VAS_ASSERT); } } while (0);

 bo->bereq = HTTP_create(p, nhttp);
 p += sz;
 p = (void*)(((uintptr_t)(p) + (sizeof(void *) - 1)) & ~(sizeof(void *) - 1));
 do { if (!(p < bo->end)) { VAS_Fail(__func__, "cache/cache_busyobj.c", 123, "p < bo->end", VAS_ASSERT); } } while (0);

 bo->beresp = HTTP_create(p, nhttp);
 p += sz;
 p = (void*)(((uintptr_t)(p) + (sizeof(void *) - 1)) & ~(sizeof(void *) - 1));
 do { if (!(p < bo->end)) { VAS_Fail(__func__, "cache/cache_busyobj.c", 128, "p < bo->end", VAS_ASSERT); } } while (0);

 sz = cache_param->vsl_buffer;
 VSL_Setup(bo->vsl, p, sz);
 bo->vsl->wid = VXID_Get(wrk, (1U<<31));
 p += sz;
 p = (void*)(((uintptr_t)(p) + (sizeof(void *) - 1)) & ~(sizeof(void *) - 1));
 do { if (!(p < bo->end)) { VAS_Fail(__func__, "cache/cache_busyobj.c", 135, "p < bo->end", VAS_ASSERT); } } while (0);
 ...
 bo->t_first = bo->t_prev = (__builtin_nanf (""));
...
{
 struct busyobj *bo;
 struct objcore *oc = ((void *)0);
 unsigned r;

 do { if ((wrk) != ((void *)0)) do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "cache/cache_busyobj.c", 163, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((pbo) != 0)) { VAS_Fail(__func__, "cache/cache_busyobj.c", 164, "(pbo) != 0", VAS_ASSERT); } } while (0); } while (0);
 bo = *pbo;
 *pbo = ((void *)0);
 do { do { if (!((bo) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_busyobj.c", 167, "(bo) != NULL", VAS_ASSERT); } } while (0); do { if (!((bo)->magic == 0x23b95567)) { VAS_Fail(__func__, "cache/cache_busyobj.c", 167, "(bo)->magic == 0x23b95567", VAS_ASSERT); } } while (0); } while (0);
 do { if ((bo->fetch_objcore) != ((void *)0)) do { if (!((bo->fetch_objcore)->magic == 0x4d301302)) { VAS_Fail(__func__, "cache/cache_busyobj.c", 168, "(bo->fetch_objcore)->magic == 0x4d301302", VAS_ASSERT); } } while (0); } while (0);
 if (bo->fetch_objcore != ((void *)0)) {
  oc = bo->fetch_objcore;
  do { do { if (!((oc) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_busyobj.c", 171, "(oc) != NULL", VAS_ASSERT); } } while (0); do { if (!((oc)->magic == 0x4d301302)) { VAS_Fail(__func__, "cache/cache_busyobj.c", 171, "(oc)->magic == 0x4d301302", VAS_ASSERT); } } while (0); } while (0);
  do { do { if (!((oc->objhead) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_busyobj.c", 172, "(oc->objhead) != NULL", VAS_ASSERT); } } while (0); do { if (!((oc->objhead)->magic == 0x1b96615d)) { VAS_Fail(__func__, "cache/cache_busyobj.c", 172, "(oc->objhead)->magic == 0x1b96615d", VAS_ASSERT); } } while (0); } while (0);
  Lck__Lock(&oc->objhead->mtx, __func__, 173);
  do { if (!(bo->refcount > 0)) { VAS_Fail(__func__, "cache/cache_busyobj.c", 174, "bo->refcount > 0", VAS_ASSERT); } } while (0);
  r = --bo->refcount;
  Lck__Unlock(&oc->objhead->mtx, __func__, 176);
 } else {
  Lck__Lock(&bo->mtx, __func__, 178);
  do { if (!(bo->refcount > 0)) { VAS_Fail(__func__, "cache/cache_busyobj.c", 179, "bo->refcount > 0", VAS_ASSERT); } } while (0);
  r = --bo->refcount;
  Lck__Unlock(&bo->mtx, __func__, 181);
 }

 if (r)
  return;

 do { do { if (!((bo->htc) == 0)) { VAS_Fail(__func__, "cache/cache_busyobj.c", 187, "(bo->htc) == 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((bo->stale_oc) == 0)) { VAS_Fail(__func__, "cache/cache_busyobj.c", 188, "(bo->stale_oc) == 0", VAS_ASSERT); } } while (0); } while (0);

 VRTPRIV_dynamic_kill(bo->privs, (uintptr_t)bo);
 do { if (!(((&bo->privs->privs)->vtqh_first == ((void *)0)))) { VAS_Fail(__func__, "cache/cache_busyobj.c", 191, "VTAILQ_EMPTY(&bo->privs->privs)", VAS_ASSERT); } } while (0);
 ...
 do { do { if (!((bo->htc) == 0)) { VAS_Fail(__func__, "cache/cache_busyobj.c", 203, "(bo->htc) == 0", VAS_ASSERT); } } while (0); } while (0);

 if (bo->fetch_objcore != ((void *)0)) {
  do { do { if (!((wrk) != 0)) { VAS_Fail(__func__, "cache/cache_busyobj.c", 206, "(wrk) != 0", VAS_ASSERT); } } while (0); } while (0);
 ...
 memset(&bo->refcount, 0,
     sizeof *bo - __builtin_offsetof (struct busyobj, refcount));
...
VBO_extend(struct busyobj *bo, ssize_t l)
{
 ...
 do { do { if (!((bo) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_busyobj.c", 225, "(bo) != NULL", VAS_ASSERT); } } while (0); do { if (!((bo)->magic == 0x23b95567)) { VAS_Fail(__func__, "cache/cache_busyobj.c", 225, "(bo)->magic == 0x23b95567", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((bo->vfc) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_busyobj.c", 226, "(bo->vfc) != NULL", VAS_ASSERT); } } while (0); do { if (!((bo->vfc)->magic == 0x61d9d3e5)) { VAS_Fail(__func__, "cache/cache_busyobj.c", 226, "(bo->vfc)->magic == 0x61d9d3e5", VAS_ASSERT); } } while (0); } while (0);
 if (l == 0)
  return;
 do { if (!(l > 0)) { VAS_Fail(__func__, "cache/cache_busyobj.c", 229, "l > 0", VAS_ASSERT); } } while (0);
 Lck__Lock(&bo->mtx, __func__, 230);
 ObjExtend(bo->wrk, bo->vfc->oc, l);
 do { do { if (!((pthread_cond_broadcast(&bo->cond)) == 0)) { VAS_Fail(__func__, "cache/cache_busyobj.c", 232, "(pthread_cond_broadcast(&bo->cond)) == 0", VAS_ASSERT); } } while (0); } while (0);
 Lck__Unlock(&bo->mtx, __func__, 233);
}
...
VBO_waitlen(struct worker *wrk, struct busyobj *bo, ssize_t l)
{
 ...
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_busyobj.c", 241, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "cache/cache_busyobj.c", 241, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((bo) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_busyobj.c", 242, "(bo) != NULL", VAS_ASSERT); } } while (0); do { if (!((bo)->magic == 0x23b95567)) { VAS_Fail(__func__, "cache/cache_busyobj.c", 242, "(bo)->magic == 0x23b95567", VAS_ASSERT); } } while (0); } while (0);
 Lck__Lock(&bo->mtx, __func__, 243);
 rv = ObjGetLen(wrk, bo->fetch_objcore);
 while (1) {
  do { if (!(l <= rv || bo->state == BOS_FAILED)) { VAS_Fail(__func__, "cache/cache_busyobj.c", 246, "l <= rv || bo->state == BOS_FAILED", VAS_ASSERT); } } while (0);
  if (rv > l || bo->state >= BOS_FINISHED)
   break;
  (void)Lck_CondWait(&bo->cond, &bo->mtx, 0);
  rv = ObjGetLen(wrk, bo->fetch_objcore);
 }
 Lck__Unlock(&bo->mtx, __func__, 252);
 return (rv);
}
...
{
 do { do { if (!((bo) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_busyobj.c", 259, "(bo) != NULL", VAS_ASSERT); } } while (0); do { if (!((bo)->magic == 0x23b95567)) { VAS_Fail(__func__, "cache/cache_busyobj.c", 259, "(bo)->magic == 0x23b95567", VAS_ASSERT); } } while (0); } while (0);
 do { if (!(bo->do_stream || next != BOS_STREAM)) { VAS_Fail(__func__, "cache/cache_busyobj.c", 260, "bo->do_stream || next != BOS_STREAM", VAS_ASSERT); } } while (0);
 do { if (!(next > bo->state)) { VAS_Fail(__func__, "cache/cache_busyobj.c", 261, "next > bo->state", VAS_ASSERT); } } while (0);
 Lck__Lock(&bo->mtx, __func__, 262);
 bo->state = next;
 do { do { if (!((pthread_cond_broadcast(&bo->cond)) == 0)) { VAS_Fail(__func__, "cache/cache_busyobj.c", 264, "(pthread_cond_broadcast(&bo->cond)) == 0", VAS_ASSERT); } } while (0); } while (0);
 Lck__Unlock(&bo->mtx, __func__, 265);
}

void
VBO_waitstate(struct busyobj *bo, enum busyobj_state_e want)
{
 Lck__Lock(&bo->mtx, __func__, 271);
 while (1) {
  if (bo->state >= want)
   break;
  (void)Lck_CondWait(&bo->cond, &bo->mtx, 0);
 }
 Lck__Unlock(&bo->mtx, __func__, 277);
}
