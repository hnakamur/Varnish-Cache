...
# 1 "<command-line>" 2
# 1 "../../lib/libvarnish/vss.c"
# 31 "../../lib/libvarnish/vss.c"
# 1 "../../config.h" 1
# 32 "../../lib/libvarnish/vss.c" 2
...
# 47 "../../lib/libvarnish/vss.c" 2
# 64 "../../lib/libvarnish/vss.c"
static const char *
 ...
 *addr = *port = ((void *)0);
  ...
  *addr = str + 1;
  p = (__extension__ (__builtin_constant_p (']') && !__builtin_constant_p (str) && (']') == '\0' ? (char *) __rawmemchr (str, ']') : __builtin_strchr (str, ']')));
  if (p == ((void *)0))
  ...
  *addr = str;
  ...
  if (p == ((void *)0))
   return (((void *)0));
  if (p[0] == ':' && (__extension__ (__builtin_constant_p (':') && !__builtin_constant_p (&p[1]) && (':') == '\0' ? (char *) __rawmemchr (&p[1], ':') : __builtin_strchr (&p[1], ':'))))
   return (((void *)0));
  if (p == str)
   *addr = ((void *)0);
 }
 ...
 *err = ((void *)0);
 h = (__extension__ (__builtin_constant_p (addr) && ((size_t)(const void *)((addr) + 1) - (size_t)(const void *)(addr) == 1) ? (((const char *) (addr))[0] == '\0' ? (char *) calloc ((size_t) 1, (size_t) 1) : ({ size_t __len = strlen (addr) + 1; char *__retval = (char *) malloc (__len); if (__retval != ((void *)0)) __retval = (char *) memcpy (__retval, addr, __len); __retval; })) : __strdup (addr)));
 do { do { if (!((h) != 0)) { VAS_Fail(__func__, "../../lib/libvarnish/vss.c", 119, "(h) != 0", VAS_ASSERT); } } while (0); } while (0);
