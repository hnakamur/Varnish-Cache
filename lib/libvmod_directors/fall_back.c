    ...
    double *changed)
{
 ...
 do { (rr) = (dir->priv); do { if (!((rr) != ((void *)0))) { VAS_Fail(__func__, "fall_back.c", 53, "(rr) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((rr))->magic == (0xad4e26ba))) { VAS_Fail(__func__, "fall_back.c", 53, "((rr))->magic == (0xad4e26ba)", VAS_ASSERT); } } while (0); } while (0); } while (0);
    ...
    struct busyobj *bo)
{
 ...
 do { do { if (!((dir) != ((void *)0))) { VAS_Fail(__func__, "fall_back.c", 65, "(dir) != NULL", VAS_ASSERT); } } while (0); do { if (!((dir)->magic == 0x3336351d)) { VAS_Fail(__func__, "fall_back.c", 65, "(dir)->magic == 0x3336351d", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "fall_back.c", 66, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "fall_back.c", 66, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((bo) != ((void *)0))) { VAS_Fail(__func__, "fall_back.c", 67, "(bo) != NULL", VAS_ASSERT); } } while (0); do { if (!((bo)->magic == 0x23b95567)) { VAS_Fail(__func__, "fall_back.c", 67, "(bo)->magic == 0x23b95567", VAS_ASSERT); } } while (0); } while (0);
 do { (rr) = (dir->priv); do { if (!((rr) != ((void *)0))) { VAS_Fail(__func__, "fall_back.c", 68, "(rr) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((rr))->magic == (0xad4e26ba))) { VAS_Fail(__func__, "fall_back.c", 68, "((rr))->magic == (0xad4e26ba)", VAS_ASSERT); } } while (0); } while (0); } while (0);
 vdir_lock(rr->vd);
 for (u = 0; u < rr->vd->n_backend; u++) {
  be = rr->vd->backend[u];
  do { do { if (!((be) != ((void *)0))) { VAS_Fail(__func__, "fall_back.c", 72, "(be) != NULL", VAS_ASSERT); } } while (0); do { if (!((be)->magic == 0x3336351d)) { VAS_Fail(__func__, "fall_back.c", 72, "(be)->magic == 0x3336351d", VAS_ASSERT); } } while (0); } while (0);
  if (be->healthy(be, bo, ((void *)0)))
   break;
 }
 vdir_unlock(rr->vd);
    ...
    struct vmod_directors_fallback **rrp, const char *vcl_name)
{
 ...
 do { do { if (!((ctx) != ((void *)0))) { VAS_Fail(__func__, "fall_back.c", 88, "(ctx) != NULL", VAS_ASSERT); } } while (0); do { if (!((ctx)->magic == 0x6bb8f0db)) { VAS_Fail(__func__, "fall_back.c", 88, "(ctx)->magic == 0x6bb8f0db", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((rrp) != 0)) { VAS_Fail(__func__, "fall_back.c", 89, "(rrp) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((*rrp) == 0)) { VAS_Fail(__func__, "fall_back.c", 90, "(*rrp) == 0", VAS_ASSERT); } } while (0); } while (0);
 do { (rr) = calloc(sizeof *(rr), 1); if ((rr) != ((void *)0)) (rr)->magic = (0xad4e26ba); } while (0);
 do { do { if (!((rr) != 0)) { VAS_Fail(__func__, "fall_back.c", 92, "(rr) != 0", VAS_ASSERT); } } while (0); } while (0);
 *rrp = rr;
...
vmod_fallback__fini(struct vmod_directors_fallback **rrp)
{
 ...
 rr = *rrp;
 *rrp = ((void *)0);
 do { do { if (!((rr) != ((void *)0))) { VAS_Fail(__func__, "fall_back.c", 105, "(rr) != NULL", VAS_ASSERT); } } while (0); do { if (!((rr)->magic == 0xad4e26ba)) { VAS_Fail(__func__, "fall_back.c", 105, "(rr)->magic == 0xad4e26ba", VAS_ASSERT); } } while (0); } while (0);
 vdir_delete(&rr->vd);
    ...
    struct vmod_directors_fallback *rr, VCL_BACKEND be)
{
 ...
 do { do { if (!((ctx) != ((void *)0))) { VAS_Fail(__func__, "fall_back.c", 115, "(ctx) != NULL", VAS_ASSERT); } } while (0); do { if (!((ctx)->magic == 0x6bb8f0db)) { VAS_Fail(__func__, "fall_back.c", 115, "(ctx)->magic == 0x6bb8f0db", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((rr) != ((void *)0))) { VAS_Fail(__func__, "fall_back.c", 116, "(rr) != NULL", VAS_ASSERT); } } while (0); do { if (!((rr)->magic == 0xad4e26ba)) { VAS_Fail(__func__, "fall_back.c", 116, "(rr)->magic == 0xad4e26ba", VAS_ASSERT); } } while (0); } while (0);
...
vmod_fallback_backend(const struct vrt_ctx *ctx,
    struct vmod_directors_fallback *rr)
{
 do { do { if (!((ctx) != ((void *)0))) { VAS_Fail(__func__, "fall_back.c", 124, "(ctx) != NULL", VAS_ASSERT); } } while (0); do { if (!((ctx)->magic == 0x6bb8f0db)) { VAS_Fail(__func__, "fall_back.c", 124, "(ctx)->magic == 0x6bb8f0db", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((rr) != ((void *)0))) { VAS_Fail(__func__, "fall_back.c", 125, "(rr) != NULL", VAS_ASSERT); } } while (0); do { if (!((rr)->magic == 0xad4e26ba)) { VAS_Fail(__func__, "fall_back.c", 125, "(rr)->magic == 0xad4e26ba", VAS_ASSERT); } } while (0); } while (0);
 return (rr->vd->dir);
}
