...
# 1 "<command-line>" 2
# 1 "storage/storage_file.c"
# 32 "storage/storage_file.c"
# 1 "../../config.h" 1
# 33 "storage/storage_file.c" 2
...
# 46 "storage/storage_file.c" 2
# 66 "storage/storage_file.c"
static struct VSC_C_lck *lck_smf;



struct smfhead { struct smf *vtqh_first; struct smf **vtqh_last; };
...
struct smf {
 ...
 struct { struct smf *vtqe_next; struct smf **vtqe_prev; } order;
 struct { struct smf *vtqe_next; struct smf **vtqe_prev; } status;
...
smf_init(struct stevedore *parent, int ac, char * const *av)
{
 ...
 do { do { if (!((av[ac]) == 0)) { VAS_Fail(__func__, "storage/storage_file.c", 114, "(av[ac]) == 0", VAS_ASSERT); } } while (0); } while (0);

 size = ((void *)0);
 page_size = getpagesize();

 if (ac > 3)
  do { fprintf(stderr, "Error: " "(-sfile) too many arguments\n"); exit(2); } while (0);
 if (ac < 1 || *av[0] == '\0')
  do { fprintf(stderr, "Error: " "(-sfile) path is mandatory\n"); exit(2); } while (0);
 fn = av[0];
 if (ac > 1 && *av[1] != '\0')
  size = av[1];
 if (ac > 2 && *av[2] != '\0') {
  ...
  if (r != ((void *)0))
   do { fprintf(stderr, "Error: " "(-sfile) granularity \"%s\": %s\n", av[2], r); exit(2); } while (0);
 }

 do { do { if (!((fn) != 0)) { VAS_Fail(__func__, "storage/storage_file.c", 133, "(fn) != 0", VAS_ASSERT); } } while (0); } while (0);

 do { (sc) = calloc(sizeof *(sc), 1); if ((sc) != ((void *)0)) (sc)->magic = (0x52962ee7); } while (0);
 do { do { if (!((sc) != 0)) { VAS_Fail(__func__, "storage/storage_file.c", 136, "(sc) != 0", VAS_MISSING); } } while (0); } while (0);
 do { (((&sc->order))->vtqh_first) = ((void *)0); (&sc->order)->vtqh_last = &(((&sc->order))->vtqh_first); } while (0);
 for (u = 0; u < (128 / 4 + 1); u++)
  do { (((&sc->free[u]))->vtqh_first) = ((void *)0); (&sc->free[u])->vtqh_last = &(((&sc->free[u]))->vtqh_first); } while (0);
 do { (((&sc->used))->vtqh_first) = ((void *)0); (&sc->used)->vtqh_last = &(((&sc->used))->vtqh_first); } while (0);
 ...
 if (VFIL_allocate(sc->fd, (off_t)sc->filesize, 0))
  do { fprintf(stderr, "Error: " "(-sfile) allocation error: %s\n", strerror((*__errno_location ()))); exit(2); } while (0);
}
...
insfree(struct smf_sc *sc, struct smf *sp)
{
 ...
 do { do { if (!((sp->alloc) == 0)) { VAS_Fail(__func__, "storage/storage_file.c", 163, "(sp->alloc) == 0", VAS_ASSERT); } } while (0); } while (0);
 do { if (!(sp->flist == ((void *)0))) { VAS_Fail(__func__, "storage/storage_file.c", 164, "sp->flist == NULL", VAS_ASSERT); } } while (0);
 ...
 sp->flist = &sc->free[b];
 ns = b * sc->pagesize;
 for ((sp2) = (((sp->flist))->vtqh_first); (sp2); (sp2) = (((sp2))->status.vtqe_next)) {
  do { if (!(sp2->size >= ns)) { VAS_Fail(__func__, "storage/storage_file.c", 176, "sp2->size >= ns", VAS_ASSERT); } } while (0);
  do { do { if (!((sp2->alloc) == 0)) { VAS_Fail(__func__, "storage/storage_file.c", 177, "(sp2->alloc) == 0", VAS_ASSERT); } } while (0); } while (0);
  do { if (!(sp2->flist == sp->flist)) { VAS_Fail(__func__, "storage/storage_file.c", 178, "sp2->flist == sp->flist", VAS_ASSERT); } } while (0);
  if (sp->offset < sp2->offset)
   break;
 }
 if (sp2 == ((void *)0))
  do { (((sp))->status.vtqe_next) = ((void *)0); (sp)->status.vtqe_prev = (sp->flist)->vtqh_last; *(sp->flist)->vtqh_last = (sp); (sp->flist)->vtqh_last = &(((sp))->status.vtqe_next); } while (0);
 else
  do { (sp)->status.vtqe_prev = (sp2)->status.vtqe_prev; (((sp))->status.vtqe_next) = (sp2); *(sp2)->status.vtqe_prev = (sp); (sp2)->status.vtqe_prev = &(((sp))->status.vtqe_next); } while (0);
}
...
remfree(const struct smf_sc *sc, struct smf *sp)
{
 ...
 do { do { if (!((sp->alloc) == 0)) { VAS_Fail(__func__, "storage/storage_file.c", 193, "(sp->alloc) == 0", VAS_ASSERT); } } while (0); } while (0);
 do { if (!(sp->flist != ((void *)0))) { VAS_Fail(__func__, "storage/storage_file.c", 194, "sp->flist != NULL", VAS_ASSERT); } } while (0);
 Lck__Assert(&sc->mtx, 1);
 b = sp->size / sc->pagesize;
 if (b >= (128 / 4 + 1)) {
  b = (128 / 4 + 1) - 1;
 ...
 do { if (!(sp->flist == &sc->free[b])) { VAS_Fail(__func__, "storage/storage_file.c", 203, "sp->flist == &sc->free[b]", VAS_ASSERT); } } while (0);
 do { if (((((sp))->status.vtqe_next)) != ((void *)0)) (((sp))->status.vtqe_next)->status.vtqe_prev = (sp)->status.vtqe_prev; else { (sp->flist)->vtqh_last = (sp)->status.vtqe_prev; } *(sp)->status.vtqe_prev = (((sp))->status.vtqe_next); ; ; } while (0);
 sp->flist = ((void *)0);
}
...
alloc_smf(struct smf_sc *sc, size_t bytes)
{
 ...
 do { do { if (!((bytes % sc->pagesize) == 0)) { VAS_Fail(__func__, "storage/storage_file.c", 218, "(bytes % sc->pagesize) == 0", VAS_ASSERT); } } while (0); } while (0);
 b = bytes / sc->pagesize;
 if (b >= (128 / 4 + 1))
  b = (128 / 4 + 1) - 1;
 sp = ((void *)0);
 for (; b < (128 / 4 + 1) - 1; b++) {
  sp = ((&sc->free[b])->vtqh_first);
  if (sp != ((void *)0))
   break;
 }
 if (sp == ((void *)0)) {
  for ((sp) = (((&sc->free[(128 / 4 + 1) -1]))->vtqh_first); (sp); (sp) = (((sp))->status.vtqe_next))
   if (sp->size >= bytes)
    break;
 }
 if (sp == ((void *)0))
 ...
 do { if (!(sp->size >= bytes)) { VAS_Fail(__func__, "storage/storage_file.c", 236, "sp->size >= bytes", VAS_ASSERT); } } while (0);
 remfree(sc, sp);

 if (sp->size == bytes) {
  sp->alloc = 1;
  do { (((sp))->status.vtqe_next) = ((void *)0); (sp)->status.vtqe_prev = (&sc->used)->vtqh_last; *(&sc->used)->vtqh_last = (sp); (&sc->used)->vtqh_last = &(((sp))->status.vtqe_next); } while (0);
  return (sp);
 }


 sp2 = malloc(sizeof *sp2);
 do { do { if (!((sp2) != 0)) { VAS_Fail(__func__, "storage/storage_file.c", 247, "(sp2) != 0", VAS_MISSING); } } while (0); } while (0);
 sc->stats->g_smf++;
 *sp2 = *sp;
 ...
 sp2->size = bytes;
 sp2->alloc = 1;
 do { (sp2)->order.vtqe_prev = (sp)->order.vtqe_prev; (((sp2))->order.vtqe_next) = (sp); *(sp)->order.vtqe_prev = (sp2); (sp)->order.vtqe_prev = &(((sp2))->order.vtqe_next); } while (0);
 do { (((sp2))->status.vtqe_next) = ((void *)0); (sp2)->status.vtqe_prev = (&sc->used)->vtqh_last; *(&sc->used)->vtqh_last = (sp2); (&sc->used)->vtqh_last = &(((sp2))->status.vtqe_next); } while (0);
 insfree(sc, sp);
 return (sp2);
}
...
free_smf(struct smf *sp)
{
 ...
 do { do { if (!((sp) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_file.c", 274, "(sp) != NULL", VAS_ASSERT); } } while (0); do { if (!((sp)->magic == 0x0927a8a0)) { VAS_Fail(__func__, "storage/storage_file.c", 274, "(sp)->magic == 0x0927a8a0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((sp->alloc) != 0)) { VAS_Fail(__func__, "storage/storage_file.c", 275, "(sp->alloc) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { if (!(sp->size > 0)) { VAS_Fail(__func__, "storage/storage_file.c", 276, "sp->size > 0", VAS_ASSERT); } } while (0);
 do { do { if (!((sp->size % sc->pagesize) == 0)) { VAS_Fail(__func__, "storage/storage_file.c", 277, "(sp->size % sc->pagesize) == 0", VAS_ASSERT); } } while (0); } while (0);
 do { if (((((sp))->status.vtqe_next)) != ((void *)0)) (((sp))->status.vtqe_next)->status.vtqe_prev = (sp)->status.vtqe_prev; else { (&sc->used)->vtqh_last = (sp)->status.vtqe_prev; } *(sp)->status.vtqe_prev = (((sp))->status.vtqe_next); ; ; } while (0);
 sp->alloc = 0;

 sp2 = ((sp)->order.vtqe_next);
 if (sp2 != ((void *)0) &&
     sp2->alloc == 0 &&
     (sp2->ptr == sp->ptr + sp->size) &&
     (sp2->offset == sp->offset + sp->size)) {
  sp->size += sp2->size;
  do { if (((((sp2))->order.vtqe_next)) != ((void *)0)) (((sp2))->order.vtqe_next)->order.vtqe_prev = (sp2)->order.vtqe_prev; else { (&sc->order)->vtqh_last = (sp2)->order.vtqe_prev; } *(sp2)->order.vtqe_prev = (((sp2))->order.vtqe_next); ; ; } while (0);
  remfree(sc, sp2);
  free(sp2);
  sc->stats->g_smf--;
 }

 sp2 = (*(((struct smfhead *)((sp)->order.vtqe_prev))->vtqh_last));
 if (sp2 != ((void *)0) &&
     sp2->alloc == 0 &&
  ...
  remfree(sc, sp2);
  sp2->size += sp->size;
  do { if (((((sp))->order.vtqe_next)) != ((void *)0)) (((sp))->order.vtqe_next)->order.vtqe_prev = (sp)->order.vtqe_prev; else { (&sc->order)->vtqh_last = (sp)->order.vtqe_prev; } *(sp)->order.vtqe_prev = (((sp))->order.vtqe_next); ; ; } while (0);
  free(sp);
  sc->stats->g_smf--;
  sp = sp2;
 }
...
trim_smf(struct smf *sp, size_t bytes)
{
 ...
 do { do { if (!((sp->alloc) != 0)) { VAS_Fail(__func__, "storage/storage_file.c", 319, "(sp->alloc) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { if (!(bytes > 0)) { VAS_Fail(__func__, "storage/storage_file.c", 320, "bytes > 0", VAS_ASSERT); } } while (0);
 do { if (!(bytes < sp->size)) { VAS_Fail(__func__, "storage/storage_file.c", 321, "bytes < sp->size", VAS_ASSERT); } } while (0);
 do { do { if (!((bytes % sc->pagesize) == 0)) { VAS_Fail(__func__, "storage/storage_file.c", 322, "(bytes % sc->pagesize) == 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((sp->size % sc->pagesize) == 0)) { VAS_Fail(__func__, "storage/storage_file.c", 323, "(sp->size % sc->pagesize) == 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((sp) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_file.c", 324, "(sp) != NULL", VAS_ASSERT); } } while (0); do { if (!((sp)->magic == 0x0927a8a0)) { VAS_Fail(__func__, "storage/storage_file.c", 324, "(sp)->magic == 0x0927a8a0", VAS_ASSERT); } } while (0); } while (0);
 sp2 = malloc(sizeof *sp2);
 do { do { if (!((sp2) != 0)) { VAS_Fail(__func__, "storage/storage_file.c", 326, "(sp2) != 0", VAS_MISSING); } } while (0); } while (0);
 sc->stats->g_smf++;
 *sp2 = *sp;
 ...
 sp2->ptr += bytes;
 sp2->offset += bytes;
 do { if (((((sp2))->order.vtqe_next) = (((sp))->order.vtqe_next)) != ((void *)0)) (((sp2))->order.vtqe_next)->order.vtqe_prev = &(((sp2))->order.vtqe_next); else { (&sc->order)->vtqh_last = &(((sp2))->order.vtqe_next); } (((sp))->order.vtqe_next) = (sp2); (sp2)->order.vtqe_prev = &(((sp))->order.vtqe_next); } while (0);
 do { (((sp2))->status.vtqe_next) = ((void *)0); (sp2)->status.vtqe_prev = (&sc->used)->vtqh_last; *(&sc->used)->vtqh_last = (sp2); (&sc->used)->vtqh_last = &(((sp2))->status.vtqe_next); } while (0);
 free_smf(sp2);
}
...
new_smf(struct smf_sc *sc, unsigned char *ptr, off_t off, size_t len)
{
 ...
 do { do { if (!((len % sc->pagesize) == 0)) { VAS_Fail(__func__, "storage/storage_file.c", 348, "(len % sc->pagesize) == 0", VAS_ASSERT); } } while (0); } while (0);
 do { (sp) = calloc(sizeof *(sp), 1); if ((sp) != ((void *)0)) (sp)->magic = (0x0927a8a0); } while (0);
 do { do { if (!((sp) != 0)) { VAS_Fail(__func__, "storage/storage_file.c", 350, "(sp) != 0", VAS_MISSING); } } while (0); } while (0);
 sp->s.magic = 0x1a4e51c0;
 sc->stats->g_smf++;
 ...
 for ((sp2) = (((&sc->order))->vtqh_first); (sp2); (sp2) = (((sp2))->order.vtqe_next)) {
  if (sp->ptr < sp2->ptr) {
   do { (sp)->order.vtqe_prev = (sp2)->order.vtqe_prev; (((sp))->order.vtqe_next) = (sp2); *(sp2)->order.vtqe_prev = (sp); (sp2)->order.vtqe_prev = &(((sp))->order.vtqe_next); } while (0);
   break;
  }
 }
 if (sp2 == ((void *)0))
  do { (((sp))->order.vtqe_next) = ((void *)0); (sp)->order.vtqe_prev = (&sc->order)->vtqh_last; *(&sc->order)->vtqh_last = (sp); (&sc->order)->vtqh_last = &(((sp))->order.vtqe_next); } while (0);

 do { if (((((sp))->status.vtqe_next) = (((&sc->used))->vtqh_first)) != ((void *)0)) (((&sc->used))->vtqh_first)->status.vtqe_prev = &(((sp))->status.vtqe_next); else (&sc->used)->vtqh_last = &(((sp))->status.vtqe_next); (((&sc->used))->vtqh_first) = (sp); (sp)->status.vtqe_prev = &(((&sc->used))->vtqh_first); } while (0);

 free_smf(sp);
}
# 383 "storage/storage_file.c"
static void
smf_open_chunk(struct smf_sc *sc, off_t sz, off_t off, off_t *fail, off_t *sum)
{
 ...
 do { do { if (!((sz) != 0)) { VAS_Fail(__func__, "storage/storage_file.c", 389, "(sz) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((sz % sc->pagesize) == 0)) { VAS_Fail(__func__, "storage/storage_file.c", 390, "(sz % sc->pagesize) == 0", VAS_ASSERT); } } while (0); } while (0);

 if (*fail < (uintmax_t)sc->pagesize * 128)
  return;

 if (sz > 0 && sz < *fail && sz < 9223372036854775807L) {
  p = mmap(((void *)0), sz, 0x1|0x2,
      0 | 0 | 0x01, sc->fd, off);
  if (p != ((void *) -1)) {
   (void) madvise(p, sz, 1);
   (*sum) += sz;
...
smf_open(const struct stevedore *st)
{
 ...
 do {do { if (!(pthread_self() == cli_thread)) { VAS_Fail(__func__, "storage/storage_file.c", 425, "pthread_self() == cli_thread", VAS_ASSERT); } } while (0);} while (0);
 if (lck_smf == ((void *)0))
  lck_smf = Lck_CreateClass("smf");
 do { (sc) = (st->priv); do { if (!((sc) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_file.c", 428, "(sc) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((sc))->magic == (0x52962ee7))) { VAS_Fail(__func__, "storage/storage_file.c", 428, "((sc))->magic == (0x52962ee7)", VAS_ASSERT); } } while (0); } while (0); } while (0);
 sc->stats = VSM_Alloc(sizeof *sc->stats,
     "Stat", VSC_type_smf, st->ident);
 Lck__New(&sc->mtx, lck_smf, "lck_smf");
 Lck__Lock(&sc->mtx, __func__, 432);
 smf_open_chunk(sc, sc->filesize, 0, &fail, &sum);
 Lck__Unlock(&sc->mtx, __func__, 434);
 printf("SMF.%s mmap'ed %ju bytes of %ju\n",
     st->ident, (uintmax_t)sum, sc->filesize);


 if (sum < 128 * (off_t)getpagesize())
  exit(4);
...
smf_alloc(const struct stevedore *st, size_t size)
{
 ...
 do { (sc) = (st->priv); do { if (!((sc) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_file.c", 453, "(sc) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((sc))->magic == (0x52962ee7))) { VAS_Fail(__func__, "storage/storage_file.c", 453, "((sc))->magic == (0x52962ee7)", VAS_ASSERT); } } while (0); } while (0); } while (0);
 do { if (!(size > 0)) { VAS_Fail(__func__, "storage/storage_file.c", 454, "size > 0", VAS_ASSERT); } } while (0);
 size += (sc->pagesize - 1);
 size &= ~(sc->pagesize - 1);
 Lck__Lock(&sc->mtx, __func__, 457);
 sc->stats->c_req++;
 smf = alloc_smf(sc, size);
 if (smf == ((void *)0)) {
  sc->stats->c_fail++;
  Lck__Unlock(&sc->mtx, __func__, 462);
  return (((void *)0));
 }
 do { do { if (!((smf) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_file.c", 465, "(smf) != NULL", VAS_ASSERT); } } while (0); do { if (!((smf)->magic == 0x0927a8a0)) { VAS_Fail(__func__, "storage/storage_file.c", 465, "(smf)->magic == 0x0927a8a0", VAS_ASSERT); } } while (0); } while (0);
 sc->stats->g_alloc++;
 sc->stats->c_bytes += smf->size;
 sc->stats->g_bytes += smf->size;
 sc->stats->g_space -= smf->size;
 Lck__Unlock(&sc->mtx, __func__, 470);
 do { do { if (!((&smf->s) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_file.c", 471, "(&smf->s) != NULL", VAS_ASSERT); } } while (0); do { if (!((&smf->s)->magic == 0x1a4e51c0)) { VAS_Fail(__func__, "storage/storage_file.c", 471, "(&smf->s)->magic == 0x1a4e51c0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((smf) != 0)) { VAS_Fail(__func__, "storage/storage_file.c", 472, "(smf) != 0", VAS_MISSING); } } while (0); } while (0);
 do { if (!(smf->size == size)) { VAS_Fail(__func__, "storage/storage_file.c", 473, "smf->size == size", VAS_ASSERT); } } while (0);
 smf->s.space = size;
 smf->s.priv = smf;
 smf->s.ptr = smf->ptr;
 smf->s.len = 0;
...
smf_trim(struct storage *s, size_t size, int move_ok)
{
 ...
 do { do { if (!((s) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_file.c", 489, "(s) != NULL", VAS_ASSERT); } } while (0); do { if (!((s)->magic == 0x1a4e51c0)) { VAS_Fail(__func__, "storage/storage_file.c", 489, "(s)->magic == 0x1a4e51c0", VAS_ASSERT); } } while (0); } while (0);
 do { if (!(size > 0)) { VAS_Fail(__func__, "storage/storage_file.c", 490, "size > 0", VAS_ASSERT); } } while (0);
 do { if (!(size <= s->space)) { VAS_Fail(__func__, "storage/storage_file.c", 491, "size <= s->space", VAS_ASSERT); } } while (0);
 do { if (!(size > 0)) { VAS_Fail(__func__, "storage/storage_file.c", 492, "size > 0", VAS_MISSING); } } while (0);
 do { (smf) = (s->priv); do { if (!((smf) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_file.c", 493, "(smf) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((smf))->magic == (0x0927a8a0))) { VAS_Fail(__func__, "storage/storage_file.c", 493, "((smf))->magic == (0x0927a8a0)", VAS_ASSERT); } } while (0); } while (0); } while (0);
 do { if (!(size <= smf->size)) { VAS_Fail(__func__, "storage/storage_file.c", 494, "size <= smf->size", VAS_ASSERT); } } while (0);
 ...
 size &= ~(sc->pagesize - 1);
 if (smf->size > size) {
  Lck__Lock(&sc->mtx, __func__, 503);
  sc->stats->c_freed += (smf->size - size);
  sc->stats->g_bytes -= (smf->size - size);
  sc->stats->g_space += (smf->size - size);
  trim_smf(smf, size);
  do { if (!(smf->size == size)) { VAS_Fail(__func__, "storage/storage_file.c", 508, "smf->size == size", VAS_ASSERT); } } while (0);
  Lck__Unlock(&sc->mtx, __func__, 509);
  s->space = size;
 }
}
...
smf_free(struct storage *s)
{
 ...
 do { do { if (!((s) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_file.c", 522, "(s) != NULL", VAS_ASSERT); } } while (0); do { if (!((s)->magic == 0x1a4e51c0)) { VAS_Fail(__func__, "storage/storage_file.c", 522, "(s)->magic == 0x1a4e51c0", VAS_ASSERT); } } while (0); } while (0);
 do { (smf) = (s->priv); do { if (!((smf) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_file.c", 523, "(smf) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((smf))->magic == (0x0927a8a0))) { VAS_Fail(__func__, "storage/storage_file.c", 523, "((smf))->magic == (0x0927a8a0)", VAS_ASSERT); } } while (0); } while (0); } while (0);
 sc = smf->sc;
 Lck__Lock(&sc->mtx, __func__, 525);
 sc->stats->g_alloc--;
 sc->stats->c_freed += smf->size;
 sc->stats->g_bytes -= smf->size;
 sc->stats->g_space += smf->size;
 free_smf(smf);
 Lck__Unlock(&sc->mtx, __func__, 531);
}
