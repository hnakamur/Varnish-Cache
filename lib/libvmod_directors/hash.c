    ...
    const char *vcl_name)
{
 ...
 do { do { if (!((ctx) != ((void *)0))) { VAS_Fail(__func__, "hash.c", 57, "(ctx) != NULL", VAS_ASSERT); } } while (0); do { if (!((ctx)->magic == 0x6bb8f0db)) { VAS_Fail(__func__, "hash.c", 57, "(ctx)->magic == 0x6bb8f0db", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((rrp) != 0)) { VAS_Fail(__func__, "hash.c", 58, "(rrp) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((*rrp) == 0)) { VAS_Fail(__func__, "hash.c", 59, "(*rrp) == 0", VAS_ASSERT); } } while (0); } while (0);
 do { (rr) = calloc(sizeof *(rr), 1); if ((rr) != ((void *)0)) (rr)->magic = (0xc08dd611); } while (0);
 do { do { if (!((rr) != 0)) { VAS_Fail(__func__, "hash.c", 61, "(rr) != 0", VAS_ASSERT); } } while (0); } while (0);
 *rrp = rr;
 vdir_new(&rr->vd, "hash", vcl_name, ((void *)0), ((void *)0), rr);
}
...
vmod_hash__fini(struct vmod_directors_hash **rrp)
{
 ...
 rr = *rrp;
 *rrp = ((void *)0);
 do { do { if (!((rr) != ((void *)0))) { VAS_Fail(__func__, "hash.c", 73, "(rr) != NULL", VAS_ASSERT); } } while (0); do { if (!((rr)->magic == 0xc08dd611)) { VAS_Fail(__func__, "hash.c", 73, "(rr)->magic == 0xc08dd611", VAS_ASSERT); } } while (0); } while (0);
 vdir_delete(&rr->vd);
    ...
    struct vmod_directors_hash *rr, VCL_BACKEND be, double w)
{
 ...
 do { do { if (!((ctx) != ((void *)0))) { VAS_Fail(__func__, "hash.c", 83, "(ctx) != NULL", VAS_ASSERT); } } while (0); do { if (!((ctx)->magic == 0x6bb8f0db)) { VAS_Fail(__func__, "hash.c", 83, "(ctx)->magic == 0x6bb8f0db", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((rr) != ((void *)0))) { VAS_Fail(__func__, "hash.c", 84, "(rr) != NULL", VAS_ASSERT); } } while (0); do { if (!((rr)->magic == 0xc08dd611)) { VAS_Fail(__func__, "hash.c", 84, "(rr)->magic == 0xc08dd611", VAS_ASSERT); } } while (0); } while (0);
    ...
    const char *arg, ...)
{
 ...
 do { do { if (!((ctx) != ((void *)0))) { VAS_Fail(__func__, "hash.c", 99, "(ctx) != NULL", VAS_ASSERT); } } while (0); do { if (!((ctx)->magic == 0x6bb8f0db)) { VAS_Fail(__func__, "hash.c", 99, "(ctx)->magic == 0x6bb8f0db", VAS_ASSERT); } } while (0); } while (0);
 do { if ((ctx->bo) != ((void *)0)) do { if (!((ctx->bo)->magic == 0x23b95567)) { VAS_Fail(__func__, "hash.c", 100, "(ctx->bo)->magic == 0x23b95567", VAS_ASSERT); } } while (0); } while (0);

 do { do { if (!((rr) != ((void *)0))) { VAS_Fail(__func__, "hash.c", 102, "(rr) != NULL", VAS_ASSERT); } } while (0); do { if (!((rr)->magic == 0xc08dd611)) { VAS_Fail(__func__, "hash.c", 102, "(rr)->magic == 0xc08dd611", VAS_ASSERT); } } while (0); } while (0);
 SHA256_Init(&sha_ctx);
 ...
 r = vbe32dec(sha256);
 r = scalbn(r, -32);
 do { if (!(r >= 0 && r <= 1.0)) { VAS_Fail(__func__, "hash.c", 116, "r >= 0 && r <= 1.0", VAS_ASSERT); } } while (0);
