...
# 1 "<command-line>" 2
# 1 "http1/cache_http1_vfp.c"
# 36 "http1/cache_http1_vfp.c"
# 1 "../../config.h" 1
# 37 "http1/cache_http1_vfp.c" 2
...
v1f_read(const struct vfp_ctx *vc, struct http_conn *htc, void *d, ssize_t len)
{
 ...
 do { do { if (!((vc) != ((void *)0))) { VAS_Fail(__func__, "http1/cache_http1_vfp.c", 58, "(vc) != NULL", VAS_ASSERT); } } while (0); do { if (!((vc)->magic == 0x61d9d3e5)) { VAS_Fail(__func__, "http1/cache_http1_vfp.c", 58, "(vc)->magic == 0x61d9d3e5", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((htc) != ((void *)0))) { VAS_Fail(__func__, "http1/cache_http1_vfp.c", 59, "(htc) != NULL", VAS_ASSERT); } } while (0); do { if (!((htc)->magic == 0x3e19edd1)) { VAS_Fail(__func__, "http1/cache_http1_vfp.c", 59, "(htc)->magic == 0x3e19edd1", VAS_ASSERT); } } while (0); } while (0);
 do { if (!(len > 0)) { VAS_Fail(__func__, "http1/cache_http1_vfp.c", 60, "len > 0", VAS_ASSERT); } } while (0);
 l = 0;
 p = d;
 if (htc->pipeline_b) {
  l = htc->pipeline_e - htc->pipeline_b;
  do { if (!(l > 0)) { VAS_Fail(__func__, "http1/cache_http1_vfp.c", 65, "l > 0", VAS_ASSERT); } } while (0);
  if (l > len)
   l = len;
  ...
  if (htc->pipeline_b == htc->pipeline_e)
   htc->pipeline_b = htc->pipeline_e = ((void *)0);
 }
 if (len > 0) {
  i = read(htc->fd, p, len);
  if (i < 0) {
    ...
    ssize_t *lp)
{
 ...
 do { do { if (!((vc) != ((void *)0))) { VAS_Fail(__func__, "http1/cache_http1_vfp.c", 106, "(vc) != NULL", VAS_ASSERT); } } while (0); do { if (!((vc)->magic == 0x61d9d3e5)) { VAS_Fail(__func__, "http1/cache_http1_vfp.c", 106, "(vc)->magic == 0x61d9d3e5", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((vfe) != ((void *)0))) { VAS_Fail(__func__, "http1/cache_http1_vfp.c", 107, "(vfe) != NULL", VAS_ASSERT); } } while (0); do { if (!((vfe)->magic == 0xbe32a027)) { VAS_Fail(__func__, "http1/cache_http1_vfp.c", 107, "(vfe)->magic == 0xbe32a027", VAS_ASSERT); } } while (0); } while (0);
 do { (htc) = (vfe->priv1); do { if (!((htc) != ((void *)0))) { VAS_Fail(__func__, "http1/cache_http1_vfp.c", 108, "(htc) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((htc))->magic == (0x3e19edd1))) { VAS_Fail(__func__, "http1/cache_http1_vfp.c", 108, "((htc))->magic == (0x3e19edd1)", VAS_ASSERT); } } while (0); } while (0); } while (0);
 do { do { if (!((ptr) != 0)) { VAS_Fail(__func__, "http1/cache_http1_vfp.c", 109, "(ptr) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((lp) != 0)) { VAS_Fail(__func__, "http1/cache_http1_vfp.c", 110, "(lp) != 0", VAS_ASSERT); } } while (0); } while (0);

 do { do { if (!((ptr) != 0)) { VAS_Fail(__func__, "http1/cache_http1_vfp.c", 112, "(ptr) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((lp) != 0)) { VAS_Fail(__func__, "http1/cache_http1_vfp.c", 113, "(lp) != 0", VAS_ASSERT); } } while (0); } while (0);
 l = *lp;
 *lp = 0;
 if (vfe->priv2 == -1) {
  ...
  while(vct_is(buf[u], ((1<<1) | (1<<0))) && buf[u] != '\n') {
   lr = v1f_read(vc, htc, buf + u, 1);
   if (lr <= 0)
    return (VFP_Error(vc, "chunked read err"));
  }
 ...
 do { do { if (!((vfe->priv2) == 0)) { VAS_Fail(__func__, "http1/cache_http1_vfp.c", 175, "(vfe->priv2) == 0", VAS_ASSERT); } } while (0); } while (0);
    ...
    ssize_t *lp)
{
 ...
 do { do { if (!((vc) != ((void *)0))) { VAS_Fail(__func__, "http1/cache_http1_vfp.c", 201, "(vc) != NULL", VAS_ASSERT); } } while (0); do { if (!((vc)->magic == 0x61d9d3e5)) { VAS_Fail(__func__, "http1/cache_http1_vfp.c", 201, "(vc)->magic == 0x61d9d3e5", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((vfe) != ((void *)0))) { VAS_Fail(__func__, "http1/cache_http1_vfp.c", 202, "(vfe) != NULL", VAS_ASSERT); } } while (0); do { if (!((vfe)->magic == 0xbe32a027)) { VAS_Fail(__func__, "http1/cache_http1_vfp.c", 202, "(vfe)->magic == 0xbe32a027", VAS_ASSERT); } } while (0); } while (0);
 do { (htc) = (vfe->priv1); do { if (!((htc) != ((void *)0))) { VAS_Fail(__func__, "http1/cache_http1_vfp.c", 203, "(htc) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((htc))->magic == (0x3e19edd1))) { VAS_Fail(__func__, "http1/cache_http1_vfp.c", 203, "((htc))->magic == (0x3e19edd1)", VAS_ASSERT); } } while (0); } while (0); } while (0);
 do { do { if (!((p) != 0)) { VAS_Fail(__func__, "http1/cache_http1_vfp.c", 204, "(p) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((lp) != 0)) { VAS_Fail(__func__, "http1/cache_http1_vfp.c", 205, "(lp) != 0", VAS_ASSERT); } } while (0); } while (0);
...
v1f_pull_eof(struct vfp_ctx *vc, struct vfp_entry *vfe, void *p, ssize_t *lp)
{
 ...
 do { do { if (!((vc) != ((void *)0))) { VAS_Fail(__func__, "http1/cache_http1_vfp.c", 237, "(vc) != NULL", VAS_ASSERT); } } while (0); do { if (!((vc)->magic == 0x61d9d3e5)) { VAS_Fail(__func__, "http1/cache_http1_vfp.c", 237, "(vc)->magic == 0x61d9d3e5", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((vfe) != ((void *)0))) { VAS_Fail(__func__, "http1/cache_http1_vfp.c", 238, "(vfe) != NULL", VAS_ASSERT); } } while (0); do { if (!((vfe)->magic == 0xbe32a027)) { VAS_Fail(__func__, "http1/cache_http1_vfp.c", 238, "(vfe)->magic == 0xbe32a027", VAS_ASSERT); } } while (0); } while (0);
 do { (htc) = (vfe->priv1); do { if (!((htc) != ((void *)0))) { VAS_Fail(__func__, "http1/cache_http1_vfp.c", 239, "(htc) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((htc))->magic == (0x3e19edd1))) { VAS_Fail(__func__, "http1/cache_http1_vfp.c", 239, "((htc))->magic == (0x3e19edd1)", VAS_ASSERT); } } while (0); } while (0); } while (0);
 do { do { if (!((p) != 0)) { VAS_Fail(__func__, "http1/cache_http1_vfp.c", 240, "(p) != 0", VAS_ASSERT); } } while (0); } while (0);

 do { do { if (!((lp) != 0)) { VAS_Fail(__func__, "http1/cache_http1_vfp.c", 242, "(lp) != 0", VAS_ASSERT); } } while (0); } while (0);
...
V1F_Setup_Fetch(struct vfp_ctx *vfc, struct http_conn *htc)
{
 ...
 do { do { if (!((vfc) != ((void *)0))) { VAS_Fail(__func__, "http1/cache_http1_vfp.c", 268, "(vfc) != NULL", VAS_ASSERT); } } while (0); do { if (!((vfc)->magic == 0x61d9d3e5)) { VAS_Fail(__func__, "http1/cache_http1_vfp.c", 268, "(vfc)->magic == 0x61d9d3e5", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((htc) != ((void *)0))) { VAS_Fail(__func__, "http1/cache_http1_vfp.c", 269, "(htc) != NULL", VAS_ASSERT); } } while (0); do { if (!((htc)->magic == 0x3e19edd1)) { VAS_Fail(__func__, "http1/cache_http1_vfp.c", 269, "(htc)->magic == 0x3e19edd1", VAS_ASSERT); } } while (0); } while (0);

 switch(htc->body_status) {
 case BS_EOF:
  do { if (!(htc->content_length == -1)) { VAS_Fail(__func__, "http1/cache_http1_vfp.c", 273, "htc->content_length == -1", VAS_ASSERT); } } while (0);
  vfe = VFP_Push(vfc, &v1f_eof, 0);
  vfe->priv2 = 0;
  break;
 case BS_LENGTH:
  do { if (!(htc->content_length > 0)) { VAS_Fail(__func__, "http1/cache_http1_vfp.c", 278, "htc->content_length > 0", VAS_ASSERT); } } while (0);
  vfe = VFP_Push(vfc, &v1f_straight, 0);
  vfe->priv2 = htc->content_length;
  break;
 case BS_CHUNKED:
  do { if (!(htc->content_length == -1)) { VAS_Fail(__func__, "http1/cache_http1_vfp.c", 283, "htc->content_length == -1", VAS_ASSERT); } } while (0);
  vfe = VFP_Push(vfc, &v1f_chunked, 0);
  vfe->priv2 = -1;
  break;
 default:
  do { VAS_Fail(__func__, "http1/cache_http1_vfp.c", 288, "Wrong body_status", VAS_WRONG); } while (0);
  break;
 }
 vfe->priv1 = htc;
}
