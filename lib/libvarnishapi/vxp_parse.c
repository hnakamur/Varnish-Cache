...
vex_alloc(const struct vxp *vxp)
{
 ...
 do { (vex) = calloc(sizeof *(vex), 1); if ((vex) != ((void *)0)) (vex)->magic = (0xC7DB792D); } while (0);
 do { do { if (!((vex) != 0)) { VAS_Fail(__func__, "vxp_parse.c", 63, "(vex) != 0", VAS_ASSERT); } } while (0); } while (0);
...
vxp_expr_lhs(struct vxp *vxp, struct vex_lhs **plhs)
{
 ...
 do { do { if (!((plhs) != 0)) { VAS_Fail(__func__, "vxp_parse.c", 74, "(plhs) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((*plhs) == 0)) { VAS_Fail(__func__, "vxp_parse.c", 75, "(*plhs) == 0", VAS_ASSERT); } } while (0); } while (0);
 do { (*plhs) = calloc(sizeof *(*plhs), 1); if ((*plhs) != ((void *)0)) (*plhs)->magic = (0x1AD3D78D); } while (0);
 do { do { if (!((*plhs) != 0)) { VAS_Fail(__func__, "vxp_parse.c", 77, "(*plhs) != 0", VAS_ASSERT); } } while (0); } while (0);
 (*plhs)->tags = vbit_init(256);
 (*plhs)->level = -1;
 ...
 if (vxp->t->tok == '{') {
  ...
  vxp_NextToken(vxp);
  do { vxp__Expect(vxp, '}'); do { if ((vxp)->err) return; } while (0); } while (0);
  vxp_NextToken(vxp);
 }
 ...
 while (1) {
  ...
  do { if (!(i > 0)) { VAS_Fail(__func__, "vxp_parse.c", 138, "i > 0", VAS_ASSERT); } } while (0);
  vxp_NextToken(vxp);
  if (vxp->t->tok != ',')
   break;
  vxp_NextToken(vxp);
 ...
 if (vxp->t->tok == ':') {
  ...
  do { do { if (!((vxp->t->dec) != 0)) { VAS_Fail(__func__, "vxp_parse.c", 154, "(vxp->t->dec) != 0", VAS_ASSERT); } } while (0); } while (0);
  (*plhs)->prefix = (__extension__ (__builtin_constant_p (vxp->t->dec) && ((size_t)(const void *)((vxp->t->dec) + 1) - (size_t)(const void *)(vxp->t->dec) == 1) ? (((const char *) (vxp->t->dec))[0] == '\0' ? (char *) calloc ((size_t) 1, (size_t) 1) : ({ size_t __len = strlen (vxp->t->dec) + 1; char *__retval = (char *) malloc (__len); if (__retval != ((void *)0)) __retval = (char *) memcpy (__retval, vxp->t->dec, __len); __retval; })) : __strdup (vxp->t->dec)));
  do { do { if (!(((*plhs)->prefix) != 0)) { VAS_Fail(__func__, "vxp_parse.c", 156, "((*plhs)->prefix) != 0", VAS_ASSERT); } } while (0); } while (0);
...
vxp_expr_num(struct vxp *vxp, struct vex_rhs **prhs)
{
 ...
 do { do { if (!((prhs) != 0)) { VAS_Fail(__func__, "vxp_parse.c", 187, "(prhs) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((*prhs) == 0)) { VAS_Fail(__func__, "vxp_parse.c", 188, "(*prhs) == 0", VAS_ASSERT); } } while (0); } while (0);
 if (vxp->t->tok != 140) {
  VSB_printf(vxp->sb, "Expected number got '%.*s' ", (int)((vxp->t)->e - (vxp->t)->b), (vxp->t)->b);
  vxp_ErrWhere(vxp, vxp->t, -1);
  return;
 }
 do { do { if (!((vxp->t->dec) != 0)) { VAS_Fail(__func__, "vxp_parse.c", 194, "(vxp->t->dec) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { (*prhs) = calloc(sizeof *(*prhs), 1); if ((*prhs) != ((void *)0)) (*prhs)->magic = (0x3F109965); } while (0);
 do { do { if (!((*prhs) != 0)) { VAS_Fail(__func__, "vxp_parse.c", 196, "(*prhs) != 0", VAS_ASSERT); } } while (0); } while (0);
 if ((__extension__ (__builtin_constant_p ('.') && !__builtin_constant_p (vxp->t->dec) && ('.') == '\0' ? (char *) __rawmemchr (vxp->t->dec, '.') : __builtin_strchr (vxp->t->dec, '.')))) {
  (*prhs)->type = VEX_FLOAT;
  (*prhs)->val_float = VNUM(vxp->t->dec);
  if ((sizeof ((*prhs)->val_float) == sizeof (float) ? __isnanf ((*prhs)->val_float) : sizeof ((*prhs)->val_float) == sizeof (double) ? __isnan ((*prhs)->val_float) : __isnanl ((*prhs)->val_float))) {
  ...
  while (((*__ctype_b_loc ())[(int) ((*endptr))] & (unsigned short int) _ISspace))
   endptr++;
  if (*endptr != '\0') {
...
vxp_expr_str(struct vxp *vxp, struct vex_rhs **prhs)
{
 ...
 do { do { if (!((prhs) != 0)) { VAS_Fail(__func__, "vxp_parse.c", 223, "(prhs) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((*prhs) == 0)) { VAS_Fail(__func__, "vxp_parse.c", 224, "(*prhs) == 0", VAS_ASSERT); } } while (0); } while (0);
 if (vxp->t->tok != 140) {
  VSB_printf(vxp->sb, "Expected string got '%.*s' ", (int)((vxp->t)->e - (vxp->t)->b), (vxp->t)->b);
  vxp_ErrWhere(vxp, vxp->t, -1);
  return;
 }
 do { do { if (!((vxp->t->dec) != 0)) { VAS_Fail(__func__, "vxp_parse.c", 230, "(vxp->t->dec) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { (*prhs) = calloc(sizeof *(*prhs), 1); if ((*prhs) != ((void *)0)) (*prhs)->magic = (0x3F109965); } while (0);
 do { do { if (!((*prhs) != 0)) { VAS_Fail(__func__, "vxp_parse.c", 232, "(*prhs) != 0", VAS_ASSERT); } } while (0); } while (0);
 (*prhs)->type = VEX_STRING;
 (*prhs)->val_string = (__extension__ (__builtin_constant_p (vxp->t->dec) && ((size_t)(const void *)((vxp->t->dec) + 1) - (size_t)(const void *)(vxp->t->dec) == 1) ? (((const char *) (vxp->t->dec))[0] == '\0' ? (char *) calloc ((size_t) 1, (size_t) 1) : ({ size_t __len = strlen (vxp->t->dec) + 1; char *__retval = (char *) malloc (__len); if (__retval != ((void *)0)) __retval = (char *) memcpy (__retval, vxp->t->dec, __len); __retval; })) : __strdup (vxp->t->dec)));
 do { do { if (!(((*prhs)->val_string) != 0)) { VAS_Fail(__func__, "vxp_parse.c", 235, "((*prhs)->val_string) != 0", VAS_ASSERT); } } while (0); } while (0);
...
vxp_expr_regex(struct vxp *vxp, struct vex_rhs **prhs)
{
 ...
 do { do { if (!((prhs) != 0)) { VAS_Fail(__func__, "vxp_parse.c", 248, "(prhs) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((*prhs) == 0)) { VAS_Fail(__func__, "vxp_parse.c", 249, "(*prhs) == 0", VAS_ASSERT); } } while (0); } while (0);
 if (vxp->t->tok != 140) {
 ...
 do { do { if (!((vxp->t->dec) != 0)) { VAS_Fail(__func__, "vxp_parse.c", 256, "(vxp->t->dec) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { (*prhs) = calloc(sizeof *(*prhs), 1); if ((*prhs) != ((void *)0)) (*prhs)->magic = (0x3F109965); } while (0);
 do { do { if (!((*prhs) != 0)) { VAS_Fail(__func__, "vxp_parse.c", 258, "(*prhs) != 0", VAS_ASSERT); } } while (0); } while (0);
 (*prhs)->type = VEX_REGEX;
 (*prhs)->val_string = (__extension__ (__builtin_constant_p (vxp->t->dec) && ((size_t)(const void *)((vxp->t->dec) + 1) - (size_t)(const void *)(vxp->t->dec) == 1) ? (((const char *) (vxp->t->dec))[0] == '\0' ? (char *) calloc ((size_t) 1, (size_t) 1) : ({ size_t __len = strlen (vxp->t->dec) + 1; char *__retval = (char *) malloc (__len); if (__retval != ((void *)0)) __retval = (char *) memcpy (__retval, vxp->t->dec, __len); __retval; })) : __strdup (vxp->t->dec)));
 (*prhs)->val_regex = VRE_compile(vxp->t->dec, vxp->vre_options,
     &errptr, &erroff);
 if ((*prhs)->val_regex == ((void *)0)) {
  do { do { if (!((errptr) != 0)) { VAS_Fail(__func__, "vxp_parse.c", 264, "(errptr) != 0", VAS_ASSERT); } } while (0); } while (0);
...
vxp_expr_cmp(struct vxp *vxp, struct vex **pvex)
{
 ...
 do { do { if (!((pvex) != 0)) { VAS_Fail(__func__, "vxp_parse.c", 283, "(pvex) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((*pvex) == 0)) { VAS_Fail(__func__, "vxp_parse.c", 284, "(*pvex) == 0", VAS_ASSERT); } } while (0); } while (0);
 *pvex = vex_alloc(vxp);
 do { do { if (!((*pvex) != 0)) { VAS_Fail(__func__, "vxp_parse.c", 286, "(*pvex) != 0", VAS_ASSERT); } } while (0); } while (0);
 vxp_expr_lhs(vxp, &(*pvex)->lhs);
 do { if ((vxp)->err) return; } while (0);
 ...
 switch((*pvex)->tok) {
 case '\0':
  do { VAS_Fail(__func__, "vxp_parse.c", 328, "Missing token", VAS_WRONG); } while (0);
  break;
 case 130:
 case '<':
 case '>':
 ...
 case 134:
  ...
  break;
 default:
  do { VAS_Fail(__func__, "vxp_parse.c", 347, "", VAS_INCOMPLETE); } while (0);
 }
}
# 358 "vxp_parse.c"
static void
vxp_expr_group(struct vxp *vxp, struct vex **pvex)
{
 ...
 do { do { if (!((pvex) != 0)) { VAS_Fail(__func__, "vxp_parse.c", 362, "(pvex) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((*pvex) == 0)) { VAS_Fail(__func__, "vxp_parse.c", 363, "(*pvex) == 0", VAS_ASSERT); } } while (0); } while (0);

 if (vxp->t->tok == '(') {
  do { vxp__Expect(vxp, '('); do { if ((vxp)->err) return; } while (0); vxp_NextToken(vxp); } while (0);
...
vxp_expr_not(struct vxp *vxp, struct vex **pvex)
{
 ...
 do { do { if (!((pvex) != 0)) { VAS_Fail(__func__, "vxp_parse.c", 387, "(pvex) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((*pvex) == 0)) { VAS_Fail(__func__, "vxp_parse.c", 388, "(*pvex) == 0", VAS_ASSERT); } } while (0); } while (0);

 if (vxp->t->tok == 135) {
  *pvex = vex_alloc(vxp);
  do { do { if (!((*pvex) != 0)) { VAS_Fail(__func__, "vxp_parse.c", 392, "(*pvex) != 0", VAS_ASSERT); } } while (0); } while (0);
  (*pvex)->tok = vxp->t->tok;
  vxp_NextToken(vxp);
...
vxp_expr_and(struct vxp *vxp, struct vex **pvex)
{
 ...
 do { do { if (!((pvex) != 0)) { VAS_Fail(__func__, "vxp_parse.c", 413, "(pvex) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((*pvex) == 0)) { VAS_Fail(__func__, "vxp_parse.c", 414, "(*pvex) == 0", VAS_ASSERT); } } while (0); } while (0);
 vxp_expr_not(vxp, pvex);
 do { if ((vxp)->err) return; } while (0);
 while (vxp->t->tok == 129) {
  a = *pvex;
  *pvex = vex_alloc(vxp);
  do { do { if (!((*pvex) != 0)) { VAS_Fail(__func__, "vxp_parse.c", 420, "(*pvex) != 0", VAS_ASSERT); } } while (0); } while (0);
  (*pvex)->tok = vxp->t->tok;
  (*pvex)->a = a;
  vxp_NextToken(vxp);
  do { if ((vxp)->err) return; } while (0);
...
vxp_expr_or(struct vxp *vxp, struct vex **pvex)
{
 ...
 do { do { if (!((pvex) != 0)) { VAS_Fail(__func__, "vxp_parse.c", 441, "(pvex) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((*pvex) == 0)) { VAS_Fail(__func__, "vxp_parse.c", 442, "(*pvex) == 0", VAS_ASSERT); } } while (0); } while (0);
 vxp_expr_and(vxp, pvex);
 do { if ((vxp)->err) return; } while (0);
 while (vxp->t->tok == 136) {
  a = *pvex;
  *pvex = vex_alloc(vxp);
  do { do { if (!((*pvex) != 0)) { VAS_Fail(__func__, "vxp_parse.c", 448, "(*pvex) != 0", VAS_ASSERT); } } while (0); } while (0);
  (*pvex)->tok = vxp->t->tok;
  (*pvex)->a = a;
  vxp_NextToken(vxp);
  do { if ((vxp)->err) return; } while (0);
...
vxp_expr(struct vxp *vxp, struct vex **pvex)
{
 vxp_expr_or(vxp, pvex);
 do { if ((vxp)->err) return; } while (0);
 do { vxp__Expect(vxp, 128); do { if ((vxp)->err) return; } while (0); } while (0);
}
...
vxp_Parse(struct vxp *vxp)
{
 ...
 if (vxp->err) {
  if (vex)
   vex_Free(&vex);
  do { do { if (!((vex) == 0)) { VAS_Fail(__func__, "vxp_parse.c", 490, "(vex) == 0", VAS_ASSERT); } } while (0); } while (0);
  return (((void *)0));
 }
...
vex_Free(struct vex **pvex)
{
 ...
 if ((*pvex)->lhs != ((void *)0)) {
  if ((*pvex)->lhs->tags != ((void *)0))
   vbit_destroy((*pvex)->lhs->tags);
  if ((*pvex)->lhs->prefix != ((void *)0))
   free((*pvex)->lhs->prefix);
  do { ((*pvex)->lhs)->magic = (0); free((*pvex)->lhs); (*pvex)->lhs = ((void *)0); } while (0);
 }
 if ((*pvex)->rhs != ((void *)0)) {
  ...
  do { ((*pvex)->rhs)->magic = (0); free((*pvex)->rhs); (*pvex)->rhs = ((void *)0); } while (0);
 }
 if ((*pvex)->a != ((void *)0)) {
  vex_Free(&(*pvex)->a);
  do { do { if (!(((*pvex)->a) == 0)) { VAS_Fail(__func__, "vxp_parse.c", 521, "((*pvex)->a) == 0", VAS_ASSERT); } } while (0); } while (0);
 }
 if ((*pvex)->b != ((void *)0)) {
  vex_Free(&(*pvex)->b);
  do { do { if (!(((*pvex)->b) == 0)) { VAS_Fail(__func__, "vxp_parse.c", 525, "((*pvex)->b) == 0", VAS_ASSERT); } } while (0); } while (0);
 }
 do { (*pvex)->magic = (0); free(*pvex); *pvex = ((void *)0); } while (0);
 *pvex = ((void *)0);
}
...
vex_print_rhs(const struct vex_rhs *rhs)
{
 ...
 do { do { if (!((rhs) != ((void *)0))) { VAS_Fail(__func__, "vxp_parse.c", 537, "(rhs) != NULL", VAS_ASSERT); } } while (0); do { if (!((rhs)->magic == 0x3F109965)) { VAS_Fail(__func__, "vxp_parse.c", 537, "(rhs)->magic == 0x3F109965", VAS_ASSERT); } } while (0); } while (0);
 fprintf(stderr, "rhs=");
 switch (rhs->type) {
 case VEX_INT:
 ...
 case VEX_FLOAT:
  ...
  break;
 case VEX_STRING:
  do { do { if (!((rhs->val_string) != 0)) { VAS_Fail(__func__, "vxp_parse.c", 547, "(rhs->val_string) != 0", VAS_ASSERT); } } while (0); } while (0);
  fprintf(stderr, "STRING(%s)", rhs->val_string);
  break;
 case VEX_REGEX:
  do { do { if (!((rhs->val_string) != 0)) { VAS_Fail(__func__, "vxp_parse.c", 551, "(rhs->val_string) != 0", VAS_ASSERT); } } while (0); } while (0);
  do { do { if (!((rhs->val_regex) != 0)) { VAS_Fail(__func__, "vxp_parse.c", 552, "(rhs->val_regex) != 0", VAS_ASSERT); } } while (0); } while (0);
  fprintf(stderr, "REGEX(%s)", rhs->val_string);
  break;
 default:
  do { VAS_Fail(__func__, "vxp_parse.c", 556, "rhs type", VAS_WRONG); } while (0);
  break;
 }
}
...
{
 do { do { if (!((vex) != ((void *)0))) { VAS_Fail(__func__, "vxp_parse.c", 583, "(vex) != NULL", VAS_ASSERT); } } while (0); do { if (!((vex)->magic == 0xC7DB792D)) { VAS_Fail(__func__, "vxp_parse.c", 583, "(vex)->magic == 0xC7DB792D", VAS_ASSERT); } } while (0); } while (0);

 fprintf(stderr, "%*s%s", indent, "", vxp_tnames[vex->tok]);
 if (vex->lhs != ((void *)0)) {
  do { do { if (!((vex->lhs) != ((void *)0))) { VAS_Fail(__func__, "vxp_parse.c", 587, "(vex->lhs) != NULL", VAS_ASSERT); } } while (0); do { if (!((vex->lhs)->magic == 0x1AD3D78D)) { VAS_Fail(__func__, "vxp_parse.c", 587, "(vex->lhs)->magic == 0x1AD3D78D", VAS_ASSERT); } } while (0); } while (0);
  do { do { if (!((vex->lhs->tags) != 0)) { VAS_Fail(__func__, "vxp_parse.c", 588, "(vex->lhs->tags) != 0", VAS_ASSERT); } } while (0); } while (0);
  fprintf(stderr, " lhs=");
  if (vex->lhs->level >= 0)
  ...
  fprintf(stderr, ")");
  if (vex->lhs->prefix) {
   do { if (!(vex->lhs->prefixlen == strlen(vex->lhs->prefix))) { VAS_Fail(__func__, "vxp_parse.c", 598, "vex->lhs->prefixlen == strlen(vex->lhs->prefix)", VAS_ASSERT); } } while (0);
...
vex_PrintTree(const struct vex *vex)
{
 ...
 do { do { if (!((vex) != ((void *)0))) { VAS_Fail(__func__, "vxp_parse.c", 619, "(vex) != NULL", VAS_ASSERT); } } while (0); do { if (!((vex)->magic == 0xC7DB792D)) { VAS_Fail(__func__, "vxp_parse.c", 619, "(vex)->magic == 0xC7DB792D", VAS_ASSERT); } } while (0); } while (0);
