...
# 1 "<command-line>" 2
# 1 "../../lib/libvarnish/vpf.c"
# 29 "../../lib/libvarnish/vpf.c"
# 1 "../../config.h" 1
# 30 "../../lib/libvarnish/vpf.c" 2
...
VPF_Open(const char *path, mode_t mode, pid_t *pidptr)
{
 ...
 {
  do { if (!(path != ((void *)0))) { VAS_Fail(__func__, "../../lib/libvarnish/vpf.c", 115, "path != NULL", VAS_ASSERT); } } while (0);
 ...
 if (fd == -1) {
  if ((*__errno_location ()) == 11 && pidptr != ((void *)0)) {
   (*__errno_location ()) = vpf_read(pfh->pf_path, pidptr);
...
VPF_Write(struct vpf_fh *pfh)
{
 ...
 (*__errno_location ()) = vpf_verify(pfh);
 if ((*__errno_location ()) != 0) {
 ...
 do { if (!(error < sizeof pidstr)) { VAS_Fail(__func__, "../../lib/libvarnish/vpf.c", 192, "error < sizeof pidstr", VAS_ASSERT); } } while (0);
