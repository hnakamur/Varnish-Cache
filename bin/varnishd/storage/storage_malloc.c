...
# 1 "<command-line>" 2
# 1 "storage/storage_malloc.c"
# 32 "storage/storage_malloc.c"
# 1 "../../config.h" 1
# 33 "storage/storage_malloc.c" 2
...
sma_alloc(const struct stevedore *st, size_t size)
{
 ...
 struct sma *sma = ((void *)0);
 void *p;

 do { (sma_sc) = (st->priv); do { if (!((sma_sc) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_malloc.c", 69, "(sma_sc) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((sma_sc))->magic == (0x1ac8a345))) { VAS_Fail(__func__, "storage/storage_malloc.c", 69, "((sma_sc))->magic == (0x1ac8a345)", VAS_ASSERT); } } while (0); } while (0); } while (0);
 Lck__Lock(&sma_sc->sma_mtx, __func__, 70);
 sma_sc->stats->c_req++;
 if (sma_sc->sma_alloc + size > sma_sc->sma_max) {
  ...
  if (sma_sc->sma_max != (18446744073709551615UL))
   sma_sc->stats->g_space -= size;
 }
 Lck__Unlock(&sma_sc->sma_mtx, __func__, 83);

 if (size == 0)
  return (((void *)0));
# 95 "storage/storage_malloc.c"
 p = malloc(size);
 if (p != ((void *)0)) {
  do { (sma) = calloc(sizeof *(sma), 1); if ((sma) != ((void *)0)) (sma)->magic = (0x69ae9bb9); } while (0);
  if (sma != ((void *)0))
   sma->s.ptr = p;
  else
   free(p);
 ...
 if (sma == ((void *)0)) {
  Lck__Lock(&sma_sc->sma_mtx, __func__, 104);
  ...
  if (sma_sc->sma_max != (18446744073709551615UL))
   sma_sc->stats->g_space += size;
  Lck__Unlock(&sma_sc->sma_mtx, __func__, 115);
  return (((void *)0));
 }
 sma->sc = sma_sc;
 sma->sz = size;
...
sma_free(struct storage *s)
{
 ...
 do { do { if (!((s) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_malloc.c", 133, "(s) != NULL", VAS_ASSERT); } } while (0); do { if (!((s)->magic == 0x1a4e51c0)) { VAS_Fail(__func__, "storage/storage_malloc.c", 133, "(s)->magic == 0x1a4e51c0", VAS_ASSERT); } } while (0); } while (0);
 do { (sma) = (s->priv); do { if (!((sma) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_malloc.c", 134, "(sma) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((sma))->magic == (0x69ae9bb9))) { VAS_Fail(__func__, "storage/storage_malloc.c", 134, "((sma))->magic == (0x69ae9bb9)", VAS_ASSERT); } } while (0); } while (0); } while (0);
 sma_sc = sma->sc;
 do { if (!(sma->sz == sma->s.space)) { VAS_Fail(__func__, "storage/storage_malloc.c", 136, "sma->sz == sma->s.space", VAS_ASSERT); } } while (0);
 Lck__Lock(&sma_sc->sma_mtx, __func__, 137);
 ...
 Lck__Unlock(&sma_sc->sma_mtx, __func__, 144);
 free(sma->s.ptr);
 free(sma);
}
...
sma_trim(struct storage *s, size_t size, int move_ok)
{
 ...
 do { do { if (!((s) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_malloc.c", 157, "(s) != NULL", VAS_ASSERT); } } while (0); do { if (!((s)->magic == 0x1a4e51c0)) { VAS_Fail(__func__, "storage/storage_malloc.c", 157, "(s)->magic == 0x1a4e51c0", VAS_ASSERT); } } while (0); } while (0);
 do { (sma) = (s->priv); do { if (!((sma) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_malloc.c", 158, "(sma) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((sma))->magic == (0x69ae9bb9))) { VAS_Fail(__func__, "storage/storage_malloc.c", 158, "((sma))->magic == (0x69ae9bb9)", VAS_ASSERT); } } while (0); } while (0); } while (0);
 sma_sc = sma->sc;

 do { if (!(sma->sz == sma->s.space)) { VAS_Fail(__func__, "storage/storage_malloc.c", 161, "sma->sz == sma->s.space", VAS_ASSERT); } } while (0);
 do { if (!(size < sma->sz)) { VAS_Fail(__func__, "storage/storage_malloc.c", 162, "size < sma->sz", VAS_ASSERT); } } while (0);
 ...
 if (delta < 256)
  return;
 if ((p = realloc(sma->s.ptr, size)) != ((void *)0)) {
  Lck__Lock(&sma_sc->sma_mtx, __func__, 171);
  ...
  sma->sz = size;
  Lck__Unlock(&sma_sc->sma_mtx, __func__, 178);
  sma->s.ptr = p;
  s->space = size;
 }
}
...
sma_used_space(const struct stevedore *st)
{
 ...
 do { (sma_sc) = (st->priv); do { if (!((sma_sc) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_malloc.c", 189, "(sma_sc) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((sma_sc))->magic == (0x1ac8a345))) { VAS_Fail(__func__, "storage/storage_malloc.c", 189, "((sma_sc))->magic == (0x1ac8a345)", VAS_ASSERT); } } while (0); } while (0); } while (0);
...
sma_free_space(const struct stevedore *st)
{
 ...
 do { (sma_sc) = (st->priv); do { if (!((sma_sc) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_malloc.c", 198, "(sma_sc) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((sma_sc))->magic == (0x1ac8a345))) { VAS_Fail(__func__, "storage/storage_malloc.c", 198, "((sma_sc))->magic == (0x1ac8a345)", VAS_ASSERT); } } while (0); } while (0); } while (0);
...
sma_init(struct stevedore *parent, int ac, char * const *av)
{
 ...
 do { do { if (!(getpid() == mgt_pid)) { VAS_Fail(__func__, "storage/storage_malloc.c", 209, "getpid() == mgt_pid", VAS_ASSERT); } } while (0);} while (0);
 do { (sc) = calloc(sizeof *(sc), 1); if ((sc) != ((void *)0)) (sc)->magic = (0x1ac8a345); } while (0);
 do { do { if (!((sc) != 0)) { VAS_Fail(__func__, "storage/storage_malloc.c", 211, "(sc) != 0", VAS_ASSERT); } } while (0); } while (0);
 sc->sma_max = (18446744073709551615UL);
 do { if (!(sc->sma_max == (18446744073709551615UL))) { VAS_Fail(__func__, "storage/storage_malloc.c", 213, "sc->sma_max == SIZE_MAX", VAS_ASSERT); } } while (0);
 parent->priv = sc;

 do { do { if (!((av[ac]) == 0)) { VAS_Fail(__func__, "storage/storage_malloc.c", 216, "(av[ac]) == 0", VAS_ASSERT); } } while (0); } while (0);
 if (ac > 1)
  do { fprintf(stderr, "Error: " "(-smalloc) too many arguments\n"); exit(2); } while (0);
 ...
 if (e != ((void *)0))
  do { fprintf(stderr, "Error: " "(-smalloc) size \"%s\": %s\n", av[0], e); exit(2); } while (0);
 if ((u != (uintmax_t)(size_t)u))
  do { fprintf(stderr, "Error: " "(-smalloc) size \"%s\": too big\n", av[0]); exit(2); } while (0);
 if (u < 1024*1024)
  do { fprintf(stderr, "Error: " "(-smalloc) size \"%s\": too small, " "did you forget to specify M or G?\n", av[0]); exit(2); } while (0)
                                                 ;
...
sma_open(const struct stevedore *st)
{
 ...
 do {do { if (!(pthread_self() == cli_thread)) { VAS_Fail(__func__, "storage/storage_malloc.c", 240, "pthread_self() == cli_thread", VAS_ASSERT); } } while (0);} while (0);
 if (lck_sma == ((void *)0))
  lck_sma = Lck_CreateClass("sma");
 do { (sma_sc) = (st->priv); do { if (!((sma_sc) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_malloc.c", 243, "(sma_sc) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((sma_sc))->magic == (0x1ac8a345))) { VAS_Fail(__func__, "storage/storage_malloc.c", 243, "((sma_sc))->magic == (0x1ac8a345)", VAS_ASSERT); } } while (0); } while (0); } while (0);
 Lck__New(&sma_sc->sma_mtx, lck_sma, "lck_sma");
 sma_sc->stats = VSM_Alloc(sizeof *sma_sc->stats,
     "Stat", VSC_type_sma, st->ident);
