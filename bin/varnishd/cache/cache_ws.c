...
# 36 "cache/cache_ws.c" 2

void
WS_Assert(const struct ws *ws)
{

 do { do { if (!((ws) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_ws.c", 41, "(ws) != NULL", VAS_ASSERT); } } while (0); do { if (!((ws)->magic == 0x35fac554)) { VAS_Fail(__func__, "cache/cache_ws.c", 41, "(ws)->magic == 0x35fac554", VAS_ASSERT); } } while (0); } while (0);
 do { if (DO_DEBUG(DBG_WORKSPACE)) VSL(SLT_Debug, (0), "WS(%p = (%s, %p %u %u %u)", ws, ws->id, ws->s, pdiff(ws->s, ws->f), ws->r == ((void *)0) ? 0 : pdiff(ws->f, ws->r), pdiff(ws->s, ws->e)); } while (0)


                         ;
 do { if (!(ws->s != ((void *)0))) { VAS_Fail(__func__, "cache/cache_ws.c", 46, "ws->s != NULL", VAS_ASSERT); } } while (0);
 do { if (!((((uintptr_t)(ws->s) & (sizeof(void *) - 1)) == 0))) { VAS_Fail(__func__, "cache/cache_ws.c", 47, "PAOK(ws->s)", VAS_ASSERT); } } while (0);
 do { if (!(ws->e != ((void *)0))) { VAS_Fail(__func__, "cache/cache_ws.c", 48, "ws->e != NULL", VAS_ASSERT); } } while (0);
 do { if (!((((uintptr_t)(ws->e) & (sizeof(void *) - 1)) == 0))) { VAS_Fail(__func__, "cache/cache_ws.c", 49, "PAOK(ws->e)", VAS_ASSERT); } } while (0);
 do { if (!(ws->s < ws->e)) { VAS_Fail(__func__, "cache/cache_ws.c", 50, "ws->s < ws->e", VAS_ASSERT); } } while (0);
 do { if (!(ws->f >= ws->s)) { VAS_Fail(__func__, "cache/cache_ws.c", 51, "ws->f >= ws->s", VAS_ASSERT); } } while (0);
 do { if (!(ws->f <= ws->e)) { VAS_Fail(__func__, "cache/cache_ws.c", 52, "ws->f <= ws->e", VAS_ASSERT); } } while (0);
 do { if (!((((uintptr_t)(ws->f) & (sizeof(void *) - 1)) == 0))) { VAS_Fail(__func__, "cache/cache_ws.c", 53, "PAOK(ws->f)", VAS_ASSERT); } } while (0);
 if (ws->r) {
  do { if (!(ws->r > ws->s)) { VAS_Fail(__func__, "cache/cache_ws.c", 55, "ws->r > ws->s", VAS_ASSERT); } } while (0);
  do { if (!(ws->r <= ws->e)) { VAS_Fail(__func__, "cache/cache_ws.c", 56, "ws->r <= ws->e", VAS_ASSERT); } } while (0);
  do { if (!((((uintptr_t)(ws->r) & (sizeof(void *) - 1)) == 0))) { VAS_Fail(__func__, "cache/cache_ws.c", 57, "PAOK(ws->r)", VAS_ASSERT); } } while (0);
 }
 do { if (!(*ws->e == 0x15)) { VAS_Fail(__func__, "cache/cache_ws.c", 59, "*ws->e == 0x15", VAS_ASSERT); } } while (0);
}
...
WS_Init(struct ws *ws, const char *id, void *space, unsigned len)
{
 ...
 do { if (DO_DEBUG(DBG_WORKSPACE)) VSL(SLT_Debug, (0), "WS_Init(%p, \"%s\", %p, %u)", ws, id, space, len); } while (0)
                                                       ;
 do { if (!(space != ((void *)0))) { VAS_Fail(__func__, "cache/cache_ws.c", 73, "space != NULL", VAS_ASSERT); } } while (0);
 do { (void)memset(ws, 0, sizeof *ws); (ws)->magic = (0x35fac554); } while (0);
 ws->s = space;
 do { if (!((((uintptr_t)(space) & (sizeof(void *) - 1)) == 0))) { VAS_Fail(__func__, "cache/cache_ws.c", 76, "PAOK(space)", VAS_ASSERT); } } while (0);
 len = ((uintptr_t)(len - 1) & ~(sizeof(void *) - 1));
 ws->e = ws->s + len;
 *ws->e = 0x15;
 ws->f = ws->s;
 do { if (!(id[0] & 0x20)) { VAS_Fail(__func__, "cache/cache_ws.c", 81, "id[0] & 0x20", VAS_ASSERT); } } while (0);
 do { if (!(strlen(id) < sizeof ws->id)) { VAS_Fail(__func__, "cache/cache_ws.c", 82, "strlen(id) < sizeof ws->id", VAS_ASSERT); } } while (0);
 strcpy(ws->id, id);
 WS_Assert(ws);
}
...
{
 do { do { if (!((ws) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_ws.c", 91, "(ws) != NULL", VAS_ASSERT); } } while (0); do { if (!((ws)->magic == 0x35fac554)) { VAS_Fail(__func__, "cache/cache_ws.c", 91, "(ws)->magic == 0x35fac554", VAS_ASSERT); } } while (0); } while (0);
...
{
 do { do { if (!((ws) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_ws.c", 99, "(ws) != NULL", VAS_ASSERT); } } while (0); do { if (!((ws)->magic == 0x35fac554)) { VAS_Fail(__func__, "cache/cache_ws.c", 99, "(ws)->magic == 0x35fac554", VAS_ASSERT); } } while (0); } while (0);
...
WS_Reset(struct ws *ws, char *p)
{
 ...
 WS_Assert(ws);
 do { if (DO_DEBUG(DBG_WORKSPACE)) VSL(SLT_Debug, (0), "WS_Reset(%p, %p)", ws, p); } while (0);
 do { if (!(ws->r == ((void *)0))) { VAS_Fail(__func__, "cache/cache_ws.c", 114, "ws->r == NULL", VAS_ASSERT); } } while (0);
 if (p == ((void *)0))
  ws->f = ws->s;
 else {
  do { if (!(p >= ws->s)) { VAS_Fail(__func__, "cache/cache_ws.c", 118, "p >= ws->s", VAS_ASSERT); } } while (0);
  do { if (!(p < ws->e)) { VAS_Fail(__func__, "cache/cache_ws.c", 119, "p < ws->e", VAS_ASSERT); } } while (0);
  ws->f = p;
 }
 ws_ClearOverflow(ws);
 WS_Assert(ws);
...
WS_Alloc(struct ws *ws, unsigned bytes)
{
 ...
 WS_Assert(ws);
 bytes = (((uintptr_t)(bytes) + (sizeof(void *) - 1)) & ~(sizeof(void *) - 1));

 do { if (!(ws->r == ((void *)0))) { VAS_Fail(__func__, "cache/cache_ws.c", 134, "ws->r == NULL", VAS_ASSERT); } } while (0);
 if (ws->f + bytes > ws->e) {
  WS_MarkOverflow(ws);
  WS_Assert(ws);
  return(((void *)0));
 ...
 r = ws->f;
 ws->f += bytes;
 do { if (DO_DEBUG(DBG_WORKSPACE)) VSL(SLT_Debug, (0), "WS_Alloc(%p, %u) = %p", ws, bytes, r); } while (0);
 WS_Assert(ws);
 return (r);
}
...
WS_Copy(struct ws *ws, const void *str, int len)
{
 ...
 WS_Assert(ws);
 do { if (!(ws->r == ((void *)0))) { VAS_Fail(__func__, "cache/cache_ws.c", 154, "ws->r == NULL", VAS_ASSERT); } } while (0);

 if (len == -1)
  len = strlen(str) + 1;
 do { if (!(len >= 0)) { VAS_Fail(__func__, "cache/cache_ws.c", 158, "len >= 0", VAS_ASSERT); } } while (0);

 bytes = (((uintptr_t)((unsigned)len) + (sizeof(void *) - 1)) & ~(sizeof(void *) - 1));
 if (ws->f + bytes > ws->e) {
  WS_MarkOverflow(ws);
  WS_Assert(ws);
  return(((void *)0));
 ...
 ws->f += bytes;
 memcpy(r, str, len);
 do { if (DO_DEBUG(DBG_WORKSPACE)) VSL(SLT_Debug, (0), "WS_Copy(%p, %d) = %p", ws, len, r); } while (0);
 WS_Assert(ws);
 return (r);
}
...
WS_Printf(struct ws *ws, const char *fmt, ...)
{
 ...
 WS_Assert(ws);
 do { if (!(ws->r == ((void *)0))) { VAS_Fail(__func__, "cache/cache_ws.c", 182, "ws->r == NULL", VAS_ASSERT); } } while (0);
 u = WS_Reserve(ws, 0);
 p = ws->f;
...
WS_Snapshot(struct ws *ws)
{
 ...
 WS_Assert(ws);
 do { if (!(ws->r == ((void *)0))) { VAS_Fail(__func__, "cache/cache_ws.c", 203, "ws->r == NULL", VAS_ASSERT); } } while (0);
 do { if (DO_DEBUG(DBG_WORKSPACE)) VSL(SLT_Debug, (0), "WS_Snapshot(%p) = %p", ws, ws->f); } while (0);
 return (ws->f);
}
...
WS_Reserve(struct ws *ws, unsigned bytes)
{
 ...
 WS_Assert(ws);
 do { if (!(ws->r == ((void *)0))) { VAS_Fail(__func__, "cache/cache_ws.c", 214, "ws->r == NULL", VAS_ASSERT); } } while (0);

 b2 = ((uintptr_t)(ws->e - ws->f) & ~(sizeof(void *) - 1));
 if (bytes != 0 && bytes < b2)
  b2 = (((uintptr_t)(bytes) + (sizeof(void *) - 1)) & ~(sizeof(void *) - 1));

 do { if (!(ws->f + b2 <= ws->e)) { VAS_Fail(__func__, "cache/cache_ws.c", 220, "ws->f + b2 <= ws->e", VAS_MISSING); } } while (0);
 ws->r = ws->f + b2;
 do { if (DO_DEBUG(DBG_WORKSPACE)) VSL(SLT_Debug, (0), "WS_Reserve(%p, %u/%u) = %u", ws, b2, bytes, pdiff(ws->f, ws->r)); } while (0)
                                        ;
 WS_Assert(ws);
...
WS_Release(struct ws *ws, unsigned bytes)
{
 WS_Assert(ws);
 bytes = (((uintptr_t)(bytes) + (sizeof(void *) - 1)) & ~(sizeof(void *) - 1));
 do { if (!(bytes <= ws->e - ws->f)) { VAS_Fail(__func__, "cache/cache_ws.c", 233, "bytes <= ws->e - ws->f", VAS_ASSERT); } } while (0);
 do { if (DO_DEBUG(DBG_WORKSPACE)) VSL(SLT_Debug, (0), "WS_Release(%p, %u)", ws, bytes); } while (0);
 do { if (!(ws->r != ((void *)0))) { VAS_Fail(__func__, "cache/cache_ws.c", 235, "ws->r != NULL", VAS_ASSERT); } } while (0);
 do { if (!(ws->f + bytes <= ws->r)) { VAS_Fail(__func__, "cache/cache_ws.c", 236, "ws->f + bytes <= ws->r", VAS_ASSERT); } } while (0);
 ws->f += bytes;
 ws->r = ((void *)0);
 WS_Assert(ws);
}
...
{
 WS_Assert(ws);
 do { if (DO_DEBUG(DBG_WORKSPACE)) VSL(SLT_Debug, (0), "WS_ReleaseP(%p, %p)", ws, ptr); } while (0);
 do { if (!(ws->r != ((void *)0))) { VAS_Fail(__func__, "cache/cache_ws.c", 247, "ws->r != NULL", VAS_ASSERT); } } while (0);
 do { if (!(ptr >= ws->f)) { VAS_Fail(__func__, "cache/cache_ws.c", 248, "ptr >= ws->f", VAS_ASSERT); } } while (0);
 do { if (!(ptr <= ws->r)) { VAS_Fail(__func__, "cache/cache_ws.c", 249, "ptr <= ws->r", VAS_ASSERT); } } while (0);
 ws->f += (((uintptr_t)(ptr - ws->f) + (sizeof(void *) - 1)) & ~(sizeof(void *) - 1));
 ws->r = ((void *)0);
 WS_Assert(ws);
}
int
...
{
 do { do { if (!((ws) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_ws.c", 257, "(ws) != NULL", VAS_ASSERT); } } while (0); do { if (!((ws)->magic == 0x35fac554)) { VAS_Fail(__func__, "cache/cache_ws.c", 257, "(ws)->magic == 0x35fac554", VAS_ASSERT); } } while (0); } while (0);
