...
# 1 "<command-line>" 2
# 1 "http1/cache_http1_proto.c"
# 46 "http1/cache_http1_proto.c"
# 1 "../../config.h" 1
# 47 "http1/cache_http1_proto.c" 2
...
# 49 "http1/cache_http1_proto.c" 2
...
# 50 "http1/cache_http1_proto.c" 2
...
# 52 "http1/cache_http1_proto.c" 2
...
HTTP1_Complete(struct http_conn *htc)
{
 ...
 do { do { if (!((htc) != ((void *)0))) { VAS_Fail(__func__, "http1/cache_http1_proto.c", 70, "(htc) != NULL", VAS_ASSERT); } } while (0); do { if (!((htc)->magic == 0x3e19edd1)) { VAS_Fail(__func__, "http1/cache_http1_proto.c", 70, "(htc)->magic == 0x3e19edd1", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((htc->pipeline_b) == 0)) { VAS_Fail(__func__, "http1/cache_http1_proto.c", 71, "(htc->pipeline_b) == 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((htc->pipeline_e) == 0)) { VAS_Fail(__func__, "http1/cache_http1_proto.c", 72, "(htc->pipeline_e) == 0", VAS_ASSERT); } } while (0); } while (0);

 do { if (!(htc->rxbuf_e >= htc->rxbuf_b)) { VAS_Fail(__func__, "http1/cache_http1_proto.c", 74, "htc->rxbuf_e >= htc->rxbuf_b", VAS_ASSERT); } } while (0);
 do { if (!(*htc->rxbuf_e == '\0')) { VAS_Fail(__func__, "http1/cache_http1_proto.c", 75, "*htc->rxbuf_e == '\\0'", VAS_ASSERT); } } while (0);


 for (p = htc->rxbuf_b ; vct_is(*p, ((1<<1) | (1<<0))); p++)
  continue;
 if (p == htc->rxbuf_e) {
...
http1_dissect_hdrs(struct http *hp, char *p, struct http_conn *htc)
{
 ...
 do { if (!(p > htc->rxbuf_b)) { VAS_Fail(__func__, "http1/cache_http1_proto.c", 113, "p > htc->rxbuf_b", VAS_ASSERT); } } while (0);
 do { if (!(p <= htc->rxbuf_e)) { VAS_Fail(__func__, "http1/cache_http1_proto.c", 114, "p <= htc->rxbuf_e", VAS_ASSERT); } } while (0);
 ...
 for (; p < htc->rxbuf_e; p = r) {
  ...
  while (r < htc->rxbuf_e) {
   ...
   q = r;
   do { if (!(r < htc->rxbuf_e)) { VAS_Fail(__func__, "http1/cache_http1_proto.c", 130, "r < htc->rxbuf_e", VAS_ASSERT); } } while (0);
   r += ((r)[0] == 0x0d && (r)[1] == 0x0a ? 2 : 1);
   if (r >= htc->rxbuf_e)
    break;
   if ((((r)[0] == '\r' && (r)[1] == '\n') || (r)[0] == '\n'))
    break;
  ...
  *q = '\0';
  ...
  if ((__extension__ (__builtin_constant_p (':') && !__builtin_constant_p (p) && (':') == '\0' ? (char *) __rawmemchr (p, ':') : __builtin_strchr (p, ':'))) == ((void *)0)) {
...
http1_splitline(struct http *hp, struct http_conn *htc, const int *hf)
{
 ...
 do { if (!(hf == HTTP1_Req || hf == HTTP1_Resp)) { VAS_Fail(__func__, "http1/cache_http1_proto.c", 208, "hf == HTTP1_Req || hf == HTTP1_Resp", VAS_ASSERT); } } while (0);
 do { do { if (!((htc) != ((void *)0))) { VAS_Fail(__func__, "http1/cache_http1_proto.c", 209, "(htc) != NULL", VAS_ASSERT); } } while (0); do { if (!((htc)->magic == 0x3e19edd1)) { VAS_Fail(__func__, "http1/cache_http1_proto.c", 209, "(htc)->magic == 0x3e19edd1", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((hp) != ((void *)0))) { VAS_Fail(__func__, "http1/cache_http1_proto.c", 210, "(hp) != NULL", VAS_ASSERT); } } while (0); do { if (!((hp)->magic == 0x6428b5c9)) { VAS_Fail(__func__, "http1/cache_http1_proto.c", 210, "(hp)->magic == 0x6428b5c9", VAS_ASSERT); } } while (0); } while (0);
 do { if (!(htc->rxbuf_e >= htc->rxbuf_b)) { VAS_Fail(__func__, "http1/cache_http1_proto.c", 211, "htc->rxbuf_e >= htc->rxbuf_b", VAS_ASSERT); } } while (0);

 do { do { if (!((hp->hd[hf[0]].b) == 0)) { VAS_Fail(__func__, "http1/cache_http1_proto.c", 213, "(hp->hd[hf[0]].b) == 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((hp->hd[hf[1]].b) == 0)) { VAS_Fail(__func__, "http1/cache_http1_proto.c", 214, "(hp->hd[hf[1]].b) == 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((hp->hd[hf[2]].b) == 0)) { VAS_Fail(__func__, "http1/cache_http1_proto.c", 215, "(hp->hd[hf[2]].b) == 0", VAS_ASSERT); } } while (0); } while (0);
 ...
 hp->hd[hf[0]].e = p;
 do { if (!(Tlen(hp->hd[hf[0]]))) { VAS_Fail(__func__, "http1/cache_http1_proto.c", 228, "Tlen(hp->hd[hf[0]])", VAS_ASSERT); } } while (0);
 *p++ = '\0';
...
http1_body_status(const struct http *hp, struct http_conn *htc)
{
 ...
 do { do { if (!((htc) != ((void *)0))) { VAS_Fail(__func__, "http1/cache_http1_proto.c", 280, "(htc) != NULL", VAS_ASSERT); } } while (0); do { if (!((htc)->magic == 0x3e19edd1)) { VAS_Fail(__func__, "http1/cache_http1_proto.c", 280, "(htc)->magic == 0x3e19edd1", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((hp) != ((void *)0))) { VAS_Fail(__func__, "http1/cache_http1_proto.c", 281, "(hp) != NULL", VAS_ASSERT); } } while (0); do { if (!((hp)->magic == 0x6428b5c9)) { VAS_Fail(__func__, "http1/cache_http1_proto.c", 281, "(hp)->magic == 0x6428b5c9", VAS_ASSERT); } } while (0); } while (0);
...
HTTP1_DissectRequest(struct http_conn *htc, struct http *hp)
{
 ...
 do { do { if (!((htc) != ((void *)0))) { VAS_Fail(__func__, "http1/cache_http1_proto.c", 344, "(htc) != NULL", VAS_ASSERT); } } while (0); do { if (!((htc)->magic == 0x3e19edd1)) { VAS_Fail(__func__, "http1/cache_http1_proto.c", 344, "(htc)->magic == 0x3e19edd1", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((hp) != ((void *)0))) { VAS_Fail(__func__, "http1/cache_http1_proto.c", 345, "(hp) != NULL", VAS_ASSERT); } } while (0); do { if (!((hp)->magic == 0x6428b5c9)) { VAS_Fail(__func__, "http1/cache_http1_proto.c", 345, "(hp)->magic == 0x6428b5c9", VAS_ASSERT); } } while (0); } while (0);
 ...
 p = http_GetMethod(hp);
 do { do { if (!((p) != 0)) { VAS_Fail(__func__, "http1/cache_http1_proto.c", 377, "(p) != 0", VAS_ASSERT); } } while (0); } while (0);
    ...
    const struct http *req)
{
 ...
 do { do { if (!((htc) != ((void *)0))) { VAS_Fail(__func__, "http1/cache_http1_proto.c", 402, "(htc) != NULL", VAS_ASSERT); } } while (0); do { if (!((htc)->magic == 0x3e19edd1)) { VAS_Fail(__func__, "http1/cache_http1_proto.c", 402, "(htc)->magic == 0x3e19edd1", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((hp) != ((void *)0))) { VAS_Fail(__func__, "http1/cache_http1_proto.c", 403, "(hp) != NULL", VAS_ASSERT); } } while (0); do { if (!((hp)->magic == 0x6428b5c9)) { VAS_Fail(__func__, "http1/cache_http1_proto.c", 403, "(hp)->magic == 0x6428b5c9", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((req) != ((void *)0))) { VAS_Fail(__func__, "http1/cache_http1_proto.c", 404, "(req) != NULL", VAS_ASSERT); } } while (0); do { if (!((req)->magic == 0x6428b5c9)) { VAS_Fail(__func__, "http1/cache_http1_proto.c", 404, "(req)->magic == 0x6428b5c9", VAS_ASSERT); } } while (0); } while (0);
 ...
 if (retval != 0) {
  ...
  do { if (!(retval >= 100 && retval <= 999)) { VAS_Fail(__func__, "http1/cache_http1_proto.c", 436, "retval >= 100 && retval <= 999", VAS_ASSERT); } } while (0);
  do { if (!(retval == 503)) { VAS_Fail(__func__, "http1/cache_http1_proto.c", 437, "retval == 503", VAS_ASSERT); } } while (0);
  hp->status = retval;
  http_SetH(hp, HTTP_HDR_STATUS, "503");
  http_SetH(hp, HTTP_HDR_REASON, http_Status2Reason(retval));
 }

 if (hp->hd[HTTP_HDR_REASON].b == ((void *)0) ||
...
http1_WrTxt(const struct worker *wrk, const txt *hh, const char *suf)
{
 ...
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "http1/cache_http1_proto.c", 459, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "http1/cache_http1_proto.c", 459, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((wrk) != 0)) { VAS_Fail(__func__, "http1/cache_http1_proto.c", 460, "(wrk) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((hh) != 0)) { VAS_Fail(__func__, "http1/cache_http1_proto.c", 461, "(hh) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((hh->b) != 0)) { VAS_Fail(__func__, "http1/cache_http1_proto.c", 462, "(hh->b) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((hh->e) != 0)) { VAS_Fail(__func__, "http1/cache_http1_proto.c", 463, "(hh->e) != 0", VAS_ASSERT); } } while (0); } while (0);
...
HTTP1_Write(const struct worker *w, const struct http *hp, const int *hf)
{
 ...
 do { if (!(hf == HTTP1_Req || hf == HTTP1_Resp)) { VAS_Fail(__func__, "http1/cache_http1_proto.c", 475, "hf == HTTP1_Req || hf == HTTP1_Resp", VAS_ASSERT); } } while (0);
 do { do { if (!((hp->hd[hf[0]].b) != 0)) { VAS_Fail(__func__, "http1/cache_http1_proto.c", 476, "(hp->hd[hf[0]].b) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((hp->hd[hf[1]].b) != 0)) { VAS_Fail(__func__, "http1/cache_http1_proto.c", 477, "(hp->hd[hf[1]].b) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((hp->hd[hf[2]].b) != 0)) { VAS_Fail(__func__, "http1/cache_http1_proto.c", 478, "(hp->hd[hf[2]].b) != 0", VAS_ASSERT); } } while (0); } while (0);
