...
# 38 "../libvarnish/vsb.c" 2

# 1 "../../include/vdef.h" 1
# 40 "../libvarnish/vsb.c" 2
# 1 "../../include/vas.h" 1
# 41 "../../include/vas.h"
enum vas_e {
 VAS_WRONG,
...
_assert_VSB_integrity(const char *fun, const struct vsb *s)
{
 ...
 (void)fun;
 (void)s;
 do { if (!(s != ((void *)0))) { VAS_Fail(__func__,
 "../libvarnish/vsb.c"
# 84 "../libvarnish/vsb.c"
 ,
 85
# 84 "../libvarnish/vsb.c"
 , "s != ((void *)0)", VAS_ASSERT); } } while (0)
                                                ;
 do { if (!(s->magic == 0x4a82dd8a)) { VAS_Fail(__func__,
 "../libvarnish/vsb.c"
# 86 "../libvarnish/vsb.c"
 ,
 87
# 86 "../libvarnish/vsb.c"
 , "s->magic == 0x4a82dd8a", VAS_ASSERT); } } while (0)
                                                 ;
 do { if (!(s->s_buf != ((void *)0))) { VAS_Fail(__func__,
 "../libvarnish/vsb.c"
# 88 "../libvarnish/vsb.c"
 ,
 89
# 88 "../libvarnish/vsb.c"
 , "s->s_buf != ((void *)0)", VAS_ASSERT); } } while (0)
                                                          ;
 do { if (!(s->s_len < s->s_size)) { VAS_Fail(__func__,
 "../libvarnish/vsb.c"
# 90 "../libvarnish/vsb.c"
 ,
 91
# 90 "../libvarnish/vsb.c"
 , "s->s_len < s->s_size", VAS_ASSERT); } } while (0)
                                                               ;
}
...
_assert_VSB_state(const char *fun, const struct vsb *s, int state)
{
 ...
 (void)s;
 (void)state;
 do { if (!((s->s_flags & 0x00020000) == state)) { VAS_Fail(__func__,

 "../libvarnish/vsb.c"
# 101 "../libvarnish/vsb.c"
 ,

 103
# 101 "../libvarnish/vsb.c"
 , "(s->s_flags & 0x00020000) == state", VAS_ASSERT); } } while (0)

                          ;
}
# 117 "../libvarnish/vsb.c"
static int
VSB_extendsize(int size)
{
 ...
 do { if (!(newsize >= size)) { VAS_Fail(__func__, "../libvarnish/vsb.c", 129, "newsize >= size", VAS_ASSERT); } } while (0);
 return (newsize);
}
...
VSB_extend(struct vsb *s, int addlen)
{
 ...
 if (((s)->s_flags & 0x00010000))
  free(s->s_buf);
 else
  do { (s)->s_flags |= (0x00010000); } while (0);
 s->s_buf = newbuf;
 s->s_size = newsize;
 return (0);
}
...
_vsb_indent(struct vsb *s)
{
 if (s->s_indent == 0 || s->s_error != 0 ||
  ...
  return;
 if (((s)->s_size - ((s)->s_len + 1)) <= s->s_indent &&
...
VSB_newbuf(struct vsb *s, char *buf, int length, int flags)
{
 ...
 if ((s->s_flags & 0x00000001) == 0) {
  do { if (!(s->s_size > 1)) { VAS_Fail(__func__,
 "../libvarnish/vsb.c"
# 189 "../libvarnish/vsb.c"
  ,
 190
# 189 "../libvarnish/vsb.c"
  , "s->s_size > 1", VAS_ASSERT); } } while (0)
                                            ;
 }
...
VSB_new(struct vsb *s, char *buf, int length, int flags)
{
 ...
 do { if (!(length >= 0)) { VAS_Fail(__func__,
 "../libvarnish/vsb.c"
# 215 "../libvarnish/vsb.c"
 ,
 216
# 215 "../libvarnish/vsb.c"
 , "length >= 0", VAS_ASSERT); } } while (0)
                                                                  ;
 do { if (!((flags & ~0x0000ffff) == 0)) { VAS_Fail(__func__,
 "../libvarnish/vsb.c"
# 217 "../libvarnish/vsb.c"
 ,
 218
# 217 "../libvarnish/vsb.c"
 , "(flags & ~0x0000ffff) == 0", VAS_ASSERT); } } while (0)
                                                ;
 ...
 if (s == ((void *)0))
  return (((void *)0));
 if (VSB_newbuf(s, buf, length, flags) == ((void *)0)) {
  free(s);
  return (((void *)0));
 }
 do { (s)->s_flags |= (0x00080000); } while (0);
 return (s);
}
...
VSB_clear(struct vsb *s)
{
 ...
 _assert_VSB_integrity(__func__, (s));


 do { (s)->s_flags &= ~(0x00020000); } while (0);
 s->s_error = 0;
 s->s_len = 0;
 s->s_indent = 0;
}
...
VSB_put_byte(struct vsb *s, int c)
{
 ...
 _assert_VSB_integrity(__func__, (s));
 _assert_VSB_state(__func__, (s), (0));

 if (s->s_error != 0)
  return;
 _vsb_indent(s);
 if (((s)->s_size - ((s)->s_len + 1)) <= 0) {
  if (VSB_extend(s, 1) < 0)
   s->s_error = 12;
  if (s->s_error != 0)
   return;
...
VSB_bcat(struct vsb *s, const void *buf, ssize_t len)
{
 ...
 do { if (!(len >= 0)) { VAS_Fail(__func__, "../libvarnish/vsb.c", 284, "len >= 0", VAS_ASSERT); } } while (0);
 if (s->s_error != 0)
  return (-1);
 if (len == 0)
  return (0);
 ...
 if (len > ((s)->s_size - ((s)->s_len + 1))) {
  if (VSB_extend(s, len - ((s)->s_size - ((s)->s_len + 1))) < 0)
   s->s_error = 12;
  if (s->s_error != 0)
   return (-1);
 }
...
VSB_vprintf(struct vsb *s, const char *fmt, va_list ap)
{
 ...
 do { if (!(fmt != ((void *)0))) { VAS_Fail(__func__,
 "../libvarnish/vsb.c"
# 334 "../libvarnish/vsb.c"
 ,
 335
# 334 "../libvarnish/vsb.c"
 , "fmt != ((void *)0)", VAS_ASSERT); } } while (0)
                                                       ;

 if (s->s_error != 0)
  return (-1);
 _vsb_indent(s);
# 352 "../libvarnish/vsb.c"
 do {
  __builtin_va_copy(ap_copy,ap);
  len = vsnprintf(&s->s_buf[s->s_len], ((s)->s_size - ((s)->s_len + 1)) + 1,
      fmt, ap_copy);
  if (len < 0) {
   s->s_error = (*__errno_location ());
   return (-1);
  }
  __builtin_va_end(ap_copy);
 } while (len > ((s)->s_size - ((s)->s_len + 1)) &&
     VSB_extend(s, len - ((s)->s_size - ((s)->s_len + 1))) == 0);
# 373 "../libvarnish/vsb.c"
 if (((s)->s_size - ((s)->s_len + 1)) < len)
  len = ((s)->s_size - ((s)->s_len + 1));
 s->s_len += len;
 if (!((s)->s_len < (s)->s_size - 1) && !((s)->s_flags & 0x00000001))
  s->s_error = 12;

 do { if (!(s->s_len < s->s_size)) { VAS_Fail(__func__,
 "../libvarnish/vsb.c"
# 379 "../libvarnish/vsb.c"
 ,
 380
# 379 "../libvarnish/vsb.c"
 , "s->s_len < s->s_size", VAS_ASSERT); } } while (0)
...
VSB_data(const struct vsb *s)
{
 ...
 _assert_VSB_integrity(__func__, (s));
 _assert_VSB_state(__func__, (s), (0x00020000));
...
VSB_quote(struct vsb *s, const char *p, int len, int how)
{
 ...
 for (q = p; q < p + len; q++) {
  if (!((*__ctype_b_loc ())[(int) ((*q))] & (unsigned short int) _ISgraph) || *q == '"' || *q == '\\') {
   quote++;
   break;
  }
 }
 ...
 for (q = p; q < p + len; q++) {
  ...
  case '\t':
   ...
   break;
  default:
   if (((*__ctype_b_loc ())[(int) ((*q))] & (unsigned short int) _ISgraph))
    (void)VSB_putc(s, *q);
   else
