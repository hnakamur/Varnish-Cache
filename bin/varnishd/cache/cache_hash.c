...
# 1 "<command-line>" 2
# 1 "cache/cache_hash.c"
# 53 "cache/cache_hash.c"
# 1 "../../config.h" 1
# 54 "cache/cache_hash.c" 2
...
hsh_NewObjCore(struct worker *wrk)
{
 ...
 do { (oc) = calloc(sizeof *(oc), 1); if ((oc) != ((void *)0)) (oc)->magic = (0x4d301302); } while (0);
 do { do { if (!((oc) != 0)) { VAS_Fail(__func__, "cache/cache_hash.c", 76, "(oc) != 0", VAS_MISSING); } } while (0); } while (0);
...
hsh_newobjhead(void)
{
 ...
 do { (oh) = calloc(sizeof *(oh), 1); if ((oh) != ((void *)0)) (oh)->magic = (0x1b96615d); } while (0);
 do { do { if (!((oh) != 0)) { VAS_Fail(__func__, "cache/cache_hash.c", 90, "(oh) != 0", VAS_MISSING); } } while (0); } while (0);
 oh->refcnt = 1;
 do { (((&oh->objcs))->vtqh_first) = ((void *)0); (&oh->objcs)->vtqh_last = &(((&oh->objcs))->vtqh_first); } while (0);
 Lck__New(&oh->mtx, lck_objhdr, "lck_objhdr");
 return (oh);
}
...
hsh_prealloc(struct worker *wrk)
{
 ...
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_hash.c", 104, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "cache/cache_hash.c", 104, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);

 if (wrk->nobjcore == ((void *)0))
  wrk->nobjcore = hsh_NewObjCore(wrk);
 do { do { if (!((wrk->nobjcore) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_hash.c", 108, "(wrk->nobjcore) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk->nobjcore)->magic == 0x4d301302)) { VAS_Fail(__func__, "cache/cache_hash.c", 108, "(wrk->nobjcore)->magic == 0x4d301302", VAS_ASSERT); } } while (0); } while (0);

 if (wrk->nobjhead == ((void *)0)) {
  wrk->nobjhead = hsh_newobjhead();
  wrk->stats->n_objecthead++;
 }
 do { do { if (!((wrk->nobjhead) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_hash.c", 114, "(wrk->nobjhead) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk->nobjhead)->magic == 0x1b96615d)) { VAS_Fail(__func__, "cache/cache_hash.c", 114, "(wrk->nobjhead)->magic == 0x1b96615d", VAS_ASSERT); } } while (0); } while (0);

 if (wrk->nwaitinglist == ((void *)0)) {
  do { (wl) = calloc(sizeof *(wl), 1); if ((wl) != ((void *)0)) (wl)->magic = (0x063a477a); } while (0);
  do { do { if (!((wl) != 0)) { VAS_Fail(__func__, "cache/cache_hash.c", 118, "(wl) != 0", VAS_MISSING); } } while (0); } while (0);
  do { (((&wl->list))->vtqh_first) = ((void *)0); (&wl->list)->vtqh_last = &(((&wl->list))->vtqh_first); } while (0);
  wrk->nwaitinglist = wl;
  wrk->stats->n_waitinglist++;
 }
 do { do { if (!((wrk->nwaitinglist) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_hash.c", 123, "(wrk->nwaitinglist) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk->nwaitinglist)->magic == 0x063a477a)) { VAS_Fail(__func__, "cache/cache_hash.c", 123, "(wrk->nwaitinglist)->magic == 0x063a477a", VAS_ASSERT); } } while (0); } while (0);
...
HSH_Private(struct worker *wrk)
{
 ...
 do { do { if (!((private_oh) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_hash.c", 136, "(private_oh) != NULL", VAS_ASSERT); } } while (0); do { if (!((private_oh)->magic == 0x1b96615d)) { VAS_Fail(__func__, "cache/cache_hash.c", 136, "(private_oh)->magic == 0x1b96615d", VAS_ASSERT); } } while (0); } while (0);

 oc = hsh_NewObjCore(wrk);
 do { do { if (!((oc) != 0)) { VAS_Fail(__func__, "cache/cache_hash.c", 139, "(oc) != 0", VAS_ASSERT); } } while (0); } while (0);
 oc->refcnt = 1;
 oc->objhead = private_oh;
 oc->flags |= (1<<8) | (1<<1);
 Lck__Lock(&private_oh->mtx, __func__, 143);
 do { (((oc))->list.vtqe_next) = ((void *)0); (oc)->list.vtqe_prev = (&private_oh->objcs)->vtqh_last; *(&private_oh->objcs)->vtqh_last = (oc); (&private_oh->objcs)->vtqh_last = &(((oc))->list.vtqe_next); } while (0);
 private_oh->refcnt++;
 Lck__Unlock(&private_oh->mtx, __func__, 146);
 return (oc);
}
...
HSH_Cleanup(struct worker *wrk)
{
 ...
 if (wrk->nobjcore != ((void *)0)) {
  do { (wrk->nobjcore)->magic = (0); free(wrk->nobjcore); wrk->nobjcore = ((void *)0); } while (0);
  wrk->stats->n_objectcore--;
  wrk->nobjcore = ((void *)0);
 }
 if (wrk->nobjhead != ((void *)0)) {
  Lck_Delete(&wrk->nobjhead->mtx);
  do { (wrk->nobjhead)->magic = (0); free(wrk->nobjhead); wrk->nobjhead = ((void *)0); } while (0);
  wrk->nobjhead = ((void *)0);
  wrk->stats->n_objecthead--;
 }
 if (wrk->nwaitinglist != ((void *)0)) {
  do { (wrk->nwaitinglist)->magic = (0); free(wrk->nwaitinglist); wrk->nwaitinglist = ((void *)0); } while (0);
  wrk->nwaitinglist = ((void *)0);
  wrk->stats->n_waitinglist--;
 }
 if (wrk->nhashpriv != ((void *)0)) {

  free(wrk->nhashpriv);
  wrk->nhashpriv = ((void *)0);
 }
}
...
HSH_DeleteObjHead(struct worker *wrk, struct objhead *oh)
{
 ...
 do { do { if (!((oh->refcnt) == 0)) { VAS_Fail(__func__, "cache/cache_hash.c", 182, "(oh->refcnt) == 0", VAS_ASSERT); } } while (0); } while (0);
 do { if (!(((&oh->objcs)->vtqh_first == ((void *)0)))) { VAS_Fail(__func__, "cache/cache_hash.c", 183, "VTAILQ_EMPTY(&oh->objcs)", VAS_ASSERT); } } while (0);
 Lck_Delete(&oh->mtx);
 wrk->stats->n_objecthead--;
 do { (oh)->magic = (0); free(oh); oh = ((void *)0); } while (0);
}
...
HSH_AddString(struct req *req, void *ctx, const char *str)
{
 ...
 do { do { if (!((req) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_hash.c", 193, "(req) != NULL", VAS_ASSERT); } } while (0); do { if (!((req)->magic == 0x2751aaa1)) { VAS_Fail(__func__, "cache/cache_hash.c", 193, "(req)->magic == 0x2751aaa1", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((ctx) != 0)) { VAS_Fail(__func__, "cache/cache_hash.c", 194, "(ctx) != 0", VAS_ASSERT); } } while (0); } while (0);
 if (str != ((void *)0)) {
...
# 209 "cache/cache_hash.c"
static struct hsh_magiclist {
 unsigned char was[32];
...
hsh_testmagic(void *result)
{
 ...
 for (i = 0; i < nused; i++)
  if (!memcmp(hsh_magiclist[i].was, result, 32))
   break;
 if (i == nused && i < (sizeof hsh_magiclist / sizeof hsh_magiclist[0]))
  memcpy(hsh_magiclist[nused++].was, result, 32);
 if (i == nused)
  return;
 do { if (!(i < (sizeof hsh_magiclist / sizeof hsh_magiclist[0]))) { VAS_Fail(__func__, "cache/cache_hash.c", 266, "i < HSH_NMAGIC", VAS_ASSERT); } } while (0);
 fprintf(stderr, "HASHMAGIC: <");
 for (j = 0; j < 32; j++)
  fprintf(stderr, "%02x", ((unsigned char*)result)[j]);
 fprintf(stderr, "> -> <");
 memcpy(result, hsh_magiclist[i].now, 32);
 for (j = 0; j < 32; j++)
  fprintf(stderr, "%02x", ((unsigned char*)result)[j]);
 fprintf(stderr, ">\n");
}
...
HSH_Insert(struct worker *wrk, const void *digest, struct objcore *oc)
{
 ...
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_hash.c", 288, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "cache/cache_hash.c", 288, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((digest) != 0)) { VAS_Fail(__func__, "cache/cache_hash.c", 289, "(digest) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((oc) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_hash.c", 290, "(oc) != NULL", VAS_ASSERT); } } while (0); do { if (!((oc)->magic == 0x4d301302)) { VAS_Fail(__func__, "cache/cache_hash.c", 290, "(oc)->magic == 0x4d301302", VAS_ASSERT); } } while (0); } while (0);

 hsh_prealloc(wrk);

 do { do { if (!((wrk->nobjhead) != 0)) { VAS_Fail(__func__, "cache/cache_hash.c", 294, "(wrk->nobjhead) != 0", VAS_ASSERT); } } while (0); } while (0);
 oh = hash->lookup(wrk, digest, &wrk->nobjhead);
 do { do { if (!((oh) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_hash.c", 296, "(oh) != NULL", VAS_ASSERT); } } while (0); do { if (!((oh)->magic == 0x1b96615d)) { VAS_Fail(__func__, "cache/cache_hash.c", 296, "(oh)->magic == 0x1b96615d", VAS_ASSERT); } } while (0); } while (0);
 Lck__Assert(&oh->mtx, 1);
 do { if (!(oh->refcnt > 0)) { VAS_Fail(__func__, "cache/cache_hash.c", 298, "oh->refcnt > 0", VAS_ASSERT); } } while (0);


 oc->refcnt = 1;
 do { do { if (!((oc) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_hash.c", 302, "(oc) != NULL", VAS_ASSERT); } } while (0); do { if (!((oc)->magic == 0x4d301302)) { VAS_Fail(__func__, "cache/cache_hash.c", 302, "(oc)->magic == 0x4d301302", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((oc->flags & (1<<1)) == 0)) { VAS_Fail(__func__, "cache/cache_hash.c", 303, "(oc->flags & (1<<1)) == 0", VAS_ASSERT); } } while (0); } while (0);

 do { if (((((oc))->list.vtqe_next) = (((&oh->objcs))->vtqh_first)) != ((void *)0)) (((&oh->objcs))->vtqh_first)->list.vtqe_prev = &(((oc))->list.vtqe_next); else (&oh->objcs)->vtqh_last = &(((oc))->list.vtqe_next); (((&oh->objcs))->vtqh_first) = (oc); (oc)->list.vtqe_prev = &(((&oh->objcs))->vtqh_first); } while (0);

 oc->objhead = oh;
 Lck__Unlock(&oh->mtx, __func__, 308);
 wrk->stats->n_objectcore++;
...
hsh_insert_busyobj(struct worker *wrk, struct objhead *oh)
{
 ...
 do { do { if (!((oh) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_hash.c", 321, "(oh) != NULL", VAS_ASSERT); } } while (0); do { if (!((oh)->magic == 0x1b96615d)) { VAS_Fail(__func__, "cache/cache_hash.c", 321, "(oh)->magic == 0x1b96615d", VAS_ASSERT); } } while (0); } while (0);
 Lck__Assert(&oh->mtx, 1);

 oc = wrk->nobjcore;
 wrk->nobjcore = ((void *)0);
 do { do { if (!((oc) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_hash.c", 326, "(oc) != NULL", VAS_ASSERT); } } while (0); do { if (!((oc)->magic == 0x4d301302)) { VAS_Fail(__func__, "cache/cache_hash.c", 326, "(oc)->magic == 0x4d301302", VAS_ASSERT); } } while (0); } while (0);

 do { do { if (!((oc->flags & (1<<1)) != 0)) { VAS_Fail(__func__, "cache/cache_hash.c", 328, "(oc->flags & (1<<1)) != 0", VAS_ASSERT); } } while (0); } while (0);
 oc->refcnt = 1;
 oc->objhead = oh;
 do { (((oc))->list.vtqe_next) = ((void *)0); (oc)->list.vtqe_prev = (&oh->objcs)->vtqh_last; *(&oh->objcs)->vtqh_last = (oc); (&oh->objcs)->vtqh_last = &(((oc))->list.vtqe_next); } while (0);
 return (oc);
}
    ...
    int wait_for_busy, int always_insert)
{
 ...
 do { do { if (!((ocp) != 0)) { VAS_Fail(__func__, "cache/cache_hash.c", 351, "(ocp) != 0", VAS_ASSERT); } } while (0); } while (0);
 *ocp = ((void *)0);
 do { do { if (!((bocp) != 0)) { VAS_Fail(__func__, "cache/cache_hash.c", 353, "(bocp) != 0", VAS_ASSERT); } } while (0); } while (0);
 *bocp = ((void *)0);

 do { do { if (!((req) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_hash.c", 356, "(req) != NULL", VAS_ASSERT); } } while (0); do { if (!((req)->magic == 0x2751aaa1)) { VAS_Fail(__func__, "cache/cache_hash.c", 356, "(req)->magic == 0x2751aaa1", VAS_ASSERT); } } while (0); } while (0);
 wrk = req->wrk;
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_hash.c", 358, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "cache/cache_hash.c", 358, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((req->http) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_hash.c", 359, "(req->http) != NULL", VAS_ASSERT); } } while (0); do { if (!((req->http)->magic == 0x6428b5c9)) { VAS_Fail(__func__, "cache/cache_hash.c", 359, "(req->http)->magic == 0x6428b5c9", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((hash) != 0)) { VAS_Fail(__func__, "cache/cache_hash.c", 360, "(hash) != 0", VAS_ASSERT); } } while (0); } while (0);

 hsh_prealloc(wrk);
 if (DO_DEBUG(DBG_HASHEDGE))
  hsh_testmagic(req->digest);

 if (req->hash_objhead != ((void *)0)) {




  do { do { if (!((req->hash_objhead) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_hash.c", 371, "(req->hash_objhead) != NULL", VAS_ASSERT); } } while (0); do { if (!((req->hash_objhead)->magic == 0x1b96615d)) { VAS_Fail(__func__, "cache/cache_hash.c", 371, "(req->hash_objhead)->magic == 0x1b96615d", VAS_ASSERT); } } while (0); } while (0);
  oh = req->hash_objhead;
  Lck__Lock(&oh->mtx, __func__, 373);
  req->hash_objhead = ((void *)0);
 } else {
  do { do { if (!((wrk->nobjhead) != 0)) { VAS_Fail(__func__, "cache/cache_hash.c", 376, "(wrk->nobjhead) != 0", VAS_ASSERT); } } while (0); } while (0);
  oh = hash->lookup(wrk, req->digest, &wrk->nobjhead);
 }

 do { do { if (!((oh) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_hash.c", 380, "(oh) != NULL", VAS_ASSERT); } } while (0); do { if (!((oh)->magic == 0x1b96615d)) { VAS_Fail(__func__, "cache/cache_hash.c", 380, "(oh)->magic == 0x1b96615d", VAS_ASSERT); } } while (0); } while (0);
 Lck__Assert(&oh->mtx, 1);
  ...
  *bocp = hsh_insert_busyobj(wrk, oh);
  ...
  Lck__Unlock(&oh->mtx, __func__, 388);
  return (HSH_MISS);
 }

 do { if (!(oh->refcnt > 0)) { VAS_Fail(__func__, "cache/cache_hash.c", 392, "oh->refcnt > 0", VAS_ASSERT); } } while (0);
 busy_found = 0;
 exp_oc = ((void *)0);
 exp_t_origin = 0.0;
 for ((oc) = (((&oh->objcs))->vtqh_first); (oc); (oc) = (((oc))->list.vtqe_next)) {

  do { if (!(oh->refcnt > 1)) { VAS_Fail(__func__, "cache/cache_hash.c", 398, "oh->refcnt > 1", VAS_ASSERT); } } while (0);
  do { do { if (!((oc) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_hash.c", 399, "(oc) != NULL", VAS_ASSERT); } } while (0); do { if (!((oc)->magic == 0x4d301302)) { VAS_Fail(__func__, "cache/cache_hash.c", 399, "(oc)->magic == 0x4d301302", VAS_ASSERT); } } while (0); } while (0);
  do { if (!(oc->objhead == oh)) { VAS_Fail(__func__, "cache/cache_hash.c", 400, "oc->objhead == oh", VAS_ASSERT); } } while (0);
  ...
  if (oc->flags & (1<<1)) {
   do { if ((oc->busyobj) != ((void *)0)) do { if (!((oc->busyobj)->magic == 0x23b95567)) { VAS_Fail(__func__, "cache/cache_hash.c", 408, "(oc->busyobj)->magic == 0x23b95567", VAS_ASSERT); } } while (0); } while (0);
   if (req->hash_ignore_busy)
    continue;

   if (oc->busyobj != ((void *)0) &&
       oc->busyobj->vary != ((void *)0) &&
  ...
  vary = ObjGetattr(wrk, oc, OA_VARY, ((void *)0));

  if (vary != ((void *)0) && !VRY_Match(req, vary))
   continue;

  if (EXP_Ttl(req, &oc->exp) >= req->t_req) {

   do { if (!(oh->refcnt > 1)) { VAS_Fail(__func__, "cache/cache_hash.c", 434, "oh->refcnt > 1", VAS_ASSERT); } } while (0);
   do { if (!(oc->objhead == oh)) { VAS_Fail(__func__, "cache/cache_hash.c", 435, "oc->objhead == oh", VAS_ASSERT); } } while (0);
   oc->refcnt++;
   if (oc->hits < 9223372036854775807L)
    oc->hits++;
   Lck__Unlock(&oh->mtx, __func__, 439);
   do { if (!(HSH_DerefObjHead(wrk, &oh))) { VAS_Fail(__func__, "cache/cache_hash.c", 440, "HSH_DerefObjHead(wrk, &oh)", VAS_ASSERT); } } while (0);
   *ocp = oc;
   return (HSH_HIT);
  }
 ...
 if (exp_oc != ((void *)0)) {
  do { if (!(oh->refcnt > 1)) { VAS_Fail(__func__, "cache/cache_hash.c", 452, "oh->refcnt > 1", VAS_ASSERT); } } while (0);
  do { if (!(exp_oc->objhead == oh)) { VAS_Fail(__func__, "cache/cache_hash.c", 453, "exp_oc->objhead == oh", VAS_ASSERT); } } while (0);
  exp_oc->refcnt++;
   ...
   *bocp = hsh_insert_busyobj(wrk, oh);
   ...
   do { do { if (!((req->hash_ignore_busy) == 0)) { VAS_Fail(__func__, "cache/cache_hash.c", 460, "(req->hash_ignore_busy) == 0", VAS_ASSERT); } } while (0); } while (0);
   retval = HSH_EXP;
  }
  if (exp_oc->hits < 9223372036854775807L)
   exp_oc->hits++;
  Lck__Unlock(&oh->mtx, __func__, 465);
  if (retval == HSH_EXP)
   do { if (!(HSH_DerefObjHead(wrk, &oh))) { VAS_Fail(__func__, "cache/cache_hash.c", 467, "HSH_DerefObjHead(wrk, &oh)", VAS_ASSERT); } } while (0);
  *ocp = exp_oc;
  return (retval);
 }
  ...
  *bocp = hsh_insert_busyobj(wrk, oh);
  ...
  Lck__Unlock(&oh->mtx, __func__, 476);
  return (HSH_MISS);
 }



 do { do { if (!((req->hash_ignore_busy) == 0)) { VAS_Fail(__func__, "cache/cache_hash.c", 482, "(req->hash_ignore_busy) == 0", VAS_ASSERT); } } while (0); } while (0);

 if (wait_for_busy) {
  do { do { if (!((wrk->nwaitinglist) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_hash.c", 485, "(wrk->nwaitinglist) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk->nwaitinglist)->magic == 0x063a477a)) { VAS_Fail(__func__, "cache/cache_hash.c", 485, "(wrk->nwaitinglist)->magic == 0x063a477a", VAS_ASSERT); } } while (0); } while (0);
  if (oh->waitinglist == ((void *)0)) {
   oh->waitinglist = wrk->nwaitinglist;
   wrk->nwaitinglist = ((void *)0);
  }
  do { (((req))->w_list.vtqe_next) = ((void *)0); (req)->w_list.vtqe_prev = (&oh->waitinglist->list)->vtqh_last; *(&oh->waitinglist->list)->vtqh_last = (req); (&oh->waitinglist->list)->vtqh_last = &(((req))->w_list.vtqe_next); } while (0)
                  ;
 ...
 req->hash_objhead = oh;
 req->wrk = ((void *)0);
 Lck__Unlock(&oh->mtx, __func__, 507);
 return (HSH_BUSY);
}
...
hsh_rush(struct worker *wrk, struct objhead *oh)
{
 ...
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_hash.c", 522, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "cache/cache_hash.c", 522, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((oh) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_hash.c", 523, "(oh) != NULL", VAS_ASSERT); } } while (0); do { if (!((oh)->magic == 0x1b96615d)) { VAS_Fail(__func__, "cache/cache_hash.c", 523, "(oh)->magic == 0x1b96615d", VAS_ASSERT); } } while (0); } while (0);
 Lck__Assert(&oh->mtx, 1);
 wl = oh->waitinglist;
 do { do { if (!((wl) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_hash.c", 526, "(wl) != NULL", VAS_ASSERT); } } while (0); do { if (!((wl)->magic == 0x063a477a)) { VAS_Fail(__func__, "cache/cache_hash.c", 526, "(wl)->magic == 0x063a477a", VAS_ASSERT); } } while (0); } while (0);
 for (u = 0; u < cache_param->rush_exponent; u++) {
  req = ((&wl->list)->vtqh_first);
  if (req == ((void *)0))
   break;
  do { do { if (!((req) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_hash.c", 531, "(req) != NULL", VAS_ASSERT); } } while (0); do { if (!((req)->magic == 0x2751aaa1)) { VAS_Fail(__func__, "cache/cache_hash.c", 531, "(req)->magic == 0x2751aaa1", VAS_ASSERT); } } while (0); } while (0);
  wrk->stats->busy_wakeup++;
  do { do { if (!((req->wrk) == 0)) { VAS_Fail(__func__, "cache/cache_hash.c", 533, "(req->wrk) == 0", VAS_ASSERT); } } while (0); } while (0);
  do { if (((((req))->w_list.vtqe_next)) != ((void *)0)) (((req))->w_list.vtqe_next)->w_list.vtqe_prev = (req)->w_list.vtqe_prev; else { (&wl->list)->vtqh_last = (req)->w_list.vtqe_prev; } *(req)->w_list.vtqe_prev = (((req))->w_list.vtqe_next); ; ; } while (0);
  do { if (DO_DEBUG(DBG_WAITINGLIST)) VSL(SLT_Debug, (req->vsl->wid), "off waiting list"); } while (0);
  if (SES_Reschedule_Req(req)) {
   ...
   while (1) {
    ...
    do { do { if (!((req->vcl) != 0)) { VAS_Fail(__func__, "cache/cache_hash.c", 544, "(req->vcl) != 0", VAS_ASSERT); } } while (0); } while (0);
    VCL_Rel(&req->vcl);
    sp = req->sp;
    do { do { if (!((sp) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_hash.c", 547, "(sp) != NULL", VAS_ASSERT); } } while (0); do { if (!((sp)->magic == 0x2c2f9c5a)) { VAS_Fail(__func__, "cache/cache_hash.c", 547, "(sp)->magic == 0x2c2f9c5a", VAS_ASSERT); } } while (0); } while (0);
    CNT_AcctLogCharge(wrk->stats, req);
    Req_Release(req);
    SES_Delete(sp, SC_OVERLOAD, (__builtin_nanf ("")));
    req = ((&wl->list)->vtqh_first);
    if (req == ((void *)0))
     break;
    do { do { if (!((req) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_hash.c", 554, "(req) != NULL", VAS_ASSERT); } } while (0); do { if (!((req)->magic == 0x2751aaa1)) { VAS_Fail(__func__, "cache/cache_hash.c", 554, "(req)->magic == 0x2751aaa1", VAS_ASSERT); } } while (0); } while (0);
    do { if (((((req))->w_list.vtqe_next)) != ((void *)0)) (((req))->w_list.vtqe_next)->w_list.vtqe_prev = (req)->w_list.vtqe_prev; else { (&wl->list)->vtqh_last = (req)->w_list.vtqe_prev; } *(req)->w_list.vtqe_prev = (((req))->w_list.vtqe_next); ; ; } while (0);
    do { if (DO_DEBUG(DBG_WAITINGLIST)) VSL(SLT_Debug, (req->vsl->wid), "kill from waiting list"); } while (0)
                                 ;
   }
   break;
  }
 }
 if (((&wl->list)->vtqh_first == ((void *)0))) {
  oh->waitinglist = ((void *)0);
  do { (wl)->magic = (0); free(wl); wl = ((void *)0); } while (0);
  wrk->stats->n_waitinglist--;
 }
}
...
double keep)
{
 ...
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_hash.c", 582, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "cache/cache_hash.c", 582, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((oh) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_hash.c", 583, "(oh) != NULL", VAS_ASSERT); } } while (0); do { if (!((oh)->magic == 0x1b96615d)) { VAS_Fail(__func__, "cache/cache_hash.c", 583, "(oh)->magic == 0x1b96615d", VAS_ASSERT); } } while (0); } while (0);
 ospc = WS_Reserve(wrk->aws, 0);
 do { if (!(ospc >= sizeof *ocp)) { VAS_Fail(__func__, "cache/cache_hash.c", 585, "ospc >= sizeof *ocp", VAS_ASSERT); } } while (0);
 do {
  more = 0;
  spc = ospc;
  nobj = 0;
  ocp = (void*)wrk->aws->f;
  Lck__Lock(&oh->mtx, __func__, 591);
  do { if (!(oh->refcnt > 0)) { VAS_Fail(__func__, "cache/cache_hash.c", 592, "oh->refcnt > 0", VAS_ASSERT); } } while (0);
  now = VTIM_real();
  for ((oc) = (((&oh->objcs))->vtqh_first); (oc); (oc) = (((oc))->list.vtqe_next)) {
   do { do { if (!((oc) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_hash.c", 595, "(oc) != NULL", VAS_ASSERT); } } while (0); do { if (!((oc)->magic == 0x4d301302)) { VAS_Fail(__func__, "cache/cache_hash.c", 595, "(oc)->magic == 0x4d301302", VAS_ASSERT); } } while (0); } while (0);
   do { if (!(oc->objhead == oh)) { VAS_Fail(__func__, "cache/cache_hash.c", 596, "oc->objhead == oh", VAS_ASSERT); } } while (0);
   if (oc->flags & (1<<1)) {
  ...
  Lck__Unlock(&oh->mtx, __func__, 618);

  for (n = 0; n < nobj; n++) {
   oc = ocp[n];
   do { do { if (!((oc) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_hash.c", 622, "(oc) != NULL", VAS_ASSERT); } } while (0); do { if (!((oc)->magic == 0x4d301302)) { VAS_Fail(__func__, "cache/cache_hash.c", 622, "(oc)->magic == 0x4d301302", VAS_ASSERT); } } while (0); } while (0);
...
HSH_Fail(struct objcore *oc)
{
 ...
 do { do { if (!((oc) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_hash.c", 640, "(oc) != NULL", VAS_ASSERT); } } while (0); do { if (!((oc)->magic == 0x4d301302)) { VAS_Fail(__func__, "cache/cache_hash.c", 640, "(oc)->magic == 0x4d301302", VAS_ASSERT); } } while (0); } while (0);
 oh = oc->objhead;
 do { do { if (!((oh)->magic == 0x1b96615d)) { VAS_Fail(__func__, "cache/cache_hash.c", 642, "(oh)->magic == 0x1b96615d", VAS_ASSERT); } } while (0); } while (0);
 ...
 do { if (!((oc->flags & (1<<1)) || (oc->stobj->stevedore != ((void *)0)))) { VAS_Fail(__func__, "cache/cache_hash.c", 649, "(oc->flags & OC_F_BUSY) || (oc->stobj->stevedore != NULL)", VAS_ASSERT); } } while (0);

 Lck__Lock(&oh->mtx, __func__, 651);
 oc->flags |= (1<<9);
 oc->flags &= ~(1<<3);
 oc->busyobj = ((void *)0);
 Lck__Unlock(&oh->mtx, __func__, 655);
}
...
HSH_Complete(struct objcore *oc)
{
 ...
 do { do { if (!((oc) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_hash.c", 667, "(oc) != NULL", VAS_ASSERT); } } while (0); do { if (!((oc)->magic == 0x4d301302)) { VAS_Fail(__func__, "cache/cache_hash.c", 667, "(oc)->magic == 0x4d301302", VAS_ASSERT); } } while (0); } while (0);
 oh = oc->objhead;
 do { do { if (!((oh)->magic == 0x1b96615d)) { VAS_Fail(__func__, "cache/cache_hash.c", 669, "(oh)->magic == 0x1b96615d", VAS_ASSERT); } } while (0); } while (0);

 Lck__Lock(&oh->mtx, __func__, 671);
 oc->busyobj = ((void *)0);
 oc->flags &= ~(1<<3);
 Lck__Unlock(&oh->mtx, __func__, 674);
}
...
HSH_Unbusy(struct worker *wrk, struct objcore *oc)
{
 ...
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_hash.c", 686, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "cache/cache_hash.c", 686, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((oc) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_hash.c", 687, "(oc) != NULL", VAS_ASSERT); } } while (0); do { if (!((oc)->magic == 0x4d301302)) { VAS_Fail(__func__, "cache/cache_hash.c", 687, "(oc)->magic == 0x4d301302", VAS_ASSERT); } } while (0); } while (0);
 oh = oc->objhead;
 do { do { if (!((oh)->magic == 0x1b96615d)) { VAS_Fail(__func__, "cache/cache_hash.c", 689, "(oh)->magic == 0x1b96615d", VAS_ASSERT); } } while (0); } while (0);

 do { do { if (!((oc->stobj->stevedore) != 0)) { VAS_Fail(__func__, "cache/cache_hash.c", 691, "(oc->stobj->stevedore) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((oc->flags & (1<<1)) != 0)) { VAS_Fail(__func__, "cache/cache_hash.c", 692, "(oc->flags & (1<<1)) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { if (!(oh->refcnt > 0)) { VAS_Fail(__func__, "cache/cache_hash.c", 693, "oh->refcnt > 0", VAS_ASSERT); } } while (0);

 if (!(oc->flags & (1<<8))) {
  BAN_NewObjCore(oc);
  EXP_Insert(wrk, oc);
  do { do { if (!((oc->exp_flags & (1<<12)) != 0)) { VAS_Fail(__func__, "cache/cache_hash.c", 698, "(oc->exp_flags & (1<<12)) != 0", VAS_ASSERT); } } while (0); } while (0);
  do { do { if (!((oc->ban) != 0)) { VAS_Fail(__func__, "cache/cache_hash.c", 699, "(oc->ban) != 0", VAS_ASSERT); } } while (0); } while (0);
 }


 Lck__Lock(&oh->mtx, __func__, 703);
 do { if (!(oh->refcnt > 0)) { VAS_Fail(__func__, "cache/cache_hash.c", 704, "oh->refcnt > 0", VAS_ASSERT); } } while (0);

 do { if (((((oc))->list.vtqe_next)) != ((void *)0)) (((oc))->list.vtqe_next)->list.vtqe_prev = (oc)->list.vtqe_prev; else { (&oh->objcs)->vtqh_last = (oc)->list.vtqe_prev; } *(oc)->list.vtqe_prev = (((oc))->list.vtqe_next); ; ; } while (0);
 do { if (((((oc))->list.vtqe_next) = (((&oh->objcs))->vtqh_first)) != ((void *)0)) (((&oh->objcs))->vtqh_first)->list.vtqe_prev = &(((oc))->list.vtqe_next); else (&oh->objcs)->vtqh_last = &(((oc))->list.vtqe_next); (((&oh->objcs))->vtqh_first) = (oc); (oc)->list.vtqe_prev = &(((&oh->objcs))->vtqh_first); } while (0);
 oc->flags &= ~(1<<1);
 if (oh->waitinglist != ((void *)0))
  hsh_rush(wrk, oh);
 Lck__Unlock(&oh->mtx, __func__, 711);
}
...
HSH_Ref(struct objcore *oc)
{
 ...
 do { do { if (!((oc) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_hash.c", 723, "(oc) != NULL", VAS_ASSERT); } } while (0); do { if (!((oc)->magic == 0x4d301302)) { VAS_Fail(__func__, "cache/cache_hash.c", 723, "(oc)->magic == 0x4d301302", VAS_ASSERT); } } while (0); } while (0);
 oh = oc->objhead;
 do { do { if (!((oh) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_hash.c", 725, "(oh) != NULL", VAS_ASSERT); } } while (0); do { if (!((oh)->magic == 0x1b96615d)) { VAS_Fail(__func__, "cache/cache_hash.c", 725, "(oh)->magic == 0x1b96615d", VAS_ASSERT); } } while (0); } while (0);
 Lck__Lock(&oh->mtx, __func__, 726);
 do { if (!(oc->refcnt > 0)) { VAS_Fail(__func__, "cache/cache_hash.c", 727, "oc->refcnt > 0", VAS_ASSERT); } } while (0);
 oc->refcnt++;
 Lck__Unlock(&oh->mtx, __func__, 729);
}
...
HSH_RefBusy(const struct objcore *oc)
{
 ...
 do { do { if (!((oc) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_hash.c", 742, "(oc) != NULL", VAS_ASSERT); } } while (0); do { if (!((oc)->magic == 0x4d301302)) { VAS_Fail(__func__, "cache/cache_hash.c", 742, "(oc)->magic == 0x4d301302", VAS_ASSERT); } } while (0); } while (0);
 oh = oc->objhead;
 do { do { if (!((oh) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_hash.c", 744, "(oh) != NULL", VAS_ASSERT); } } while (0); do { if (!((oh)->magic == 0x1b96615d)) { VAS_Fail(__func__, "cache/cache_hash.c", 744, "(oh)->magic == 0x1b96615d", VAS_ASSERT); } } while (0); } while (0);
 Lck__Lock(&oh->mtx, __func__, 745);
 do { if (!(oc->refcnt > 0)) { VAS_Fail(__func__, "cache/cache_hash.c", 746, "oc->refcnt > 0", VAS_ASSERT); } } while (0);
 bo = oc->busyobj;
 do { if ((bo) != ((void *)0)) do { if (!((bo)->magic == 0x23b95567)) { VAS_Fail(__func__, "cache/cache_hash.c", 748, "(bo)->magic == 0x23b95567", VAS_ASSERT); } } while (0); } while (0);
 if (bo != ((void *)0))
  bo->refcount++;
 Lck__Unlock(&oh->mtx, __func__, 751);
 return (bo);
}
...
HSH_DerefObjCore(struct worker *wrk, struct objcore **ocp)
{
 ...
 do { do { if (!((ocp) != 0)) { VAS_Fail(__func__, "cache/cache_hash.c", 768, "(ocp) != 0", VAS_ASSERT); } } while (0); } while (0);
 oc = *ocp;
 *ocp = ((void *)0);

 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_hash.c", 772, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "cache/cache_hash.c", 772, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((oc) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_hash.c", 773, "(oc) != NULL", VAS_ASSERT); } } while (0); do { if (!((oc)->magic == 0x4d301302)) { VAS_Fail(__func__, "cache/cache_hash.c", 773, "(oc)->magic == 0x4d301302", VAS_ASSERT); } } while (0); } while (0);
 do { if (!(oc->refcnt > 0)) { VAS_Fail(__func__, "cache/cache_hash.c", 774, "oc->refcnt > 0", VAS_ASSERT); } } while (0);

 oh = oc->objhead;
 do { do { if (!((oh) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_hash.c", 777, "(oh) != NULL", VAS_ASSERT); } } while (0); do { if (!((oh)->magic == 0x1b96615d)) { VAS_Fail(__func__, "cache/cache_hash.c", 777, "(oh)->magic == 0x1b96615d", VAS_ASSERT); } } while (0); } while (0);

 Lck__Lock(&oh->mtx, __func__, 779);
 do { if (!(oh->refcnt > 0)) { VAS_Fail(__func__, "cache/cache_hash.c", 780, "oh->refcnt > 0", VAS_ASSERT); } } while (0);
 r = --oc->refcnt;
 if (!r)
  do { if (((((oc))->list.vtqe_next)) != ((void *)0)) (((oc))->list.vtqe_next)->list.vtqe_prev = (oc)->list.vtqe_prev; else { (&oh->objcs)->vtqh_last = (oc)->list.vtqe_prev; } *(oc)->list.vtqe_prev = (((oc))->list.vtqe_next); ; ; } while (0);
 if (oh->waitinglist != ((void *)0))
  hsh_rush(wrk, oh);
 Lck__Unlock(&oh->mtx, __func__, 786);
 if (r != 0)
  return (r);

 BAN_DestroyObj(oc);
 do { do { if (!((oc->ban) == 0)) { VAS_Fail(__func__, "cache/cache_hash.c", 791, "(oc->ban) == 0", VAS_ASSERT); } } while (0); } while (0);

 if (oc->stobj->stevedore != ((void *)0))
  ObjFreeObj(wrk, oc);
 do { (oc)->magic = (0); free(oc); oc = ((void *)0); } while (0);

 wrk->stats->n_objectcore--;

 do { if (!(oh->refcnt > 0)) { VAS_Fail(__func__, "cache/cache_hash.c", 799, "oh->refcnt > 0", VAS_ASSERT); } } while (0);
...
HSH_DerefObjHead(struct worker *wrk, struct objhead **poh)
{
 ...
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_hash.c", 810, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "cache/cache_hash.c", 810, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((poh) != 0)) { VAS_Fail(__func__, "cache/cache_hash.c", 811, "(poh) != 0", VAS_ASSERT); } } while (0); } while (0);
 oh = *poh;
 *poh = ((void *)0);
 do { do { if (!((oh) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_hash.c", 814, "(oh) != NULL", VAS_ASSERT); } } while (0); do { if (!((oh)->magic == 0x1b96615d)) { VAS_Fail(__func__, "cache/cache_hash.c", 814, "(oh)->magic == 0x1b96615d", VAS_ASSERT); } } while (0); } while (0);

 if (oh == private_oh) {
  Lck__Lock(&oh->mtx, __func__, 817);
  do { if (!(oh->refcnt > 1)) { VAS_Fail(__func__, "cache/cache_hash.c", 818, "oh->refcnt > 1", VAS_ASSERT); } } while (0);
  oh->refcnt--;
  Lck__Unlock(&oh->mtx, __func__, 820);
  return(1);
 }

 do { if (!(oh->refcnt > 0)) { VAS_Fail(__func__, "cache/cache_hash.c", 824, "oh->refcnt > 0", VAS_ASSERT); } } while (0);
 r = hash->deref(oh);
 if (!r)
...
HSH_Init(const struct hash_slinger *slinger)
{
 ...
 do { if (!(32 == 32)) { VAS_Fail(__func__, "cache/cache_hash.c", 835, "DIGEST_LEN == SHA256_LEN", VAS_ASSERT); } } while (0);
 hash = slinger;
 if (hash->start != ((void *)0))
  hash->start();
