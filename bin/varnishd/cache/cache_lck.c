...
# 1 "<command-line>" 2
# 1 "cache/cache_lck.c"
# 36 "cache/cache_lck.c"
# 1 "../../config.h" 1
# 37 "cache/cache_lck.c" 2
...
Lck_Witness_Lock(const struct ilck *il, const char *p, int l, const char *try)
{
 ...
 do { do { if (!((p) != 0)) { VAS_Fail(__func__, "cache/cache_lck.c", 64, "(p) != 0", VAS_ASSERT); } } while (0); } while (0);
 q = pthread_getspecific(witness_key);
 if (q == ((void *)0)) {
  q = calloc(1, 1024);
  do { do { if (!((q) != 0)) { VAS_Fail(__func__, "cache/cache_lck.c", 68, "(q) != 0", VAS_ASSERT); } } while (0); } while (0);
  do { do { if (!((pthread_setspecific(witness_key, q)) == 0)) { VAS_Fail(__func__, "cache/cache_lck.c", 69, "(pthread_setspecific(witness_key, q)) == 0", VAS_ASSERT); } } while (0); } while (0);
 }
 emit = *q != '\0';
 strcat(q, " ");
 strcat(q, il->w);
 ...
 strcat(q, p);
 strcat(q, ",");
 do { do { if (!(snprintf(t, sizeof t, "%d", l) < sizeof t)) { VAS_Fail(__func__, "cache/cache_lck.c", 78, "snprintf(t, sizeof t, \"%d\", l) < sizeof t", VAS_ASSERT); } } while (0); } while (0);
 strcat(q, t);
 if (emit)
...
Lck__Lock(struct lock *lck, const char *p, int l)
{
 ...
 do { (ilck) = (lck->priv); do { if (!((ilck) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_lck.c", 110, "(ilck) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((ilck))->magic == (0x7b86c8a5))) { VAS_Fail(__func__, "cache/cache_lck.c", 110, "((ilck))->magic == (0x7b86c8a5)", VAS_ASSERT); } } while (0); } while (0); } while (0);
 if (DO_DEBUG(DBG_WITNESS))
  Lck_Witness_Lock(ilck, p, l, "");
 do { do { if (!((pthread_mutex_lock(&ilck->mtx)) == 0)) { VAS_Fail(__func__, "cache/cache_lck.c", 113, "(pthread_mutex_lock(&ilck->mtx)) == 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((ilck->held) == 0)) { VAS_Fail(__func__, "cache/cache_lck.c", 114, "(ilck->held) == 0", VAS_ASSERT); } } while (0); } while (0);
 ilck->stat->locks++;
...
Lck__Unlock(struct lock *lck, const char *p, int l)
{
 ...
 do { (ilck) = (lck->priv); do { if (!((ilck) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_lck.c", 128, "(ilck) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((ilck))->magic == (0x7b86c8a5))) { VAS_Fail(__func__, "cache/cache_lck.c", 128, "((ilck))->magic == (0x7b86c8a5)", VAS_ASSERT); } } while (0); } while (0); } while (0);
 do { if (!(pthread_equal(ilck->owner, pthread_self()))) { VAS_Fail(__func__, "cache/cache_lck.c", 129, "pthread_equal(ilck->owner, pthread_self())", VAS_ASSERT); } } while (0);
 do { do { if (!((ilck->held) != 0)) { VAS_Fail(__func__, "cache/cache_lck.c", 130, "(ilck->held) != 0", VAS_ASSERT); } } while (0); } while (0);
 ilck->held = 0;
# 142 "cache/cache_lck.c"
 memset(&ilck->owner, 0, sizeof ilck->owner);
 do { do { if (!((pthread_mutex_unlock(&ilck->mtx)) == 0)) { VAS_Fail(__func__, "cache/cache_lck.c", 143, "(pthread_mutex_unlock(&ilck->mtx)) == 0", VAS_ASSERT); } } while (0); } while (0);
 if (DO_DEBUG(DBG_WITNESS))
...
Lck__Trylock(struct lock *lck, const char *p, int l)
{
 ...
 do { (ilck) = (lck->priv); do { if (!((ilck) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_lck.c", 154, "(ilck) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((ilck))->magic == (0x7b86c8a5))) { VAS_Fail(__func__, "cache/cache_lck.c", 154, "((ilck))->magic == (0x7b86c8a5)", VAS_ASSERT); } } while (0); } while (0); } while (0);
 if (DO_DEBUG(DBG_WITNESS))
  Lck_Witness_Lock(ilck, p, l, "?");
 r = pthread_mutex_trylock(&ilck->mtx);
 do { if (!(r == 0 || r == 16)) { VAS_Fail(__func__, "cache/cache_lck.c", 158, "r == 0 || r == EBUSY", VAS_ASSERT); } } while (0);
 if (r == 0) {
  do { do { if (!((ilck->held) == 0)) { VAS_Fail(__func__, "cache/cache_lck.c", 160, "(ilck->held) == 0", VAS_ASSERT); } } while (0); } while (0);
  ilck->held = 1;
  ilck->stat->locks++;
  ilck->owner = pthread_self();
 }
...
Lck__Assert(const struct lock *lck, int held)
{
 ...
 do { (ilck) = (lck->priv); do { if (!((ilck) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_lck.c", 173, "(ilck) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((ilck))->magic == (0x7b86c8a5))) { VAS_Fail(__func__, "cache/cache_lck.c", 173, "((ilck))->magic == (0x7b86c8a5)", VAS_ASSERT); } } while (0); } while (0); } while (0);
 if (held) {
  do { if (!(ilck->held)) { VAS_Fail(__func__, "cache/cache_lck.c", 175, "ilck->held", VAS_ASSERT); } } while (0);
  do { if (!(pthread_equal(ilck->owner, pthread_self()))) { VAS_Fail(__func__, "cache/cache_lck.c", 176, "pthread_equal(ilck->owner, pthread_self())", VAS_ASSERT); } } while (0);
 } else {
  do { do { if (!((ilck->held) == 0)) { VAS_Fail(__func__, "cache/cache_lck.c", 178, "(ilck->held) == 0", VAS_ASSERT); } } while (0); } while (0);
  do { do { if (!((pthread_equal(ilck->owner, pthread_self())) == 0)) { VAS_Fail(__func__, "cache/cache_lck.c", 179, "(pthread_equal(ilck->owner, pthread_self())) == 0", VAS_ASSERT); } } while (0); } while (0);
 }
}
...
Lck_CondWait(pthread_cond_t *cond, struct lock *lck, double when)
{
 ...
 do { (ilck) = (lck->priv); do { if (!((ilck) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_lck.c", 191, "(ilck) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((ilck))->magic == (0x7b86c8a5))) { VAS_Fail(__func__, "cache/cache_lck.c", 191, "((ilck))->magic == (0x7b86c8a5)", VAS_ASSERT); } } while (0); } while (0); } while (0);
 do { do { if (!((ilck->held) != 0)) { VAS_Fail(__func__, "cache/cache_lck.c", 192, "(ilck->held) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { if (!(pthread_equal(ilck->owner, pthread_self()))) { VAS_Fail(__func__, "cache/cache_lck.c", 193, "pthread_equal(ilck->owner, pthread_self())", VAS_ASSERT); } } while (0);
 ilck->held = 0;
 if (when == 0) {
  do { do { if (!((pthread_cond_wait(cond, &ilck->mtx)) == 0)) { VAS_Fail(__func__, "cache/cache_lck.c", 196, "(pthread_cond_wait(cond, &ilck->mtx)) == 0", VAS_ASSERT); } } while (0); } while (0);
 } else {
  ts.tv_nsec = (long)(modf(when, &t) * 1e9);
  ts.tv_sec = (long)t;
  retval = pthread_cond_timedwait(cond, &ilck->mtx, &ts);
  do { if (!(retval == 0 || retval == 110)) { VAS_Fail(__func__, "cache/cache_lck.c", 201, "retval == 0 || retval == ETIMEDOUT", VAS_ASSERT); } } while (0);
 }
 do { do { if (!((ilck->held) == 0)) { VAS_Fail(__func__, "cache/cache_lck.c", 203, "(ilck->held) == 0", VAS_ASSERT); } } while (0); } while (0);
 ilck->held = 1;
 ilck->owner = pthread_self();
 return (retval);
}
...
Lck__New(struct lock *lck, struct VSC_C_lck *st, const char *w)
{
 ...
 do { do { if (!((st) != 0)) { VAS_Fail(__func__, "cache/cache_lck.c", 214, "(st) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((w) != 0)) { VAS_Fail(__func__, "cache/cache_lck.c", 215, "(w) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((lck->priv) == 0)) { VAS_Fail(__func__, "cache/cache_lck.c", 216, "(lck->priv) == 0", VAS_ASSERT); } } while (0); } while (0);
 do { (ilck) = calloc(sizeof *(ilck), 1); if ((ilck) != ((void *)0)) (ilck)->magic = (0x7b86c8a5); } while (0);
 do { do { if (!((ilck) != 0)) { VAS_Fail(__func__, "cache/cache_lck.c", 218, "(ilck) != 0", VAS_ASSERT); } } while (0); } while (0);
 ilck->w = w;
 ilck->stat = st;
 ilck->stat->creat++;
 do { do { if (!((pthread_mutex_init(&ilck->mtx, &attr)) == 0)) { VAS_Fail(__func__, "cache/cache_lck.c", 222, "(pthread_mutex_init(&ilck->mtx, &attr)) == 0", VAS_ASSERT); } } while (0); } while (0);
 lck->priv = ilck;
}
...
Lck_Delete(struct lock *lck)
{
 ...
 do { (ilck) = (lck->priv); do { if (!((ilck) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_lck.c", 231, "(ilck) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((ilck))->magic == (0x7b86c8a5))) { VAS_Fail(__func__, "cache/cache_lck.c", 231, "((ilck))->magic == (0x7b86c8a5)", VAS_ASSERT); } } while (0); } while (0); } while (0);
 ilck->stat->destroy++;
 lck->priv = ((void *)0);
 do { do { if (!((pthread_mutex_destroy(&ilck->mtx)) == 0)) { VAS_Fail(__func__, "cache/cache_lck.c", 234, "(pthread_mutex_destroy(&ilck->mtx)) == 0", VAS_ASSERT); } } while (0); } while (0);
 do { (ilck)->magic = (0); free(ilck); ilck = ((void *)0); } while (0);
}
...
Lck_CreateClass(const char *name)
{
 return(VSM_Alloc(sizeof(struct VSC_C_lck),
    "Stat", VSC_type_lck, name));
}


# 1 "../../include/tbl/locks.h" 1
# 31 "../../include/tbl/locks.h"
struct VSC_C_lck *lck_backend;
struct VSC_C_lck *lck_backend_tcp;
struct VSC_C_lck *lck_ban;
struct VSC_C_lck *lck_busyobj;
struct VSC_C_lck *lck_cli;
struct VSC_C_lck *lck_exp;
struct VSC_C_lck *lck_hcb;
struct VSC_C_lck *lck_lru;
struct VSC_C_lck *lck_mempool;
struct VSC_C_lck *lck_objhdr;
struct VSC_C_lck *lck_pipestat;
struct VSC_C_lck *lck_sess;
struct VSC_C_lck *lck_vbe;
struct VSC_C_lck *lck_vcapace;
struct VSC_C_lck *lck_vcl;
struct VSC_C_lck *lck_vxid;
struct VSC_C_lck *lck_waiter;
struct VSC_C_lck *lck_wq;
struct VSC_C_lck *lck_wstat;
# 247 "cache/cache_lck.c" 2
...
LCK_Init(void)
{
 ...
 do { do { if (!((pthread_mutexattr_init(&attr)) == 0)) { VAS_Fail(__func__, "cache/cache_lck.c", 253, "(pthread_mutexattr_init(&attr)) == 0", VAS_ASSERT); } } while (0); } while (0);

 do { do { if (!((pthread_mutexattr_settype(&attr, PTHREAD_MUTEX_ERRORCHECK)) == 0)) { VAS_Fail(__func__, "cache/cache_lck.c", 255, "(pthread_mutexattr_settype(&attr, PTHREAD_MUTEX_ERRORCHECK)) == 0", VAS_ASSERT); } } while (0); } while (0);


# 1 "../../include/tbl/locks.h" 1
# 31 "../../include/tbl/locks.h"
lck_backend = Lck_CreateClass("backend");
lck_backend_tcp = Lck_CreateClass("backend_tcp");
lck_ban = Lck_CreateClass("ban");
lck_busyobj = Lck_CreateClass("busyobj");
lck_cli = Lck_CreateClass("cli");
lck_exp = Lck_CreateClass("exp");
lck_hcb = Lck_CreateClass("hcb");
lck_lru = Lck_CreateClass("lru");
lck_mempool = Lck_CreateClass("mempool");
lck_objhdr = Lck_CreateClass("objhdr");
lck_pipestat = Lck_CreateClass("pipestat");
lck_sess = Lck_CreateClass("sess");
lck_vbe = Lck_CreateClass("vbe");
lck_vcapace = Lck_CreateClass("vcapace");
lck_vcl = Lck_CreateClass("vcl");
lck_vxid = Lck_CreateClass("vxid");
lck_waiter = Lck_CreateClass("waiter");
lck_wq = Lck_CreateClass("wq");
lck_wstat = Lck_CreateClass("wstat");
# 259 "cache/cache_lck.c" 2
