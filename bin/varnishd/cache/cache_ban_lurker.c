...
# 1 "<command-line>" 2
# 1 "cache/cache_ban_lurker.c"
# 31 "cache/cache_ban_lurker.c"
# 1 "../../config.h" 1
# 32 "cache/cache_ban_lurker.c" 2
...
# 38 "cache/cache_ban_lurker.c" 2

static struct objcore oc_marker = { .magic = 0x4d301302, };
...
ban_kick_lurker(void)
{
 ...
 ban_generation++;
 do { do { if (!((pthread_cond_signal(&ban_lurker_cond)) == 0)) { VAS_Fail(__func__, "cache/cache_ban_lurker.c", 51, "(pthread_cond_signal(&ban_lurker_cond)) == 0", VAS_ASSERT); } } while (0); } while (0);
}
...
ban_cleantail(void)
{
 ...
 do {
  Lck__Lock(&ban_mtx, __func__, 60);
  b = (*(((struct banhead_s *)((&ban_head)->vtqh_last))->vtqh_last));
  if (b != ((&ban_head)->vtqh_first) && b->refcount == 0) {
   if (b->flags & (1<<2))
   ...
   do { if (((((b))->list.vtqe_next)) != ((void *)0)) (((b))->list.vtqe_next)->list.vtqe_prev = (b)->list.vtqe_prev; else { (&ban_head)->vtqh_last = (b)->list.vtqe_prev; } *(b)->list.vtqe_prev = (((b))->list.vtqe_next); ; ; } while (0);
  ...
  Lck__Unlock(&ban_mtx, __func__, 78);
  if (b != ((void *)0))
   BAN_Free(b);
 } while (b != ((void *)0));
}
# 92 "cache/cache_ban_lurker.c"
...
ban_lurker_getfirst(struct vsl_log *vsl, struct ban *bt)
{
 ...
 while (1) {
  Lck__Lock(&ban_mtx, __func__, 99);
  oc = ((&bt->objcore)->vtqh_first);
  do { do { if (!((oc) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_ban_lurker.c", 101, "(oc) != NULL", VAS_ASSERT); } } while (0); do { if (!((oc)->magic == 0x4d301302)) { VAS_Fail(__func__, "cache/cache_ban_lurker.c", 101, "(oc)->magic == 0x4d301302", VAS_ASSERT); } } while (0); } while (0);
  if (oc == &oc_marker) {
   do { if (((((oc))->ban_list.vtqe_next)) != ((void *)0)) (((oc))->ban_list.vtqe_next)->ban_list.vtqe_prev = (oc)->ban_list.vtqe_prev; else { (&bt->objcore)->vtqh_last = (oc)->ban_list.vtqe_prev; } *(oc)->ban_list.vtqe_prev = (((oc))->ban_list.vtqe_next); ; ; } while (0);
   Lck__Unlock(&ban_mtx, __func__, 104);
   return (((void *)0));
  }
  oh = oc->objhead;
  do { do { if (!((oh) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_ban_lurker.c", 108, "(oh) != NULL", VAS_ASSERT); } } while (0); do { if (!((oh)->magic == 0x1b96615d)) { VAS_Fail(__func__, "cache/cache_ban_lurker.c", 108, "(oh)->magic == 0x1b96615d", VAS_ASSERT); } } while (0); } while (0);
  if (!Lck__Trylock(&oh->mtx, __func__, 109)) {
   if (oc->refcnt == 0) {
    Lck__Unlock(&oh->mtx, __func__, 111);
   } else {
    ...
    do { do { if (!((oc->flags & (1<<1)) == 0)) { VAS_Fail(__func__, "cache/cache_ban_lurker.c", 119, "(oc->flags & (1<<1)) == 0", VAS_ASSERT); } } while (0); } while (0);
    oc->refcnt += 1;
    do { if (((((oc))->ban_list.vtqe_next)) != ((void *)0)) (((oc))->ban_list.vtqe_next)->ban_list.vtqe_prev = (oc)->ban_list.vtqe_prev; else { (&bt->objcore)->vtqh_last = (oc)->ban_list.vtqe_prev; } *(oc)->ban_list.vtqe_prev = (((oc))->ban_list.vtqe_next); ; ; } while (0);
    do { (((oc))->ban_list.vtqe_next) = ((void *)0); (oc)->ban_list.vtqe_prev = (&bt->objcore)->vtqh_last; *(&bt->objcore)->vtqh_last = (oc); (&bt->objcore)->vtqh_last = &(((oc))->ban_list.vtqe_next); } while (0);
    Lck__Unlock(&oh->mtx, __func__, 123);
    Lck__Unlock(&ban_mtx, __func__, 124);
    break;
   }
  }


  Lck__Unlock(&ban_mtx, __func__, 130);
    ...
    struct banhead_s *obans, struct ban *bd)
{
 ...
 Lck__Lock(&ban_mtx, __func__, 150);
 oc = ((&bt->objcore)->vtqh_first);
 if (oc != ((void *)0))
  do { (((&oc_marker))->ban_list.vtqe_next) = ((void *)0); (&oc_marker)->ban_list.vtqe_prev = (&bt->objcore)->vtqh_last; *(&bt->objcore)->vtqh_last = (&oc_marker); (&bt->objcore)->vtqh_last = &(((&oc_marker))->ban_list.vtqe_next); } while (0);
 Lck__Unlock(&ban_mtx, __func__, 154);
 if (oc == ((void *)0))
  return;
 ...
 while (1) {
  ...
  if (oc == ((void *)0))
   return;
  i = 0;
  for ((bl) = (*(((struct banhead_s *)(((obans))->vtqh_last))->vtqh_last)); (bl) && ((bln) = (*(((struct banhead_s *)(((bl))->l_list.vtqe_prev))->vtqh_last)), 1); (bl) = (bln)) {
   if (bl->flags & (1<<2)) {

    do { if (((((bl))->l_list.vtqe_next)) != ((void *)0)) (((bl))->l_list.vtqe_next)->l_list.vtqe_prev = (bl)->l_list.vtqe_prev; else { (obans)->vtqh_last = (bl)->l_list.vtqe_prev; } *(bl)->l_list.vtqe_prev = (((bl))->l_list.vtqe_next); ; ; } while (0);
    continue;
   }
   tests = 0;
   i = ban_evaluate(wrk, bl->spec, oc, ((void *)0), &tests);
  ...
  if (i) {
   ...
   if (oc->ban != bd) {
    Lck__Lock(&ban_mtx, __func__, 189);
    oc->ban->refcount--;
    ...
    oc->ban = bd;
    bd->refcount++;
    do { (((oc))->ban_list.vtqe_next) = ((void *)0); (oc)->ban_list.vtqe_prev = (&bd->objcore)->vtqh_last; *(&bd->objcore)->vtqh_last = (oc); (&bd->objcore)->vtqh_last = &(((oc))->ban_list.vtqe_next); } while (0);
    Lck__Unlock(&ban_mtx, __func__, 195);
...
ban_lurker_work(struct worker *wrk, struct vsl_log *vsl)
{
 ...
 Lck__Lock(&ban_mtx, __func__, 218);
 b = ban_start;
 Lck__Unlock(&ban_mtx, __func__, 220);
 d = VTIM_real() - cache_param->ban_lurker_age;
 bd = ((void *)0);
 do { (((&obans))->vtqh_first) = ((void *)0); (&obans)->vtqh_last = &(((&obans))->vtqh_first); } while (0);
 for (; b != ((void *)0); b = ((b)->list.vtqe_next)) {
  if (bd != ((void *)0))
  ...
  n = ban_time(b->spec) - d;
  if (n < 0) {
   do { (((b))->l_list.vtqe_next) = ((void *)0); (b)->l_list.vtqe_prev = (&obans)->vtqh_last; *(&obans)->vtqh_last = (b); (&obans)->vtqh_last = &(((b))->l_list.vtqe_next); } while (0);
   if (bd == ((void *)0))
    bd = b;
  } else if (n < dt) {
   dt = n;
 ...
 Lck__Lock(&ban_mtx, __func__, 243);
 for ((b) = (((&obans))->vtqh_first); (b); (b) = (((b))->l_list.vtqe_next))
  ban_mark_completed(b);
 Lck__Unlock(&ban_mtx, __func__, 246);
 return (dt);
}
...
ban_lurker(struct worker *wrk, void *priv)
{
 ...
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_ban_lurker.c", 257, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "cache/cache_ban_lurker.c", 257, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((priv) == 0)) { VAS_Fail(__func__, "cache/cache_ban_lurker.c", 258, "(priv) == 0", VAS_ASSERT); } } while (0); } while (0);

 VSL_Setup(&vsl, ((void *)0), 0);
