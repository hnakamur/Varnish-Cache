...
# 1 "<command-line>" 2
# 1 "cache/cache_main.c"
# 30 "cache/cache_main.c"
# 1 "../../config.h" 1
# 31 "cache/cache_main.c" 2
...
# 40 "cache/cache_main.c" 2
# 1 "../../include/vrnd.h" 1
# 31 "../../include/vrnd.h"
void VRND_Seed(void);
# 41 "cache/cache_main.c" 2
...
THR_SetBusyobj(const struct busyobj *bo)
{
 ...
 do { do { if (!((pthread_setspecific(bo_key, bo)) == 0)) { VAS_Fail(__func__, "cache/cache_main.c", 60, "(pthread_setspecific(bo_key, bo)) == 0", VAS_ASSERT); } } while (0); } while (0);
}
...
THR_SetRequest(const struct req *req)
{
 ...
 do { do { if (!((pthread_setspecific(req_key, req)) == 0)) { VAS_Fail(__func__, "cache/cache_main.c", 74, "(pthread_setspecific(req_key, req)) == 0", VAS_ASSERT); } } while (0); } while (0);
}
...
THR_SetName(const char *name)
{
 ...
 do { do { if (!((pthread_setspecific(name_key, name)) == 0)) { VAS_Fail(__func__, "cache/cache_main.c", 94, "(pthread_setspecific(name_key, name)) == 0", VAS_ASSERT); } } while (0); } while (0);
# 103 "cache/cache_main.c"
...
VXID_Get(struct worker *wrk, uint32_t mask)
{
 ...
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_main.c", 132, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "cache/cache_main.c", 132, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);
 v = &wrk->vxid_pool;
 do { do { if (!((((mask) & (~(3U<<30)))) == 0)) { VAS_Fail(__func__, "cache/cache_main.c", 134, "(((mask) & (~(3U<<30)))) == 0", VAS_ASSERT); } } while (0); } while (0);
 do {
  if (v->count == 0) {
   Lck__Lock(&vxid_lock, __func__, 137);
   v->next = vxid_base;
   v->count = vxid_chunk;
   vxid_base = (vxid_base + v->count) & (~(3U<<30));
   Lck__Unlock(&vxid_lock, __func__, 141);
  }
  v->count--;
  v->next++;
 } while (v->next == 0);
...
child_main(void)
{
 ...
 do { do { if (!((pthread_key_create(&req_key, ((void *)0))) == 0)) { VAS_Fail(__func__, "cache/cache_main.c", 222, "(pthread_key_create(&req_key, ((void *)0))) == 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((pthread_key_create(&bo_key, ((void *)0))) == 0)) { VAS_Fail(__func__, "cache/cache_main.c", 223, "(pthread_key_create(&bo_key, ((void *)0))) == 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((pthread_key_create(&witness_key, ((void *)0))) == 0)) { VAS_Fail(__func__, "cache/cache_main.c", 224, "(pthread_key_create(&witness_key, ((void *)0))) == 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((pthread_key_create(&name_key, ((void *)0))) == 0)) { VAS_Fail(__func__, "cache/cache_main.c", 225, "(pthread_key_create(&name_key, ((void *)0))) == 0", VAS_ASSERT); } } while (0); } while (0);
 ...
 Lck__New(&vxid_lock, lck_vxid, "lck_vxid");
