...
# 1 "<command-line>" 2
# 1 "cache/cache_shmlog.c"
# 30 "cache/cache_shmlog.c"
# 1 "../../config.h" 1
# 31 "cache/cache_shmlog.c" 2
...
# 40 "cache/cache_shmlog.c" 2
# 1 "../../include/vmb.h" 1
# 41 "cache/cache_shmlog.c" 2
# 1 "../../include/vtim.h" 1
# 33 "../../include/vtim.h"
...
{
 do { do { if (!((vsl) != 0)) { VAS_Fail(__func__, "cache/cache_shmlog.c", 59, "(vsl) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((vsl->wlp) != 0)) { VAS_Fail(__func__, "cache/cache_shmlog.c", 60, "(vsl->wlp) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((vsl->wlb) != 0)) { VAS_Fail(__func__, "cache/cache_shmlog.c", 61, "(vsl->wlb) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((vsl->wle) != 0)) { VAS_Fail(__func__, "cache/cache_shmlog.c", 62, "(vsl->wle) != 0", VAS_ASSERT); } } while (0); } while (0);
}
...
vsl_tag_is_masked(enum VSL_tag_e tag)
{
 ...
 do { if (!(tag > SLT__Bogus)) { VAS_Fail(__func__, "cache/cache_shmlog.c", 75, "tag > SLT__Bogus", VAS_ASSERT); } } while (0);
 do { if (!(tag < SLT__Reserved)) { VAS_Fail(__func__, "cache/cache_shmlog.c", 76, "tag < SLT__Reserved", VAS_ASSERT); } } while (0);
 bm += ((unsigned)tag >> 3);
...
vsl_hdr(enum VSL_tag_e tag, uint32_t *p, unsigned len, uint32_t vxid)
{
 ...
 do { do { if (!(((uintptr_t)p & 0x3) == 0)) { VAS_Fail(__func__, "cache/cache_shmlog.c", 90, "((uintptr_t)p & 0x3) == 0", VAS_ASSERT); } } while (0); } while (0);
 do { if (!(tag > SLT__Bogus)) { VAS_Fail(__func__, "cache/cache_shmlog.c", 91, "tag > SLT__Bogus", VAS_ASSERT); } } while (0);
 do { if (!(tag < SLT__Reserved)) { VAS_Fail(__func__, "cache/cache_shmlog.c", 92, "tag < SLT__Reserved", VAS_ASSERT); } } while (0);
 do { do { if (!((len & ~0xffff) == 0)) { VAS_Fail(__func__, "cache/cache_shmlog.c", 93, "(len & ~0xffff) == 0", VAS_ASSERT); } } while (0); } while (0);
...
vsl_wrap(void)
{
 ...
 do { if (!(vsl_ptr >= vsl_head->log)) { VAS_Fail(__func__, "cache/cache_shmlog.c", 108, "vsl_ptr >= vsl_head->log", VAS_ASSERT); } } while (0);
 do { if (!(vsl_ptr < vsl_end)) { VAS_Fail(__func__, "cache/cache_shmlog.c", 109, "vsl_ptr < vsl_end", VAS_ASSERT); } } while (0);
 vsl_segment_n += 8U - (vsl_segment_n % 8U);
 do { if (!(vsl_segment_n % 8U == 0)) { VAS_Fail(__func__, "cache/cache_shmlog.c", 111, "vsl_segment_n % VSL_SEGMENTS == 0", VAS_ASSERT); } } while (0);
 vsl_head->offset[0] = 0;
 vsl_head->log[0] = (((uint32_t)SLT__Reserved << 24) | 0x454545);
 __asm __volatile("sfence;" : : : "memory");
 if (vsl_ptr != vsl_head->log) {
  *vsl_ptr = (((uint32_t)SLT__Reserved << 24) | 0x575757);
...
vsl_get(unsigned len, unsigned records, unsigned flushes)
{
 ...
 if (err == 16) {
  do { do { if (!((pthread_mutex_lock(&vsl_mtx)) == 0)) { VAS_Fail(__func__, "cache/cache_shmlog.c", 135, "(pthread_mutex_lock(&vsl_mtx)) == 0", VAS_ASSERT); } } while (0); } while (0);
  VSC_C_main->shm_cont++;
 } else {
  do { do { if (!((err) == 0)) { VAS_Fail(__func__, "cache/cache_shmlog.c", 138, "(err) == 0", VAS_ASSERT); } } while (0); } while (0);
 }
 do { if (!(vsl_ptr < vsl_end)) { VAS_Fail(__func__, "cache/cache_shmlog.c", 140, "vsl_ptr < vsl_end", VAS_ASSERT); } } while (0);
 do { do { if (!(((uintptr_t)vsl_ptr & 0x3) == 0)) { VAS_Fail(__func__, "cache/cache_shmlog.c", 141, "((uintptr_t)vsl_ptr & 0x3) == 0", VAS_ASSERT); } } while (0); } while (0);
 ...
 if (((vsl_ptr) + 2 + (((len) + 3) / 4)) >= vsl_end)
  vsl_wrap();

 p = vsl_ptr;
 vsl_ptr = ((vsl_ptr) + 2 + (((len) + 3) / 4));
 do { if (!(vsl_ptr < vsl_end)) { VAS_Fail(__func__, "cache/cache_shmlog.c", 153, "vsl_ptr < vsl_end", VAS_ASSERT); } } while (0);
 do { do { if (!(((uintptr_t)vsl_ptr & 0x3) == 0)) { VAS_Fail(__func__, "cache/cache_shmlog.c", 154, "((uintptr_t)vsl_ptr & 0x3) == 0", VAS_ASSERT); } } while (0); } while (0);

 *vsl_ptr = (((uint32_t)SLT__Reserved << 24) | 0x454545);

 while ((vsl_ptr - vsl_head->log) / vsl_segsize >
     vsl_segment_n % 8U) {
  vsl_segment_n++;
  vsl_head->offset[vsl_segment_n % 8U] =
      vsl_ptr - vsl_head->log;
 }

 do { do { if (!((pthread_mutex_unlock(&vsl_mtx)) == 0)) { VAS_Fail(__func__, "cache/cache_shmlog.c", 165, "(pthread_mutex_unlock(&vsl_mtx)) == 0", VAS_ASSERT); } } while (0); } while (0);
...
VSL(enum VSL_tag_e tag, uint32_t vxid, const char *fmt, ...)
{
 ...
 do { do { if (!((fmt) != 0)) { VAS_Fail(__func__, "cache/cache_shmlog.c", 216, "(fmt) != 0", VAS_ASSERT); } } while (0); } while (0);
 if (vsl_tag_is_masked(tag))
  return;


 if ((__extension__ (__builtin_constant_p ('%') && !__builtin_constant_p (fmt) && ('%') == '\0' ? (char *) __rawmemchr (fmt, '%') : __builtin_strchr (fmt, '%'))) == ((void *)0)) {
...
VSL_Flush(struct vsl_log *vsl, int overflow)
{
 ...
 do { if (!(l >= 8)) { VAS_Fail(__func__, "cache/cache_shmlog.c", 247, "l >= 8", VAS_ASSERT); } } while (0);
...
VSLbt(struct vsl_log *vsl, enum VSL_tag_e tag, txt t)
{
 ...
 do { if (!(vsl->wlp < vsl->wle)) { VAS_Fail(__func__, "cache/cache_shmlog.c", 280, "vsl->wlp < vsl->wle", VAS_ASSERT); } } while (0);


 if (((vsl->wlp) + 2 + (((l + 1) + 3) / 4)) >= vsl->wle)
  VSL_Flush(vsl, 1);
 do { if (!(((vsl->wlp) + 2 + (((l + 1) + 3) / 4)) < vsl->wle)) { VAS_Fail(__func__, "cache/cache_shmlog.c", 285, "VSL_END(vsl->wlp, l + 1) < vsl->wle", VAS_ASSERT); } } while (0);
 p = ((char*)((vsl->wlp)+2));
 memcpy(p, t.b, l);
 p[l++] = '\0';
 vsl->wlp = vsl_hdr(tag, vsl->wlp, l, vsl->wid);
 do { if (!(vsl->wlp < vsl->wle)) { VAS_Fail(__func__, "cache/cache_shmlog.c", 290, "vsl->wlp < vsl->wle", VAS_ASSERT); } } while (0);
 vsl->wlr++;
...
VSLbv(struct vsl_log *vsl, enum VSL_tag_e tag, const char *fmt, va_list ap)
{
 ...
 vsl_sanity(vsl);
 do { do { if (!((fmt) != 0)) { VAS_Fail(__func__, "cache/cache_shmlog.c", 310, "(fmt) != 0", VAS_ASSERT); } } while (0); } while (0);
 if (vsl_tag_is_masked(tag))
  return;
 ...
 if (((vsl->wlp) + 2 + (((mlen + 1) + 3) / 4)) >= vsl->wle)
  VSL_Flush(vsl, 1);
 ...
 do { if (!(vsl->wlp < vsl->wle)) { VAS_Fail(__func__, "cache/cache_shmlog.c", 340, "vsl->wlp < vsl->wle", VAS_ASSERT); } } while (0);
 vsl->wlr++;
    ...
    double now)
{
 ...
 vsl_sanity(vsl);
 do { if (!(!(sizeof (now) == sizeof (float) ? __isnanf (now) : sizeof (now) == sizeof (double) ? __isnan (now) : __isnanl (now)) && now != 0.)) { VAS_Fail(__func__, "cache/cache_shmlog.c", 368, "!isnan(now) && now != 0.", VAS_ASSERT); } } while (0);
...
VSL_Setup(struct vsl_log *vsl, void *ptr, size_t len)
{
 ...
 if (ptr == ((void *)0)) {
  ...
  ptr = malloc(len);
  do { do { if (!((ptr) != 0)) { VAS_Fail(__func__, "cache/cache_shmlog.c", 385, "(ptr) != 0", VAS_ASSERT); } } while (0); } while (0);
 }
 vsl->wlp = ptr;
 vsl->wlb = ptr;
 vsl->wle = ptr;
...
VSL_ChgId(struct vsl_log *vsl, const char *typ, const char *why, uint32_t vxid)
{
 ...
 vsl_sanity(vsl);
 ovxid = vsl->wid;
 VSLb(vsl, SLT_Link, "%s %u %s", typ, ((vxid) & (~(3U<<30))), why);
 VSL_End(vsl);
 vsl->wid = vxid;
 VSLb(vsl, SLT_Begin, "%s %u %s", typ, ((ovxid) & (~(3U<<30))), why);
}
...
VSL_End(struct vsl_log *vsl)
{
 ...
 vsl_sanity(vsl);
 do { do { if (!((vsl->wid) != 0)) { VAS_Fail(__func__, "cache/cache_shmlog.c", 420, "(vsl->wid) != 0", VAS_ASSERT); } } while (0); } while (0);
 t.b = p;
 t.e = p;
 VSLbt(vsl, SLT_End, t);
 VSL_Flush(vsl, 0);
...
vsm_cleaner(void *priv)
{
 ...
 while (1) {
  do { do { if (!((pthread_mutex_lock(&vsm_mtx)) == 0)) { VAS_Fail(__func__, "cache/cache_shmlog.c", 436, "(pthread_mutex_lock(&vsm_mtx)) == 0", VAS_ASSERT); } } while (0); } while (0);
  VSM_common_cleaner(heritage.vsm, VSC_C_main);
  do { do { if (!((pthread_mutex_unlock(&vsm_mtx)) == 0)) { VAS_Fail(__func__, "cache/cache_shmlog.c", 438, "(pthread_mutex_unlock(&vsm_mtx)) == 0", VAS_ASSERT); } } while (0); } while (0);
  VTIM_sleep(1.1);
 }
 return (((void *)0));
}
...
VSM_Init(void)
{
 ...
 do { if (!((2147483647 * 2U + 1U) % 8U == 8U - 1)) { VAS_Fail(__func__, "cache/cache_shmlog.c", 452, "UINT_MAX % VSL_SEGMENTS == VSL_SEGMENTS - 1", VAS_ASSERT); } } while (0);

 do { do { if (!((pthread_mutex_init(&vsl_mtx, ((void *)0))) == 0)) { VAS_Fail(__func__, "cache/cache_shmlog.c", 454, "(pthread_mutex_init(&vsl_mtx, ((void *)0))) == 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((pthread_mutex_init(&vsm_mtx, ((void *)0))) == 0)) { VAS_Fail(__func__, "cache/cache_shmlog.c", 455, "(pthread_mutex_init(&vsm_mtx, ((void *)0))) == 0", VAS_ASSERT); } } while (0); } while (0);

 vsl_head = VSM_Alloc(cache_param->vsl_space, "Log", "", "");
 do { do { if (!((vsl_head) != 0)) { VAS_Fail(__func__, "cache/cache_shmlog.c", 458, "(vsl_head) != 0", VAS_ASSERT); } } while (0); } while (0);
 vsl_segsize = ((cache_param->vsl_space - sizeof *vsl_head) /
     sizeof *vsl_end) / 8U;
 vsl_end = vsl_head->log + vsl_segsize * 8U;


 vsl_segment_n = (2147483647 * 2U + 1U) - 8U + 1;
 do { do { if (!((vsl_segment_n % 8U) == 0)) { VAS_Fail(__func__, "cache/cache_shmlog.c", 465, "(vsl_segment_n % 8U) == 0", VAS_ASSERT); } } while (0); } while (0);
 vsl_head->segment_n = vsl_segment_n;
 vsl_ptr = vsl_head->log;
 *vsl_ptr = (((uint32_t)SLT__Reserved << 24) | 0x454545);
 ...
 for (i = 1; i < 8U; i++)
  vsl_head->offset[i] = -1;
 __asm __volatile("sfence;" : : : "memory");
 memcpy(vsl_head->marker, "VSLHEAD1", sizeof vsl_head->marker);

 VSC_C_main = VSM_Alloc(sizeof *VSC_C_main,
     "Stat", VSC_type_main, "");
 do { do { if (!((VSC_C_main) != 0)) { VAS_Fail(__func__, "cache/cache_shmlog.c", 480, "(VSC_C_main) != 0", VAS_ASSERT); } } while (0); } while (0);
 memset(VSC_C_main, 0, sizeof *VSC_C_main);

 do { do { if (!((pthread_create(&tp, ((void *)0), vsm_cleaner, ((void *)0))) == 0)) { VAS_Fail(__func__, "cache/cache_shmlog.c", 483, "(pthread_create(&tp, ((void *)0), vsm_cleaner, ((void *)0))) == 0", VAS_ASSERT); } } while (0); } while (0);
}
    ...
    const char *ident)
{
 ...
 do { do { if (!((pthread_mutex_lock(&vsm_mtx)) == 0)) { VAS_Fail(__func__, "cache/cache_shmlog.c", 494, "(pthread_mutex_lock(&vsm_mtx)) == 0", VAS_ASSERT); } } while (0); } while (0);
 p = VSM_common_alloc(heritage.vsm, size, class, type, ident);
 do { do { if (!((pthread_mutex_unlock(&vsm_mtx)) == 0)) { VAS_Fail(__func__, "cache/cache_shmlog.c", 496, "(pthread_mutex_unlock(&vsm_mtx)) == 0", VAS_ASSERT); } } while (0); } while (0);
...
VSM_Free(void *ptr)
{
 ...
 do { do { if (!((pthread_mutex_lock(&vsm_mtx)) == 0)) { VAS_Fail(__func__, "cache/cache_shmlog.c", 504, "(pthread_mutex_lock(&vsm_mtx)) == 0", VAS_ASSERT); } } while (0); } while (0);
 VSM_common_free(heritage.vsm, ptr);
 do { do { if (!((pthread_mutex_unlock(&vsm_mtx)) == 0)) { VAS_Fail(__func__, "cache/cache_shmlog.c", 506, "(pthread_mutex_unlock(&vsm_mtx)) == 0", VAS_ASSERT); } } while (0); } while (0);
}
