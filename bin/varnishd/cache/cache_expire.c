...
# 1 "<command-line>" 2
# 1 "cache/cache_expire.c"
# 33 "cache/cache_expire.c"
# 1 "../../config.h" 1
# 34 "cache/cache_expire.c" 2
...
# 38 "cache/cache_expire.c" 2

# 1 "../../include/binary_heap.h" 1
# 36 "../../include/binary_heap.h"
struct binheap;
...
struct exp_callback {
 ...
 exp_callback_f *func;
 void *priv;
 struct { struct exp_callback *vtqe_next; struct exp_callback **vtqe_prev; } list;
};
...
struct exp_priv {
 ...
 struct { struct objcore *vtqh_first; struct objcore **vtqh_last; } inbox;
 struct binheap *heap;
 pthread_cond_t condvar;

 struct { struct exp_callback *vtqh_first; struct exp_callback **vtqh_last; } ecb_list;
...
exp_event(struct worker *wrk, struct objcore *oc, enum exp_event_e e)
{
 ...
 if (((&exphdl->ecb_list)->vtqh_first == ((void *)0)))
  return;

 do { do { if (!((pthread_rwlock_rdlock(&exphdl->cb_rwl)) == 0)) { VAS_Fail(__func__, "cache/cache_expire.c", 81, "(pthread_rwlock_rdlock(&exphdl->cb_rwl)) == 0", VAS_ASSERT); } } while (0); } while (0);
 for ((cb) = (((&exphdl->ecb_list))->vtqh_first); (cb); (cb) = (((cb))->list.vtqe_next)) {
  do { do { if (!((cb) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_expire.c", 83, "(cb) != NULL", VAS_ASSERT); } } while (0); do { if (!((cb)->magic == 0xab956eb1)) { VAS_Fail(__func__, "cache/cache_expire.c", 83, "(cb)->magic == 0xab956eb1", VAS_ASSERT); } } while (0); } while (0);
  cb->func(wrk, oc, e, cb->priv);
 }
 do { do { if (!((pthread_rwlock_unlock(&exphdl->cb_rwl)) == 0)) { VAS_Fail(__func__, "cache/cache_expire.c", 86, "(pthread_rwlock_unlock(&exphdl->cb_rwl)) == 0", VAS_ASSERT); } } while (0); } while (0);
}
...
EXP_Ttl(const struct req *req, const struct exp *e)
{
 ...
 r = e->ttl;
 if (req != ((void *)0) && req->d_ttl > 0. && req->d_ttl < r)
  r = req->d_ttl;
 return (e->t_origin + r);
}
...
EXP_When(const struct exp *e)
{
 ...
 do { do { if (!(((sizeof (when) == sizeof (float) ? __isnanf (when) : sizeof (when) == sizeof (double) ? __isnan (when) : __isnanl (when))) == 0)) { VAS_Fail(__func__, "cache/cache_expire.c", 131, "((sizeof (when) == sizeof (float) ? __isnanf (when) : sizeof (when) == sizeof (double) ? __isnan (when) : __isnanl (when))) == 0", VAS_ASSERT); } } while (0); } while (0);
 return (when);
}
...
{
 do { do { if (!((oc) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_expire.c", 142, "(oc) != NULL", VAS_ASSERT); } } while (0); do { if (!((oc)->magic == 0x4d301302)) { VAS_Fail(__func__, "cache/cache_expire.c", 142, "(oc)->magic == 0x4d301302", VAS_ASSERT); } } while (0); } while (0);

 do { do { if (!((oc->exp_flags & (1<<4)) != 0)) { VAS_Fail(__func__, "cache/cache_expire.c", 144, "(oc->exp_flags & (1<<4)) != 0", VAS_ASSERT); } } while (0); } while (0);
 Lck__Lock(&exphdl->mtx, __func__, 145);
 if (oc->exp_flags & (1<<7))
  do { if (((((oc))->lru_list.vtqe_next) = (((&exphdl->inbox))->vtqh_first)) != ((void *)0)) (((&exphdl->inbox))->vtqh_first)->lru_list.vtqe_prev = &(((oc))->lru_list.vtqe_next); else (&exphdl->inbox)->vtqh_last = &(((oc))->lru_list.vtqe_next); (((&exphdl->inbox))->vtqh_first) = (oc); (oc)->lru_list.vtqe_prev = &(((&exphdl->inbox))->vtqh_first); } while (0);
 else
  do { (((oc))->lru_list.vtqe_next) = ((void *)0); (oc)->lru_list.vtqe_prev = (&exphdl->inbox)->vtqh_last; *(&exphdl->inbox)->vtqh_last = (oc); (&exphdl->inbox)->vtqh_last = &(((oc))->lru_list.vtqe_next); } while (0);
 VSC_C_main->exp_mailed++;
 do { do { if (!((pthread_cond_signal(&exphdl->condvar)) == 0)) { VAS_Fail(__func__, "cache/cache_expire.c", 151, "(pthread_cond_signal(&exphdl->condvar)) == 0", VAS_ASSERT); } } while (0); } while (0);
 Lck__Unlock(&exphdl->mtx, __func__, 152);
}
# 162 "cache/cache_expire.c"
void
EXP_Inject(struct worker *wrk, struct objcore *oc, struct lru *lru)
{

 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_expire.c", 166, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "cache/cache_expire.c", 166, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((oc) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_expire.c", 167, "(oc) != NULL", VAS_ASSERT); } } while (0); do { if (!((oc)->magic == 0x4d301302)) { VAS_Fail(__func__, "cache/cache_expire.c", 167, "(oc)->magic == 0x4d301302", VAS_ASSERT); } } while (0); } while (0);

 do { do { if (!((oc->exp_flags & ((1<<4) | (1<<11) | (1<<10))) == 0)) { VAS_Fail(__func__, "cache/cache_expire.c", 169, "(oc->exp_flags & ((1<<4) | (1<<11) | (1<<10))) == 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((oc->exp_flags & (1<<7)) == 0)) { VAS_Fail(__func__, "cache/cache_expire.c", 170, "(oc->exp_flags & (1<<7)) == 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((oc->flags & (1<<1)) == 0)) { VAS_Fail(__func__, "cache/cache_expire.c", 171, "(oc->flags & (1<<1)) == 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((lru) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_expire.c", 172, "(lru) != NULL", VAS_ASSERT); } } while (0); do { if (!((lru)->magic == 0x3fec7bb0)) { VAS_Fail(__func__, "cache/cache_expire.c", 172, "(lru)->magic == 0x3fec7bb0", VAS_ASSERT); } } while (0); } while (0);

 Lck__Lock(&lru->mtx, __func__, 174);
 lru->n_objcore++;
 oc->exp_flags |= (1<<4) | (1<<11) | (1<<12);
 oc->timer_when = EXP_When(&oc->exp);
 Lck__Unlock(&lru->mtx, __func__, 178);

 exp_event(wrk, oc, EXP_INJECT);

 exp_mail_it(oc);
}
# 192 "cache/cache_expire.c"
void
EXP_Insert(struct worker *wrk, struct objcore *oc)
{
 struct lru *lru;

 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_expire.c", 197, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "cache/cache_expire.c", 197, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((oc) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_expire.c", 198, "(oc) != NULL", VAS_ASSERT); } } while (0); do { if (!((oc)->magic == 0x4d301302)) { VAS_Fail(__func__, "cache/cache_expire.c", 198, "(oc)->magic == 0x4d301302", VAS_ASSERT); } } while (0); } while (0);
 HSH_Ref(oc);

 do { do { if (!((oc->exp_flags & ((1<<4) | (1<<11) | (1<<10))) == 0)) { VAS_Fail(__func__, "cache/cache_expire.c", 201, "(oc->exp_flags & ((1<<4) | (1<<11) | (1<<10))) == 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((oc->exp_flags & (1<<7)) == 0)) { VAS_Fail(__func__, "cache/cache_expire.c", 202, "(oc->exp_flags & (1<<7)) == 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((oc->flags & (1<<1)) != 0)) { VAS_Fail(__func__, "cache/cache_expire.c", 203, "(oc->flags & (1<<1)) != 0", VAS_ASSERT); } } while (0); } while (0);

 lru = ObjGetLRU(oc);
 do { do { if (!((lru) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_expire.c", 206, "(lru) != NULL", VAS_ASSERT); } } while (0); do { if (!((lru)->magic == 0x3fec7bb0)) { VAS_Fail(__func__, "cache/cache_expire.c", 206, "(lru)->magic == 0x3fec7bb0", VAS_ASSERT); } } while (0); } while (0);

 Lck__Lock(&lru->mtx, __func__, 208);
 lru->n_objcore++;
 oc->exp_flags |= (1<<4) | (1<<11) | (1<<12);
 oc->exp_flags |= (1<<10);
 Lck__Unlock(&lru->mtx, __func__, 212);
...
EXP_Rearm(struct objcore *oc, double now, double ttl, double grace, double keep)
{
 ...
 do { do { if (!((oc) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_expire.c", 230, "(oc) != NULL", VAS_ASSERT); } } while (0); do { if (!((oc)->magic == 0x4d301302)) { VAS_Fail(__func__, "cache/cache_expire.c", 230, "(oc)->magic == 0x4d301302", VAS_ASSERT); } } while (0); } while (0);
 do { if (!(oc->refcnt > 0)) { VAS_Fail(__func__, "cache/cache_expire.c", 231, "oc->refcnt > 0", VAS_ASSERT); } } while (0);

 do { do { if (!((oc->exp_flags & (1<<12)) != 0)) { VAS_Fail(__func__, "cache/cache_expire.c", 233, "(oc->exp_flags & (1<<12)) != 0", VAS_ASSERT); } } while (0); } while (0);

 if (!(sizeof (ttl) == sizeof (float) ? __isnanf (ttl) : sizeof (ttl) == sizeof (double) ? __isnan (ttl) : __isnanl (ttl)))
  oc->exp.ttl = now + ttl - oc->exp.t_origin;
 if (!(sizeof (grace) == sizeof (float) ? __isnanf (grace) : sizeof (grace) == sizeof (double) ? __isnan (grace) : __isnanl (grace)))
  oc->exp.grace = grace;
 if (!(sizeof (keep) == sizeof (float) ? __isnanf (keep) : sizeof (keep) == sizeof (double) ? __isnan (keep) : __isnanl (keep)))
  oc->exp.keep = keep;
 ...
 lru = ObjGetLRU(oc);
 do { do { if (!((lru) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_expire.c", 251, "(lru) != NULL", VAS_ASSERT); } } while (0); do { if (!((lru)->magic == 0x3fec7bb0)) { VAS_Fail(__func__, "cache/cache_expire.c", 251, "(lru)->magic == 0x3fec7bb0", VAS_ASSERT); } } while (0); } while (0);

 Lck__Lock(&lru->mtx, __func__, 253);

 if (!(sizeof (now) == sizeof (float) ? __isnanf (now) : sizeof (now) == sizeof (double) ? __isnan (now) : __isnanl (now)) && when <= now)
  oc->exp_flags |= (1<<7);
 else
  oc->exp_flags |= (1<<10);
 ...
 Lck__Unlock(&lru->mtx, __func__, 266);
...
EXP_NukeOne(struct worker *wrk, struct lru *lru)
{
 ...
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_expire.c", 284, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "cache/cache_expire.c", 284, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((lru) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_expire.c", 285, "(lru) != NULL", VAS_ASSERT); } } while (0); do { if (!((lru)->magic == 0x3fec7bb0)) { VAS_Fail(__func__, "cache/cache_expire.c", 285, "(lru)->magic == 0x3fec7bb0", VAS_ASSERT); } } while (0); } while (0);

 Lck__Lock(&lru->mtx, __func__, 287);
 for ((oc) = (((&lru->lru_head))->vtqh_first); (oc) && ((oc2) = (((oc))->lru_list.vtqe_next), 1); (oc) = (oc2)) {
  do { do { if (!((oc) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_expire.c", 289, "(oc) != NULL", VAS_ASSERT); } } while (0); do { if (!((oc)->magic == 0x4d301302)) { VAS_Fail(__func__, "cache/cache_expire.c", 289, "(oc)->magic == 0x4d301302", VAS_ASSERT); } } while (0); } while (0);

  VSLb(wrk->vsl, SLT_ExpKill, "LRU_Cand p=%p f=0x%x r=%d",
      oc, oc->flags, oc->refcnt);

  do { do { if (!((oc->exp_flags & (1<<4)) == 0)) { VAS_Fail(__func__, "cache/cache_expire.c", 294, "(oc->exp_flags & (1<<4)) == 0", VAS_ASSERT); } } while (0); } while (0);
  do { do { if (!((oc->exp_flags & (1<<7)) == 0)) { VAS_Fail(__func__, "cache/cache_expire.c", 295, "(oc->exp_flags & (1<<7)) == 0", VAS_ASSERT); } } while (0); } while (0);
  ...
  if (oc->refcnt > 1)
   continue;
  oh = oc->objhead;
  do { do { if (!((oh) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_expire.c", 305, "(oh) != NULL", VAS_ASSERT); } } while (0); do { if (!((oh)->magic == 0x1b96615d)) { VAS_Fail(__func__, "cache/cache_expire.c", 305, "(oh)->magic == 0x1b96615d", VAS_ASSERT); } } while (0); } while (0);
  if (Lck__Trylock(&oh->mtx, __func__, 306))
   continue;
  if (oc->refcnt == 1) {
   oc->exp_flags |= (1<<7) | (1<<4);
   oc->refcnt++;
  ...
  Lck__Unlock(&oh->mtx, __func__, 316);
  if (oc != ((void *)0))
   break;
 }
 Lck__Unlock(&lru->mtx, __func__, 320);
...
EXP_Register_Callback(exp_callback_f *func, void *priv)
{
 ...
 do { do { if (!((func) != 0)) { VAS_Fail(__func__, "cache/cache_expire.c", 344, "(func) != 0", VAS_ASSERT); } } while (0); } while (0);

 do { (ecb) = calloc(sizeof *(ecb), 1); if ((ecb) != ((void *)0)) (ecb)->magic = (0xab956eb1); } while (0);
 do { do { if (!((ecb) != 0)) { VAS_Fail(__func__, "cache/cache_expire.c", 347, "(ecb) != 0", VAS_ASSERT); } } while (0); } while (0);
 ecb->func = func;
 ecb->priv = priv;
 do { do { if (!((pthread_rwlock_wrlock(&exphdl->cb_rwl)) == 0)) { VAS_Fail(__func__, "cache/cache_expire.c", 350, "(pthread_rwlock_wrlock(&exphdl->cb_rwl)) == 0", VAS_ASSERT); } } while (0); } while (0);
 do { (((ecb))->list.vtqe_next) = ((void *)0); (ecb)->list.vtqe_prev = (&exphdl->ecb_list)->vtqh_last; *(&exphdl->ecb_list)->vtqh_last = (ecb); (&exphdl->ecb_list)->vtqh_last = &(((ecb))->list.vtqe_next); } while (0);
 do { do { if (!((pthread_rwlock_unlock(&exphdl->cb_rwl)) == 0)) { VAS_Fail(__func__, "cache/cache_expire.c", 352, "(pthread_rwlock_unlock(&exphdl->cb_rwl)) == 0", VAS_ASSERT); } } while (0); } while (0);
...
EXP_Deregister_Callback(uintptr_t *handle)
{
 ...
 do { do { if (!((handle) != 0)) { VAS_Fail(__func__, "cache/cache_expire.c", 361, "(handle) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((*handle) != 0)) { VAS_Fail(__func__, "cache/cache_expire.c", 362, "(*handle) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((pthread_rwlock_wrlock(&exphdl->cb_rwl)) == 0)) { VAS_Fail(__func__, "cache/cache_expire.c", 363, "(pthread_rwlock_wrlock(&exphdl->cb_rwl)) == 0", VAS_ASSERT); } } while (0); } while (0);
 for ((ecb) = (((&exphdl->ecb_list))->vtqh_first); (ecb); (ecb) = (((ecb))->list.vtqe_next)) {
  do { do { if (!((ecb) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_expire.c", 365, "(ecb) != NULL", VAS_ASSERT); } } while (0); do { if (!((ecb)->magic == 0xab956eb1)) { VAS_Fail(__func__, "cache/cache_expire.c", 365, "(ecb)->magic == 0xab956eb1", VAS_ASSERT); } } while (0); } while (0);
  if ((uintptr_t)ecb == *handle)
   break;
 }
 do { do { if (!((ecb) != 0)) { VAS_Fail(__func__, "cache/cache_expire.c", 369, "(ecb) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { if (((((ecb))->list.vtqe_next)) != ((void *)0)) (((ecb))->list.vtqe_next)->list.vtqe_prev = (ecb)->list.vtqe_prev; else { (&exphdl->ecb_list)->vtqh_last = (ecb)->list.vtqe_prev; } *(ecb)->list.vtqe_prev = (((ecb))->list.vtqe_next); ; ; } while (0);
 do { do { if (!((pthread_rwlock_unlock(&exphdl->cb_rwl)) == 0)) { VAS_Fail(__func__, "cache/cache_expire.c", 371, "(pthread_rwlock_unlock(&exphdl->cb_rwl)) == 0", VAS_ASSERT); } } while (0); } while (0);
 do { (ecb)->magic = (0); free(ecb); ecb = ((void *)0); } while (0);
 *handle = 0;
}
...
exp_inbox(struct exp_priv *ep, struct objcore *oc, double now)
{
 ...
 do { do { if (!((ep) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_expire.c", 386, "(ep) != NULL", VAS_ASSERT); } } while (0); do { if (!((ep)->magic == 0x9db22482)) { VAS_Fail(__func__, "cache/cache_expire.c", 386, "(ep)->magic == 0x9db22482", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((oc) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_expire.c", 387, "(oc) != NULL", VAS_ASSERT); } } while (0); do { if (!((oc)->magic == 0x4d301302)) { VAS_Fail(__func__, "cache/cache_expire.c", 387, "(oc)->magic == 0x4d301302", VAS_ASSERT); } } while (0); } while (0);

 VSLb(&ep->vsl, SLT_ExpKill, "EXP_Inbox p=%p e=%.9f f=0x%x", oc,
     oc->timer_when, oc->flags);

 lru = ObjGetLRU(oc);
 do { do { if (!((lru) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_expire.c", 393, "(lru) != NULL", VAS_ASSERT); } } while (0); do { if (!((lru)->magic == 0x3fec7bb0)) { VAS_Fail(__func__, "cache/cache_expire.c", 393, "(lru)->magic == 0x3fec7bb0", VAS_ASSERT); } } while (0); } while (0);


 Lck__Lock(&lru->mtx, __func__, 396);
 flags = oc->exp_flags;
 do { do { if (!((flags & (1<<4)) != 0)) { VAS_Fail(__func__, "cache/cache_expire.c", 398, "(flags & (1<<4)) != 0", VAS_ASSERT); } } while (0); } while (0);
 oc->exp_flags &= ~((1<<11) | (1<<10));
 oc->last_lru = now;
 if (!(flags & (1<<7))) {
 ...
 Lck__Unlock(&lru->mtx, __func__, 405);

 if (flags & (1<<7)) {
  VSLb(&ep->vsl, SLT_ExpKill, "EXP_Kill p=%p e=%.9f f=0x%x", oc,
      oc->timer_when, oc->flags);
  if (!(flags & (1<<11))) {
   do { if (!(oc->timer_idx != 0)) { VAS_Fail(__func__, "cache/cache_expire.c", 411, "oc->timer_idx != BINHEAP_NOIDX", VAS_ASSERT); } } while (0);
   binheap_delete(ep->heap, oc->timer_idx);
  }
  do { if (!(oc->timer_idx == 0)) { VAS_Fail(__func__, "cache/cache_expire.c", 414, "oc->timer_idx == BINHEAP_NOIDX", VAS_ASSERT); } } while (0);
 ...
 if (flags & (1<<11)) {
  do { if (!(oc->timer_idx == 0)) { VAS_Fail(__func__, "cache/cache_expire.c", 435, "oc->timer_idx == BINHEAP_NOIDX", VAS_ASSERT); } } while (0);
  binheap_insert(exphdl->heap, oc);
  do { if (!(oc->timer_idx != 0)) { VAS_Fail(__func__, "cache/cache_expire.c", 437, "oc->timer_idx != BINHEAP_NOIDX", VAS_ASSERT); } } while (0);
 } else if (flags & (1<<10)) {
  do { if (!(oc->timer_idx != 0)) { VAS_Fail(__func__, "cache/cache_expire.c", 439, "oc->timer_idx != BINHEAP_NOIDX", VAS_ASSERT); } } while (0);
  binheap_reorder(exphdl->heap, oc->timer_idx);
  do { if (!(oc->timer_idx != 0)) { VAS_Fail(__func__, "cache/cache_expire.c", 441, "oc->timer_idx != BINHEAP_NOIDX", VAS_ASSERT); } } while (0);
 } else {
  do { VAS_Fail(__func__, "cache/cache_expire.c", 443, "Objcore state wrong in inbox", VAS_WRONG); } while (0);
 }
}
...
exp_expire(struct exp_priv *ep, double now)
{
 ...
 do { do { if (!((ep) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_expire.c", 457, "(ep) != NULL", VAS_ASSERT); } } while (0); do { if (!((ep)->magic == 0x9db22482)) { VAS_Fail(__func__, "cache/cache_expire.c", 457, "(ep)->magic == 0x9db22482", VAS_ASSERT); } } while (0); } while (0);

 oc = binheap_root(ep->heap);
 if (oc == ((void *)0))
  return (now + 355./113.);

 do { do { if (!((oc) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_expire.c", 463, "(oc) != NULL", VAS_ASSERT); } } while (0); do { if (!((oc)->magic == 0x4d301302)) { VAS_Fail(__func__, "cache/cache_expire.c", 463, "(oc)->magic == 0x4d301302", VAS_ASSERT); } } while (0); } while (0);
 ...
 lru = ObjGetLRU(oc);
 do { do { if (!((lru) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_expire.c", 472, "(lru) != NULL", VAS_ASSERT); } } while (0); do { if (!((lru)->magic == 0x3fec7bb0)) { VAS_Fail(__func__, "cache/cache_expire.c", 472, "(lru)->magic == 0x3fec7bb0", VAS_ASSERT); } } while (0); } while (0);
 Lck__Lock(&lru->mtx, __func__, 473);
 ...
 Lck__Unlock(&lru->mtx, __func__, 482);

 if (oc == ((void *)0))
  return (now + 1e-3);


 do { if (!(oc->timer_idx != 0)) { VAS_Fail(__func__, "cache/cache_expire.c", 488, "oc->timer_idx != BINHEAP_NOIDX", VAS_ASSERT); } } while (0);
 binheap_delete(ep->heap, oc->timer_idx);
 do { if (!(oc->timer_idx == 0)) { VAS_Fail(__func__, "cache/cache_expire.c", 490, "oc->timer_idx == BINHEAP_NOIDX", VAS_ASSERT); } } while (0);

 do { do { if (!((oc->objhead) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_expire.c", 492, "(oc->objhead) != NULL", VAS_ASSERT); } } while (0); do { if (!((oc->objhead)->magic == 0x1b96615d)) { VAS_Fail(__func__, "cache/cache_expire.c", 492, "(oc->objhead)->magic == 0x1b96615d", VAS_ASSERT); } } while (0); } while (0);
 VSLb(&ep->vsl, SLT_ExpKill, "EXP_Expired x=%u t=%.0f",
     ObjGetXID(ep->wrk, oc), EXP_Ttl(((void *)0), &oc->exp) - now);
 exp_event(ep->wrk, oc, EXP_REMOVE);
 (void)HSH_DerefObjCore(ep->wrk, &oc);
 return (0);
}
...
object_cmp(void *priv, const void *a, const void *b)
{
 ...
 (void)priv;
 do { (aa) = (a); do { if (!((aa) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_expire.c", 511, "(aa) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((aa))->magic == (0x4d301302))) { VAS_Fail(__func__, "cache/cache_expire.c", 511, "((aa))->magic == (0x4d301302)", VAS_ASSERT); } } while (0); } while (0); } while (0);
 do { (bb) = (b); do { if (!((bb) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_expire.c", 512, "(bb) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((bb))->magic == (0x4d301302))) { VAS_Fail(__func__, "cache/cache_expire.c", 512, "((bb))->magic == (0x4d301302)", VAS_ASSERT); } } while (0); } while (0); } while (0);
...
object_update(void *priv, void *p, unsigned u)
{
 ...
 (void)priv;
 do { (oc) = (p); do { if (!((oc) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_expire.c", 522, "(oc) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((oc))->magic == (0x4d301302))) { VAS_Fail(__func__, "cache/cache_expire.c", 522, "((oc))->magic == (0x4d301302)", VAS_ASSERT); } } while (0); } while (0); } while (0);
 oc->timer_idx = u;
}
...
exp_thread(struct worker *wrk, void *priv)
{
 ...
 do { (ep) = (priv); do { if (!((ep) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_expire.c", 533, "(ep) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((ep))->magic == (0x9db22482))) { VAS_Fail(__func__, "cache/cache_expire.c", 533, "((ep))->magic == (0x9db22482)", VAS_ASSERT); } } while (0); } while (0); } while (0);
 ep->wrk = wrk;
 VSL_Setup(&ep->vsl, ((void *)0), 0);
 ep->heap = binheap_new(((void *)0), object_cmp, object_update);
 do { do { if (!((ep->heap) != 0)) { VAS_Fail(__func__, "cache/cache_expire.c", 537, "(ep->heap) != 0", VAS_ASSERT); } } while (0); } while (0);
 while (1) {

  Lck__Lock(&ep->mtx, __func__, 540);
  oc = ((&ep->inbox)->vtqh_first);
  if (oc != ((void *)0)) {
   do { if (((((oc))->lru_list.vtqe_next)) != ((void *)0)) (((oc))->lru_list.vtqe_next)->lru_list.vtqe_prev = (oc)->lru_list.vtqe_prev; else { (&ep->inbox)->vtqh_last = (oc)->lru_list.vtqe_prev; } *(oc)->lru_list.vtqe_prev = (((oc))->lru_list.vtqe_next); ; ; } while (0);
  ...
  Lck__Unlock(&ep->mtx, __func__, 551);
...
EXP_Init(void)
{
 ...
 do { (ep) = calloc(sizeof *(ep), 1); if ((ep) != ((void *)0)) (ep)->magic = (0x9db22482); } while (0);
 do { do { if (!((ep) != 0)) { VAS_Fail(__func__, "cache/cache_expire.c", 572, "(ep) != 0", VAS_ASSERT); } } while (0); } while (0);

 Lck__New(&ep->mtx, lck_exp, "lck_exp");
 do { do { if (!((pthread_cond_init(&ep->condvar, ((void *)0))) == 0)) { VAS_Fail(__func__, "cache/cache_expire.c", 575, "(pthread_cond_init(&ep->condvar, ((void *)0))) == 0", VAS_ASSERT); } } while (0); } while (0);
 do { (((&ep->inbox))->vtqh_first) = ((void *)0); (&ep->inbox)->vtqh_last = &(((&ep->inbox))->vtqh_first); } while (0);
 do { do { if (!((pthread_rwlock_init(&ep->cb_rwl, ((void *)0))) == 0)) { VAS_Fail(__func__, "cache/cache_expire.c", 577, "(pthread_rwlock_init(&ep->cb_rwl, ((void *)0))) == 0", VAS_ASSERT); } } while (0); } while (0);
 do { (((&ep->ecb_list))->vtqh_first) = ((void *)0); (&ep->ecb_list)->vtqh_last = &(((&ep->ecb_list))->vtqh_first); } while (0);
 exphdl = ep;
