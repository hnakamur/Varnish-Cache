...
# 1 "<command-line>" 2
# 1 "../libvarnish/cli_common.c"
# 30 "../libvarnish/cli_common.c"
# 1 "../../config.h" 1
# 31 "../libvarnish/cli_common.c" 2
...
# 45 "../libvarnish/cli_common.c" 2

# 1 "../../include/vdef.h" 1
# 47 "../libvarnish/cli_common.c" 2
# 1 "../../include/vas.h" 1
# 41 "../../include/vas.h"
enum vas_e {
 VAS_WRONG,
...
# 48 "../libvarnish/cli_common.c" 2
# 1 "../../include/miniobj.h" 1
# 49 "../libvarnish/cli_common.c" 2
...
VCLI_Out(struct cli *cli, const char *fmt, ...)
{
 ...
 if (cli != ((void *)0)) {
  do { do { if (!((cli) != ((void *)0))) { VAS_Fail(__func__, "../libvarnish/cli_common.c", 63, "(cli) != NULL", VAS_ASSERT); } } while (0); do { if (!((cli)->magic == 0x4038d570)) { VAS_Fail(__func__, "../libvarnish/cli_common.c", 63, "(cli)->magic == 0x4038d570", VAS_ASSERT); } } while (0); } while (0);
...
{
 do { do { if (!((cli) != ((void *)0))) { VAS_Fail(__func__, "../libvarnish/cli_common.c", 78, "(cli) != NULL", VAS_ASSERT); } } while (0); do { if (!((cli)->magic == 0x4038d570)) { VAS_Fail(__func__, "../libvarnish/cli_common.c", 78, "(cli)->magic == 0x4038d570", VAS_ASSERT); } } while (0); } while (0);
...
VCLI_Quote(struct cli *cli, const char *s)
{
 ...
 do { do { if (!((cli) != ((void *)0))) { VAS_Fail(__func__, "../libvarnish/cli_common.c", 90, "(cli) != NULL", VAS_ASSERT); } } while (0); do { if (!((cli)->magic == 0x4038d570)) { VAS_Fail(__func__, "../libvarnish/cli_common.c", 90, "(cli)->magic == 0x4038d570", VAS_ASSERT); } } while (0); } while (0);
...
VCLI_SetResult(struct cli *cli, unsigned res)
{
 ...
 if (cli != ((void *)0)) {
  do { do { if (!((cli) != ((void *)0))) { VAS_Fail(__func__, "../libvarnish/cli_common.c", 99, "(cli) != NULL", VAS_ASSERT); } } while (0); do { if (!((cli)->magic == 0x4038d570)) { VAS_Fail(__func__, "../libvarnish/cli_common.c", 99, "(cli)->magic == 0x4038d570", VAS_ASSERT); } } while (0); } while (0);
...
VCLI_WriteResult(int fd, unsigned status, const char *result)
{
 ...
 do { if (!(status >= 100)) { VAS_Fail(__func__, "../libvarnish/cli_common.c", 119, "status >= 100", VAS_ASSERT); } } while (0);
 do { if (!(status <= 999)) { VAS_Fail(__func__, "../libvarnish/cli_common.c", 120, "status <= 999", VAS_ASSERT); } } while (0);

 len = strlen(result);

 i = snprintf(res, sizeof res,
     "%-3d %-8zd\n", status, len);
 do { if (!(i == 13)) { VAS_Fail(__func__, "../libvarnish/cli_common.c", 126, "i == CLI_LINE0_LEN", VAS_ASSERT); } } while (0);
 do { if (!(strtoul(res + 3, ((void *)0), 10) == len)) { VAS_Fail(__func__, "../libvarnish/cli_common.c", 127, "strtoul(res + 3, NULL, 10) == len", VAS_ASSERT); } } while (0);

 iov[0].iov_base = res;
 iov[0].iov_len = 13;

 iov[1].iov_base = (void*)(uintptr_t)result;
 iov[1].iov_len = len;
 ...
 *status = CLIS_COMMS;
 if (ptr != ((void *)0))
  *ptr = (__extension__ (__builtin_constant_p (err) && ((size_t)(const void *)((err) + 1) - (size_t)(const void *)(err) == 1) ? (((const char *) (err))[0] == '\0' ? (char *) calloc ((size_t) 1, (size_t) 1) : ({ size_t __len = strlen (err) + 1; char *__retval = (char *) malloc (__len); if (__retval != ((void *)0)) __retval = (char *) memcpy (__retval, err, __len); __retval; })) : __strdup (err)));
 return (*status);
}
