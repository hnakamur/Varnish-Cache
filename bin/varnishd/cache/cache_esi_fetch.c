...
# 1 "<command-line>" 2
# 1 "cache/cache_esi_fetch.c"
# 31 "cache/cache_esi_fetch.c"
# 1 "../../config.h" 1
# 32 "cache/cache_esi_fetch.c" 2
...
vfp_vep_callback(struct vfp_ctx *vc, void *priv, ssize_t l, enum vgz_flag flg)
{
 ...
 do { do { if (!((vc) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_esi_fetch.c", 69, "(vc) != NULL", VAS_ASSERT); } } while (0); do { if (!((vc)->magic == 0x61d9d3e5)) { VAS_Fail(__func__, "cache/cache_esi_fetch.c", 69, "(vc)->magic == 0x61d9d3e5", VAS_ASSERT); } } while (0); } while (0);
 do { (vef) = (priv); do { if (!((vef) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_esi_fetch.c", 70, "(vef) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((vef))->magic == (0xf104b51f))) { VAS_Fail(__func__, "cache/cache_esi_fetch.c", 70, "((vef))->magic == (0xf104b51f)", VAS_ASSERT); } } while (0); } while (0); } while (0);
 do { if (!(l >= 0)) { VAS_Fail(__func__, "cache/cache_esi_fetch.c", 71, "l >= 0", VAS_ASSERT); } } while (0);
 ...
 do { do { if (!((vc->bo) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_esi_fetch.c", 86, "(vc->bo) != NULL", VAS_ASSERT); } } while (0); do { if (!((vc->bo)->magic == 0x23b95567)) { VAS_Fail(__func__, "cache/cache_esi_fetch.c", 86, "(vc->bo)->magic == 0x23b95567", VAS_ASSERT); } } while (0); } while (0);
 ...
 do { if (!(i == VGZ_ERROR || VGZ_IbufEmpty(vef->vgz))) { VAS_Fail(__func__, "cache/cache_esi_fetch.c", 102, "i == VGZ_ERROR || VGZ_IbufEmpty(vef->vgz)", VAS_ASSERT); } } while (0);
 vef->ibuf_o += l;
 return (vef->tot);
}
    ...
    enum vfp_status retval)
{
 ...
 do { do { if (!((vc) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_esi_fetch.c", 115, "(vc) != NULL", VAS_ASSERT); } } while (0); do { if (!((vc)->magic == 0x61d9d3e5)) { VAS_Fail(__func__, "cache/cache_esi_fetch.c", 115, "(vc)->magic == 0x61d9d3e5", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((vef) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_esi_fetch.c", 116, "(vef) != NULL", VAS_ASSERT); } } while (0); do { if (!((vef)->magic == 0xf104b51f)) { VAS_Fail(__func__, "cache/cache_esi_fetch.c", 116, "(vef)->magic == 0xf104b51f", VAS_ASSERT); } } while (0); } while (0);
 ...
 if (vsb != ((void *)0)) {
  if (retval == VFP_END) {
   l = VSB_len(vsb);
   do { if (!(l > 0)) { VAS_Fail(__func__, "cache/cache_esi_fetch.c", 123, "l > 0", VAS_ASSERT); } } while (0);
 ...
 if (vef->ibuf != ((void *)0))
  free(vef->ibuf);
 do { (vef)->magic = (0); free(vef); vef = ((void *)0); } while (0);
 return (retval);
}
...
vfp_esi_gzip_init(struct vfp_ctx *vc, struct vfp_entry *vfe)
{
 ...
 do { do { if (!((vc) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_esi_fetch.c", 151, "(vc) != NULL", VAS_ASSERT); } } while (0); do { if (!((vc)->magic == 0x61d9d3e5)) { VAS_Fail(__func__, "cache/cache_esi_fetch.c", 151, "(vc)->magic == 0x61d9d3e5", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((vc->esi_req) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_esi_fetch.c", 152, "(vc->esi_req) != NULL", VAS_ASSERT); } } while (0); do { if (!((vc->esi_req)->magic == 0x6428b5c9)) { VAS_Fail(__func__, "cache/cache_esi_fetch.c", 152, "(vc->esi_req)->magic == 0x6428b5c9", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((vfe) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_esi_fetch.c", 153, "(vfe) != NULL", VAS_ASSERT); } } while (0); do { if (!((vfe)->magic == 0xbe32a027)) { VAS_Fail(__func__, "cache/cache_esi_fetch.c", 153, "(vfe)->magic == 0xbe32a027", VAS_ASSERT); } } while (0); } while (0);
 do { (vef) = calloc(sizeof *(vef), 1); if ((vef) != ((void *)0)) (vef)->magic = (0xf104b51f); } while (0);
 if (vef == ((void *)0))
  return (VFP_ERROR);
   ...
   ssize_t *lp)
{
 ...
 do { do { if (!((vc) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_esi_fetch.c", 185, "(vc) != NULL", VAS_ASSERT); } } while (0); do { if (!((vc)->magic == 0x61d9d3e5)) { VAS_Fail(__func__, "cache/cache_esi_fetch.c", 185, "(vc)->magic == 0x61d9d3e5", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((vfe) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_esi_fetch.c", 186, "(vfe) != NULL", VAS_ASSERT); } } while (0); do { if (!((vfe)->magic == 0xbe32a027)) { VAS_Fail(__func__, "cache/cache_esi_fetch.c", 186, "(vfe)->magic == 0xbe32a027", VAS_ASSERT); } } while (0); } while (0);
 do { (vef) = (vfe->priv1); do { if (!((vef) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_esi_fetch.c", 187, "(vef) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((vef))->magic == (0xf104b51f))) { VAS_Fail(__func__, "cache/cache_esi_fetch.c", 187, "((vef))->magic == (0xf104b51f)", VAS_ASSERT); } } while (0); } while (0); } while (0);
 do { do { if (!((p) != 0)) { VAS_Fail(__func__, "cache/cache_esi_fetch.c", 188, "(p) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((lp) != 0)) { VAS_Fail(__func__, "cache/cache_esi_fetch.c", 189, "(lp) != 0", VAS_ASSERT); } } while (0); } while (0);
 *lp = 0;
 ...
 if (l > 0) {
  ...
  vef->ibuf_i += l;
  do { if (!(vef->ibuf_o >= vef->ibuf && vef->ibuf_o <= vef->ibuf_i)) { VAS_Fail(__func__, "cache/cache_esi_fetch.c", 202, "vef->ibuf_o >= vef->ibuf && vef->ibuf_o <= vef->ibuf_i", VAS_ASSERT); } } while (0);
  if (vef->error) {
   (*__errno_location ()) = vef->error;
   return (VFP_ERROR);
  }
...
vfp_esi_init(struct vfp_ctx *vc, struct vfp_entry *vfe)
{
 ...
 do { do { if (!((vc) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_esi_fetch.c", 225, "(vc) != NULL", VAS_ASSERT); } } while (0); do { if (!((vc)->magic == 0x61d9d3e5)) { VAS_Fail(__func__, "cache/cache_esi_fetch.c", 225, "(vc)->magic == 0x61d9d3e5", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((vc->esi_req) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_esi_fetch.c", 226, "(vc->esi_req) != NULL", VAS_ASSERT); } } while (0); do { if (!((vc->esi_req)->magic == 0x6428b5c9)) { VAS_Fail(__func__, "cache/cache_esi_fetch.c", 226, "(vc->esi_req)->magic == 0x6428b5c9", VAS_ASSERT); } } while (0); } while (0);
 do { (vef) = calloc(sizeof *(vef), 1); if ((vef) != ((void *)0)) (vef)->magic = (0xf104b51f); } while (0);
 if (vef == ((void *)0))
  return (VFP_ERROR);
 vef->vep = VEP_Init(vc, vc->esi_req, ((void *)0), ((void *)0));
 vfe->priv1 = vef;
 return (VFP_OK);
}
...
vfp_esi_pull(struct vfp_ctx *vc, struct vfp_entry *vfe, void *p, ssize_t *lp)
{
 ...
 do { do { if (!((vc) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_esi_fetch.c", 242, "(vc) != NULL", VAS_ASSERT); } } while (0); do { if (!((vc)->magic == 0x61d9d3e5)) { VAS_Fail(__func__, "cache/cache_esi_fetch.c", 242, "(vc)->magic == 0x61d9d3e5", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((vfe) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_esi_fetch.c", 243, "(vfe) != NULL", VAS_ASSERT); } } while (0); do { if (!((vfe)->magic == 0xbe32a027)) { VAS_Fail(__func__, "cache/cache_esi_fetch.c", 243, "(vfe)->magic == 0xbe32a027", VAS_ASSERT); } } while (0); } while (0);
 do { (vef) = (vfe->priv1); do { if (!((vef) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_esi_fetch.c", 244, "(vef) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((vef))->magic == (0xf104b51f))) { VAS_Fail(__func__, "cache/cache_esi_fetch.c", 244, "((vef))->magic == (0xf104b51f)", VAS_ASSERT); } } while (0); } while (0); } while (0);
 do { do { if (!((p) != 0)) { VAS_Fail(__func__, "cache/cache_esi_fetch.c", 245, "(p) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((lp) != 0)) { VAS_Fail(__func__, "cache/cache_esi_fetch.c", 246, "(lp) != 0", VAS_ASSERT); } } while (0); } while (0);
 if (DO_DEBUG(DBG_ESI_CHOP)) {
  d = (random() & 3) + 1;
  if (d < *lp)
   *lp = d;
...
{
 do { do { if (!((vc) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_esi_fetch.c", 265, "(vc) != NULL", VAS_ASSERT); } } while (0); do { if (!((vc)->magic == 0x61d9d3e5)) { VAS_Fail(__func__, "cache/cache_esi_fetch.c", 265, "(vc)->magic == 0x61d9d3e5", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((vfe) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_esi_fetch.c", 266, "(vfe) != NULL", VAS_ASSERT); } } while (0); do { if (!((vfe)->magic == 0xbe32a027)) { VAS_Fail(__func__, "cache/cache_esi_fetch.c", 266, "(vfe)->magic == 0xbe32a027", VAS_ASSERT); } } while (0); } while (0);
