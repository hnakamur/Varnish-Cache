...
# 1 "<command-line>" 2
# 1 "../libvarnish/cli_auth.c"
# 29 "../libvarnish/cli_auth.c"
# 1 "../../config.h" 1
# 30 "../libvarnish/cli_auth.c" 2
    ...
    char response[64 + 1])
{
 ...
 do { if (!(64 == (32 * 2))) { VAS_Fail(__func__, "../libvarnish/cli_auth.c", 49, "CLI_AUTH_RESPONSE_LEN == (SHA256_LEN * 2)", VAS_ASSERT); } } while (0);
