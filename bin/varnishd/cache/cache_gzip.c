...
# 1 "<command-line>" 2
# 1 "cache/cache_gzip.c"
# 39 "cache/cache_gzip.c"
# 1 "../../config.h" 1
# 40 "cache/cache_gzip.c" 2
...
# 46 "cache/cache_gzip.c" 2

# 1 "../../lib/libvgz/vgz.h" 1
# 34 "../../lib/libvgz/vgz.h"
# 1 "../../lib/libvgz/zconf.h" 1
# 368 "../../lib/libvgz/zconf.h"
...
# 1 "/usr/lib/gcc/x86_64-redhat-linux/4.8.5/include/limits.h" 1 3 4
# 396 "../../lib/libvgz/zconf.h" 2
# 406 "../../lib/libvgz/zconf.h"
   typedef unsigned z_crc_t;
# 35 "../../lib/libvgz/vgz.h" 2
# 80 "../../lib/libvgz/vgz.h"
...
# 220 "../../lib/libvgz/vgz.h"
extern const char * zlibVersion (void);
# 250 "../../lib/libvgz/vgz.h"
extern int deflate (z_streamp strm, int flush);
# 357 "../../lib/libvgz/vgz.h"
extern int deflateEnd (z_streamp strm);
# 396 "../../lib/libvgz/vgz.h"
extern int inflate (z_streamp strm, int flush);
# 512 "../../lib/libvgz/vgz.h"
extern int inflateEnd (z_streamp strm);
# 591 "../../lib/libvgz/vgz.h"
extern int deflateSetDictionary (z_streamp strm, const Bytef *dictionary, uInt dictLength)

                                                               ;
# 635 "../../lib/libvgz/vgz.h"
extern int deflateCopy (z_streamp dest, z_streamp source)
                                                      ;
# 653 "../../lib/libvgz/vgz.h"
extern int deflateReset (z_streamp strm);
# 664 "../../lib/libvgz/vgz.h"
extern int deflateParams (z_streamp strm, int level, int strategy)

                                                    ;
# 685 "../../lib/libvgz/vgz.h"
extern int deflateTune (z_streamp strm, int good_length, int max_lazy, int nice_length, int max_chain)



                                                   ;
# 702 "../../lib/libvgz/vgz.h"
extern uLong deflateBound (z_streamp strm, uLong sourceLen)
                                                        ;
# 717 "../../lib/libvgz/vgz.h"
extern int deflatePending (z_streamp strm, unsigned *pending, int *bits)

                                                  ;
# 732 "../../lib/libvgz/vgz.h"
extern int deflatePrime (z_streamp strm, int bits, int value)

                                                ;
# 749 "../../lib/libvgz/vgz.h"
extern int deflateSetHeader (z_streamp strm, gz_headerp head)
                                                          ;
# 823 "../../lib/libvgz/vgz.h"
extern int inflateSetDictionary (z_streamp strm, const Bytef *dictionary, uInt dictLength)

                                                               ;
# 846 "../../lib/libvgz/vgz.h"
extern int inflateGetDictionary (z_streamp strm, Bytef *dictionary, uInt *dictLength)

                                                                ;
# 861 "../../lib/libvgz/vgz.h"
extern int inflateSync (z_streamp strm);
# 880 "../../lib/libvgz/vgz.h"
extern int inflateCopy (z_streamp dest, z_streamp source)
                                                      ;
# 896 "../../lib/libvgz/vgz.h"
extern int inflateReset (z_streamp strm);
# 906 "../../lib/libvgz/vgz.h"
extern int inflateReset2 (z_streamp strm, int windowBits)
                                                      ;
# 918 "../../lib/libvgz/vgz.h"
extern int inflatePrime (z_streamp strm, int bits, int value)

                                                ;
# 939 "../../lib/libvgz/vgz.h"
extern long inflateMark (z_streamp strm);
# 967 "../../lib/libvgz/vgz.h"
extern int inflateGetHeader (z_streamp strm, gz_headerp head)
                                                          ;
# 1029 "../../lib/libvgz/vgz.h"
...
# 1164 "../../lib/libvgz/vgz.h"
extern int compress (Bytef *dest, uLongf *destLen, const Bytef *source, uLong sourceLen)
                                                                       ;
# 1178 "../../lib/libvgz/vgz.h"
extern int compress2 (Bytef *dest, uLongf *destLen, const Bytef *source, uLong sourceLen, int level)

                                             ;
# 1194 "../../lib/libvgz/vgz.h"
...
extern int uncompress (Bytef *dest, uLongf *destLen, const Bytef *source, uLong sourceLen)
                                                                         ;
# 1228 "../../lib/libvgz/vgz.h"
typedef struct gzFile_s *gzFile;
# 1268 "../../lib/libvgz/vgz.h"
extern gzFile gzdopen (int fd, const char *mode);
# 1291 "../../lib/libvgz/vgz.h"
extern int gzbuffer (gzFile file, unsigned size);
# 1308 "../../lib/libvgz/vgz.h"
extern int gzsetparams (gzFile file, int level, int strategy);
# 1317 "../../lib/libvgz/vgz.h"
extern int gzread (gzFile file, voidp buf, unsigned len);
# 1345 "../../lib/libvgz/vgz.h"
...
# 1404 "../../lib/libvgz/vgz.h"
extern int gzungetc (int c, gzFile file);
# 1416 "../../lib/libvgz/vgz.h"
extern int gzflush (gzFile file, int flush);
# 1451 "../../lib/libvgz/vgz.h"
extern int gzrewind (gzFile file);
# 1479 "../../lib/libvgz/vgz.h"
extern int gzeof (gzFile file);
# 1494 "../../lib/libvgz/vgz.h"
extern int gzdirect (gzFile file);
# 1515 "../../lib/libvgz/vgz.h"
extern int gzclose (gzFile file);
# 1528 "../../lib/libvgz/vgz.h"
extern int gzclose_r (gzFile file);
extern int gzclose_w (gzFile file);
# 1540 "../../lib/libvgz/vgz.h"
extern const char * gzerror (gzFile file, int *errnum);
# 1556 "../../lib/libvgz/vgz.h"
extern void gzclearerr (gzFile file);
# 1573 "../../lib/libvgz/vgz.h"
extern uLong adler32 (uLong adler, const Bytef *buf, uInt len);
# 1604 "../../lib/libvgz/vgz.h"
extern uLong crc32 (uLong crc, const Bytef *buf, uInt len);
# 1637 "../../lib/libvgz/vgz.h"
...
{
 do { do { if (!((vg) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_gzip.c", 70, "(vg) != NULL", VAS_ASSERT); } } while (0); do { if (!((vg)->magic == 0x162df0cb)) { VAS_Fail(__func__, "cache/cache_gzip.c", 70, "(vg)->magic == 0x162df0cb", VAS_ASSERT); } } while (0); } while (0);
...
vgz_alloc_vgz(struct vsl_log *vsl, const char *id)
{
 ...
 do { (vg) = calloc(sizeof *(vg), 1); if ((vg) != ((void *)0)) (vg)->magic = (0x162df0cb); } while (0);
 do { do { if (!((vg) != 0)) { VAS_Fail(__func__, "cache/cache_gzip.c", 84, "(vg) != 0", VAS_ASSERT); } } while (0); } while (0);
 vg->vsl = vsl;
 vg->id = id;
 return (vg);
}
...
VGZ_NewUngzip(struct vsl_log *vsl, const char *id)
{
 ...
 do { if (!(0 == inflateInit2_((&vg->vz), (31), "1.2.8", (int)sizeof(z_stream)))) { VAS_Fail(__func__, "cache/cache_gzip.c", 105, "Z_OK == inflateInit2(&vg->vz, 31)", VAS_ASSERT); } } while (0);
 return (vg);
}
...
VGZ_NewGzip(struct vsl_log *vsl, const char *id)
{
 ...
 vg->dir = VGZ_GZ;
 VSC_C_main->n_gzip++;
# 129 "cache/cache_gzip.c"
 i = deflateInit2_((&vg->vz),(cache_param->gzip_level),(8),(16 + 15),(cache_param->gzip_memlevel), (0), "1.2.8", (int)sizeof(z_stream))




                        ;
 do { if (!(0 == i)) { VAS_Fail(__func__, "cache/cache_gzip.c", 135, "Z_OK == i", VAS_ASSERT); } } while (0);
 return (vg);
}
...
vgz_getmbuf(struct vgz *vg)
{
 ...
 do { do { if (!((vg) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_gzip.c", 146, "(vg) != NULL", VAS_ASSERT); } } while (0); do { if (!((vg)->magic == 0x162df0cb)) { VAS_Fail(__func__, "cache/cache_gzip.c", 146, "(vg)->magic == 0x162df0cb", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((vg->m_sz) == 0)) { VAS_Fail(__func__, "cache/cache_gzip.c", 147, "(vg->m_sz) == 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((vg->m_len) == 0)) { VAS_Fail(__func__, "cache/cache_gzip.c", 148, "(vg->m_len) == 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((vg->m_buf) == 0)) { VAS_Fail(__func__, "cache/cache_gzip.c", 149, "(vg->m_buf) == 0", VAS_ASSERT); } } while (0); } while (0);
...
VGZ_Ibuf(struct vgz *vg, const void *ptr, ssize_t len)
{
 ...
 do { do { if (!((vg) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_gzip.c", 166, "(vg) != NULL", VAS_ASSERT); } } while (0); do { if (!((vg)->magic == 0x162df0cb)) { VAS_Fail(__func__, "cache/cache_gzip.c", 166, "(vg)->magic == 0x162df0cb", VAS_ASSERT); } } while (0); } while (0);

 do { do { if (!((vg->vz.avail_in) == 0)) { VAS_Fail(__func__, "cache/cache_gzip.c", 168, "(vg->vz.avail_in) == 0", VAS_ASSERT); } } while (0); } while (0);
 vg->vz.next_in = ((void*)(uintptr_t)(ptr));
 vg->vz.avail_in = len;
}
...
VGZ_IbufEmpty(const struct vgz *vg)
{
 ...
 do { do { if (!((vg) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_gzip.c", 177, "(vg) != NULL", VAS_ASSERT); } } while (0); do { if (!((vg)->magic == 0x162df0cb)) { VAS_Fail(__func__, "cache/cache_gzip.c", 177, "(vg)->magic == 0x162df0cb", VAS_ASSERT); } } while (0); } while (0);
...
VGZ_Obuf(struct vgz *vg, void *ptr, ssize_t len)
{
 ...
 do { do { if (!((vg) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_gzip.c", 187, "(vg) != NULL", VAS_ASSERT); } } while (0); do { if (!((vg)->magic == 0x162df0cb)) { VAS_Fail(__func__, "cache/cache_gzip.c", 187, "(vg)->magic == 0x162df0cb", VAS_ASSERT); } } while (0); } while (0);

 vg->vz.next_out = ((void*)(uintptr_t)(ptr));
 vg->vz.avail_out = len;
}
...
VGZ_ObufFull(const struct vgz *vg)
{
 ...
 do { do { if (!((vg) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_gzip.c", 197, "(vg) != NULL", VAS_ASSERT); } } while (0); do { if (!((vg)->magic == 0x162df0cb)) { VAS_Fail(__func__, "cache/cache_gzip.c", 197, "(vg)->magic == 0x162df0cb", VAS_ASSERT); } } while (0); } while (0);
...
VGZ_Gunzip(struct vgz *vg, const void **pptr, ssize_t *plen)
{
 ...
 do { do { if (!((vg) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_gzip.c", 210, "(vg) != NULL", VAS_ASSERT); } } while (0); do { if (!((vg)->magic == 0x162df0cb)) { VAS_Fail(__func__, "cache/cache_gzip.c", 210, "(vg)->magic == 0x162df0cb", VAS_ASSERT); } } while (0); } while (0);

 *pptr = ((void *)0);
 *plen = 0;
 do { do { if (!((vg->vz.next_out) != 0)) { VAS_Fail(__func__, "cache/cache_gzip.c", 214, "(vg->vz.next_out) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((vg->vz.avail_out) != 0)) { VAS_Fail(__func__, "cache/cache_gzip.c", 215, "(vg->vz.avail_out) != 0", VAS_ASSERT); } } while (0); } while (0);
...
VGZ_Gzip(struct vgz *vg, const void **pptr, ssize_t *plen, enum vgz_flag flags)
{
 ...
 do { do { if (!((vg) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_gzip.c", 244, "(vg) != NULL", VAS_ASSERT); } } while (0); do { if (!((vg)->magic == 0x162df0cb)) { VAS_Fail(__func__, "cache/cache_gzip.c", 244, "(vg)->magic == 0x162df0cb", VAS_ASSERT); } } while (0); } while (0);

 *pptr = ((void *)0);
 *plen = 0;
 do { do { if (!((vg->vz.next_out) != 0)) { VAS_Fail(__func__, "cache/cache_gzip.c", 248, "(vg->vz.next_out) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((vg->vz.avail_out) != 0)) { VAS_Fail(__func__, "cache/cache_gzip.c", 249, "(vg->vz.avail_out) != 0", VAS_ASSERT); } } while (0); } while (0);
 before = vg->vz.next_out;
 switch(flags) {
 case VGZ_NORMAL: zflg = 0; break;
 case VGZ_ALIGN: zflg = 2; break;
 case VGZ_RESET: zflg = 3; break;
 case VGZ_FINISH: zflg = 4; break;
 default: do { VAS_Fail(__func__, "cache/cache_gzip.c", 256, "", VAS_INCOMPLETE); } while (0);
 }
    ...
    const void *ptr, ssize_t len)
{
 ...
 do { do { if (!((req) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_gzip.c", 291, "(req) != NULL", VAS_ASSERT); } } while (0); do { if (!((req)->magic == 0x2751aaa1)) { VAS_Fail(__func__, "cache/cache_gzip.c", 291, "(req)->magic == 0x2751aaa1", VAS_ASSERT); } } while (0); } while (0);
 wrk = req->wrk;
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_gzip.c", 293, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "cache/cache_gzip.c", 293, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);

 if (act == VDP_INIT) {
  vg = VGZ_NewUngzip(req->vsl, "U D -");
  do { do { if (!((vg) != 0)) { VAS_Fail(__func__, "cache/cache_gzip.c", 297, "(vg) != 0", VAS_ASSERT); } } while (0); } while (0);
  if (vgz_getmbuf(vg)) {
   (void)VGZ_Destroy(&vg);
   return (-1);
  }
  ...
  *priv = vg;
  ...
  if (u != 0 && ((&req->vdp)->vtqh_first)->func == VDP_gunzip)
   req->resp_len = u;

  return (0);
 }

 do { (vg) = (*priv); do { if (!((vg) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_gzip.c", 328, "(vg) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((vg))->magic == (0x162df0cb))) { VAS_Fail(__func__, "cache/cache_gzip.c", 328, "((vg))->magic == (0x162df0cb)", VAS_ASSERT); } } while (0); } while (0); } while (0);
 do { do { if (!((vg->m_buf) != 0)) { VAS_Fail(__func__, "cache/cache_gzip.c", 329, "(vg->m_buf) != 0", VAS_ASSERT); } } while (0); } while (0);

 if (act == VDP_FINI) {

  do { do { if (!((len) == 0)) { VAS_Fail(__func__, "cache/cache_gzip.c", 333, "(len) == 0", VAS_ASSERT); } } while (0); } while (0);
  (void)VGZ_Destroy(&vg);
  *priv = ((void *)0);
  return (0);
 }
 ...
 do { if (!(vr == VGZ_STUCK || vr == VGZ_OK || vr == VGZ_END)) { VAS_Fail(__func__, "cache/cache_gzip.c", 355, "vr == VGZ_STUCK || vr == VGZ_OK || vr == VGZ_END", VAS_ASSERT); } } while (0);
 return (0);
}
...
VGZ_UpdateObj(const struct vfp_ctx *vc, struct vgz *vg, enum vgz_ua_e e)
{
 ...
 do { do { if (!((vg) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_gzip.c", 367, "(vg) != NULL", VAS_ASSERT); } } while (0); do { if (!((vg)->magic == 0x162df0cb)) { VAS_Fail(__func__, "cache/cache_gzip.c", 367, "(vg)->magic == 0x162df0cb", VAS_ASSERT); } } while (0); } while (0);
 ii = vg->vz.start_bit + vg->vz.last_bit + vg->vz.stop_bit;
 if (e == VUA_UPDATE && ii == vg->bits)
  return;
 vg->bits = ii;
 p = ObjSetattr(vc->wrk, vc->oc, OA_GZIPBITS, 32, ((void *)0));
 do { do { if (!((p) != 0)) { VAS_Fail(__func__, "cache/cache_gzip.c", 373, "(p) != 0", VAS_ASSERT); } } while (0); } while (0);
...
VGZ_Destroy(struct vgz **vgp)
{
 ...
 vg = *vgp;
 do { do { if (!((vg) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_gzip.c", 394, "(vg) != NULL", VAS_ASSERT); } } while (0); do { if (!((vg)->magic == 0x162df0cb)) { VAS_Fail(__func__, "cache/cache_gzip.c", 394, "(vg)->magic == 0x162df0cb", VAS_ASSERT); } } while (0); } while (0);
 *vgp = ((void *)0);

 do { do { if (!((vg->id) != 0)) { VAS_Fail(__func__, "cache/cache_gzip.c", 397, "(vg->id) != 0", VAS_ASSERT); } } while (0); } while (0);
 ...
 do { (vg)->magic = (0); free(vg); vg = ((void *)0); } while (0);
 return (vr);
}
...
vfp_gzip_init(struct vfp_ctx *vc, struct vfp_entry *vfe)
{
 ...
 do { do { if (!((vc) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_gzip.c", 439, "(vc) != NULL", VAS_ASSERT); } } while (0); do { if (!((vc)->magic == 0x61d9d3e5)) { VAS_Fail(__func__, "cache/cache_gzip.c", 439, "(vc)->magic == 0x61d9d3e5", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((vfe) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_gzip.c", 440, "(vfe) != NULL", VAS_ASSERT); } } while (0); do { if (!((vfe)->magic == 0xbe32a027)) { VAS_Fail(__func__, "cache/cache_gzip.c", 440, "(vfe)->magic == 0xbe32a027", VAS_ASSERT); } } while (0); } while (0);
 ...
 if (vfe->vfp->priv2 == 1) {
  if (http_GetHdr(vc->http, H_Content_Encoding, ((void *)0)))
   return (VFP_NULL);
 ...
 do { do { if (!((vg->m_len) == 0)) { VAS_Fail(__func__, "cache/cache_gzip.c", 462, "(vg->m_len) == 0", VAS_ASSERT); } } while (0); } while (0);

 if (vfe->vfp->priv2 == 0 || vfe->vfp->priv2 == 1) {
  http_Unset(vc->http, H_Content_Encoding);
 ...
 if (vfe->vfp->priv2 == 1 || vfe->vfp->priv2 == 2)
    ...
    ssize_t *lp)
{
 ...
 do { do { if (!((vc) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_gzip.c", 496, "(vc) != NULL", VAS_ASSERT); } } while (0); do { if (!((vc)->magic == 0x61d9d3e5)) { VAS_Fail(__func__, "cache/cache_gzip.c", 496, "(vc)->magic == 0x61d9d3e5", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((vfe) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_gzip.c", 497, "(vfe) != NULL", VAS_ASSERT); } } while (0); do { if (!((vfe)->magic == 0xbe32a027)) { VAS_Fail(__func__, "cache/cache_gzip.c", 497, "(vfe)->magic == 0xbe32a027", VAS_ASSERT); } } while (0); } while (0);
 do { (vg) = (vfe->priv1); do { if (!((vg) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_gzip.c", 498, "(vg) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((vg))->magic == (0x162df0cb))) { VAS_Fail(__func__, "cache/cache_gzip.c", 498, "((vg))->magic == (0x162df0cb)", VAS_ASSERT); } } while (0); } while (0); } while (0);
 do { do { if (!((p) != 0)) { VAS_Fail(__func__, "cache/cache_gzip.c", 499, "(p) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((lp) != 0)) { VAS_Fail(__func__, "cache/cache_gzip.c", 500, "(lp) != 0", VAS_ASSERT); } } while (0); } while (0);
 l = *lp;
 *lp = 0;
 VGZ_Obuf(vg, p, l);
 do {
  ...
  if (!VGZ_IbufEmpty(vg) || vp == VFP_END) {
   ...
   if (dl > 0) {
    *lp = dl;
    do { if (!(dp == p)) { VAS_Fail(__func__, "cache/cache_gzip.c", 521, "dp == p", VAS_ASSERT); } } while (0);
    return (VFP_OK);
   }
  }
  do { do { if (!((VGZ_IbufEmpty(vg)) != 0)) { VAS_Fail(__func__, "cache/cache_gzip.c", 525, "(VGZ_IbufEmpty(vg)) != 0", VAS_ASSERT); } } while (0); } while (0);
 } while (vp == VFP_OK);
 if (vr != VGZ_END)
  return(VFP_Error(vc, "Gunzip error at the very end"));
 return (vp);
}
# 539 "cache/cache_gzip.c"
static enum vfp_status
    ...
    ssize_t *lp)
{
 ...
 do { do { if (!((vc) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_gzip.c", 550, "(vc) != NULL", VAS_ASSERT); } } while (0); do { if (!((vc)->magic == 0x61d9d3e5)) { VAS_Fail(__func__, "cache/cache_gzip.c", 550, "(vc)->magic == 0x61d9d3e5", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((vfe) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_gzip.c", 551, "(vfe) != NULL", VAS_ASSERT); } } while (0); do { if (!((vfe)->magic == 0xbe32a027)) { VAS_Fail(__func__, "cache/cache_gzip.c", 551, "(vfe)->magic == 0xbe32a027", VAS_ASSERT); } } while (0); } while (0);
 do { (vg) = (vfe->priv1); do { if (!((vg) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_gzip.c", 552, "(vg) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((vg))->magic == (0x162df0cb))) { VAS_Fail(__func__, "cache/cache_gzip.c", 552, "((vg))->magic == (0x162df0cb)", VAS_ASSERT); } } while (0); } while (0); } while (0);
 do { do { if (!((p) != 0)) { VAS_Fail(__func__, "cache/cache_gzip.c", 553, "(p) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((lp) != 0)) { VAS_Fail(__func__, "cache/cache_gzip.c", 554, "(lp) != 0", VAS_ASSERT); } } while (0); } while (0);
 l = *lp;
 *lp = 0;
 VGZ_Obuf(vg, p, l);
 do {
  ...
  if (!VGZ_IbufEmpty(vg) || vg->flag == VGZ_FINISH) {
    ...
    *lp = dl;
    do { if (!(dp == p)) { VAS_Fail(__func__, "cache/cache_gzip.c", 575, "dp == p", VAS_ASSERT); } } while (0);
    return (VFP_OK);
   }
  }
  do { do { if (!((VGZ_IbufEmpty(vg)) != 0)) { VAS_Fail(__func__, "cache/cache_gzip.c", 579, "(VGZ_IbufEmpty(vg)) != 0", VAS_ASSERT); } } while (0); } while (0);
    ...
    ssize_t *lp)
{
 ...
 do { do { if (!((vc) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_gzip.c", 605, "(vc) != NULL", VAS_ASSERT); } } while (0); do { if (!((vc)->magic == 0x61d9d3e5)) { VAS_Fail(__func__, "cache/cache_gzip.c", 605, "(vc)->magic == 0x61d9d3e5", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((vfe) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_gzip.c", 606, "(vfe) != NULL", VAS_ASSERT); } } while (0); do { if (!((vfe)->magic == 0xbe32a027)) { VAS_Fail(__func__, "cache/cache_gzip.c", 606, "(vfe)->magic == 0xbe32a027", VAS_ASSERT); } } while (0); } while (0);
 do { (vg) = (vfe->priv1); do { if (!((vg) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_gzip.c", 607, "(vg) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((vg))->magic == (0x162df0cb))) { VAS_Fail(__func__, "cache/cache_gzip.c", 607, "((vg))->magic == (0x162df0cb)", VAS_ASSERT); } } while (0); } while (0); } while (0);
 do { do { if (!((p) != 0)) { VAS_Fail(__func__, "cache/cache_gzip.c", 608, "(p) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((lp) != 0)) { VAS_Fail(__func__, "cache/cache_gzip.c", 609, "(lp) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { (vg) = (vfe->priv1); do { if (!((vg) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_gzip.c", 610, "(vg) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((vg))->magic == (0x162df0cb))) { VAS_Fail(__func__, "cache/cache_gzip.c", 610, "((vg))->magic == (0x162df0cb)", VAS_ASSERT); } } while (0); } while (0); } while (0);
 vp = VFP_Suck(vc, p, lp);
 if (vp == VFP_ERROR)
  return (vp);
 if (*lp > 0 || vp == VFP_END) {
...
vfp_gzip_fini(struct vfp_ctx *vc, struct vfp_entry *vfe)
{
 ...
 do { do { if (!((vc) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_gzip.c", 642, "(vc) != NULL", VAS_ASSERT); } } while (0); do { if (!((vc)->magic == 0x61d9d3e5)) { VAS_Fail(__func__, "cache/cache_gzip.c", 642, "(vc)->magic == 0x61d9d3e5", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((vfe) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_gzip.c", 643, "(vfe) != NULL", VAS_ASSERT); } } while (0); do { if (!((vfe)->magic == 0xbe32a027)) { VAS_Fail(__func__, "cache/cache_gzip.c", 643, "(vfe)->magic == 0xbe32a027", VAS_ASSERT); } } while (0); } while (0);

 if (vfe->priv1 != ((void *)0)) {
  do { (vg) = (vfe->priv1); do { if (!((vg) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_gzip.c", 646, "(vg) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((vg))->magic == (0x162df0cb))) { VAS_Fail(__func__, "cache/cache_gzip.c", 646, "((vg))->magic == (0x162df0cb)", VAS_ASSERT); } } while (0); } while (0); } while (0);
  vfe->priv1 = ((void *)0);
  (void)VGZ_Destroy(&vg);
 }
}
