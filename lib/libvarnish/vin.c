...
# 42 "../libvarnish/vin.c" 2
# 1 "../../include/vdef.h" 1
# 43 "../libvarnish/vin.c" 2
# 1 "../../include/vin.h" 1
# 35 "../../include/vin.h"
int VIN_N_Arg(const char *n_arg, char **name, char **dir, char **vsl);
# 44 "../libvarnish/vin.c" 2
...
VIN_N_Arg(const char *n_arg, char **name, char **dir, char **vsl)
{
 ...
 if (n_arg == ((void *)0) || *n_arg == '\0') {
  ...
  do { do { if (!(snprintf(nm, sizeof nm, "%s", n_arg) < sizeof nm)) { VAS_Fail(__func__, "../libvarnish/vin.c", 62, "snprintf(nm, sizeof nm, \"%s\", n_arg) < sizeof nm", VAS_ASSERT); } } while (0); } while (0);
 ...
 if (*nm == '/')
  strcpy(dn, nm);
 else if (strlen("/var/lib/varnish") + 1 + strlen(nm) >= sizeof dn){

  (*__errno_location ()) = 36;
  return (-1);
 } else {
  do { do { if (!(snprintf(dn, sizeof dn, "%s/%s", "/var/lib/varnish", nm) < sizeof dn)) { VAS_Fail(__func__, "../libvarnish/vin.c", 74, "snprintf(dn, sizeof dn, \"%s/%s\", \"/var/lib/varnish\", nm) < sizeof dn", VAS_ASSERT); } } while (0); } while (0);
 }


 if (strlen(dn) + 1 + strlen("_.vsm") >= sizeof dn) {
  (*__errno_location ()) = 36;
  return (-1);
 }
 ...
 if (name != ((void *)0)) {
  *name = (__extension__ (__builtin_constant_p (nm) && ((size_t)(const void *)((nm) + 1) - (size_t)(const void *)(nm) == 1) ? (((const char *) (nm))[0] == '\0' ? (char *) calloc ((size_t) 1, (size_t) 1) : ({ size_t __len = strlen (nm) + 1; char *__retval = (char *) malloc (__len); if (__retval != ((void *)0)) __retval = (char *) memcpy (__retval, nm, __len); __retval; })) : __strdup (nm)));
  if (*name == ((void *)0))
   return (-1);
 }
 if (dir != ((void *)0)) {
  *dir = (__extension__ (__builtin_constant_p (dn) && ((size_t)(const void *)((dn) + 1) - (size_t)(const void *)(dn) == 1) ? (((const char *) (dn))[0] == '\0' ? (char *) calloc ((size_t) 1, (size_t) 1) : ({ size_t __len = strlen (dn) + 1; char *__retval = (char *) malloc (__len); if (__retval != ((void *)0)) __retval = (char *) memcpy (__retval, dn, __len); __retval; })) : __strdup (dn)));
  if (*dir == ((void *)0))
   return (-1);
 }
 if (vsl != ((void *)0)) {
  do { do { if (!(snprintf(nm, sizeof nm, "%s%s", dn, "_.vsm") < sizeof nm)) { VAS_Fail(__func__, "../libvarnish/vin.c", 96, "snprintf(nm, sizeof nm, \"%s%s\", dn, \"_.vsm\") < sizeof nm", VAS_ASSERT); } } while (0); } while (0);
  *vsl = (__extension__ (__builtin_constant_p (nm) && ((size_t)(const void *)((nm) + 1) - (size_t)(const void *)(nm) == 1) ? (((const char *) (nm))[0] == '\0' ? (char *) calloc ((size_t) 1, (size_t) 1) : ({ size_t __len = strlen (nm) + 1; char *__retval = (char *) malloc (__len); if (__retval != ((void *)0)) __retval = (char *) memcpy (__retval, nm, __len); __retval; })) : __strdup (nm)));
  if (*vsl == ((void *)0))
   return (-1);
 }
 return (0);
