...
vjn_init(char **args)
{
 if (args != ((void *)0) && *args != ((void *)0))
  do { fprintf(stderr, "Error: " "-jnone takes no arguments.\n"); exit(2); } while (0);
 return (0);
}
...
VJ_Init(const char *j_arg)
{
 ...
 if (j_arg != ((void *)0)) {
  av = VAV_Parse(j_arg, ((void *)0), (1 << 1));
  do { do { if (!((av) != 0)) { VAS_Fail(__func__, "mgt/mgt_jail.c", 98, "(av) != 0", VAS_ASSERT); } } while (0); } while (0);
  if (av[0] != ((void *)0))
   do { fprintf(stderr, "Error: " "-j argument: %s\n", av[0]); exit(2); } while (0);
  if (av[1] == ((void *)0))
   do { fprintf(stderr, "Error: " "-j argument is emtpy\n"); exit(2); } while (0);
  vjt = pick(vj_choice, av[1], "jail");
  do { do { if (!((vjt) != ((void *)0))) { VAS_Fail(__func__, "mgt/mgt_jail.c", 104, "(vjt) != NULL", VAS_ASSERT); } } while (0); do { if (!((vjt)->magic == 0x4d00fa4d)) { VAS_Fail(__func__, "mgt/mgt_jail.c", 104, "(vjt)->magic == 0x4d00fa4d", VAS_ASSERT); } } while (0); } while (0);
  (void)vjt->init(av + 2);
  VAV_Free(av);
 } else {
  ...
  for (i = 0; vj_choice[i].name != ((void *)0); i++) {
   vjt = vj_choice[i].ptr;
   do { do { if (!((vjt) != ((void *)0))) { VAS_Fail(__func__, "mgt/mgt_jail.c", 114, "(vjt) != NULL", VAS_ASSERT); } } while (0); do { if (!((vjt)->magic == 0x4d00fa4d)) { VAS_Fail(__func__, "mgt/mgt_jail.c", 114, "(vjt)->magic == 0x4d00fa4d", VAS_ASSERT); } } while (0); } while (0);
   if (!vjt->init(((void *)0)))
    break;
  }
 }
...
{
 do { do { if (!((vjt) != ((void *)0))) { VAS_Fail(__func__, "mgt/mgt_jail.c", 125, "(vjt) != NULL", VAS_ASSERT); } } while (0); do { if (!((vjt)->magic == 0x4d00fa4d)) { VAS_Fail(__func__, "mgt/mgt_jail.c", 125, "(vjt)->magic == 0x4d00fa4d", VAS_ASSERT); } } while (0); } while (0);
 vjt->master(jme);
}
...
{
 do { do { if (!((vjt) != ((void *)0))) { VAS_Fail(__func__, "mgt/mgt_jail.c", 132, "(vjt) != NULL", VAS_ASSERT); } } while (0); do { if (!((vjt)->magic == 0x4d00fa4d)) { VAS_Fail(__func__, "mgt/mgt_jail.c", 132, "(vjt)->magic == 0x4d00fa4d", VAS_ASSERT); } } while (0); } while (0);
 vjt->subproc(jse);
}
...
VJ_make_workdir(const char *dname)
{
 ...
 do { do { if (!((dname) != 0)) { VAS_Fail(__func__, "mgt/mgt_jail.c", 141, "(dname) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((vjt) != ((void *)0))) { VAS_Fail(__func__, "mgt/mgt_jail.c", 142, "(vjt) != NULL", VAS_ASSERT); } } while (0); do { if (!((vjt)->magic == 0x4d00fa4d)) { VAS_Fail(__func__, "mgt/mgt_jail.c", 142, "(vjt)->magic == 0x4d00fa4d", VAS_ASSERT); } } while (0); } while (0);
 if (vjt->make_workdir != ((void *)0)) {
  vjt->make_workdir(dname);
  return;
 }

 VJ_master(JAIL_MASTER_FILE);
 if (mkdir(dname, 0755) < 0 && (*__errno_location ()) != 17)
  do { fprintf(stderr, "Error: " "Cannot create working directory '%s': %s\n", dname, strerror((*__errno_location ()))); exit(2); } while (0)
                             ;

 if (chdir(dname) < 0)
  do { fprintf(stderr, "Error: " "Cannot change to working directory '%s': %s\n", dname, strerror((*__errno_location ()))); exit(2); } while (0)
                             ;

 fd = open("_.testfile", 02|0100|0200, 0600);
 if (fd < 0)
  do { fprintf(stderr, "Error: " "Error: Cannot create test-file in %s (%s)\n" "Check permissions (or delete old directory)\n", dname, strerror((*__errno_location ()))); exit(2); } while (0)

                             ;
 do { do { if (!((close(fd)) == 0)) { VAS_Fail(__func__, "mgt/mgt_jail.c", 162, "(close(fd)) == 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((unlink("_.testfile")) == 0)) { VAS_Fail(__func__, "mgt/mgt_jail.c", 163, "(unlink(\"_.testfile\")) == 0", VAS_ASSERT); } } while (0); } while (0);
...
VJ_make_vcldir(const char *dname)
{
 ...
 do { do { if (!((dname) != 0)) { VAS_Fail(__func__, "mgt/mgt_jail.c", 171, "(dname) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((vjt) != ((void *)0))) { VAS_Fail(__func__, "mgt/mgt_jail.c", 172, "(vjt) != NULL", VAS_ASSERT); } } while (0); do { if (!((vjt)->magic == 0x4d00fa4d)) { VAS_Fail(__func__, "mgt/mgt_jail.c", 172, "(vjt)->magic == 0x4d00fa4d", VAS_ASSERT); } } while (0); } while (0);
 if (vjt->make_vcldir != ((void *)0)) {
  vjt->make_vcldir(dname);
  return;
 }

 if (mkdir(dname, 0755) < 0 && (*__errno_location ()) != 17)
  do { fprintf(stderr, "Error: " "Cannot create VCL directory '%s': %s\n", dname, strerror((*__errno_location ()))); exit(2); } while (0)
                             ;
}
...
VJ_fix_storage_file(int fd)
{
 ...
 do { do { if (!((vjt) != ((void *)0))) { VAS_Fail(__func__, "mgt/mgt_jail.c", 187, "(vjt) != NULL", VAS_ASSERT); } } while (0); do { if (!((vjt)->magic == 0x4d00fa4d)) { VAS_Fail(__func__, "mgt/mgt_jail.c", 187, "(vjt)->magic == 0x4d00fa4d", VAS_ASSERT); } } while (0); } while (0);
 if (vjt->storage_file != ((void *)0))
  vjt->storage_file(fd);
}
...
VJ_fix_vsm_file(int fd)
{
 ...
 do { do { if (!((vjt) != ((void *)0))) { VAS_Fail(__func__, "mgt/mgt_jail.c", 196, "(vjt) != NULL", VAS_ASSERT); } } while (0); do { if (!((vjt)->magic == 0x4d00fa4d)) { VAS_Fail(__func__, "mgt/mgt_jail.c", 196, "(vjt)->magic == 0x4d00fa4d", VAS_ASSERT); } } while (0); } while (0);
 if (vjt->vsm_file != ((void *)0))
  vjt->vsm_file(fd);
}
