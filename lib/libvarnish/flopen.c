...
# 1 "<command-line>" 2
# 1 "../../lib/libvarnish/flopen.c"
# 30 "../../lib/libvarnish/flopen.c"
# 1 "../../config.h" 1
# 31 "../../lib/libvarnish/flopen.c" 2
...
flopen(const char *path, int flags, ...)
{
 ...
 lock.l_type = ((flags & 0003) == 00) ? 0 : 1;
 lock.l_whence = 0;
 operation = (flags & 04000) ? 6 : 7;
