...
# 1 "<command-line>" 2
# 1 "waiter/cache_waiter_epoll.c"
# 34 "waiter/cache_waiter_epoll.c"
# 1 "../../config.h" 1
# 35 "waiter/cache_waiter_epoll.c" 2
...
# 23 "/usr/include/sys/epoll.h" 2 3 4
...
# 39 "waiter/cache_waiter_epoll.c" 2
...
# 41 "waiter/cache_waiter_epoll.c" 2
...
typedef int error_t;
# 42 "waiter/cache_waiter_epoll.c" 2
...
# 44 "waiter/cache_waiter_epoll.c" 2
...
# 46 "waiter/cache_waiter_epoll.c" 2
...
# 47 "waiter/cache_waiter_epoll.c" 2
# 1 "../../include/vtim.h" 1
# 33 "../../include/vtim.h"
...
# 48 "waiter/cache_waiter_epoll.c" 2
# 1 "../../include/vfil.h" 1
# 32 "../../include/vfil.h"
...
# 49 "waiter/cache_waiter_epoll.c" 2
...
vwe_thread(void *priv)
{
 ...
 do { (vwe) = (priv); do { if (!((vwe) != ((void *)0))) { VAS_Fail(__func__, "waiter/cache_waiter_epoll.c", 82, "(vwe) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((vwe))->magic == (0x6bd73424))) { VAS_Fail(__func__, "waiter/cache_waiter_epoll.c", 82, "((vwe))->magic == (0x6bd73424)", VAS_ASSERT); } } while (0); } while (0); } while (0);
 w = vwe->waiter;
 do { do { if (!((w) != ((void *)0))) { VAS_Fail(__func__, "waiter/cache_waiter_epoll.c", 84, "(w) != NULL", VAS_ASSERT); } } while (0); do { if (!((w)->magic == 0x17c399db)) { VAS_Fail(__func__, "waiter/cache_waiter_epoll.c", 84, "(w)->magic == 0x17c399db", VAS_ASSERT); } } while (0); } while (0);
 THR_SetName("cache-epoll");

 now = VTIM_real();
 while (1) {
  while (1) {
   Lck__Lock(&vwe->mtx, __func__, 90);
   ...
   do { do { if (!((wp) != ((void *)0))) { VAS_Fail(__func__, "waiter/cache_waiter_epoll.c", 103, "(wp) != NULL", VAS_ASSERT); } } while (0); do { if (!((wp)->magic == 0x1743992d)) { VAS_Fail(__func__, "waiter/cache_waiter_epoll.c", 103, "(wp)->magic == 0x1743992d", VAS_ASSERT); } } while (0); } while (0);
   do { do { if (!((epoll_ctl(vwe->epfd, 2, wp->fd, ((void *)0))) == 0)) { VAS_Fail(__func__, "waiter/cache_waiter_epoll.c", 104, "(epoll_ctl(vwe->epfd, 2, wp->fd, ((void *)0))) == 0", VAS_ASSERT); } } while (0); } while (0);
   vwe->nwaited--;
   Wait_HeapDelete(w, wp);
   Lck__Unlock(&vwe->mtx, __func__, 107);
   Wait_Call(w, wp, WAITER_TIMEOUT, now);
  }
  then = vwe->next - now;
  i = (int)ceil(1e3 * then);
  do { if (!(i > 0)) { VAS_Fail(__func__, "waiter/cache_waiter_epoll.c", 112, "i > 0", VAS_ASSERT); } } while (0);
  Lck__Unlock(&vwe->mtx, __func__, 113);
  do {



   n = epoll_wait(vwe->epfd, ev, 8192, i);
  } while (n < 0 && (*__errno_location ()) == 4);
  do { if (!(n >= 0)) { VAS_Fail(__func__, "waiter/cache_waiter_epoll.c", 120, "n >= 0", VAS_ASSERT); } } while (0);
  do { if (!(n <= 8192)) { VAS_Fail(__func__, "waiter/cache_waiter_epoll.c", 121, "n <= NEEV", VAS_ASSERT); } } while (0);
  now = VTIM_real();
  for (ep = ev, i = 0; i < n; i++, ep++) {
   if (ep->data.ptr == vwe) {
    do { if (!(read(vwe->pipe[0], &c, 1) == 1)) { VAS_Fail(__func__, "waiter/cache_waiter_epoll.c", 125, "read(vwe->pipe[0], &c, 1) == 1", VAS_ASSERT); } } while (0);
    continue;
   }
   do { (wp) = (ep->data.ptr); do { if (!((wp) != ((void *)0))) { VAS_Fail(__func__, "waiter/cache_waiter_epoll.c", 128, "(wp) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((wp))->magic == (0x1743992d))) { VAS_Fail(__func__, "waiter/cache_waiter_epoll.c", 128, "((wp))->magic == (0x1743992d)", VAS_ASSERT); } } while (0); } while (0); } while (0);
   Lck__Lock(&vwe->mtx, __func__, 129);
   Wait_HeapDelete(w, wp);
   Lck__Unlock(&vwe->mtx, __func__, 131);
   do { do { if (!((epoll_ctl(vwe->epfd, 2, wp->fd, ((void *)0))) == 0)) { VAS_Fail(__func__, "waiter/cache_waiter_epoll.c", 132, "(epoll_ctl(vwe->epfd, 2, wp->fd, ((void *)0))) == 0", VAS_ASSERT); } } while (0); } while (0);
   vwe->nwaited--;
 ...
 do { do { if (!((close(vwe->pipe[0])) == 0)) { VAS_Fail(__func__, "waiter/cache_waiter_epoll.c", 146, "(close(vwe->pipe[0])) == 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((close(vwe->pipe[1])) == 0)) { VAS_Fail(__func__, "waiter/cache_waiter_epoll.c", 147, "(close(vwe->pipe[1])) == 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((close(vwe->epfd)) == 0)) { VAS_Fail(__func__, "waiter/cache_waiter_epoll.c", 148, "(close(vwe->epfd)) == 0", VAS_ASSERT); } } while (0); } while (0);
 return (((void *)0));
}
...
vwe_enter(void *priv, struct waited *wp)
{
 ...
 do { (vwe) = (priv); do { if (!((vwe) != ((void *)0))) { VAS_Fail(__func__, "waiter/cache_waiter_epoll.c", 160, "(vwe) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((vwe))->magic == (0x6bd73424))) { VAS_Fail(__func__, "waiter/cache_waiter_epoll.c", 160, "((vwe))->magic == (0x6bd73424)", VAS_ASSERT); } } while (0); } while (0); } while (0);
 ee.events = EPOLLIN | EPOLLRDHUP;
 ee.data.ptr = wp;
 Lck__Lock(&vwe->mtx, __func__, 163);
 vwe->nwaited++;
 Wait_HeapInsert(vwe->waiter, wp);
 do { do { if (!((epoll_ctl(vwe->epfd, 1, wp->fd, &ee)) == 0)) { VAS_Fail(__func__, "waiter/cache_waiter_epoll.c", 166, "(epoll_ctl(vwe->epfd, 1, wp->fd, &ee)) == 0", VAS_ASSERT); } } while (0); } while (0);

 if (Wait_When(wp) < vwe->next)
  do { if (!(write(vwe->pipe[1], "X", 1) == 1)) { VAS_Fail(__func__, "waiter/cache_waiter_epoll.c", 169, "write(vwe->pipe[1], \"X\", 1) == 1", VAS_ASSERT); } } while (0);
 Lck__Unlock(&vwe->mtx, __func__, 170);
 return(0);
}
...
vwe_init(struct waiter *w)
{
 ...
 do { do { if (!((w) != ((void *)0))) { VAS_Fail(__func__, "waiter/cache_waiter_epoll.c", 182, "(w) != NULL", VAS_ASSERT); } } while (0); do { if (!((w)->magic == 0x17c399db)) { VAS_Fail(__func__, "waiter/cache_waiter_epoll.c", 182, "(w)->magic == 0x17c399db", VAS_ASSERT); } } while (0); } while (0);
 vwe = w->priv;
 do { (void)memset(vwe, 0, sizeof *vwe); (vwe)->magic = (0x6bd73424); } while (0);
 vwe->waiter = w;

 vwe->epfd = epoll_create(1);
 do { if (!(vwe->epfd >= 0)) { VAS_Fail(__func__, "waiter/cache_waiter_epoll.c", 188, "vwe->epfd >= 0", VAS_ASSERT); } } while (0);
 Lck__New(&vwe->mtx, lck_waiter, "lck_waiter");
 do { do { if (!((pipe(vwe->pipe)) == 0)) { VAS_Fail(__func__, "waiter/cache_waiter_epoll.c", 190, "(pipe(vwe->pipe)) == 0", VAS_ASSERT); } } while (0); } while (0);
 ee.events = EPOLLIN | EPOLLRDHUP;
 ee.data.ptr = vwe;
 do { do { if (!((epoll_ctl(vwe->epfd, 1, vwe->pipe[0], &ee)) == 0)) { VAS_Fail(__func__, "waiter/cache_waiter_epoll.c", 193, "(epoll_ctl(vwe->epfd, 1, vwe->pipe[0], &ee)) == 0", VAS_ASSERT); } } while (0); } while (0);

 do { do { if (!((pthread_create(&vwe->thread, ((void *)0), vwe_thread, vwe)) == 0)) { VAS_Fail(__func__, "waiter/cache_waiter_epoll.c", 195, "(pthread_create(&vwe->thread, ((void *)0), vwe_thread, vwe)) == 0", VAS_ASSERT); } } while (0); } while (0);
}
...
vwe_fini(struct waiter *w)
{
 ...
 do { (vwe) = (w->priv); do { if (!((vwe) != ((void *)0))) { VAS_Fail(__func__, "waiter/cache_waiter_epoll.c", 209, "(vwe) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((vwe))->magic == (0x6bd73424))) { VAS_Fail(__func__, "waiter/cache_waiter_epoll.c", 209, "((vwe))->magic == (0x6bd73424)", VAS_ASSERT); } } while (0); } while (0); } while (0);

 Lck__Lock(&vwe->mtx, __func__, 211);
 vwe->die = 1;
 do { if (!(write(vwe->pipe[1], "Y", 1) == 1)) { VAS_Fail(__func__, "waiter/cache_waiter_epoll.c", 213, "write(vwe->pipe[1], \"Y\", 1) == 1", VAS_ASSERT); } } while (0);
 Lck__Unlock(&vwe->mtx, __func__, 214);
 do { do { if (!((pthread_join(vwe->thread, &vp)) == 0)) { VAS_Fail(__func__, "waiter/cache_waiter_epoll.c", 215, "(pthread_join(vwe->thread, &vp)) == 0", VAS_ASSERT); } } while (0); } while (0);
 Lck_Delete(&vwe->mtx);
}
