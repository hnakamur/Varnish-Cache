...
# 1 "<command-line>" 2
# 1 "cache/cache_req.c"
# 33 "cache/cache_req.c"
# 1 "../../config.h" 1
# 34 "cache/cache_req.c" 2
...
Req_New(const struct worker *wrk, struct sess *sp)
{
 ...
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_req.c", 58, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "cache/cache_req.c", 58, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((sp) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_req.c", 59, "(sp) != NULL", VAS_ASSERT); } } while (0); do { if (!((sp)->magic == 0x2c2f9c5a)) { VAS_Fail(__func__, "cache/cache_req.c", 59, "(sp)->magic == 0x2c2f9c5a", VAS_ASSERT); } } while (0); } while (0);
 pp = sp->pool;
 do { do { if (!((pp) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_req.c", 61, "(pp) != NULL", VAS_ASSERT); } } while (0); do { if (!((pp)->magic == 0x606658fa)) { VAS_Fail(__func__, "cache/cache_req.c", 61, "(pp)->magic == 0x606658fa", VAS_ASSERT); } } while (0); } while (0);

 req = MPL_Get(pp->mpl_req, &sz);
 do { do { if (!((req) != 0)) { VAS_Fail(__func__, "cache/cache_req.c", 64, "(req) != 0", VAS_ASSERT); } } while (0); } while (0);
 req->magic = 0x2751aaa1;
 req->sp = sp;
 req->top = req;
 ...
 do { if (!(p < e)) { VAS_Fail(__func__, "cache/cache_req.c", 72, "p < e", VAS_ASSERT); } } while (0);
 ...
 p += hl;
 p = (void*)(((uintptr_t)(p) + (sizeof(void *) - 1)) & ~(sizeof(void *) - 1));
 do { if (!(p < e)) { VAS_Fail(__func__, "cache/cache_req.c", 80, "p < e", VAS_ASSERT); } } while (0);

 req->http0 = HTTP_create(p, nhttp);
 p += hl;
 p = (void*)(((uintptr_t)(p) + (sizeof(void *) - 1)) & ~(sizeof(void *) - 1));
 do { if (!(p < e)) { VAS_Fail(__func__, "cache/cache_req.c", 85, "p < e", VAS_ASSERT); } } while (0);

 req->resp = HTTP_create(p, nhttp);
 p += hl;
 p = (void*)(((uintptr_t)(p) + (sizeof(void *) - 1)) & ~(sizeof(void *) - 1));
 do { if (!(p < e)) { VAS_Fail(__func__, "cache/cache_req.c", 90, "p < e", VAS_ASSERT); } } while (0);
 ...
 do { if (!(p < e)) { VAS_Fail(__func__, "cache/cache_req.c", 97, "p < e", VAS_ASSERT); } } while (0);

 WS_Init(req->ws, "req", p, e - p);

 req->req_bodybytes = 0;

 req->t_first = (__builtin_nanf (""));
 req->t_prev = (__builtin_nanf (""));
 req->t_req = (__builtin_nanf (""));

 req->vdp_nxt = 0;
 do { (((&req->vdp))->vtqh_first) = ((void *)0); (&req->vdp)->vtqh_last = &(((&req->vdp))->vtqh_first); } while (0);
...
Req_Release(struct req *req)
{
 ...
 do { do { if (!((req) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_req.c", 119, "(req) != NULL", VAS_ASSERT); } } while (0); do { if (!((req)->magic == 0x2751aaa1)) { VAS_Fail(__func__, "cache/cache_req.c", 119, "(req)->magic == 0x2751aaa1", VAS_ASSERT); } } while (0); } while (0);
...
# 1 "../../include/tbl/acct_fields_req.h" 1
# 34 "../../include/tbl/acct_fields_req.h"
do { do { if (!((req->acct.req_hdrbytes) == 0)) { VAS_Fail(__func__, "../../include/tbl/acct_fields_req.h", 34, "(req->acct.req_hdrbytes) == 0", VAS_ASSERT); } } while (0); } while (0);
do { do { if (!((req->acct.req_bodybytes) == 0)) { VAS_Fail(__func__, "../../include/tbl/acct_fields_req.h", 35, "(req->acct.req_bodybytes) == 0", VAS_ASSERT); } } while (0); } while (0);
do { do { if (!((req->acct.resp_hdrbytes) == 0)) { VAS_Fail(__func__, "../../include/tbl/acct_fields_req.h", 36, "(req->acct.resp_hdrbytes) == 0", VAS_ASSERT); } } while (0); } while (0);
do { do { if (!((req->acct.resp_bodybytes) == 0)) { VAS_Fail(__func__, "../../include/tbl/acct_fields_req.h", 37, "(req->acct.resp_bodybytes) == 0", VAS_ASSERT); } } while (0); } while (0);
# 125 "cache/cache_req.c" 2


 do { do { if (!((req->vcl) == 0)) { VAS_Fail(__func__, "cache/cache_req.c", 127, "(req->vcl) == 0", VAS_ASSERT); } } while (0); } while (0);
 if (req->vsl->wid)
  VSL_End(req->vsl);
 sp = req->sp;
 do { do { if (!((sp) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_req.c", 131, "(sp) != NULL", VAS_ASSERT); } } while (0); do { if (!((sp)->magic == 0x2c2f9c5a)) { VAS_Fail(__func__, "cache/cache_req.c", 131, "(sp)->magic == 0x2c2f9c5a", VAS_ASSERT); } } while (0); } while (0);
 pp = sp->pool;
 do { do { if (!((pp) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_req.c", 133, "(pp) != NULL", VAS_ASSERT); } } while (0); do { if (!((pp)->magic == 0x606658fa)) { VAS_Fail(__func__, "cache/cache_req.c", 133, "(pp)->magic == 0x606658fa", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((req) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_req.c", 134, "(req) != NULL", VAS_ASSERT); } } while (0); do { if (!((req)->magic == 0x2751aaa1)) { VAS_Fail(__func__, "cache/cache_req.c", 134, "(req)->magic == 0x2751aaa1", VAS_ASSERT); } } while (0); } while (0);
 MPL_AssertSane(req);
 VSL_Flush(req->vsl, 0);
 req->sp = ((void *)0);
...
Req_Cleanup(struct sess *sp, struct worker *wrk, struct req *req)
{
 ...
 do { do { if (!((sp) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_req.c", 148, "(sp) != NULL", VAS_ASSERT); } } while (0); do { if (!((sp)->magic == 0x2c2f9c5a)) { VAS_Fail(__func__, "cache/cache_req.c", 148, "(sp)->magic == 0x2c2f9c5a", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_req.c", 149, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "cache/cache_req.c", 149, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((req) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_req.c", 150, "(req) != NULL", VAS_ASSERT); } } while (0); do { if (!((req)->magic == 0x2751aaa1)) { VAS_Fail(__func__, "cache/cache_req.c", 150, "(req)->magic == 0x2751aaa1", VAS_ASSERT); } } while (0); } while (0);
 do { if (!(sp == req->sp)) { VAS_Fail(__func__, "cache/cache_req.c", 151, "sp == req->sp", VAS_ASSERT); } } while (0);

 req->director_hint = ((void *)0);
 req->restarts = 0;

 do { do { if (!((req->esi_level) == 0)) { VAS_Fail(__func__, "cache/cache_req.c", 156, "(req->esi_level) == 0", VAS_ASSERT); } } while (0); } while (0);
 do { if (!(req->top == req)) { VAS_Fail(__func__, "cache/cache_req.c", 157, "req->top == req", VAS_ASSERT); } } while (0);
 ...
 if (!(sizeof (req->t_prev) == sizeof (float) ? __isnanf (req->t_prev) : sizeof (req->t_prev) == sizeof (double) ? __isnan (req->t_prev) : __isnanl (req->t_prev)) && req->t_prev > 0.)
  sp->t_idle = req->t_prev;
 else
  sp->t_idle = ((wrk)->lastused = VTIM_real());
 ...
 if (sp->fd < 0) {
  ...
  do { do { if (!((req->vcl) == 0)) { VAS_Fail(__func__, "cache/cache_req.c", 196, "(req->vcl) == 0", VAS_ASSERT); } } while (0); } while (0);
  Req_Release(req);
  SES_Delete(sp, SC_NULL, (__builtin_nanf ("")));
  return (1);
 }

 WS_Reset(req->ws, ((void *)0));
...
{
 do { do { if (!((req) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_req.c", 213, "(req) != NULL", VAS_ASSERT); } } while (0); do { if (!((req)->magic == 0x2751aaa1)) { VAS_Fail(__func__, "cache/cache_req.c", 213, "(req)->magic == 0x2751aaa1", VAS_ASSERT); } } while (0); } while (0);
