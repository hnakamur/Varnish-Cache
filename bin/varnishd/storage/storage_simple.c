...
# 1 "<command-line>" 2
# 1 "storage/storage_simple.c"
# 30 "storage/storage_simple.c"
# 1 "../../config.h" 1
# 31 "storage/storage_simple.c" 2
...
sml_stv_alloc(const struct stevedore *stv, size_t size)
{
 ...
 do { do { if (!((stv) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_simple.c", 49, "(stv) != NULL", VAS_ASSERT); } } while (0); do { if (!((stv)->magic == 0x4baf43db)) { VAS_Fail(__func__, "storage/storage_simple.c", 49, "(stv)->magic == 0x4baf43db", VAS_ASSERT); } } while (0); } while (0);

 if (size > cache_param->fetch_maxchunksize)
  size = cache_param->fetch_maxchunksize;

 do { if (!(size <= (2147483647 * 2U + 1U))) { VAS_Fail(__func__, "storage/storage_simple.c", 54, "size <= UINT_MAX", VAS_ASSERT); } } while (0);

 for (;;) {

  do { do { if (!((stv->alloc) != 0)) { VAS_Fail(__func__, "storage/storage_simple.c", 58, "(stv->alloc) != 0", VAS_ASSERT); } } while (0); } while (0);
 ...
 do { if ((st) != ((void *)0)) do { if (!((st)->magic == 0x1a4e51c0)) { VAS_Fail(__func__, "storage/storage_simple.c", 68, "(st)->magic == 0x1a4e51c0", VAS_ASSERT); } } while (0); } while (0);
 return (st);
}
...
sml_stv_free(const struct stevedore *stv, struct storage *st)
{
 ...
 do { do { if (!((stv) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_simple.c", 76, "(stv) != NULL", VAS_ASSERT); } } while (0); do { if (!((stv)->magic == 0x4baf43db)) { VAS_Fail(__func__, "storage/storage_simple.c", 76, "(stv)->magic == 0x4baf43db", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((st) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_simple.c", 77, "(st) != NULL", VAS_ASSERT); } } while (0); do { if (!((st)->magic == 0x1a4e51c0)) { VAS_Fail(__func__, "storage/storage_simple.c", 77, "(st)->magic == 0x1a4e51c0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((stv->free) != 0)) { VAS_Fail(__func__, "storage/storage_simple.c", 78, "(stv->free) != 0", VAS_ASSERT); } } while (0); } while (0);
 stv->free(st);
}
    ...
    int move_ok)
{
 ...
 do { do { if (!((stv) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_simple.c", 87, "(stv) != NULL", VAS_ASSERT); } } while (0); do { if (!((stv)->magic == 0x4baf43db)) { VAS_Fail(__func__, "storage/storage_simple.c", 87, "(stv)->magic == 0x4baf43db", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((st) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_simple.c", 88, "(st) != NULL", VAS_ASSERT); } } while (0); do { if (!((st)->magic == 0x1a4e51c0)) { VAS_Fail(__func__, "storage/storage_simple.c", 88, "(st)->magic == 0x1a4e51c0", VAS_ASSERT); } } while (0); } while (0);
 if (stv->trim)
  stv->trim(st, size, move_ok);
}
# 101 "storage/storage_simple.c"
struct object *
SML_MkObject(const struct stevedore *stv, struct objcore *oc, void *ptr)
{
 struct object *o;

 do { do { if (!((stv) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_simple.c", 106, "(stv) != NULL", VAS_ASSERT); } } while (0); do { if (!((stv)->magic == 0x4baf43db)) { VAS_Fail(__func__, "storage/storage_simple.c", 106, "(stv)->magic == 0x4baf43db", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((oc) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_simple.c", 107, "(oc) != NULL", VAS_ASSERT); } } while (0); do { if (!((oc)->magic == 0x4d301302)) { VAS_Fail(__func__, "storage/storage_simple.c", 107, "(oc)->magic == 0x4d301302", VAS_ASSERT); } } while (0); } while (0);

 do { if (!((((uintptr_t)(ptr) & (sizeof(void *) - 1)) == 0))) { VAS_Fail(__func__, "storage/storage_simple.c", 109, "PAOK(ptr)", VAS_ASSERT); } } while (0);

 o = ptr;
 do { (void)memset(o, 0, sizeof *o); (o)->magic = (0x32851d42); } while (0);

 do { (((&o->list))->vtqh_first) = ((void *)0); (&o->list)->vtqh_last = &(((&o->list))->vtqh_first); } while (0);

 oc->stobj->magic = 0x6faed850;
 oc->stobj->stevedore = stv;
 do { do { if (!((stv->methods) != 0)) { VAS_Fail(__func__, "storage/storage_simple.c", 118, "(stv->methods) != 0", VAS_ASSERT); } } while (0); } while (0);
 oc->stobj->priv = o;
 return (o);
}
    ...
    struct objcore *oc, unsigned wsl, int really)
{
 ...
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_simple.c", 136, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "storage/storage_simple.c", 136, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((oc) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_simple.c", 137, "(oc) != NULL", VAS_ASSERT); } } while (0); do { if (!((oc)->magic == 0x4d301302)) { VAS_Fail(__func__, "storage/storage_simple.c", 137, "(oc)->magic == 0x4d301302", VAS_ASSERT); } } while (0); } while (0);
 do { if (!(really >= 0)) { VAS_Fail(__func__, "storage/storage_simple.c", 138, "really >= 0", VAS_ASSERT); } } while (0);
 ...
 do { do { if (!((st) != 0)) { VAS_Fail(__func__, "storage/storage_simple.c", 156, "(st) != 0", VAS_ASSERT); } } while (0); } while (0);
 o = SML_MkObject(stv, oc, st->ptr);
 do { do { if (!((o) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_simple.c", 158, "(o) != NULL", VAS_ASSERT); } } while (0); do { if (!((o)->magic == 0x32851d42)) { VAS_Fail(__func__, "storage/storage_simple.c", 158, "(o)->magic == 0x32851d42", VAS_ASSERT); } } while (0); } while (0);
 st->len = sizeof(*o);
 o->objstore = st;
 return (1);
}
...
getobj(struct worker *wrk, struct objcore *oc)
{
 ...
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_simple.c", 173, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "storage/storage_simple.c", 173, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((oc) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_simple.c", 174, "(oc) != NULL", VAS_ASSERT); } } while (0); do { if (!((oc)->magic == 0x4d301302)) { VAS_Fail(__func__, "storage/storage_simple.c", 174, "(oc)->magic == 0x4d301302", VAS_ASSERT); } } while (0); } while (0);
 m = oc->stobj->stevedore->methods;
 if (m->sml_getobj != ((void *)0))
  return (m->sml_getobj(wrk, oc));
 if (oc->stobj->priv == ((void *)0))
  return (((void *)0));
 do { (o) = (oc->stobj->priv); do { if (!((o) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_simple.c", 180, "(o) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((o))->magic == (0x32851d42))) { VAS_Fail(__func__, "storage/storage_simple.c", 180, "((o))->magic == (0x32851d42)", VAS_ASSERT); } } while (0); } while (0); } while (0);
 return (o);
}
...
sml_slim(struct worker *wrk, struct objcore *oc)
{
 ...
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_simple.c", 191, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "storage/storage_simple.c", 191, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);

 stv = oc->stobj->stevedore;
 do { do { if (!((stv) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_simple.c", 194, "(stv) != NULL", VAS_ASSERT); } } while (0); do { if (!((stv)->magic == 0x4baf43db)) { VAS_Fail(__func__, "storage/storage_simple.c", 194, "(stv)->magic == 0x4baf43db", VAS_ASSERT); } } while (0); } while (0);
 o = getobj(wrk, oc);
 do { do { if (!((o) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_simple.c", 196, "(o) != NULL", VAS_ASSERT); } } while (0); do { if (!((o)->magic == 0x32851d42)) { VAS_Fail(__func__, "storage/storage_simple.c", 196, "(o)->magic == 0x32851d42", VAS_ASSERT); } } while (0); } while (0);

 if (o->esidata != ((void *)0)) {
  sml_stv_free(stv, o->esidata);
  o->esidata = ((void *)0);
 }
 for ((st) = (((&o->list))->vtqh_first); (st) && ((stn) = (((st))->list.vtqe_next), 1); (st) = (stn)) {
  do { do { if (!((st) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_simple.c", 203, "(st) != NULL", VAS_ASSERT); } } while (0); do { if (!((st)->magic == 0x1a4e51c0)) { VAS_Fail(__func__, "storage/storage_simple.c", 203, "(st)->magic == 0x1a4e51c0", VAS_ASSERT); } } while (0); } while (0);
  do { if (((((st))->list.vtqe_next)) != ((void *)0)) (((st))->list.vtqe_next)->list.vtqe_prev = (st)->list.vtqe_prev; else { (&o->list)->vtqh_last = (st)->list.vtqe_prev; } *(st)->list.vtqe_prev = (((st))->list.vtqe_next); ; ; } while (0);
  sml_stv_free(stv, st);
 }
}
...
sml_objfree(struct worker *wrk, struct objcore *oc)
{
 ...
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_simple.c", 214, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "storage/storage_simple.c", 214, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((oc) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_simple.c", 215, "(oc) != NULL", VAS_ASSERT); } } while (0); do { if (!((oc)->magic == 0x4d301302)) { VAS_Fail(__func__, "storage/storage_simple.c", 215, "(oc)->magic == 0x4d301302", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((oc->stobj) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_simple.c", 216, "(oc->stobj) != NULL", VAS_ASSERT); } } while (0); do { if (!((oc->stobj)->magic == 0x6faed850)) { VAS_Fail(__func__, "storage/storage_simple.c", 216, "(oc->stobj)->magic == 0x6faed850", VAS_ASSERT); } } while (0); } while (0);
 sml_slim(wrk, oc);
 do { (o) = (oc->stobj->priv); do { if (!((o) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_simple.c", 218, "(o) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((o))->magic == (0x32851d42))) { VAS_Fail(__func__, "storage/storage_simple.c", 218, "((o))->magic == (0x32851d42)", VAS_ASSERT); } } while (0); } while (0); } while (0);
 o->magic = 0;
...
sml_objgetlru(const struct objcore *oc)
{
 ...
 stv = oc->stobj->stevedore;
 do { do { if (!((stv) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_simple.c", 234, "(stv) != NULL", VAS_ASSERT); } } while (0); do { if (!((stv)->magic == 0x4baf43db)) { VAS_Fail(__func__, "storage/storage_simple.c", 234, "(stv)->magic == 0x4baf43db", VAS_ASSERT); } } while (0); } while (0);
 return (stv->lru);
}
    ...
    void *priv, objiterate_f *func)
{
 ...
 struct object *obj;
 struct storage *st;
 struct storage *checkpoint = ((void *)0);
 ...
 obj = getobj(wrk, oc);
 do { do { if (!((obj) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_simple.c", 256, "(obj) != NULL", VAS_ASSERT); } } while (0); do { if (!((obj)->magic == 0x32851d42)) { VAS_Fail(__func__, "storage/storage_simple.c", 256, "(obj)->magic == 0x32851d42", VAS_ASSERT); } } while (0); } while (0);

 bo = HSH_RefBusy(oc);

 if (bo == ((void *)0)) {
  for ((st) = (((&obj->list))->vtqh_first); (st); (st) = (((st))->list.vtqe_next))
 ...
 while (1) {
  ...
  Lck__Lock(&bo->mtx, __func__, 282);
  do { do { if (!((((&obj->list)->vtqh_first == ((void *)0))) == 0)) { VAS_Fail(__func__, "storage/storage_simple.c", 283, "(((&obj->list)->vtqh_first == ((void *)0))) == 0", VAS_ASSERT); } } while (0); } while (0);
  if (checkpoint == ((void *)0)) {
   st = ((&obj->list)->vtqh_first);
   sl = 0;
  } else {
   st = checkpoint;
   sl = checkpoint_len;
  ...
  while (st != ((void *)0)) {
   ...
   ol -= st->len;
   do { if (!(ol >= 0)) { VAS_Fail(__func__, "storage/storage_simple.c", 300, "ol >= 0", VAS_ASSERT); } } while (0);
   nl -= st->len;
   do { if (!(nl > 0)) { VAS_Fail(__func__, "storage/storage_simple.c", 302, "nl > 0", VAS_ASSERT); } } while (0);
   sl += st->len;
   st = ((st)->list.vtqe_next);
   if (((st)->list.vtqe_next) != ((void *)0)) {
    checkpoint = st;
    checkpoint_len = sl;
   }
  }
  do { do { if (!((obj) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_simple.c", 310, "(obj) != NULL", VAS_ASSERT); } } while (0); do { if (!((obj)->magic == 0x32851d42)) { VAS_Fail(__func__, "storage/storage_simple.c", 310, "(obj)->magic == 0x32851d42", VAS_ASSERT); } } while (0); } while (0);
  do { do { if (!((st) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_simple.c", 311, "(st) != NULL", VAS_ASSERT); } } while (0); do { if (!((st)->magic == 0x1a4e51c0)) { VAS_Fail(__func__, "storage/storage_simple.c", 311, "(st)->magic == 0x1a4e51c0", VAS_ASSERT); } } while (0); } while (0);
  st = ((st)->list.vtqe_next);
  if (st != ((void *)0) && st->len == 0)
   st = ((void *)0);
  Lck__Unlock(&bo->mtx, __func__, 315);
  do { if (!(l > 0 || bo->state == BOS_FINISHED)) { VAS_Fail(__func__, "storage/storage_simple.c", 316, "l > 0 || bo->state == BOS_FINISHED", VAS_ASSERT); } } while (0);
  if (func(priv, st != ((void *)0) ? 0 : 1, p, l)) {
   ret = -1;
   break;
  }
 }
...
{
 struct storage *st = ((void *)0);
 unsigned fail;

 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_simple.c", 337, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "storage/storage_simple.c", 337, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((stv) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_simple.c", 338, "(stv) != NULL", VAS_ASSERT); } } while (0); do { if (!((stv)->magic == 0x4baf43db)) { VAS_Fail(__func__, "storage/storage_simple.c", 338, "(stv)->magic == 0x4baf43db", VAS_ASSERT); } } while (0); } while (0);

 if (size > cache_param->fetch_maxchunksize)
  size = cache_param->fetch_maxchunksize;

 do { if (!(size <= (2147483647 * 2U + 1U))) { VAS_Fail(__func__, "storage/storage_simple.c", 343, "size <= UINT_MAX", VAS_ASSERT); } } while (0);

 for (fail = 0; fail <= cache_param->nuke_limit; fail++) {

  do { do { if (!((stv->alloc) != 0)) { VAS_Fail(__func__, "storage/storage_simple.c", 347, "(stv->alloc) != 0", VAS_ASSERT); } } while (0); } while (0);
 ...
 do { if ((st) != ((void *)0)) do { if (!((st)->magic == 0x1a4e51c0)) { VAS_Fail(__func__, "storage/storage_simple.c", 357, "(st)->magic == 0x1a4e51c0", VAS_ASSERT); } } while (0); } while (0);
 return (st);
}
    ...
    uint8_t **ptr)
{
 ...
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_simple.c", 368, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "storage/storage_simple.c", 368, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((sz) != 0)) { VAS_Fail(__func__, "storage/storage_simple.c", 369, "(sz) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((ptr) != 0)) { VAS_Fail(__func__, "storage/storage_simple.c", 370, "(ptr) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { if (!(*sz > 0)) { VAS_Fail(__func__, "storage/storage_simple.c", 371, "*sz > 0", VAS_ASSERT); } } while (0);

 o = getobj(wrk, oc);
 do { do { if (!((o) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_simple.c", 374, "(o) != NULL", VAS_ASSERT); } } while (0); do { if (!((o)->magic == 0x32851d42)) { VAS_Fail(__func__, "storage/storage_simple.c", 374, "(o)->magic == 0x32851d42", VAS_ASSERT); } } while (0); } while (0);

 st = (*(((struct storagehead *)((&o->list)->vtqh_last))->vtqh_last));
 if (st != ((void *)0) && st->len < st->space) {
  *sz = st->space - st->len;
  *ptr = st->ptr + st->len;
  do { if (!(*sz > 0)) { VAS_Fail(__func__, "storage/storage_simple.c", 380, "*sz > 0", VAS_ASSERT); } } while (0);
  return (1);
 }
 ...
 if (oc->busyobj != ((void *)0)) {
  do { do { if (!((oc->busyobj) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_simple.c", 389, "(oc->busyobj) != NULL", VAS_ASSERT); } } while (0); do { if (!((oc->busyobj)->magic == 0x23b95567)) { VAS_Fail(__func__, "storage/storage_simple.c", 389, "(oc->busyobj)->magic == 0x23b95567", VAS_ASSERT); } } while (0); } while (0);
  Lck__Lock(&oc->busyobj->mtx, __func__, 390);
  do { (((st))->list.vtqe_next) = ((void *)0); (st)->list.vtqe_prev = (&o->list)->vtqh_last; *(&o->list)->vtqh_last = (st); (&o->list)->vtqh_last = &(((st))->list.vtqe_next); } while (0);
  Lck__Unlock(&oc->busyobj->mtx, __func__, 392);
 } else {
  do { do { if (!((oc->flags & ((1<<8))) != 0)) { VAS_Fail(__func__, "storage/storage_simple.c", 394, "(oc->flags & ((1<<8))) != 0", VAS_ASSERT); } } while (0); } while (0);
  do { (((st))->list.vtqe_next) = ((void *)0); (st)->list.vtqe_prev = (&o->list)->vtqh_last; *(&o->list)->vtqh_last = (st); (&o->list)->vtqh_last = &(((st))->list.vtqe_next); } while (0);
 }
 *sz = st->space - st->len;
 do { if (!(*sz > 0)) { VAS_Fail(__func__, "storage/storage_simple.c", 398, "*sz > 0", VAS_ASSERT); } } while (0);
 *ptr = st->ptr + st->len;
 return (1);
}
...
sml_extend(struct worker *wrk, struct objcore *oc, ssize_t l)
{
 ...
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_simple.c", 409, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "storage/storage_simple.c", 409, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);
 do { if (!(l > 0)) { VAS_Fail(__func__, "storage/storage_simple.c", 410, "l > 0", VAS_ASSERT); } } while (0);

 o = getobj(wrk, oc);
 do { do { if (!((o) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_simple.c", 413, "(o) != NULL", VAS_ASSERT); } } while (0); do { if (!((o)->magic == 0x32851d42)) { VAS_Fail(__func__, "storage/storage_simple.c", 413, "(o)->magic == 0x32851d42", VAS_ASSERT); } } while (0); } while (0);
 st = (*(((struct storagehead *)((&o->list)->vtqh_last))->vtqh_last));
 do { do { if (!((st) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_simple.c", 415, "(st) != NULL", VAS_ASSERT); } } while (0); do { if (!((st)->magic == 0x1a4e51c0)) { VAS_Fail(__func__, "storage/storage_simple.c", 415, "(st)->magic == 0x1a4e51c0", VAS_ASSERT); } } while (0); } while (0);
 do { if (!(st->len + l <= st->space)) { VAS_Fail(__func__, "storage/storage_simple.c", 416, "st->len + l <= st->space", VAS_ASSERT); } } while (0);
 st->len += l;
 o->len += l;
}
...
sml_getlen(struct worker *wrk, struct objcore *oc)
{
 ...
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_simple.c", 426, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "storage/storage_simple.c", 426, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);

 o = getobj(wrk, oc);
 do { do { if (!((o) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_simple.c", 429, "(o) != NULL", VAS_ASSERT); } } while (0); do { if (!((o)->magic == 0x32851d42)) { VAS_Fail(__func__, "storage/storage_simple.c", 429, "(o)->magic == 0x32851d42", VAS_ASSERT); } } while (0); } while (0);
 return (o->len);
}
...
sml_trimstore(struct worker *wrk, struct objcore *oc)
{
 ...
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_simple.c", 440, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "storage/storage_simple.c", 440, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);

 stv = oc->stobj->stevedore;
 do { do { if (!((stv) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_simple.c", 443, "(stv) != NULL", VAS_ASSERT); } } while (0); do { if (!((stv)->magic == 0x4baf43db)) { VAS_Fail(__func__, "storage/storage_simple.c", 443, "(stv)->magic == 0x4baf43db", VAS_ASSERT); } } while (0); } while (0);
 o = getobj(wrk, oc);
 do { do { if (!((o) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_simple.c", 445, "(o) != NULL", VAS_ASSERT); } } while (0); do { if (!((o)->magic == 0x32851d42)) { VAS_Fail(__func__, "storage/storage_simple.c", 445, "(o)->magic == 0x32851d42", VAS_ASSERT); } } while (0); } while (0);
 st = (*(((struct storagehead *)((&o->list)->vtqh_last))->vtqh_last));
 if (st == ((void *)0))
  return;
 if (st->len == 0) {
   ...
   ssize_t *len)
{
 ...
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_simple.c", 464, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "storage/storage_simple.c", 464, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);

 if (len == ((void *)0))
  len = &dummy;
 o = getobj(wrk, oc);
 do { do { if (!((o) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_simple.c", 469, "(o) != NULL", VAS_ASSERT); } } while (0); do { if (!((o)->magic == 0x32851d42)) { VAS_Fail(__func__, "storage/storage_simple.c", 469, "(o)->magic == 0x32851d42", VAS_ASSERT); } } while (0); } while (0);
 switch (attr) {
 case OA_ESIDATA:
  if (o->esidata == ((void *)0))
   return (((void *)0));
 ...
 do { VAS_Fail(__func__, "storage/storage_simple.c", 497, "Unsupported OBJ_ATTR", VAS_WRONG); } while (0);
}
    ...
    ssize_t len, const void *ptr)
{
 ...
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_simple.c", 508, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "storage/storage_simple.c", 508, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);

 o = getobj(wrk, oc);
 do { do { if (!((o) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_simple.c", 511, "(o) != NULL", VAS_ASSERT); } } while (0); do { if (!((o)->magic == 0x32851d42)) { VAS_Fail(__func__, "storage/storage_simple.c", 511, "(o)->magic == 0x32851d42", VAS_ASSERT); } } while (0); } while (0);
 st = o->objstore;
 switch (attr) {
 case OA_ESIDATA:
  ...
  break;
 case OA_FLAGS:
  do { if (!(len == sizeof o->oa_flags)) { VAS_Fail(__func__, "storage/storage_simple.c", 522, "len == sizeof o->oa_flags", VAS_ASSERT); } } while (0);
  retval = o->oa_flags;
  break;
 case OA_GZIPBITS:
  do { if (!(len == sizeof o->oa_gzipbits)) { VAS_Fail(__func__, "storage/storage_simple.c", 526, "len == sizeof o->oa_gzipbits", VAS_ASSERT); } } while (0);
  retval = o->oa_gzipbits;
  break;
 case OA_HEADERS:
  len = (((uintptr_t)(len) + (sizeof(void *) - 1)) & ~(sizeof(void *) - 1));
  do { if (!(st->len + len <= st->space)) { VAS_Fail(__func__, "storage/storage_simple.c", 531, "st->len + len <= st->space", VAS_ASSERT); } } while (0);
  o->oa_http = (void*)(st->ptr + st->len);
  st->len += len;
  retval = o->oa_http;
  break;
 case OA_LASTMODIFIED:
  do { if (!(len == sizeof o->oa_lastmodified)) { VAS_Fail(__func__, "storage/storage_simple.c", 537, "len == sizeof o->oa_lastmodified", VAS_ASSERT); } } while (0);
  retval = o->oa_lastmodified;
  break;
 case OA_VARY:
  len = (((uintptr_t)(len) + (sizeof(void *) - 1)) & ~(sizeof(void *) - 1));
  do { if (!(st->len + len <= st->space)) { VAS_Fail(__func__, "storage/storage_simple.c", 542, "st->len + len <= st->space", VAS_ASSERT); } } while (0);
  o->oa_vary = (void*)(st->ptr + st->len);
  st->len += len;
  retval = o->oa_vary;
  break;
 case OA_VXID:
  do { if (!(len == sizeof o->oa_vxid)) { VAS_Fail(__func__, "storage/storage_simple.c", 548, "len == sizeof o->oa_vxid", VAS_ASSERT); } } while (0);
  retval = o->oa_vxid;
  break;
 default:
  do { VAS_Fail(__func__, "storage/storage_simple.c", 552, "Unsupported OBJ_ATTR", VAS_WRONG); } while (0);
  break;
 }
 if (ptr != ((void *)0))
...
sml_touch(struct worker *wrk, struct objcore *oc, double now)
{
 ...
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_simple.c", 565, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "storage/storage_simple.c", 565, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((oc) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_simple.c", 566, "(oc) != NULL", VAS_ASSERT); } } while (0); do { if (!((oc)->magic == 0x4d301302)) { VAS_Fail(__func__, "storage/storage_simple.c", 566, "(oc)->magic == 0x4d301302", VAS_ASSERT); } } while (0); } while (0);
# 575 "storage/storage_simple.c"
 if (oc->flags & (1<<3))
  return;
 ...
 lru = ObjGetLRU(oc);
 do { do { if (!((lru) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_simple.c", 582, "(lru) != NULL", VAS_ASSERT); } } while (0); do { if (!((lru)->magic == 0x3fec7bb0)) { VAS_Fail(__func__, "storage/storage_simple.c", 582, "(lru)->magic == 0x3fec7bb0", VAS_ASSERT); } } while (0); } while (0);

 if (Lck__Trylock(&lru->mtx, __func__, 584))
  return;

 do { do { if (!((oc->exp_flags & (1<<12)) != 0)) { VAS_Fail(__func__, "storage/storage_simple.c", 587, "(oc->exp_flags & (1<<12)) != 0", VAS_ASSERT); } } while (0); } while (0);

 if (!(oc->exp_flags & (1<<4))) {

  do { if (((((oc))->lru_list.vtqe_next)) != ((void *)0)) (((oc))->lru_list.vtqe_next)->lru_list.vtqe_prev = (oc)->lru_list.vtqe_prev; else { (&lru->lru_head)->vtqh_last = (oc)->lru_list.vtqe_prev; } *(oc)->lru_list.vtqe_prev = (((oc))->lru_list.vtqe_next); ; ; } while (0);
  do { (((oc))->lru_list.vtqe_next) = ((void *)0); (oc)->lru_list.vtqe_prev = (&lru->lru_head)->vtqh_last; *(&lru->lru_head)->vtqh_last = (oc); (&lru->lru_head)->vtqh_last = &(((oc))->lru_list.vtqe_next); } while (0);
  VSC_C_main->n_lru_moved++;
 }
 oc->last_lru = now;
 Lck__Unlock(&lru->mtx, __func__, 596);
}
