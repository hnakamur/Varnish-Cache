...
# 1 "<command-line>" 2
# 1 "cache/cache_director.c"
# 36 "cache/cache_director.c"
# 1 "../../config.h" 1
# 37 "cache/cache_director.c" 2
...
vdi_resolve(struct worker *wrk, struct busyobj *bo)
{
 ...
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_director.c", 50, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "cache/cache_director.c", 50, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((bo) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_director.c", 51, "(bo) != NULL", VAS_ASSERT); } } while (0); do { if (!((bo)->magic == 0x23b95567)) { VAS_Fail(__func__, "cache/cache_director.c", 51, "(bo)->magic == 0x23b95567", VAS_ASSERT); } } while (0); } while (0);

 for (d = bo->director_req; d != ((void *)0) && d->resolve != ((void *)0); d = d2) {
  do { do { if (!((d) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_director.c", 54, "(d) != NULL", VAS_ASSERT); } } while (0); do { if (!((d)->magic == 0x3336351d)) { VAS_Fail(__func__, "cache/cache_director.c", 54, "(d)->magic == 0x3336351d", VAS_ASSERT); } } while (0); } while (0);
  d2 = d->resolve(d, wrk, bo);
  if (d2 == ((void *)0))
   VSLb(bo->vsl, SLT_FetchError,
       "Director %s returned no backend", d->vcl_name);
 }
 do { if ((d) != ((void *)0)) do { if (!((d)->magic == 0x3336351d)) { VAS_Fail(__func__, "cache/cache_director.c", 60, "(d)->magic == 0x3336351d", VAS_ASSERT); } } while (0); } while (0);
 if (d == ((void *)0))
...
VDI_GetHdr(struct worker *wrk, struct busyobj *bo)
{
 ...
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_director.c", 75, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "cache/cache_director.c", 75, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((bo) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_director.c", 76, "(bo) != NULL", VAS_ASSERT); } } while (0); do { if (!((bo)->magic == 0x23b95567)) { VAS_Fail(__func__, "cache/cache_director.c", 76, "(bo)->magic == 0x23b95567", VAS_ASSERT); } } while (0); } while (0);

 d = vdi_resolve(wrk, bo);
 if (d != ((void *)0)) {
  do { do { if (!((d->gethdrs) != 0)) { VAS_Fail(__func__, "cache/cache_director.c", 80, "(d->gethdrs) != 0", VAS_ASSERT); } } while (0); } while (0);
...
VDI_GetBody(struct worker *wrk, struct busyobj *bo)
{
 ...
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_director.c", 96, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "cache/cache_director.c", 96, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((bo) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_director.c", 97, "(bo) != NULL", VAS_ASSERT); } } while (0); do { if (!((bo)->magic == 0x23b95567)) { VAS_Fail(__func__, "cache/cache_director.c", 97, "(bo)->magic == 0x23b95567", VAS_ASSERT); } } while (0); } while (0);

 d = bo->director_resp;
 do { do { if (!((d) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_director.c", 100, "(d) != NULL", VAS_ASSERT); } } while (0); do { if (!((d)->magic == 0x3336351d)) { VAS_Fail(__func__, "cache/cache_director.c", 100, "(d)->magic == 0x3336351d", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((d->resolve) == 0)) { VAS_Fail(__func__, "cache/cache_director.c", 101, "(d->resolve) == 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((d->getbody) != 0)) { VAS_Fail(__func__, "cache/cache_director.c", 102, "(d->getbody) != 0", VAS_ASSERT); } } while (0); } while (0);

 do { if (!(bo->director_state == DIR_S_HDRS)) { VAS_Fail(__func__, "cache/cache_director.c", 104, "bo->director_state == DIR_S_HDRS", VAS_ASSERT); } } while (0);
...
VDI_GetIP(struct worker *wrk, struct busyobj *bo)
{
 ...
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_director.c", 116, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "cache/cache_director.c", 116, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((bo) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_director.c", 117, "(bo) != NULL", VAS_ASSERT); } } while (0); do { if (!((bo)->magic == 0x23b95567)) { VAS_Fail(__func__, "cache/cache_director.c", 117, "(bo)->magic == 0x23b95567", VAS_ASSERT); } } while (0); } while (0);

 d = bo->director_resp;
 do { do { if (!((d) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_director.c", 120, "(d) != NULL", VAS_ASSERT); } } while (0); do { if (!((d)->magic == 0x3336351d)) { VAS_Fail(__func__, "cache/cache_director.c", 120, "(d)->magic == 0x3336351d", VAS_ASSERT); } } while (0); } while (0);
 do { if (!(bo->director_state == DIR_S_HDRS || bo->director_state == DIR_S_BODY)) { VAS_Fail(__func__,
 "cache/cache_director.c"
# 121 "cache/cache_director.c"
 ,
 122
# 121 "cache/cache_director.c"
 , "bo->director_state == DIR_S_HDRS || bo->director_state == DIR_S_BODY", VAS_ASSERT); } } while (0)
                                     ;
 do { do { if (!((d->resolve) == 0)) { VAS_Fail(__func__, "cache/cache_director.c", 123, "(d->resolve) == 0", VAS_ASSERT); } } while (0); } while (0);
 if (d->getip == ((void *)0))
  return (((void *)0));
...
VDI_Finish(struct worker *wrk, struct busyobj *bo)
{
 ...
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_director.c", 136, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "cache/cache_director.c", 136, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((bo) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_director.c", 137, "(bo) != NULL", VAS_ASSERT); } } while (0); do { if (!((bo)->magic == 0x23b95567)) { VAS_Fail(__func__, "cache/cache_director.c", 137, "(bo)->magic == 0x23b95567", VAS_ASSERT); } } while (0); } while (0);

 d = bo->director_resp;
 do { do { if (!((d) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_director.c", 140, "(d) != NULL", VAS_ASSERT); } } while (0); do { if (!((d)->magic == 0x3336351d)) { VAS_Fail(__func__, "cache/cache_director.c", 140, "(d)->magic == 0x3336351d", VAS_ASSERT); } } while (0); } while (0);

 do { do { if (!((d->resolve) == 0)) { VAS_Fail(__func__, "cache/cache_director.c", 142, "(d->resolve) == 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((d->finish) != 0)) { VAS_Fail(__func__, "cache/cache_director.c", 143, "(d->finish) != 0", VAS_ASSERT); } } while (0); } while (0);

 do { if (!(bo->director_state != DIR_S_NULL)) { VAS_Fail(__func__, "cache/cache_director.c", 145, "bo->director_state != DIR_S_NULL", VAS_ASSERT); } } while (0);
 d->finish(d, wrk, bo);
 bo->director_state = DIR_S_NULL;
}
...
VDI_Http1Pipe(struct req *req, struct busyobj *bo)
{
 ...
 do { do { if (!((req) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_director.c", 157, "(req) != NULL", VAS_ASSERT); } } while (0); do { if (!((req)->magic == 0x2751aaa1)) { VAS_Fail(__func__, "cache/cache_director.c", 157, "(req)->magic == 0x2751aaa1", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((bo) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_director.c", 158, "(bo) != NULL", VAS_ASSERT); } } while (0); do { if (!((bo)->magic == 0x23b95567)) { VAS_Fail(__func__, "cache/cache_director.c", 158, "(bo)->magic == 0x23b95567", VAS_ASSERT); } } while (0); } while (0);

 d = vdi_resolve(req->wrk, bo);
 if (d == ((void *)0) || d->http1pipe == ((void *)0))
  return (-1);
...
VDI_Healthy(const struct director *d, const struct busyobj *bo)
{
 ...
 do { do { if (!((d) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_director.c", 176, "(d) != NULL", VAS_ASSERT); } } while (0); do { if (!((d)->magic == 0x3336351d)) { VAS_Fail(__func__, "cache/cache_director.c", 176, "(d)->magic == 0x3336351d", VAS_ASSERT); } } while (0); } while (0);
 if (d->healthy == ((void *)0))
  return (1);
 return (d->healthy(d, bo, ((void *)0)));
}
