...
vtc_loginit(char *buf, unsigned buflen)
{
 ...
 vtclog_buf = buf;
 vtclog_left = buflen;
 do { do { if (!((pthread_mutex_init(&vtclog_mtx, ((void *)0))) == 0)) { VAS_Fail(__func__, "vtc_log.c", 65, "(pthread_mutex_init(&vtclog_mtx, ((void *)0))) == 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((pthread_key_create(&log_key, ((void *)0))) == 0)) { VAS_Fail(__func__, "vtc_log.c", 66, "(pthread_key_create(&log_key, ((void *)0))) == 0", VAS_ASSERT); } } while (0); } while (0);
}
...
vtc_logopen(const char *id)
{
 ...
 do { (vl) = calloc(sizeof *(vl), 1); if ((vl) != ((void *)0)) (vl)->magic = (0x82731202); } while (0);
 do { do { if (!((vl) != 0)) { VAS_Fail(__func__, "vtc_log.c", 78, "(vl) != 0", VAS_ASSERT); } } while (0); } while (0);
 vl->id = id;
 vl->vsb = VSB_new(((void *)0), ((void *)0), 0, 0x00000001);
 do { do { if (!((pthread_mutex_init(&vl->mtx, ((void *)0))) == 0)) { VAS_Fail(__func__, "vtc_log.c", 81, "(pthread_mutex_init(&vl->mtx, ((void *)0))) == 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((pthread_setspecific(log_key, vl)) == 0)) { VAS_Fail(__func__, "vtc_log.c", 82, "(pthread_setspecific(log_key, vl)) == 0", VAS_ASSERT); } } while (0); } while (0);
 return (vl);
}
...
vtc_logclose(struct vtclog *vl)
{
 ...
 do { do { if (!((vl) != ((void *)0))) { VAS_Fail(__func__, "vtc_log.c", 90, "(vl) != NULL", VAS_ASSERT); } } while (0); do { if (!((vl)->magic == 0x82731202)) { VAS_Fail(__func__, "vtc_log.c", 90, "(vl)->magic == 0x82731202", VAS_ASSERT); } } while (0); } while (0);
 if (pthread_getspecific(log_key) == vl)
  do { do { if (!((pthread_setspecific(log_key, ((void *)0))) == 0)) { VAS_Fail(__func__, "vtc_log.c", 92, "(pthread_setspecific(log_key, ((void *)0))) == 0", VAS_ASSERT); } } while (0); } while (0);
 VSB_delete(vl->vsb);
 do { do { if (!((pthread_mutex_destroy(&vl->mtx)) == 0)) { VAS_Fail(__func__, "vtc_log.c", 94, "(pthread_mutex_destroy(&vl->mtx)) == 0", VAS_ASSERT); } } while (0); } while (0);
 do { (vl)->magic = (0); free(vl); vl = ((void *)0); } while (0);
}
...
vtc_log_emit(const struct vtclog *vl, int lvl)
{
 ...
 if (vtc_stop && lvl == 0)
  return;
 l = VSB_len(vl->vsb);
 do { do { if (!((pthread_mutex_lock(&vtclog_mtx)) == 0)) { VAS_Fail(__func__, "vtc_log.c", 118, "(pthread_mutex_lock(&vtclog_mtx)) == 0", VAS_ASSERT); } } while (0); } while (0);
 do { if (!(vtclog_left > l)) { VAS_Fail(__func__, "vtc_log.c", 119, "vtclog_left > l", VAS_ASSERT); } } while (0);
 memcpy(vtclog_buf,VSB_data(vl->vsb), l);
 vtclog_buf += l;
 *vtclog_buf = '\0';
 vtclog_left -= l;
 do { do { if (!((pthread_mutex_unlock(&vtclog_mtx)) == 0)) { VAS_Fail(__func__, "vtc_log.c", 124, "(pthread_mutex_unlock(&vtclog_mtx)) == 0", VAS_ASSERT); } } while (0); } while (0);
}
...
vtc_log(struct vtclog *vl, int lvl, const char *fmt, ...)
{
 ...
 do { do { if (!((vl) != ((void *)0))) { VAS_Fail(__func__, "vtc_log.c", 133, "(vl) != NULL", VAS_ASSERT); } } while (0); do { if (!((vl)->magic == 0x82731202)) { VAS_Fail(__func__, "vtc_log.c", 133, "(vl)->magic == 0x82731202", VAS_ASSERT); } } while (0); } while (0);
 tx = VTIM_mono() - t0;
 do { do { if (!((pthread_mutex_lock(&vl->mtx)) == 0)) { VAS_Fail(__func__, "vtc_log.c", 135, "(pthread_mutex_lock(&vl->mtx)) == 0", VAS_ASSERT); } } while (0); } while (0);
 vl->act = 1;
 do { if (!(lvl < (int)(sizeof(lead)/sizeof(lead[0])))) { VAS_Fail(__func__, "vtc_log.c", 137, "lvl < (int)NLEAD", VAS_ASSERT); } } while (0);
 VSB_clear(vl->vsb);
 ...
 __builtin_va_end(ap);
 VSB_putc(vl->vsb, '\n');
 do { do { if (!((VSB_finish(vl->vsb)) == 0)) { VAS_Fail(__func__, "vtc_log.c", 146, "(VSB_finish(vl->vsb)) == 0", VAS_ASSERT); } } while (0); } while (0);

 vtc_log_emit(vl, lvl);

 VSB_clear(vl->vsb);
 vl->act = 0;
 do { do { if (!((pthread_mutex_unlock(&vl->mtx)) == 0)) { VAS_Fail(__func__, "vtc_log.c", 152, "(pthread_mutex_unlock(&vl->mtx)) == 0", VAS_ASSERT); } } while (0); } while (0);
 if (lvl > 0)
  return;
 if (lvl == 0)
  vtc_error = 1;
...
vtc_dump(struct vtclog *vl, int lvl, const char *pfx, const char *str, int len)
{
 ...
 do { do { if (!((vl) != ((void *)0))) { VAS_Fail(__func__, "vtc_log.c", 173, "(vl) != NULL", VAS_ASSERT); } } while (0); do { if (!((vl)->magic == 0x82731202)) { VAS_Fail(__func__, "vtc_log.c", 173, "(vl)->magic == 0x82731202", VAS_ASSERT); } } while (0); } while (0);
 tx = VTIM_mono() - t0;
 do { if (!(lvl >= 0)) { VAS_Fail(__func__, "vtc_log.c", 175, "lvl >= 0", VAS_ASSERT); } } while (0);
 do { if (!(lvl < (sizeof(lead)/sizeof(lead[0])))) { VAS_Fail(__func__, "vtc_log.c", 176, "lvl < NLEAD", VAS_ASSERT); } } while (0);
 do { do { if (!((pthread_mutex_lock(&vl->mtx)) == 0)) { VAS_Fail(__func__, "vtc_log.c", 177, "(pthread_mutex_lock(&vl->mtx)) == 0", VAS_ASSERT); } } while (0); } while (0);
 vl->act = 1;
 VSB_clear(vl->vsb);
 if (pfx == ((void *)0))
  pfx = "";
 ...
 if (!nl)
  VSB_printf(vl->vsb, "\n");
 do { do { if (!((VSB_finish(vl->vsb)) == 0)) { VAS_Fail(__func__, "vtc_log.c", 214, "(VSB_finish(vl->vsb)) == 0", VAS_ASSERT); } } while (0); } while (0);

 vtc_log_emit(vl, lvl);

 VSB_clear(vl->vsb);
 vl->act = 0;
 do { do { if (!((pthread_mutex_unlock(&vl->mtx)) == 0)) { VAS_Fail(__func__, "vtc_log.c", 220, "(pthread_mutex_unlock(&vl->mtx)) == 0", VAS_ASSERT); } } while (0); } while (0);
 if (lvl == 0) {
  vtc_error = 1;
  if (pthread_self() != vtc_thread)
   pthread_exit(((void *)0));
    ...
    const unsigned char *str, int len)
{
 ...
 do { do { if (!((vl) != ((void *)0))) { VAS_Fail(__func__, "vtc_log.c", 241, "(vl) != NULL", VAS_ASSERT); } } while (0); do { if (!((vl)->magic == 0x82731202)) { VAS_Fail(__func__, "vtc_log.c", 241, "(vl)->magic == 0x82731202", VAS_ASSERT); } } while (0); } while (0);
 tx = VTIM_mono() - t0;
 do { if (!(len >= 0)) { VAS_Fail(__func__, "vtc_log.c", 243, "len >= 0", VAS_ASSERT); } } while (0);
 do { if (!(lvl >= 0)) { VAS_Fail(__func__, "vtc_log.c", 244, "lvl >= 0", VAS_ASSERT); } } while (0);
 do { if (!(lvl < (sizeof(lead)/sizeof(lead[0])))) { VAS_Fail(__func__, "vtc_log.c", 245, "lvl < NLEAD", VAS_ASSERT); } } while (0);
 do { do { if (!((pthread_mutex_lock(&vl->mtx)) == 0)) { VAS_Fail(__func__, "vtc_log.c", 246, "(pthread_mutex_lock(&vl->mtx)) == 0", VAS_ASSERT); } } while (0); } while (0);
 vl->act = 1;
 VSB_clear(vl->vsb);
 if (pfx == ((void *)0))
  pfx = "";
 ...
 if (!nl)
  VSB_printf(vl->vsb, "\n");
 do { do { if (!((VSB_finish(vl->vsb)) == 0)) { VAS_Fail(__func__, "vtc_log.c", 274, "(VSB_finish(vl->vsb)) == 0", VAS_ASSERT); } } while (0); } while (0);

 vtc_log_emit(vl, lvl);

 VSB_clear(vl->vsb);
 vl->act = 0;
 do { do { if (!((pthread_mutex_unlock(&vl->mtx)) == 0)) { VAS_Fail(__func__, "vtc_log.c", 280, "(pthread_mutex_unlock(&vl->mtx)) == 0", VAS_ASSERT); } } while (0); } while (0);
 if (lvl == 0) {
  vtc_error = 1;
  if (pthread_self() != vtc_thread)
   pthread_exit(((void *)0));
