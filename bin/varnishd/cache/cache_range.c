...
# 1 "<command-line>" 2
# 1 "cache/cache_range.c"
# 30 "cache/cache_range.c"
# 1 "../../config.h" 1
# 31 "cache/cache_range.c" 2
    ...
    const void *ptr, ssize_t len)
{
 ...
 do { do { if (!((req) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_range.c", 56, "(req) != NULL", VAS_ASSERT); } } while (0); do { if (!((req)->magic == 0x2751aaa1)) { VAS_Fail(__func__, "cache/cache_range.c", 56, "(req)->magic == 0x2751aaa1", VAS_ASSERT); } } while (0); } while (0);
 if (act == VDP_INIT)
  return (0);
 do { (vrg_priv) = (*priv); do { if (!((vrg_priv) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_range.c", 59, "(vrg_priv) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((vrg_priv))->magic == (0xb886e711))) { VAS_Fail(__func__, "cache/cache_range.c", 59, "((vrg_priv))->magic == (0xb886e711)", VAS_ASSERT); } } while (0); } while (0); } while (0);
 if (act == VDP_FINI) {
...
vrg_dorange(struct req *req, const char *r)
{
 ...
 do { do { if (!((vrg_priv) != 0)) { VAS_Fail(__func__, "cache/cache_range.c", 167, "(vrg_priv) != 0", VAS_MISSING); } } while (0); } while (0);
 do { (void)memset(vrg_priv, 0, sizeof *vrg_priv); (vrg_priv)->magic = (0xb886e711); } while (0);
 vrg_priv->range_off = 0;
 vrg_priv->range_low = low;
 vrg_priv->range_high = high + 1;
 VDP_push(req, vrg_range_bytes, vrg_priv, 1);
 http_PutResponse(req->resp, "HTTP/1.1", 206, ((void *)0));
 return (((void *)0));
}
...
VRG_dorange(struct req *req, const char *r)
{
 ...
 do { do { if (!((req) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_range.c", 182, "(req) != NULL", VAS_ASSERT); } } while (0); do { if (!((req)->magic == 0x2751aaa1)) { VAS_Fail(__func__, "cache/cache_range.c", 182, "(req)->magic == 0x2751aaa1", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((req->objcore) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_range.c", 183, "(req->objcore) != NULL", VAS_ASSERT); } } while (0); do { if (!((req->objcore)->magic == 0x4d301302)) { VAS_Fail(__func__, "cache/cache_range.c", 183, "(req->objcore)->magic == 0x4d301302", VAS_ASSERT); } } while (0); } while (0);
 do { if (!(http_IsStatus(req->resp, 200))) { VAS_Fail(__func__, "cache/cache_range.c", 184, "http_IsStatus(req->resp, 200)", VAS_ASSERT); } } while (0);
 ...
 if (err != ((void *)0)) {
  ...
  http_PutResponse(req->resp, "HTTP/1.1", 416, ((void *)0));
