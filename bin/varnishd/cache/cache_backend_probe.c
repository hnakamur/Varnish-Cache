...
# 1 "<command-line>" 2
# 1 "cache/cache_backend_probe.c"
# 38 "cache/cache_backend_probe.c"
# 1 "../../config.h" 1
# 39 "cache/cache_backend_probe.c" 2
...
# 41 "cache/cache_backend_probe.c" 2
...
# 42 "cache/cache_backend_probe.c" 2
...
# 43 "cache/cache_backend_probe.c" 2
...
# 45 "cache/cache_backend_probe.c" 2
...
# 47 "cache/cache_backend_probe.c" 2
...
# 48 "cache/cache_backend_probe.c" 2
# 1 "../../include/vrt.h" 1
# 55 "../../include/vrt.h"
struct VCL_conf;
struct busyobj;
...
# 49 "cache/cache_backend_probe.c" 2
# 1 "../../include/vsa.h" 1
# 33 "../../include/vsa.h"
struct suckaddr;
...
# 50 "cache/cache_backend_probe.c" 2
# 1 "../../include/vtcp.h" 1
# 31 "../../include/vtcp.h"
struct suckaddr;
...
# 51 "cache/cache_backend_probe.c" 2
# 1 "../../include/vtim.h" 1
# 33 "../../include/vtim.h"
...
# 52 "cache/cache_backend_probe.c" 2
...
# 54 "cache/cache_backend_probe.c" 2
...
# 55 "cache/cache_backend_probe.c" 2
...
# 1 "../../include/tbl/backend_poll.h" 1
# 31 "../../include/tbl/backend_poll.h"
uint64_t good_ipv4;
uint64_t good_ipv6;
uint64_t err_xmit;
uint64_t good_xmit;
...
uint64_t good_recv;
uint64_t happy;
# 77 "cache/cache_backend_probe.c" 2
...
vbp_delete(struct vbp_target *vt)
{
 ...
 VBT_Rel(&vt->tcp_pool);
 free(vt->req);
 do { (vt)->magic = (0); free(vt); vt = ((void *)0); } while (0);
}
...
{
 do { do { if (!((vt) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend_probe.c", 114, "(vt) != NULL", VAS_ASSERT); } } while (0); do { if (!((vt)->magic == 0x6b7cb656)) { VAS_Fail(__func__, "cache/cache_backend_probe.c", 114, "(vt)->magic == 0x6b7cb656", VAS_ASSERT); } } while (0); } while (0);
...
vt->good_recv <<= 1;
vt->happy <<= 1;
# 119 "cache/cache_backend_probe.c" 2
...
vbp_has_poked(struct vbp_target *vt)
{
 ...
 do { do { if (!((vt) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend_probe.c", 131, "(vt) != NULL", VAS_ASSERT); } } while (0); do { if (!((vt)->magic == 0x6b7cb656)) { VAS_Fail(__func__, "cache/cache_backend_probe.c", 131, "(vt)->magic == 0x6b7cb656", VAS_ASSERT); } } while (0); } while (0);
...
vbp_update_backend(struct vbp_target *vt)
{
 ...
 do { do { if (!((vt) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend_probe.c", 156, "(vt) != NULL", VAS_ASSERT); } } while (0); do { if (!((vt)->magic == 0x6b7cb656)) { VAS_Fail(__func__, "cache/cache_backend_probe.c", 156, "(vt)->magic == 0x6b7cb656", VAS_ASSERT); } } while (0); } while (0);

 Lck__Lock(&vbp_mtx, __func__, 158);
 if (vt->backend != ((void *)0)) {
  i = 0;


# 1 "../../include/tbl/backend_poll.h" 1
# 31 "../../include/tbl/backend_poll.h"
bits[i++] = (vt->good_ipv4 & 1) ? '4' : '-';
bits[i++] = (vt->good_ipv6 & 1) ? '6' : '-';
bits[i++] = (vt->err_xmit & 1) ? 'x' : '-';
bits[i++] = (vt->good_xmit & 1) ? 'X' : '-';
bits[i++] = (vt->err_recv & 1) ? 'r' : '-';
bits[i++] = (vt->good_recv & 1) ? 'R' : '-';
bits[i++] = (vt->happy & 1) ? 'H' : '-';
# 164 "cache/cache_backend_probe.c" 2
  ...
  if (vt->backend != ((void *)0) && vt->backend->vsc != ((void *)0))
   vt->backend->vsc->happy = vt->happy;
 }
 Lck__Unlock(&vbp_mtx, __func__, 190);
}
...
vbp_reset(struct vbp_target *vt)
{
 ...
 do { do { if (!((vt) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend_probe.c", 198, "(vt) != NULL", VAS_ASSERT); } } while (0); do { if (!((vt)->magic == 0x6b7cb656)) { VAS_Fail(__func__, "cache/cache_backend_probe.c", 198, "(vt)->magic == 0x6b7cb656", VAS_ASSERT); } } while (0); } while (0);
 vt->avg = 0.0;
 vt->rate = 0.0;
...
vt->good_recv = 0;
vt->happy = 0;
# 204 "cache/cache_backend_probe.c" 2
...
# 220 "cache/cache_backend_probe.c"
static void
vbp_poke(struct vbp_target *vt)
{
 ...
 if (i == 2)
  ...
  do { VAS_Fail(__func__, "cache/cache_backend_probe.c", 245, "Wrong probe protocol family", VAS_WRONG); } while (0);
 ...
 p = (__extension__ (__builtin_constant_p ('\r') && !__builtin_constant_p (vt->resp_buf) && ('\r') == '\0' ? (char *) __rawmemchr (vt->resp_buf, '\r') : __builtin_strchr (vt->resp_buf, '\r')));
 if (p != ((void *)0))
  *p = '\0';
 p = (__extension__ (__builtin_constant_p ('\n') && !__builtin_constant_p (vt->resp_buf) && ('\n') == '\0' ? (char *) __rawmemchr (vt->resp_buf, '\n') : __builtin_strchr (vt->resp_buf, '\n')));
 if (p != ((void *)0))
  *p = '\0';
...
vbp_task(struct worker *wrk, void *priv)
{
 ...
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend_probe.c", 323, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "cache/cache_backend_probe.c", 323, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);
 do { (vt) = (priv); do { if (!((vt) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend_probe.c", 324, "(vt) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((vt))->magic == (0x6b7cb656))) { VAS_Fail(__func__, "cache/cache_backend_probe.c", 324, "((vt))->magic == (0x6b7cb656)", VAS_ASSERT); } } while (0); } while (0); } while (0);

 do { do { if (!((vt->running) != 0)) { VAS_Fail(__func__, "cache/cache_backend_probe.c", 326, "(vt->running) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((vt->req) != 0)) { VAS_Fail(__func__, "cache/cache_backend_probe.c", 327, "(vt->req) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { if (!(vt->req_len > 0)) { VAS_Fail(__func__, "cache/cache_backend_probe.c", 328, "vt->req_len > 0", VAS_ASSERT); } } while (0);
 ...
 Lck__Lock(&vbp_mtx, __func__, 335);
 if (vt->running < 0) {
  do { if (!(vt->heap_idx == 0)) { VAS_Fail(__func__, "cache/cache_backend_probe.c", 337, "vt->heap_idx == BINHEAP_NOIDX", VAS_ASSERT); } } while (0);
  vbp_delete(vt);
 } else {
  vt->running = 0;
  if (vt->heap_idx != 0) {
 ...
 Lck__Unlock(&vbp_mtx, __func__, 347);
}
...
vbp_thread(struct worker *wrk, void *priv)
{
 ...
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend_probe.c", 359, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "cache/cache_backend_probe.c", 359, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((priv) == 0)) { VAS_Fail(__func__, "cache/cache_backend_probe.c", 360, "(priv) == 0", VAS_ASSERT); } } while (0); } while (0);
 Lck__Lock(&vbp_mtx, __func__, 361);
 while (1) {
  now = VTIM_real();
 ...
 Lck__Unlock(&vbp_mtx, __func__, 385);
 return (((void *)0));
}
...
# 1 "../../include/tbl/backend_poll.h" 1
# 31 "../../include/tbl/backend_poll.h"
if ((vt->good_ipv4 != 0) || (0)) vbp_bitmap(cli, ('4'), vt->good_ipv4, ("Good IPv4"));
if ((vt->good_ipv6 != 0) || (0)) vbp_bitmap(cli, ('6'), vt->good_ipv6, ("Good IPv6"));
if ((vt->err_xmit != 0) || (0)) vbp_bitmap(cli, ('x'), vt->err_xmit, ("Error Xmit"));
if ((vt->good_xmit != 0) || (0)) vbp_bitmap(cli, ('X'), vt->good_xmit, ("Good Xmit"));
if ((vt->err_recv != 0) || (0)) vbp_bitmap(cli, ('r'), vt->err_recv, ("Error Recv"));
if ((vt->good_recv != 0) || (0)) vbp_bitmap(cli, ('R'), vt->good_recv, ("Good Recv"));
if ((vt->happy != 0) || (1)) vbp_bitmap(cli, ('H'), vt->happy, ("Happy"));
# 430 "cache/cache_backend_probe.c" 2
...
VBP_Status(struct cli *cli, const struct backend *be, int details)
{
 ...
 do { do { if (!((be) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend_probe.c", 438, "(be) != NULL", VAS_ASSERT); } } while (0); do { if (!((be)->magic == 0x64c4c7c6)) { VAS_Fail(__func__, "cache/cache_backend_probe.c", 438, "(be)->magic == 0x64c4c7c6", VAS_ASSERT); } } while (0); } while (0);
 vt = be->probe;
 do { do { if (!((vt) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend_probe.c", 440, "(vt) != NULL", VAS_ASSERT); } } while (0); do { if (!((vt)->magic == 0x6b7cb656)) { VAS_Fail(__func__, "cache/cache_backend_probe.c", 440, "(vt)->magic == 0x6b7cb656", VAS_ASSERT); } } while (0); } while (0);
    ...
    const struct backend *be)
{
 ...
 do { do { if (!((vsb) != 0)) { VAS_Fail(__func__, "cache/cache_backend_probe.c", 459, "(vsb) != 0", VAS_ASSERT); } } while (0); } while (0);
 VSB_clear(vsb);
 if(vbp->request != ((void *)0)) {
  VSB_cat(vsb, vbp->request);
 } else {
  VSB_printf(vsb, "GET %s HTTP/1.1\r\n",
      vbp->url != ((void *)0) ? vbp->url : "/");
  if (be->hosthdr != ((void *)0))
   VSB_printf(vsb, "Host: %s\r\n", be->hosthdr);
  VSB_printf(vsb, "Connection: close\r\n");
  VSB_printf(vsb, "\r\n");
 }
 do { do { if (!((VSB_finish(vsb)) == 0)) { VAS_Fail(__func__, "cache/cache_backend_probe.c", 471, "(VSB_finish(vsb)) == 0", VAS_ASSERT); } } while (0); } while (0);
 vt->req = (__extension__ (__builtin_constant_p (VSB_data(vsb)) && ((size_t)(const void *)((VSB_data(vsb)) + 1) - (size_t)(const void *)(VSB_data(vsb)) == 1) ? (((const char *) (VSB_data(vsb)))[0] == '\0' ? (char *) calloc ((size_t) 1, (size_t) 1) : ({ size_t __len = strlen (VSB_data(vsb)) + 1; char *__retval = (char *) malloc (__len); if (__retval != ((void *)0)) __retval = (char *) memcpy (__retval, VSB_data(vsb), __len); __retval; })) : __strdup (VSB_data(vsb))));
 do { do { if (!((vt->req) != 0)) { VAS_Fail(__func__, "cache/cache_backend_probe.c", 473, "(vt->req) != 0", VAS_ASSERT); } } while (0); } while (0);
...
vbp_set_defaults(struct vbp_target *vt, const struct vrt_backend_probe *vp)
{
 ...
 do { do { vt->timeout = vp->timeout; } while (0); do { vt->interval = vp->interval; } while (0); do { vt->exp_status = vp->exp_status; } while (0); do { vt->window = vp->window; } while (0); do { vt->threshold = vp->threshold; } while (0); do { vt->initial = vp->initial; } while (0); } while (0);
...
VBP_Control(const struct backend *be, int enable)
{
 ...
 do { do { if (!((be) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend_probe.c", 517, "(be) != NULL", VAS_ASSERT); } } while (0); do { if (!((be)->magic == 0x64c4c7c6)) { VAS_Fail(__func__, "cache/cache_backend_probe.c", 517, "(be)->magic == 0x64c4c7c6", VAS_ASSERT); } } while (0); } while (0);
 vt = be->probe;
 do { do { if (!((vt) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend_probe.c", 519, "(vt) != NULL", VAS_ASSERT); } } while (0); do { if (!((vt)->magic == 0x6b7cb656)) { VAS_Fail(__func__, "cache/cache_backend_probe.c", 519, "(vt)->magic == 0x6b7cb656", VAS_ASSERT); } } while (0); } while (0);

 vbp_reset(vt);
 vbp_update_backend(vt);

 Lck__Lock(&vbp_mtx, __func__, 524);
 if (enable) {
  do { if (!(vt->heap_idx == 0)) { VAS_Fail(__func__, "cache/cache_backend_probe.c", 526, "vt->heap_idx == BINHEAP_NOIDX", VAS_ASSERT); } } while (0);
  vt->due = VTIM_real();
  binheap_insert(vbp_heap, vt);
  do { do { if (!((pthread_cond_signal(&vbp_cond)) == 0)) { VAS_Fail(__func__, "cache/cache_backend_probe.c", 529, "(pthread_cond_signal(&vbp_cond)) == 0", VAS_ASSERT); } } while (0); } while (0);
 } else {
  do { if (!(vt->heap_idx != 0)) { VAS_Fail(__func__, "cache/cache_backend_probe.c", 531, "vt->heap_idx != BINHEAP_NOIDX", VAS_ASSERT); } } while (0);
  binheap_delete(vbp_heap, vt->heap_idx);
 }
 Lck__Unlock(&vbp_mtx, __func__, 534);
}
    ...
    struct tcp_pool *tp)
{
 ...
 do { do { if (!((b) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend_probe.c", 547, "(b) != NULL", VAS_ASSERT); } } while (0); do { if (!((b)->magic == 0x64c4c7c6)) { VAS_Fail(__func__, "cache/cache_backend_probe.c", 547, "(b)->magic == 0x64c4c7c6", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((vp) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend_probe.c", 548, "(vp) != NULL", VAS_ASSERT); } } while (0); do { if (!((vp)->magic == 0x84998490)) { VAS_Fail(__func__, "cache/cache_backend_probe.c", 548, "(vp)->magic == 0x84998490", VAS_ASSERT); } } while (0); } while (0);

 do { do { if (!((b->probe) == 0)) { VAS_Fail(__func__, "cache/cache_backend_probe.c", 550, "(b->probe) == 0", VAS_ASSERT); } } while (0); } while (0);

 do { (vt) = calloc(sizeof *(vt), 1); if ((vt) != ((void *)0)) (vt)->magic = (0x6b7cb656); } while (0);
 do { do { if (!((vt) != 0)) { VAS_Fail(__func__, "cache/cache_backend_probe.c", 553, "(vt) != 0", VAS_MISSING); } } while (0); } while (0);
...
VBP_Remove(struct backend *be)
{
 ...
 do { do { if (!((be) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend_probe.c", 571, "(be) != NULL", VAS_ASSERT); } } while (0); do { if (!((be)->magic == 0x64c4c7c6)) { VAS_Fail(__func__, "cache/cache_backend_probe.c", 571, "(be)->magic == 0x64c4c7c6", VAS_ASSERT); } } while (0); } while (0);
 vt = be->probe;
 do { do { if (!((vt) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend_probe.c", 573, "(vt) != NULL", VAS_ASSERT); } } while (0); do { if (!((vt)->magic == 0x6b7cb656)) { VAS_Fail(__func__, "cache/cache_backend_probe.c", 573, "(vt)->magic == 0x6b7cb656", VAS_ASSERT); } } while (0); } while (0);

 Lck__Lock(&vbp_mtx, __func__, 575);
 be->healthy = 1;
 be->probe = ((void *)0);
 vt->backend = ((void *)0);
 if (vt->running) {
 ...
 Lck__Unlock(&vbp_mtx, __func__, 583);
 if (vt != ((void *)0)) {
  do { if (!(vt->heap_idx == 0)) { VAS_Fail(__func__, "cache/cache_backend_probe.c", 585, "vt->heap_idx == BINHEAP_NOIDX", VAS_ASSERT); } } while (0);
  vbp_delete(vt);
 }
}
...
vbp_cmp(void *priv, const void *a, const void *b)
{
 ...
 do { do { if (!((priv) == 0)) { VAS_Fail(__func__, "cache/cache_backend_probe.c", 597, "(priv) == 0", VAS_ASSERT); } } while (0); } while (0);
 do { (aa) = (a); do { if (!((aa) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend_probe.c", 598, "(aa) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((aa))->magic == (0x6b7cb656))) { VAS_Fail(__func__, "cache/cache_backend_probe.c", 598, "((aa))->magic == (0x6b7cb656)", VAS_ASSERT); } } while (0); } while (0); } while (0);
 do { (bb) = (b); do { if (!((bb) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend_probe.c", 599, "(bb) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((bb))->magic == (0x6b7cb656))) { VAS_Fail(__func__, "cache/cache_backend_probe.c", 599, "((bb))->magic == (0x6b7cb656)", VAS_ASSERT); } } while (0); } while (0); } while (0);
...
vbp_update(void *priv, void *p, unsigned u)
{
 ...
 do { do { if (!((priv) == 0)) { VAS_Fail(__func__, "cache/cache_backend_probe.c", 612, "(priv) == 0", VAS_ASSERT); } } while (0); } while (0);
 do { (vt) = (p); do { if (!((vt) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend_probe.c", 613, "(vt) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((vt))->magic == (0x6b7cb656))) { VAS_Fail(__func__, "cache/cache_backend_probe.c", 613, "((vt))->magic == (0x6b7cb656)", VAS_ASSERT); } } while (0); } while (0); } while (0);
 vt->heap_idx = u;
}
...
VBP_Init(void)
{
 ...
 Lck__New(&vbp_mtx, lck_backend, "lck_backend");
 vbp_heap = binheap_new(((void *)0), vbp_cmp, vbp_update);
 do { do { if (!((vbp_heap) != 0)) { VAS_Fail(__func__, "cache/cache_backend_probe.c", 626, "(vbp_heap) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((pthread_cond_init(&vbp_cond, ((void *)0))) == 0)) { VAS_Fail(__func__, "cache/cache_backend_probe.c", 627, "(pthread_cond_init(&vbp_cond, ((void *)0))) == 0", VAS_ASSERT); } } while (0); } while (0);
 WRK_BgThread(&thr, "Backend poller", vbp_thread, ((void *)0));
}
