...
VCL_VOID vmod_round_robin__init(const struct vrt_ctx *ctx,
    struct vmod_directors_round_robin **, const char *);
VCL_VOID vmod_round_robin__fini(struct vmod_directors_round_robin **);
VCL_VOID vmod_round_robin_add_backend(const struct vrt_ctx *ctx,
    struct vmod_directors_round_robin *, VCL_BACKEND);
VCL_BACKEND vmod_round_robin_backend(const struct vrt_ctx *ctx,
    struct vmod_directors_round_robin *);


struct vmod_directors_fallback;
VCL_VOID vmod_fallback__init(const struct vrt_ctx *ctx, struct vmod_directors_fallback **,
    const char *);
VCL_VOID vmod_fallback__fini(struct vmod_directors_fallback **);
VCL_VOID vmod_fallback_add_backend(const struct vrt_ctx *ctx,
    struct vmod_directors_fallback *, VCL_BACKEND);
VCL_BACKEND vmod_fallback_backend(const struct vrt_ctx *ctx,
    struct vmod_directors_fallback *);


struct vmod_directors_random;
VCL_VOID vmod_random__init(const struct vrt_ctx *ctx, struct vmod_directors_random **,
    const char *);
VCL_VOID vmod_random__fini(struct vmod_directors_random **);
VCL_VOID vmod_random_add_backend(const struct vrt_ctx *ctx,
    struct vmod_directors_random *, VCL_BACKEND, VCL_REAL);
VCL_BACKEND vmod_random_backend(const struct vrt_ctx *ctx,
    struct vmod_directors_random *);


struct vmod_directors_hash;
VCL_VOID vmod_hash__init(const struct vrt_ctx *ctx, struct vmod_directors_hash **,
    const char *);
VCL_VOID vmod_hash__fini(struct vmod_directors_hash **);
VCL_VOID vmod_hash_add_backend(const struct vrt_ctx *ctx, struct vmod_directors_hash *,
    VCL_BACKEND, VCL_REAL);
VCL_BACKEND vmod_hash_backend(const struct vrt_ctx *ctx, struct vmod_directors_hash *,
    const char *, ...);
# 43 "random.c" 2
    ...
    double *changed)
{
 ...
 do { (rr) = (dir->priv); do { if (!((rr) != ((void *)0))) { VAS_Fail(__func__, "random.c", 56, "(rr) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((rr))->magic == (0x4732d092))) { VAS_Fail(__func__, "random.c", 56, "((rr))->magic == (0x4732d092)", VAS_ASSERT); } } while (0); } while (0); } while (0);
    ...
    struct busyobj *bo)
{
 ...
 do { do { if (!((dir) != ((void *)0))) { VAS_Fail(__func__, "random.c", 68, "(dir) != NULL", VAS_ASSERT); } } while (0); do { if (!((dir)->magic == 0x3336351d)) { VAS_Fail(__func__, "random.c", 68, "(dir)->magic == 0x3336351d", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "random.c", 69, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "random.c", 69, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((bo) != ((void *)0))) { VAS_Fail(__func__, "random.c", 70, "(bo) != NULL", VAS_ASSERT); } } while (0); do { if (!((bo)->magic == 0x23b95567)) { VAS_Fail(__func__, "random.c", 70, "(bo)->magic == 0x23b95567", VAS_ASSERT); } } while (0); } while (0);
 do { (rr) = (dir->priv); do { if (!((rr) != ((void *)0))) { VAS_Fail(__func__, "random.c", 71, "(rr) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((rr))->magic == (0x4732d092))) { VAS_Fail(__func__, "random.c", 71, "((rr))->magic == (0x4732d092)", VAS_ASSERT); } } while (0); } while (0); } while (0);
 r = scalbn(random(), -31);
 do { if (!(r >= 0 && r < 1.0)) { VAS_Fail(__func__, "random.c", 73, "r >= 0 && r < 1.0", VAS_ASSERT); } } while (0);
    ...
    const char *vcl_name)
{
 ...
 do { do { if (!((ctx) != ((void *)0))) { VAS_Fail(__func__, "random.c", 84, "(ctx) != NULL", VAS_ASSERT); } } while (0); do { if (!((ctx)->magic == 0x6bb8f0db)) { VAS_Fail(__func__, "random.c", 84, "(ctx)->magic == 0x6bb8f0db", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((rrp) != 0)) { VAS_Fail(__func__, "random.c", 85, "(rrp) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((*rrp) == 0)) { VAS_Fail(__func__, "random.c", 86, "(*rrp) == 0", VAS_ASSERT); } } while (0); } while (0);
 do { (rr) = calloc(sizeof *(rr), 1); if ((rr) != ((void *)0)) (rr)->magic = (0x4732d092); } while (0);
 do { do { if (!((rr) != 0)) { VAS_Fail(__func__, "random.c", 88, "(rr) != 0", VAS_ASSERT); } } while (0); } while (0);
 *rrp = rr;
...
vmod_random__fini(struct vmod_directors_random **rrp)
{
 ...
 rr = *rrp;
 *rrp = ((void *)0);
 do { do { if (!((rr) != ((void *)0))) { VAS_Fail(__func__, "random.c", 101, "(rr) != NULL", VAS_ASSERT); } } while (0); do { if (!((rr)->magic == 0x4732d092)) { VAS_Fail(__func__, "random.c", 101, "(rr)->magic == 0x4732d092", VAS_ASSERT); } } while (0); } while (0);
 vdir_delete(&rr->vd);
 do { (rr)->magic = (0); free(rr); rr = ((void *)0); } while (0);
}
    ...
    struct vmod_directors_random *rr, VCL_BACKEND be, double w)
{
 ...
 do { do { if (!((ctx) != ((void *)0))) { VAS_Fail(__func__, "random.c", 111, "(ctx) != NULL", VAS_ASSERT); } } while (0); do { if (!((ctx)->magic == 0x6bb8f0db)) { VAS_Fail(__func__, "random.c", 111, "(ctx)->magic == 0x6bb8f0db", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((rr) != ((void *)0))) { VAS_Fail(__func__, "random.c", 112, "(rr) != NULL", VAS_ASSERT); } } while (0); do { if (!((rr)->magic == 0x4732d092)) { VAS_Fail(__func__, "random.c", 112, "(rr)->magic == 0x4732d092", VAS_ASSERT); } } while (0); } while (0);
...
{
 do { do { if (!((ctx) != ((void *)0))) { VAS_Fail(__func__, "random.c", 119, "(ctx) != NULL", VAS_ASSERT); } } while (0); do { if (!((ctx)->magic == 0x6bb8f0db)) { VAS_Fail(__func__, "random.c", 119, "(ctx)->magic == 0x6bb8f0db", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((rr) != ((void *)0))) { VAS_Fail(__func__, "random.c", 120, "(rr) != NULL", VAS_ASSERT); } } while (0); do { if (!((rr)->magic == 0x4732d092)) { VAS_Fail(__func__, "random.c", 120, "(rr)->magic == 0x4732d092", VAS_ASSERT); } } while (0); } while (0);
 return (rr->vd->dir);
}
