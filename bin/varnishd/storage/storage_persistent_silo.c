# 1 "storage/storage_persistent_silo.c"
...
# 1 "<command-line>" 2
# 1 "storage/storage_persistent_silo.c"
# 35 "storage/storage_persistent_silo.c"
# 1 "../../config.h" 1
# 36 "storage/storage_persistent_silo.c" 2
...
# 38 "storage/storage_persistent_silo.c" 2
...
# 39 "storage/storage_persistent_silo.c" 2
...
# 40 "storage/storage_persistent_silo.c" 2
...
# 42 "storage/storage_persistent_silo.c" 2
...
# 43 "storage/storage_persistent_silo.c" 2
...
# 44 "storage/storage_persistent_silo.c" 2
...
# 45 "storage/storage_persistent_silo.c" 2
...
# 47 "storage/storage_persistent_silo.c" 2
...
# 48 "storage/storage_persistent_silo.c" 2
# 1 "../../include/vtim.h" 1
# 33 "../../include/vtim.h"
...
# 49 "storage/storage_persistent_silo.c" 2
...
# 51 "storage/storage_persistent_silo.c" 2
# 69 "storage/storage_persistent_silo.c"
static void
smp_save_seg(const struct smp_sc *sc, struct smp_signspace *spc)
{
 ...
 Lck__Assert(&sc->mtx, 1);
 smp_reset_signspace(spc);
 ss = (((void *)((&(spc)->ctx)->ss + 1)));
 length = 0;
 for ((sg) = (((&sc->segments))->vtqh_first); (sg); (sg) = (((sg))->list.vtqe_next)) {
  do { if (!(sg->p.offset < sc->mediasize)) { VAS_Fail(__func__, "storage/storage_persistent_silo.c", 81, "sg->p.offset < sc->mediasize", VAS_ASSERT); } } while (0);
  do { if (!(sg->p.offset + sg->p.length <= sc->mediasize)) { VAS_Fail(__func__, "storage/storage_persistent_silo.c", 82, "sg->p.offset + sg->p.length <= sc->mediasize", VAS_ASSERT); } } while (0);
  *ss = sg->p;
  ss++;
  length += sizeof *ss;
 }
...
smp_save_segs(struct smp_sc *sc)
{
 ...
 for ((sg) = (((&sc->segments))->vtqh_first); (sg) && ((sg2) = (((sg))->list.vtqe_next), 1); (sg) = (sg2)) {
  if (sg->nobj > 0)
   break;
  if (sg == sc->cur_seg)
   continue;
  do { if (((((sg))->list.vtqe_next)) != ((void *)0)) (((sg))->list.vtqe_next)->list.vtqe_prev = (sg)->list.vtqe_prev; else { (&sc->segments)->vtqh_last = (sg)->list.vtqe_prev; } *(sg)->list.vtqe_prev = (((sg))->list.vtqe_next); ; ; } while (0);
  LRU_Free(sg->lru);
  do { (sg)->magic = (0); free(sg); sg = ((void *)0); } while (0);
 }
 smp_save_seg(sc, &sc->seg1);
 smp_save_seg(sc, &sc->seg2);
}
# 129 "storage/storage_persistent_silo.c"
void
    ...
    struct smp_seg *sg)
{
 ...
 do {do { if (!(pthread_equal(pthread_self(), (sc)->thread))) { VAS_Fail(__func__, "storage/storage_persistent_silo.c", 139, "pthread_equal(pthread_self(), (sc)->thread)", VAS_ASSERT); } } while (0);} while (0);
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_persistent_silo.c", 140, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "storage/storage_persistent_silo.c", 140, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((sg) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_persistent_silo.c", 141, "(sg) != NULL", VAS_ASSERT); } } while (0); do { if (!((sg)->magic == 0x45c61895)) { VAS_Fail(__func__, "storage/storage_persistent_silo.c", 141, "(sg)->magic == 0x45c61895", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((sg->lru) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_persistent_silo.c", 142, "(sg->lru) != NULL", VAS_ASSERT); } } while (0); do { if (!((sg->lru)->magic == 0x3fec7bb0)) { VAS_Fail(__func__, "storage/storage_persistent_silo.c", 142, "(sg->lru)->magic == 0x3fec7bb0", VAS_ASSERT); } } while (0); } while (0);
 do { if (!(sg->flags & (1 << 0))) { VAS_Fail(__func__, "storage/storage_persistent_silo.c", 143, "sg->flags & SMP_SEG_MUSTLOAD", VAS_ASSERT); } } while (0);
 sg->flags &= ~(1 << 0);
 do { do { if (!((sg->p.offset) != 0)) { VAS_Fail(__func__, "storage/storage_persistent_silo.c", 145, "(sg->p.offset) != 0", VAS_ASSERT); } } while (0); } while (0);
 if (sg->p.objlist == 0)
  return;
 ...
 for (;no > 0; so++,no--) {
  ...
  do { do { if (!((oc) != 0)) { VAS_Fail(__func__, "storage/storage_persistent_silo.c", 163, "(oc) != 0", VAS_ASSERT); } } while (0); } while (0);
  oc->flags &= ~(1<<1);
  oc->stobj->stevedore = sc->parent;
  smp_init_oc(oc, sg, no);
  oc->stobj->priv2 |= (1U << 31);
...
smp_new_seg(struct smp_sc *sc)
{
 ...
 do { do { if (!((sc->cur_seg) == 0)) { VAS_Fail(__func__, "storage/storage_persistent_silo.c", 188, "(sc->cur_seg) == 0", VAS_ASSERT); } } while (0); } while (0);
 Lck__Assert(&sc->mtx, 1);



 do { (void)memset(&tmpsg, 0, sizeof *&tmpsg); (&tmpsg)->magic = (0x45c61895); } while (0);
 tmpsg.sc = sc;
 tmpsg.p.offset = sc->free_offset;

 do { if (!(tmpsg.p.offset >= sc->ident->stuff[4])) { VAS_Fail(__func__, "storage/storage_persistent_silo.c", 197, "tmpsg.p.offset >= sc->ident->stuff[SMP_SPC_STUFF]", VAS_ASSERT); } } while (0);
 do { if (!(tmpsg.p.offset < sc->mediasize)) { VAS_Fail(__func__, "storage/storage_persistent_silo.c", 198, "tmpsg.p.offset < sc->mediasize", VAS_ASSERT); } } while (0);

 tmpsg.p.length = sc->aim_segl;
 tmpsg.p.length = ((tmpsg.p.length)&(~((uintptr_t)(8)-1UL)));

 if (smp_segend(&tmpsg) > sc->mediasize)

  tmpsg.p.offset = sc->ident->stuff[4];

 do { if (!(smp_segend(&tmpsg) <= sc->mediasize)) { VAS_Fail(__func__, "storage/storage_persistent_silo.c", 207, "smp_segend(&tmpsg) <= sc->mediasize", VAS_ASSERT); } } while (0);

 sg = ((&sc->segments)->vtqh_first);
 if (sg != ((void *)0) && tmpsg.p.offset <= sg->p.offset) {
  if (smp_segend(&tmpsg) > sg->p.offset)


   return;
  do { if (!(smp_segend(&tmpsg) <= sg->p.offset)) { VAS_Fail(__func__, "storage/storage_persistent_silo.c", 215, "smp_segend(&tmpsg) <= sg->p.offset", VAS_ASSERT); } } while (0);
 }

 if (tmpsg.p.offset == sc->ident->stuff[4])
  printf("Wrapped silo\n");
 ...
 *sg = tmpsg;
 sg->lru = LRU_Alloc();
 do { do { if (!((sg->lru) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_persistent_silo.c", 227, "(sg->lru) != NULL", VAS_ASSERT); } } while (0); do { if (!((sg->lru)->magic == 0x3fec7bb0)) { VAS_Fail(__func__, "storage/storage_persistent_silo.c", 227, "(sg->lru)->magic == 0x3fec7bb0", VAS_ASSERT); } } while (0); } while (0);

 sg->p.offset = (((sg->p.offset)+((sc->align)-1))&(~((uintptr_t)(sc->align)-1UL)));
 sg->p.length -= sg->p.offset - tmpsg.p.offset;
 sg->p.length = ((sg->p.length)&(~((uintptr_t)(sc->align)-1UL)));
 do { if (!(sg->p.offset + sg->p.length <= tmpsg.p.offset + tmpsg.p.length)) { VAS_Fail(__func__, "storage/storage_persistent_silo.c", 232, "sg->p.offset + sg->p.length <= tmpsg.p.offset + tmpsg.p.length", VAS_ASSERT); } } while (0);
 ...
 do { do { if (!((sg->p.offset) != 0)) { VAS_Fail(__func__, "storage/storage_persistent_silo.c", 238, "(sg->p.offset) != 0", VAS_ASSERT); } } while (0); } while (0);
 ...
 sc->cur_seg = sg;
 sc->next_bot = sg->p.offset + ((((sizeof(struct smp_sign) + 32))+((sc->align)-1))&(~((uintptr_t)(sc->align)-1UL)));
 sc->next_top = smp_segend(sg);
 sc->next_top -= ((((sizeof(struct smp_sign) + 32))+((sc->align)-1))&(~((uintptr_t)(sc->align)-1UL)));
 do { if (!(((sc->next_bot)&(~((uintptr_t)(sc->align)-1UL))) == (sc->next_bot))) { VAS_Fail(__func__, "storage/storage_persistent_silo.c", 248, "IRNDN(sc, sc->next_bot) == (sc->next_bot)", VAS_ASSERT); } } while (0);
 do { if (!(((sc->next_top)&(~((uintptr_t)(sc->align)-1UL))) == (sc->next_top))) { VAS_Fail(__func__, "storage/storage_persistent_silo.c", 249, "IRNDN(sc, sc->next_top) == (sc->next_top)", VAS_ASSERT); } } while (0);
...
smp_close_seg(struct smp_sc *sc, struct smp_seg *sg)
{
 ...
 do { do { if (!((sg) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_persistent_silo.c", 265, "(sg) != NULL", VAS_ASSERT); } } while (0); do { if (!((sg)->magic == 0x45c61895)) { VAS_Fail(__func__, "storage/storage_persistent_silo.c", 265, "(sg)->magic == 0x45c61895", VAS_ASSERT); } } while (0); } while (0);
 do { if (!(sg == sc->cur_seg)) { VAS_Fail(__func__, "storage/storage_persistent_silo.c", 266, "sg == sc->cur_seg", VAS_ASSERT); } } while (0);
 do { do { if (!((sg->p.offset) != 0)) { VAS_Fail(__func__, "storage/storage_persistent_silo.c", 267, "(sg->p.offset) != 0", VAS_ASSERT); } } while (0); } while (0);
 sc->cur_seg = ((void *)0);

 if (sg->nalloc == 0) {

  do { if (((((sg))->list.vtqe_next)) != ((void *)0)) (((sg))->list.vtqe_next)->list.vtqe_prev = (sg)->list.vtqe_prev; else { (&sc->segments)->vtqh_last = (sg)->list.vtqe_prev; } *(sg)->list.vtqe_prev = (((sg))->list.vtqe_next); ; ; } while (0);
  do { if (!(sg->p.offset >= sc->ident->stuff[4])) { VAS_Fail(__func__, "storage/storage_persistent_silo.c", 273, "sg->p.offset >= sc->ident->stuff[SMP_SPC_STUFF]", VAS_ASSERT); } } while (0);
  do { if (!(sg->p.offset < sc->mediasize)) { VAS_Fail(__func__, "storage/storage_persistent_silo.c", 274, "sg->p.offset < sc->mediasize", VAS_ASSERT); } } while (0);
 ...
 if (len < left) {
  dst = sc->next_bot + ((((sizeof(struct smp_sign) + 32))+((sc->align)-1))&(~((uintptr_t)(sc->align)-1UL)));
  dp = sc->base + dst;
  do { if (!((uintptr_t)dp + len < (uintptr_t)sg->objs)) { VAS_Fail(__func__, "storage/storage_persistent_silo.c", 291, "(uintptr_t)dp + len < (uintptr_t)sg->objs", VAS_ASSERT); } } while (0);
  memcpy(dp, sg->objs, len);
  sc->next_top = dst;
  sg->objs = dp;
  sg->p.length = (sc->next_top - sg->p.offset)
       + len + ((((sizeof(struct smp_sign) + 32))+((sc->align)-1))&(~((uintptr_t)(sc->align)-1UL)));
 ...
 sc->next_top -= ((((sizeof(struct smp_sign) + 32))+((sc->align)-1))&(~((uintptr_t)(sc->align)-1UL)));
 do { if (!(sc->next_top >= sc->next_bot)) { VAS_Fail(__func__, "storage/storage_persistent_silo.c", 306, "sc->next_top >= sc->next_bot", VAS_ASSERT); } } while (0);
 ...
 smp_def_sign(sc, sg->ctx,
     sg->p.offset + sg->p.length - ((((sizeof(struct smp_sign) + 32))+((sc->align)-1))&(~((uintptr_t)(sc->align)-1UL))), "SEGTAIL");
 smp_reset_sign(sg->ctx);
 smp_sync_sign(sg->ctx);
...
smp_find_so(const struct smp_seg *sg, unsigned priv2)
{
 ...
 priv2 &= ~(1U << 31);
 do { if (!(priv2 > 0)) { VAS_Fail(__func__, "storage/storage_persistent_silo.c", 332, "priv2 > 0", VAS_ASSERT); } } while (0);
 do { if (!(priv2 <= sg->p.lobjlist)) { VAS_Fail(__func__, "storage/storage_persistent_silo.c", 333, "priv2 <= sg->p.lobjlist", VAS_ASSERT); } } while (0);
    ...
    const struct storage *st)
{
 ...
 if (pst < (sc->base + sc->ident->stuff[4]))
  return (0x01);
 if (pst > (sc->base + sc->ident->stuff[5]))
  return (0x02);

 o = pst - sc->base;


 for ((sg2) = (((&sc->segments))->vtqh_first); (sg2); (sg2) = (((sg2))->list.vtqe_next))
...
smp_oc_sml_getobj(struct worker *wrk, struct objcore *oc)
{
 ...
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_persistent_silo.c", 400, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "storage/storage_persistent_silo.c", 400, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((oc) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_persistent_silo.c", 401, "(oc) != NULL", VAS_ASSERT); } } while (0); do { if (!((oc)->magic == 0x4d301302)) { VAS_Fail(__func__, "storage/storage_persistent_silo.c", 401, "(oc)->magic == 0x4d301302", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((oc->stobj->stevedore) != 0)) { VAS_Fail(__func__, "storage/storage_persistent_silo.c", 402, "(oc->stobj->stevedore) != 0", VAS_ASSERT); } } while (0); } while (0);


 do { if (!(oc->stobj->stevedore->methods->sml_getobj == smp_oc_sml_getobj)) { VAS_Fail(__func__, "storage/storage_persistent_silo.c", 405, "oc->stobj->stevedore->methods->sml_getobj == smp_oc_sml_getobj", VAS_ASSERT); } } while (0);

 do { (sg) = (oc->stobj->priv); do { if (!((sg) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_persistent_silo.c", 407, "(sg) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((sg))->magic == (0x45c61895))) { VAS_Fail(__func__, "storage/storage_persistent_silo.c", 407, "((sg))->magic == (0x45c61895)", VAS_ASSERT); } } while (0); } while (0); } while (0);
 ...
 do { if (!((const void*)(o) >= (const void*)((sg->sc)->base) && (const void*)(o) < (const void *)((sg->sc)->base + (sg->sc)->mediasize))) { VAS_Fail(__func__, "storage/storage_persistent_silo.c", 417, "(const void*)(o) >= (const void*)((sg->sc)->base) && (const void*)(o) < (const void *)((sg->sc)->base + (sg->sc)->mediasize)", VAS_ASSERT); } } while (0);
 do { do { if (!((o) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_persistent_silo.c", 418, "(o) != NULL", VAS_ASSERT); } } while (0); do { if (!((o)->magic == 0x32851d42)) { VAS_Fail(__func__, "storage/storage_persistent_silo.c", 418, "(o)->magic == 0x32851d42", VAS_ASSERT); } } while (0); } while (0);





 if (!(oc->stobj->priv2 & (1U << 31)))
  return (o);

 Lck__Lock(&sg->sc->mtx, __func__, 427);
 ...
 if (oc->stobj->priv2 & (1U << 31)) {
  ...
  bad = 0;
  l = 0;
  for ((st) = (((&o->list))->vtqh_first); (st); (st) = (((st))->list.vtqe_next)) {
 ...
 Lck__Unlock(&sg->sc->mtx, __func__, 453);
 EXP_Rearm(oc, (__builtin_nanf ("")), (__builtin_nanf ("")), (__builtin_nanf ("")), (__builtin_nanf ("")));
 return (o);
}
...
smp_oc_objupdatemeta(struct worker *wrk, struct objcore *oc)
{
 ...
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_persistent_silo.c", 465, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "storage/storage_persistent_silo.c", 465, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((oc) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_persistent_silo.c", 466, "(oc) != NULL", VAS_ASSERT); } } while (0); do { if (!((oc)->magic == 0x4d301302)) { VAS_Fail(__func__, "storage/storage_persistent_silo.c", 466, "(oc)->magic == 0x4d301302", VAS_ASSERT); } } while (0); } while (0);
 o = smp_oc_sml_getobj(wrk, oc);
 do { do { if (!((o) != 0)) { VAS_Fail(__func__, "storage/storage_persistent_silo.c", 468, "(o) != 0", VAS_ASSERT); } } while (0); } while (0);

 do { (sg) = (oc->stobj->priv); do { if (!((sg) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_persistent_silo.c", 470, "(sg) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((sg))->magic == (0x45c61895))) { VAS_Fail(__func__, "storage/storage_persistent_silo.c", 470, "((sg))->magic == (0x45c61895)", VAS_ASSERT); } } while (0); } while (0); } while (0);
 do { do { if (!((sg->sc) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_persistent_silo.c", 471, "(sg->sc) != NULL", VAS_ASSERT); } } while (0); do { if (!((sg->sc)->magic == 0x7b73af0a)) { VAS_Fail(__func__, "storage/storage_persistent_silo.c", 471, "(sg->sc)->magic == 0x7b73af0a", VAS_ASSERT); } } while (0); } while (0);
 so = smp_find_so(sg, oc->stobj->priv2);

 if (sg == sg->sc->cur_seg) {

  Lck__Lock(&sg->sc->mtx, __func__, 476);
  so->ban = BAN_Time(oc->ban);
  so->exp = oc->exp;
  Lck__Unlock(&sg->sc->mtx, __func__, 479);
 } else {
  so->ban = BAN_Time(oc->ban);
  so->exp = oc->exp;
 }
...
smp_oc_objfree(struct worker *wrk, struct objcore *oc)
{
 ...
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_persistent_silo.c", 492, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "storage/storage_persistent_silo.c", 492, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((oc) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_persistent_silo.c", 493, "(oc) != NULL", VAS_ASSERT); } } while (0); do { if (!((oc)->magic == 0x4d301302)) { VAS_Fail(__func__, "storage/storage_persistent_silo.c", 493, "(oc)->magic == 0x4d301302", VAS_ASSERT); } } while (0); } while (0);

 do { (sg) = (oc->stobj->priv); do { if (!((sg) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_persistent_silo.c", 495, "(sg) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((sg))->magic == (0x45c61895))) { VAS_Fail(__func__, "storage/storage_persistent_silo.c", 495, "((sg))->magic == (0x45c61895)", VAS_ASSERT); } } while (0); } while (0); } while (0);
 so = smp_find_so(sg, oc->stobj->priv2);

 Lck__Lock(&sg->sc->mtx, __func__, 498);
 EXP_Clr(&so->exp);
 so->ptr = 0;

 do { if (!(sg->nobj > 0)) { VAS_Fail(__func__, "storage/storage_persistent_silo.c", 502, "sg->nobj > 0", VAS_ASSERT); } } while (0);
 sg->nobj--;
 if (oc->stobj->priv2 & (1U << 31)) {
  wrk->stats->n_vampireobject--;
 } else {
  do { if (!(sg->nfixed > 0)) { VAS_Fail(__func__, "storage/storage_persistent_silo.c", 507, "sg->nfixed > 0", VAS_ASSERT); } } while (0);
  sg->nfixed--;
  wrk->stats->n_object--;
 }

 Lck__Unlock(&sg->sc->mtx, __func__, 512);
...
smp_oc_objgetlru(const struct objcore *oc)
{
 ...
 do { (sg) = (oc->stobj->priv); do { if (!((sg) != ((void *)0))) { VAS_Fail(__func__, "storage/storage_persistent_silo.c", 525, "(sg) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((sg))->magic == (0x45c61895))) { VAS_Fail(__func__, "storage/storage_persistent_silo.c", 525, "((sg))->magic == (0x45c61895)", VAS_ASSERT); } } while (0); } while (0); } while (0);
 return (sg->lru);
}
...
smp_init_oc(struct objcore *oc, struct smp_seg *sg, unsigned objidx)
{
 ...
 do { do { if (!((objidx & (1U << 31)) == 0)) { VAS_Fail(__func__, "storage/storage_persistent_silo.c", 542, "(objidx & (1U << 31)) == 0", VAS_ASSERT); } } while (0); } while (0);
 oc->stobj->priv = sg;
