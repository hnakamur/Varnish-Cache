...
# 1 "<command-line>" 2
# 1 "cache/cache_backend_tcp.c"
# 35 "cache/cache_backend_tcp.c"
# 1 "../../config.h" 1
# 36 "cache/cache_backend_tcp.c" 2
...
# 38 "cache/cache_backend_tcp.c" 2
...
# 40 "cache/cache_backend_tcp.c" 2
...
# 42 "cache/cache_backend_tcp.c" 2
# 1 "../../include/vsa.h" 1
# 33 "../../include/vsa.h"
struct suckaddr;
...
# 43 "cache/cache_backend_tcp.c" 2
# 1 "../../include/vtcp.h" 1
# 31 "../../include/vtcp.h"
struct suckaddr;
...
# 44 "cache/cache_backend_tcp.c" 2
# 1 "../../include/vtim.h" 1
# 33 "../../include/vtim.h"
...
# 45 "cache/cache_backend_tcp.c" 2
...
# 47 "cache/cache_backend_tcp.c" 2
...
# 48 "cache/cache_backend_tcp.c" 2
...
# 49 "cache/cache_backend_tcp.c" 2
...
struct tcp_pool {
 ...
 struct { struct tcp_pool *vtqe_next; struct tcp_pool **vtqe_prev; } list;
 int refcnt;
 struct lock mtx;

 struct waitfor waitfor;

 struct { struct vbc *vtqh_first; struct vbc **vtqh_last; } connlist;
 int n_conn;

 struct { struct vbc *vtqh_first; struct vbc **vtqh_last; } killlist;
 int n_kill;
...
static struct { struct tcp_pool *vtqh_first; struct tcp_pool **vtqh_last; } pools = { ((void *)0), &(pools).vtqh_first, };
...
tcp_handle(struct waited *w, enum wait_event ev, double now)
{
 ...
 do { (vbc) = (w->ptr); do { if (!((vbc) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend_tcp.c", 86, "(vbc) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((vbc))->magic == (0x0c5e6592))) { VAS_Fail(__func__, "cache/cache_backend_tcp.c", 86, "((vbc))->magic == (0x0c5e6592)", VAS_ASSERT); } } while (0); } while (0); } while (0);
 (void)ev;
 (void)now;
 do { do { if (!((vbc->tcp_pool) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend_tcp.c", 89, "(vbc->tcp_pool) != NULL", VAS_ASSERT); } } while (0); do { if (!((vbc->tcp_pool)->magic == 0x28b0e42a)) { VAS_Fail(__func__, "cache/cache_backend_tcp.c", 89, "(vbc->tcp_pool)->magic == 0x28b0e42a", VAS_ASSERT); } } while (0); } while (0);
 tp = vbc->tcp_pool;

 Lck__Lock(&tp->mtx, __func__, 92);

 switch(vbc->state) {
 case (1<<2):
  vbc->state = (1<<1);
  do { if (((((vbc))->list.vtqe_next)) != ((void *)0)) (((vbc))->list.vtqe_next)->list.vtqe_prev = (vbc)->list.vtqe_prev; else { (&tp->connlist)->vtqh_last = (vbc)->list.vtqe_prev; } *(vbc)->list.vtqe_prev = (((vbc))->list.vtqe_next); ; ; } while (0);
  do { do { if (!((vbc->cond) != 0)) { VAS_Fail(__func__, "cache/cache_backend_tcp.c", 98, "(vbc->cond) != 0", VAS_ASSERT); } } while (0); } while (0);
  do { do { if (!((pthread_cond_signal(vbc->cond)) == 0)) { VAS_Fail(__func__, "cache/cache_backend_tcp.c", 99, "(pthread_cond_signal(vbc->cond)) == 0", VAS_ASSERT); } } while (0); } while (0);
  break;
 case (1<<0):
  VTCP_close(&vbc->fd);
  do { if (((((vbc))->list.vtqe_next)) != ((void *)0)) (((vbc))->list.vtqe_next)->list.vtqe_prev = (vbc)->list.vtqe_prev; else { (&tp->connlist)->vtqh_last = (vbc)->list.vtqe_prev; } *(vbc)->list.vtqe_prev = (((vbc))->list.vtqe_next); ; ; } while (0);
  tp->n_conn--;
  do { (vbc)->magic = (0); free(vbc); vbc = ((void *)0); } while (0);
  break;
 case (1<<3):
  VTCP_close(&vbc->fd);
  tp->n_kill--;
  do { if (((((vbc))->list.vtqe_next)) != ((void *)0)) (((vbc))->list.vtqe_next)->list.vtqe_prev = (vbc)->list.vtqe_prev; else { (&tp->killlist)->vtqh_last = (vbc)->list.vtqe_prev; } *(vbc)->list.vtqe_prev = (((vbc))->list.vtqe_next); ; ; } while (0);
  memset(vbc, 0x11, sizeof *vbc);
  free(vbc);
  break;
 default:
  do { VAS_Fail(__func__, "cache/cache_backend_tcp.c", 115, "Wrong vbc state", VAS_WRONG); } while (0);
 }
 Lck__Unlock(&tp->mtx, __func__, 117);
}
...
VBT_Ref(const struct suckaddr *ip4, const struct suckaddr *ip6)
{
 ...
 for ((tp) = (((&pools))->vtqh_first); (tp); (tp) = (((tp))->list.vtqe_next)) {
  do { if (!(tp->refcnt > 0)) { VAS_Fail(__func__, "cache/cache_backend_tcp.c", 131, "tp->refcnt > 0", VAS_ASSERT); } } while (0);
  if (ip4 == ((void *)0)) {
   if (tp->ip4 != ((void *)0))
    continue;
  } else {
 ...
 do { (tp) = calloc(sizeof *(tp), 1); if ((tp) != ((void *)0)) (tp)->magic = (0x28b0e42a); } while (0);
 do { do { if (!((tp) != 0)) { VAS_Fail(__func__, "cache/cache_backend_tcp.c", 155, "(tp) != 0", VAS_ASSERT); } } while (0); } while (0);
 if (ip4 != ((void *)0))
  tp->ip4 = VSA_Clone(ip4);
 if (ip6 != ((void *)0))
  tp->ip6 = VSA_Clone(ip6);
 tp->refcnt = 1;
 Lck__New(&tp->mtx, lck_backend_tcp, "lck_backend_tcp");
 do { (((&tp->connlist))->vtqh_first) = ((void *)0); (&tp->connlist)->vtqh_last = &(((&tp->connlist))->vtqh_first); } while (0);
 do { (((&tp->killlist))->vtqh_first) = ((void *)0); (&tp->killlist)->vtqh_last = &(((&tp->killlist))->vtqh_first); } while (0);
 do { if (((((tp))->list.vtqe_next) = (((&pools))->vtqh_first)) != ((void *)0)) (((&pools))->vtqh_first)->list.vtqe_prev = &(((tp))->list.vtqe_next); else (&pools)->vtqh_last = &(((tp))->list.vtqe_next); (((&pools))->vtqh_first) = (tp); (tp)->list.vtqe_prev = &(((&pools))->vtqh_first); } while (0);
 do { (void)memset(&tp->waitfor, 0, sizeof *&tp->waitfor); (&tp->waitfor)->magic = (0x16b79246); } while (0);
...
VBT_Rel(struct tcp_pool **tpp)
{
 ...
 do { do { if (!((tpp) != 0)) { VAS_Fail(__func__, "cache/cache_backend_tcp.c", 181, "(tpp) != 0", VAS_ASSERT); } } while (0); } while (0);
 tp = *tpp;
 *tpp = ((void *)0);
 do { do { if (!((tp) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend_tcp.c", 184, "(tp) != NULL", VAS_ASSERT); } } while (0); do { if (!((tp)->magic == 0x28b0e42a)) { VAS_Fail(__func__, "cache/cache_backend_tcp.c", 184, "(tp)->magic == 0x28b0e42a", VAS_ASSERT); } } while (0); } while (0);
 do { if (!(tp->refcnt > 0)) { VAS_Fail(__func__, "cache/cache_backend_tcp.c", 185, "tp->refcnt > 0", VAS_ASSERT); } } while (0);
 if (--tp->refcnt > 0)
  return;
 do { do { if (!((tp->n_used) == 0)) { VAS_Fail(__func__, "cache/cache_backend_tcp.c", 188, "(tp->n_used) == 0", VAS_ASSERT); } } while (0); } while (0);
 do { if (((((tp))->list.vtqe_next)) != ((void *)0)) (((tp))->list.vtqe_next)->list.vtqe_prev = (tp)->list.vtqe_prev; else { (&pools)->vtqh_last = (tp)->list.vtqe_prev; } *(tp)->list.vtqe_prev = (((tp))->list.vtqe_next); ; ; } while (0);
 free(tp->name);
 free(tp->ip4);
 free(tp->ip6);
 Lck__Lock(&tp->mtx, __func__, 193);
 for ((vbc) = (((&tp->connlist))->vtqh_first); (vbc) && ((vbc2) = (((vbc))->list.vtqe_next), 1); (vbc) = (vbc2)) {
  do { if (((((vbc))->list.vtqe_next)) != ((void *)0)) (((vbc))->list.vtqe_next)->list.vtqe_prev = (vbc)->list.vtqe_prev; else { (&tp->connlist)->vtqh_last = (vbc)->list.vtqe_prev; } *(vbc)->list.vtqe_prev = (((vbc))->list.vtqe_next); ; ; } while (0);
  tp->n_conn--;
  do { if (!(vbc->state == (1<<0))) { VAS_Fail(__func__, "cache/cache_backend_tcp.c", 197, "vbc->state == VBC_STATE_AVAIL", VAS_ASSERT); } } while (0);
  vbc->state = (1<<3);
  (void)shutdown(vbc->fd, SHUT_WR);
  do { (((vbc))->list.vtqe_next) = ((void *)0); (vbc)->list.vtqe_prev = (&tp->killlist)->vtqh_last; *(&tp->killlist)->vtqh_last = (vbc); (&tp->killlist)->vtqh_last = &(((vbc))->list.vtqe_next); } while (0);
  tp->n_kill++;
 }
 while (tp->n_kill) {
  Lck__Unlock(&tp->mtx, __func__, 204);
  (void)usleep(20000);
  Lck__Lock(&tp->mtx, __func__, 206);
 }
 Lck__Unlock(&tp->mtx, __func__, 208);
 Lck_Delete(&tp->mtx);
 do { do { if (!((tp->n_conn) == 0)) { VAS_Fail(__func__, "cache/cache_backend_tcp.c", 210, "(tp->n_conn) == 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((tp->n_kill) == 0)) { VAS_Fail(__func__, "cache/cache_backend_tcp.c", 211, "(tp->n_kill) == 0", VAS_ASSERT); } } while (0); } while (0);

 do { (tp)->magic = (0); free(tp); tp = ((void *)0); } while (0);
}
...
VBT_Open(const struct tcp_pool *tp, double tmo, const struct suckaddr **sa)
{
 ...
 do { do { if (!((tp) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend_tcp.c", 227, "(tp) != NULL", VAS_ASSERT); } } while (0); do { if (!((tp)->magic == 0x28b0e42a)) { VAS_Fail(__func__, "cache/cache_backend_tcp.c", 227, "(tp)->magic == 0x28b0e42a", VAS_ASSERT); } } while (0); } while (0);
...
VBT_Recycle(const struct worker *wrk, struct tcp_pool *tp, struct vbc **vbcp)
{
 ...
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend_tcp.c", 255, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "cache/cache_backend_tcp.c", 255, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((tp) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend_tcp.c", 256, "(tp) != NULL", VAS_ASSERT); } } while (0); do { if (!((tp)->magic == 0x28b0e42a)) { VAS_Fail(__func__, "cache/cache_backend_tcp.c", 256, "(tp)->magic == 0x28b0e42a", VAS_ASSERT); } } while (0); } while (0);
 vbc = *vbcp;
 *vbcp = ((void *)0);
 do { do { if (!((vbc) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend_tcp.c", 259, "(vbc) != NULL", VAS_ASSERT); } } while (0); do { if (!((vbc)->magic == 0x0c5e6592)) { VAS_Fail(__func__, "cache/cache_backend_tcp.c", 259, "(vbc)->magic == 0x0c5e6592", VAS_ASSERT); } } while (0); } while (0);

 do { if (!(vbc->state == (1<<1))) { VAS_Fail(__func__, "cache/cache_backend_tcp.c", 261, "vbc->state == VBC_STATE_USED", VAS_ASSERT); } } while (0);
 do { if (!(vbc->fd > 0)) { VAS_Fail(__func__, "cache/cache_backend_tcp.c", 262, "vbc->fd > 0", VAS_ASSERT); } } while (0);

 Lck__Lock(&tp->mtx, __func__, 264);
 tp->n_used--;
 ...
 if (Wait_Enter(wrk->pool->waiter, vbc->waited)) {
  ...
  do { if (((((vbc))->list.vtqe_next) = (((&tp->connlist))->vtqh_first)) != ((void *)0)) (((&tp->connlist))->vtqh_first)->list.vtqe_prev = &(((vbc))->list.vtqe_next); else (&tp->connlist)->vtqh_last = &(((vbc))->list.vtqe_next); (((&tp->connlist))->vtqh_first) = (vbc); (vbc)->list.vtqe_prev = &(((&tp->connlist))->vtqh_first); } while (0);
  i++;
 }

 if (vbc != ((void *)0))
  tp->n_conn++;
 Lck__Unlock(&tp->mtx, __func__, 285);

 if (i && DO_DEBUG(DBG_VTC_MODE)) {
# 301 "cache/cache_backend_tcp.c"
  (void)usleep(10000);
 }
}
...
VBT_Close(struct tcp_pool *tp, struct vbc **vbcp)
{
 ...
 do { do { if (!((tp) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend_tcp.c", 314, "(tp) != NULL", VAS_ASSERT); } } while (0); do { if (!((tp)->magic == 0x28b0e42a)) { VAS_Fail(__func__, "cache/cache_backend_tcp.c", 314, "(tp)->magic == 0x28b0e42a", VAS_ASSERT); } } while (0); } while (0);
 vbc = *vbcp;
 *vbcp = ((void *)0);
 do { do { if (!((vbc) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend_tcp.c", 317, "(vbc) != NULL", VAS_ASSERT); } } while (0); do { if (!((vbc)->magic == 0x0c5e6592)) { VAS_Fail(__func__, "cache/cache_backend_tcp.c", 317, "(vbc)->magic == 0x0c5e6592", VAS_ASSERT); } } while (0); } while (0);

 do { if (!(vbc->state == (1<<1))) { VAS_Fail(__func__, "cache/cache_backend_tcp.c", 319, "vbc->state == VBC_STATE_USED", VAS_ASSERT); } } while (0);
 do { if (!(vbc->fd > 0)) { VAS_Fail(__func__, "cache/cache_backend_tcp.c", 320, "vbc->fd > 0", VAS_ASSERT); } } while (0);

 Lck__Lock(&tp->mtx, __func__, 322);
 tp->n_used--;
 if (vbc->state == (1<<2)) {
  (void)shutdown(vbc->fd, SHUT_WR);
  vbc->state = (1<<3);
  do { if (((((vbc))->list.vtqe_next) = (((&tp->killlist))->vtqh_first)) != ((void *)0)) (((&tp->killlist))->vtqh_first)->list.vtqe_prev = &(((vbc))->list.vtqe_next); else (&tp->killlist)->vtqh_last = &(((vbc))->list.vtqe_next); (((&tp->killlist))->vtqh_first) = (vbc); (vbc)->list.vtqe_prev = &(((&tp->killlist))->vtqh_first); } while (0);
  tp->n_kill++;
 } else {
  do { if (!(vbc->state == (1<<1))) { VAS_Fail(__func__, "cache/cache_backend_tcp.c", 330, "vbc->state == VBC_STATE_USED", VAS_ASSERT); } } while (0);
  VTCP_close(&vbc->fd);
  memset(vbc, 0x44, sizeof *vbc);
  free(vbc);
 }
 Lck__Unlock(&tp->mtx, __func__, 335);
}
    ...
    struct worker *wrk)
{
 ...
 do { do { if (!((tp) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend_tcp.c", 348, "(tp) != NULL", VAS_ASSERT); } } while (0); do { if (!((tp)->magic == 0x28b0e42a)) { VAS_Fail(__func__, "cache/cache_backend_tcp.c", 348, "(tp)->magic == 0x28b0e42a", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((be) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend_tcp.c", 349, "(be) != NULL", VAS_ASSERT); } } while (0); do { if (!((be)->magic == 0x64c4c7c6)) { VAS_Fail(__func__, "cache/cache_backend_tcp.c", 349, "(be)->magic == 0x64c4c7c6", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend_tcp.c", 350, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "cache/cache_backend_tcp.c", 350, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);

 Lck__Lock(&tp->mtx, __func__, 352);
 vbc = ((&tp->connlist)->vtqh_first);
 do { if ((vbc) != ((void *)0)) do { if (!((vbc)->magic == 0x0c5e6592)) { VAS_Fail(__func__, "cache/cache_backend_tcp.c", 354, "(vbc)->magic == 0x0c5e6592", VAS_ASSERT); } } while (0); } while (0);
 if (vbc == ((void *)0) || vbc->state == (1<<2))
  vbc = ((void *)0);
 else {
  do { if (!(vbc->tcp_pool == tp)) { VAS_Fail(__func__, "cache/cache_backend_tcp.c", 358, "vbc->tcp_pool == tp", VAS_ASSERT); } } while (0);
  do { if (!(vbc->state == (1<<0))) { VAS_Fail(__func__, "cache/cache_backend_tcp.c", 359, "vbc->state == VBC_STATE_AVAIL", VAS_ASSERT); } } while (0);
  do { if (((((vbc))->list.vtqe_next)) != ((void *)0)) (((vbc))->list.vtqe_next)->list.vtqe_prev = (vbc)->list.vtqe_prev; else { (&tp->connlist)->vtqh_last = (vbc)->list.vtqe_prev; } *(vbc)->list.vtqe_prev = (((vbc))->list.vtqe_next); ; ; } while (0);
  do { (((vbc))->list.vtqe_next) = ((void *)0); (vbc)->list.vtqe_prev = (&tp->connlist)->vtqh_last; *(&tp->connlist)->vtqh_last = (vbc); (&tp->connlist)->vtqh_last = &(((vbc))->list.vtqe_next); } while (0);
  tp->n_conn--;
 ...
 tp->n_used++;
 Lck__Unlock(&tp->mtx, __func__, 368);

 if (vbc != ((void *)0))
  return (vbc);

 do { (vbc) = calloc(sizeof *(vbc), 1); if ((vbc) != ((void *)0)) (vbc)->magic = (0x0c5e6592); } while (0);
 do { do { if (!((vbc) != 0)) { VAS_Fail(__func__, "cache/cache_backend_tcp.c", 374, "(vbc) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { (void)memset(vbc->waited, 0, sizeof *vbc->waited); (vbc->waited)->magic = (0x1743992d); } while (0);
 vbc->state = (1<<1);
 vbc->tcp_pool = tp;
 ...
 if (vbc->fd < 0)
  do { (vbc)->magic = (0); free(vbc); vbc = ((void *)0); } while (0);
 if (vbc == ((void *)0)) {
  Lck__Lock(&tp->mtx, __func__, 382);
  tp->n_used--;
  Lck__Unlock(&tp->mtx, __func__, 384);
 }
 return (vbc);
}
...
VBT_Wait(struct worker *wrk, struct vbc *vbc)
{
 ...
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend_tcp.c", 397, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "cache/cache_backend_tcp.c", 397, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((vbc) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend_tcp.c", 398, "(vbc) != NULL", VAS_ASSERT); } } while (0); do { if (!((vbc)->magic == 0x0c5e6592)) { VAS_Fail(__func__, "cache/cache_backend_tcp.c", 398, "(vbc)->magic == 0x0c5e6592", VAS_ASSERT); } } while (0); } while (0);
 tp = vbc->tcp_pool;
 do { do { if (!((tp) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend_tcp.c", 400, "(tp) != NULL", VAS_ASSERT); } } while (0); do { if (!((tp)->magic == 0x28b0e42a)) { VAS_Fail(__func__, "cache/cache_backend_tcp.c", 400, "(tp)->magic == 0x28b0e42a", VAS_ASSERT); } } while (0); } while (0);
 do { if (!(vbc->cond == &wrk->cond)) { VAS_Fail(__func__, "cache/cache_backend_tcp.c", 401, "vbc->cond == &wrk->cond", VAS_ASSERT); } } while (0);
 Lck__Lock(&tp->mtx, __func__, 402);
 while (vbc->state == (1<<2))
  do { do { if (!((Lck_CondWait(&wrk->cond, &tp->mtx, 0)) == 0)) { VAS_Fail(__func__, "cache/cache_backend_tcp.c", 404, "(Lck_CondWait(&wrk->cond, &tp->mtx, 0)) == 0", VAS_ASSERT); } } while (0); } while (0);
 do { if (!(vbc->state == (1<<1))) { VAS_Fail(__func__, "cache/cache_backend_tcp.c", 405, "vbc->state == VBC_STATE_USED", VAS_ASSERT); } } while (0);
 vbc->cond = ((void *)0);
 Lck__Unlock(&tp->mtx, __func__, 407);
}
