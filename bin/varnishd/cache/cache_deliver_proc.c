...
# 1 "<command-line>" 2
# 1 "cache/cache_deliver_proc.c"
# 30 "cache/cache_deliver_proc.c"
# 1 "../../config.h" 1
# 31 "cache/cache_deliver_proc.c" 2
...
# 33 "cache/cache_deliver_proc.c" 2
...
vdp_bytes VDP_ESI;
# 34 "cache/cache_deliver_proc.c" 2
...
VDP_bytes(struct req *req, enum vdp_action act, const void *ptr, ssize_t len)
{
 ...
 do { do { if (!((req) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_deliver_proc.c", 41, "(req) != NULL", VAS_ASSERT); } } while (0); do { if (!((req)->magic == 0x2751aaa1)) { VAS_Fail(__func__, "cache/cache_deliver_proc.c", 41, "(req)->magic == 0x2751aaa1", VAS_ASSERT); } } while (0); } while (0);
 do { if (!(act == VDP_NULL || act == VDP_FLUSH)) { VAS_Fail(__func__, "cache/cache_deliver_proc.c", 42, "act == VDP_NULL || act == VDP_FLUSH", VAS_ASSERT); } } while (0);
 if (req->vdp_errval)
  return (req->vdp_errval);
 vdp = req->vdp_nxt;
 do { do { if (!((vdp) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_deliver_proc.c", 46, "(vdp) != NULL", VAS_ASSERT); } } while (0); do { if (!((vdp)->magic == 0x353eb781)) { VAS_Fail(__func__, "cache/cache_deliver_proc.c", 46, "(vdp)->magic == 0x353eb781", VAS_ASSERT); } } while (0); } while (0);
 req->vdp_nxt = ((vdp)->list.vtqe_next);

 do { if (!(act > VDP_NULL || len > 0)) { VAS_Fail(__func__, "cache/cache_deliver_proc.c", 49, "act > VDP_NULL || len > 0", VAS_ASSERT); } } while (0);

 retval = vdp->func(req, act, &vdp->priv, ptr, len);
 if (retval)
  req->vdp_errval = retval;
 req->vdp_nxt = vdp;
 return (retval);
}
...
VDP_push(struct req *req, vdp_bytes *func, void *priv, int bottom)
{
 ...
 do { do { if (!((req) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_deliver_proc.c", 63, "(req) != NULL", VAS_ASSERT); } } while (0); do { if (!((req)->magic == 0x2751aaa1)) { VAS_Fail(__func__, "cache/cache_deliver_proc.c", 63, "(req)->magic == 0x2751aaa1", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((func) != 0)) { VAS_Fail(__func__, "cache/cache_deliver_proc.c", 64, "(func) != 0", VAS_ASSERT); } } while (0); } while (0);
# 76 "cache/cache_deliver_proc.c"
 vdp = WS_Alloc(req->ws, sizeof *vdp);
 if (vdp == ((void *)0))
  return;
 do { (void)memset(vdp, 0, sizeof *vdp); (vdp)->magic = (0x353eb781); } while (0);
 vdp->func = func;
 vdp->priv = priv;
 if (bottom)
  do { (((vdp))->list.vtqe_next) = ((void *)0); (vdp)->list.vtqe_prev = (&req->vdp)->vtqh_last; *(&req->vdp)->vtqh_last = (vdp); (&req->vdp)->vtqh_last = &(((vdp))->list.vtqe_next); } while (0);
 else
  do { if (((((vdp))->list.vtqe_next) = (((&req->vdp))->vtqh_first)) != ((void *)0)) (((&req->vdp))->vtqh_first)->list.vtqe_prev = &(((vdp))->list.vtqe_next); else (&req->vdp)->vtqh_last = &(((vdp))->list.vtqe_next); (((&req->vdp))->vtqh_first) = (vdp); (vdp)->list.vtqe_prev = &(((&req->vdp))->vtqh_first); } while (0);
 req->vdp_nxt = ((&req->vdp)->vtqh_first);

 do { do { if (!((vdp->func(req, VDP_INIT, &vdp->priv, ((void *)0), 0)) == 0)) { VAS_Fail(__func__, "cache/cache_deliver_proc.c", 88, "(vdp->func(req, VDP_INIT, &vdp->priv, ((void *)0), 0)) == 0", VAS_ASSERT); } } while (0); } while (0);
}
...
{
 struct vdp_entry *vdp;
 do { do { if (!((req) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_deliver_proc.c", 95, "(req) != NULL", VAS_ASSERT); } } while (0); do { if (!((req)->magic == 0x2751aaa1)) { VAS_Fail(__func__, "cache/cache_deliver_proc.c", 95, "(req)->magic == 0x2751aaa1", VAS_ASSERT); } } while (0); } while (0);

 vdp = ((&req->vdp)->vtqh_first);
 do { do { if (!((vdp) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_deliver_proc.c", 98, "(vdp) != NULL", VAS_ASSERT); } } while (0); do { if (!((vdp)->magic == 0x353eb781)) { VAS_Fail(__func__, "cache/cache_deliver_proc.c", 98, "(vdp)->magic == 0x353eb781", VAS_ASSERT); } } while (0); } while (0);
 do { if (!(vdp->func == func)) { VAS_Fail(__func__, "cache/cache_deliver_proc.c", 99, "vdp->func == func", VAS_ASSERT); } } while (0);
 do { if (((((vdp))->list.vtqe_next)) != ((void *)0)) (((vdp))->list.vtqe_next)->list.vtqe_prev = (vdp)->list.vtqe_prev; else { (&req->vdp)->vtqh_last = (vdp)->list.vtqe_prev; } *(vdp)->list.vtqe_prev = (((vdp))->list.vtqe_next); ; ; } while (0);
 do { do { if (!((vdp->func(req, VDP_FINI, &vdp->priv, ((void *)0), 0)) == 0)) { VAS_Fail(__func__, "cache/cache_deliver_proc.c", 101, "(vdp->func(req, VDP_FINI, &vdp->priv, ((void *)0), 0)) == 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((vdp->priv) == 0)) { VAS_Fail(__func__, "cache/cache_deliver_proc.c", 102, "(vdp->priv) == 0", VAS_ASSERT); } } while (0); } while (0);
 req->vdp_nxt = ((&req->vdp)->vtqh_first);
}
...
VDP_close(struct req *req)
{
 ...
 do { do { if (!((req) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_deliver_proc.c", 110, "(req) != NULL", VAS_ASSERT); } } while (0); do { if (!((req)->magic == 0x2751aaa1)) { VAS_Fail(__func__, "cache/cache_deliver_proc.c", 110, "(req)->magic == 0x2751aaa1", VAS_ASSERT); } } while (0); } while (0);
 while (!((&req->vdp)->vtqh_first == ((void *)0)))
  vdp_pop(req, ((&req->vdp)->vtqh_first)->func);
}
...
VDP_DeliverObj(struct req *req)
{
 ...
 do { do { if (!((req) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_deliver_proc.c", 128, "(req) != NULL", VAS_ASSERT); } } while (0); do { if (!((req)->magic == 0x2751aaa1)) { VAS_Fail(__func__, "cache/cache_deliver_proc.c", 128, "(req)->magic == 0x2751aaa1", VAS_ASSERT); } } while (0); } while (0);
