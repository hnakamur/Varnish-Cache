...
# 1 "<command-line>" 2
# 1 "cache/cache_esi_deliver.c"
# 31 "cache/cache_esi_deliver.c"
# 1 "../../config.h" 1
# 32 "cache/cache_esi_deliver.c" 2
...
# 34 "cache/cache_esi_deliver.c" 2
...
# 35 "cache/cache_esi_deliver.c" 2
...
# 37 "cache/cache_esi_deliver.c" 2
...
vdp_bytes VDP_ESI;
# 38 "cache/cache_esi_deliver.c" 2
...
# 40 "cache/cache_esi_deliver.c" 2
# 1 "cache/cache_esi.h" 1
# 42 "cache/cache_esi.h"
...
# 41 "cache/cache_esi_deliver.c" 2
# 1 "../../include/vend.h" 1
# 37 "../../include/vend.h"
...
# 42 "cache/cache_esi_deliver.c" 2
...
extern int gzvprintf (gzFile file, const char *format, va_list va)
                                                              ...
                                                              ;
# 43 "cache/cache_esi_deliver.c" 2
    ...
    struct ecx *ecx)
{
 ...
 do { do { if (!((preq) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 78, "(preq) != NULL", VAS_ASSERT); } } while (0); do { if (!((preq)->magic == 0x2751aaa1)) { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 78, "(preq)->magic == 0x2751aaa1", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((ecx) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 79, "(ecx) != NULL", VAS_ASSERT); } } while (0); do { if (!((ecx)->magic == 0x0b0f9163)) { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 79, "(ecx)->magic == 0x0b0f9163", VAS_ASSERT); } } while (0); } while (0);
 wrk = preq->wrk;
 ...
 do { do { if (!((req->vsl->wid) == 0)) { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 87, "(req->vsl->wid) == 0", VAS_ASSERT); } } while (0); } while (0);
 req->vsl->wid = VXID_Get(wrk, (1U<<30));
 VSLb(req->vsl, SLT_Begin, "req %u esi", ((preq->vsl->wid) & (~(3U<<30))));
 VSLb(preq->vsl, SLT_Link, "req %u esi", ((req->vsl->wid) & (~(3U<<30))));
 req->esi_level = preq->esi_level + 1;

 if (preq->esi_level == 0)
  do { if (!(preq->top == preq)) { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 94, "preq->top == preq", VAS_ASSERT); } } while (0);
 else
  do { do { if (!((preq->top) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 96, "(preq->top) != NULL", VAS_ASSERT); } } while (0); do { if (!((preq->top)->magic == 0x2751aaa1)) { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 96, "(preq->top)->magic == 0x2751aaa1", VAS_ASSERT); } } while (0); } while (0);
 ...
 do { if (!((sizeof (req->t_first) == sizeof (float) ? __isnanf (req->t_first) : sizeof (req->t_first) == sizeof (double) ? __isnan (req->t_first) : __isnanl (req->t_first)))) { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 145, "isnan(req->t_first)", VAS_ASSERT); } } while (0);
 do { if (!((sizeof (req->t_prev) == sizeof (float) ? __isnanf (req->t_prev) : sizeof (req->t_prev) == sizeof (double) ? __isnan (req->t_prev) : __isnanl (req->t_prev)))) { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 146, "isnan(req->t_prev)", VAS_ASSERT); } } while (0);

 do { (void)memset(&xp, 0, sizeof *&xp); (&xp)->magic = (0xf157f32f); } while (0);
 ...
 VSLb_ts_req(req, "Start", ((wrk)->lastused = VTIM_real()));
 ...
 while (1) {
  ...
  if (s == REQ_FSM_DONE)
   break;
  do { if (DO_DEBUG(DBG_WAITINGLIST)) VSL(SLT_Debug, (req->vsl->wid), "loop waiting for ESI (%d)", (int)s); } while (0)
                                          ;
  do { if (!(s == REQ_FSM_DISEMBARK)) { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 166, "s == REQ_FSM_DISEMBARK", VAS_ASSERT); } } while (0);
  do { do { if (!((req->wrk) == 0)) { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 167, "(req->wrk) == 0", VAS_ASSERT); } } while (0); } while (0);
  (void)usleep(10000);
 }
...
ved_decode_len(struct req *req, uint8_t **pp)
{
 ...
 default:
  ...
  do { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 212, "ESI-codes: illegal length", VAS_WRONG); } while (0);
 }
 *pp = p;
 do { if (!(l > 0)) { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 215, "l > 0", VAS_ASSERT); } } while (0);
 return (l);
}
    ...
    const void *ptr, ssize_t len)
{
 ...
 if (act == VDP_INIT) {
  do { do { if (!((*priv) == 0)) { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 235, "(*priv) == 0", VAS_ASSERT); } } while (0); } while (0);
  do { (ecx) = calloc(sizeof *(ecx), 1); if ((ecx) != ((void *)0)) (ecx)->magic = (0x0b0f9163); } while (0);
  do { do { if (!((ecx) != 0)) { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 237, "(ecx) != 0", VAS_ASSERT); } } while (0); } while (0);
  ecx->preq = req;
  *priv = ecx;
 ...
 do { (ecx) = (*priv); do { if (!((ecx) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 246, "(ecx) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((ecx))->magic == (0x0b0f9163))) { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 246, "((ecx))->magic == (0x0b0f9163)", VAS_ASSERT); } } while (0); } while (0); } while (0);
 if (act == VDP_FINI) {
  do { (ecx)->magic = (0); free(ecx); ecx = ((void *)0); } while (0);
  *priv = ((void *)0);
  return (0);
 }
 pp = ptr;
 ...
 while (1) {
  ...
  case 0:
   ecx->p = ObjGetattr(req->wrk, req->objcore,
       OA_ESIDATA, &l);
   do { do { if (!((ecx->p) != 0)) { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 259, "(ecx->p) != 0", VAS_ASSERT); } } while (0); } while (0);
   do { if (!(l > 0)) { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 260, "l > 0", VAS_ASSERT); } } while (0);
   ecx->e = ecx->p + l;
   ...
   if (req->esi_level == 0) {
    ...
    if (ecx->isgzip) {
     do { if (!(sizeof gzip_hdr == 10)) { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 274, "sizeof gzip_hdr == 10", VAS_ASSERT); } } while (0);

     retval = VDP_bytes(req, VDP_NULL,
         gzip_hdr, 10);
     ecx->l_crc = 0;
     ecx->crc = crc32(0L, 0, 0);
    }
   }
   ecx->state = 1;
  ...
  case 1:
   ...
   case (0x40 + 8):
    ...
    if (ecx->l < 0)
     return (-1);
    if (ecx->isgzip) {
     do { if (!(*ecx->p == (0x50 + 1) || *ecx->p == (0x50 + 2) || *ecx->p == (0x50 + 8))) { VAS_Fail(__func__,

 "cache/cache_esi_deliver.c"
# 298 "cache/cache_esi_deliver.c"
     ,

 300
# 298 "cache/cache_esi_deliver.c"
     , "*ecx->p == VEC_C1 || *ecx->p == VEC_C2 || *ecx->p == VEC_C8", VAS_ASSERT); } } while (0)
   ...
   case 'I':
    ecx->p++;
    q = (void*)(__extension__ (__builtin_constant_p ('\0') && !__builtin_constant_p ((const char*)ecx->p) && ('\0') == '\0' ? (char *) __rawmemchr ((const char*)ecx->p, '\0') : __builtin_strchr ((const char*)ecx->p, '\0')));
    do { do { if (!((q) != 0)) { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 326, "(q) != 0", VAS_ASSERT); } } while (0); } while (0);
    q++;
    r = (void*)(__extension__ (__builtin_constant_p ('\0') && !__builtin_constant_p ((const char*)q) && ('\0') == '\0' ? (char *) __rawmemchr ((const char*)q, '\0') : __builtin_strchr ((const char*)q, '\0')));
    do { do { if (!((r) != 0)) { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 329, "(r) != 0", VAS_ASSERT); } } while (0); } while (0);
    if (VDP_bytes(req, VDP_FLUSH, ((void *)0), 0)) {
     ecx->p = ecx->e;
     break;
    }
    ;
   ...
   default:
    VSLb(req->vsl, SLT_Error,
        ...
        343, *ecx->p, ecx->p);
    do { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 344, "ESI-codes: Illegal code", VAS_WRONG); } while (0);
   }
   break;
  case 2:
   ...
   if (req->transport->deliver == VED_Deliver) {
    do { (pecx) = (req->transport_priv); do { if (!((pecx) != ((void *)0))) { VAS_Fail(__func__,
 "cache/cache_esi_deliver.c"
# 368 "cache/cache_esi_deliver.c"
    ,
 369
# 368 "cache/cache_esi_deliver.c"
    , "(pecx) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((pecx))->magic == (0x0b0f9163))) { VAS_Fail(__func__,
 "cache/cache_esi_deliver.c"
# 368 "cache/cache_esi_deliver.c"
    ,
 369
# 368 "cache/cache_esi_deliver.c"
    , "((pecx))->magic == (0x0b0f9163)", VAS_ASSERT); } } while (0); } while (0); } while (0)
                  ;
    pecx->crc = crc32_combine(pecx->crc,
        ecx->crc, ecx->l_crc);
    pecx->l_crc += ecx->l_crc;
   }
   retval = VDP_bytes(req, VDP_FLUSH, ((void *)0), 0);
   ecx->state = 99;
   return (retval);
  case 3:
  case 4:
  ...
  case 99:
   ...
   return (retval);
  default:
   do { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 404, "FOO", VAS_WRONG); } while (0);
   break;
  }
  if (retval)
   return (retval);
    ...
    const void *pv, ssize_t l)
{
 ...
 do { do { if (!((req) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 452, "(req) != NULL", VAS_ASSERT); } } while (0); do { if (!((req)->magic == 0x2751aaa1)) { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 452, "(req)->magic == 0x2751aaa1", VAS_ASSERT); } } while (0); } while (0);
 do { (ecx) = (*priv); do { if (!((ecx) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 453, "(ecx) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((ecx))->magic == (0x0b0f9163))) { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 453, "((ecx))->magic == (0x0b0f9163)", VAS_ASSERT); } } while (0); } while (0); } while (0);
 preq = ecx->preq;
 ...
 return (ved_bytes(req, preq, VDP_FLUSH, ((void *)0), 0));
}
# 519 "cache/cache_esi_deliver.c"
struct ved_foo {
 unsigned magic;
...
ved_objiterate(void *priv, int flush, const void *ptr, ssize_t len)
{
 ...
 do { (foo) = (priv); do { if (!((foo) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 539, "(foo) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((foo))->magic == (0x6a5a262d))) { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 539, "((foo))->magic == (0x6a5a262d)", VAS_ASSERT); } } while (0); } while (0); } while (0);
 (void)flush;
 pp = ptr;
 if (len > 0) {
 ...
 if (len > 0 && (foo->stop & 7) && foo->ll == foo->stop / 8) {
  ...
  case 0:
  default:
   do { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 643, "compiler must be broken", VAS_WRONG); } while (0);
  }
 ...
 if (len > 0) {
  ...
  dl = foo->olen - foo->ll;
  do { if (!(dl >= 0)) { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 652, "dl >= 0", VAS_ASSERT); } } while (0);
  if (dl > len)
   dl = len;
  if (dl > 0) {
   do { if (!(dl <= 8)) { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 656, "dl <= 8", VAS_ASSERT); } } while (0);
   l = foo->ll - (foo->olen - 8);
   do { if (!(l >= 0)) { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 658, "l >= 0", VAS_ASSERT); } } while (0);
   do { if (!(l <= 8)) { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 659, "l <= 8", VAS_ASSERT); } } while (0);
   do { if (!(l + dl <= 8)) { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 660, "l + dl <= 8", VAS_ASSERT); } } while (0);
   memcpy(foo->tailbuf + l, pp, dl);
   foo->ll += dl;
   len -= dl;
  }
 }
 do { if (!(len == 0)) { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 666, "len == 0", VAS_ASSERT); } } while (0);
 return (0);
}
...
ved_stripgzip(struct req *req, struct busyobj *bo)
{
 ...
 do { do { if (!((req) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 681, "(req) != NULL", VAS_ASSERT); } } while (0); do { if (!((req)->magic == 0x2751aaa1)) { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 681, "(req)->magic == 0x2751aaa1", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((req->objcore) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 682, "(req->objcore) != NULL", VAS_ASSERT); } } while (0); do { if (!((req->objcore)->magic == 0x4d301302)) { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 682, "(req->objcore)->magic == 0x4d301302", VAS_ASSERT); } } while (0); } while (0);
 do { (ecx) = (req->transport_priv); do { if (!((ecx) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 683, "(ecx) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((ecx))->magic == (0x0b0f9163))) { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 683, "((ecx))->magic == (0x0b0f9163)", VAS_ASSERT); } } while (0); } while (0); } while (0);

 do { (void)memset(&foo, 0, sizeof *&foo); (&foo)->magic = (0x6a5a262d); } while (0);
 foo.req = req;
 foo.preq = ecx->preq;
 ...
 do { do { if (!((ObjCheckFlag(req->wrk, req->objcore, OF_GZIPED)) != 0)) { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 694, "(ObjCheckFlag(req->wrk, req->objcore, OF_GZIPED)) != 0", VAS_ASSERT); } } while (0); } while (0);
 ...
 do { do { if (!((p) != 0)) { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 703, "(p) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { if (!(l == 32)) { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 704, "l == 32", VAS_ASSERT); } } while (0);
 foo.start = vbe64dec(p);
 foo.last = vbe64dec(p + 8);
 foo.stop = vbe64dec(p + 16);
 foo.olen = ObjGetLen(req->wrk, req->objcore);
 do { if (!(foo.start > 0 && foo.start < foo.olen * 8)) { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 709, "foo.start > 0 && foo.start < foo.olen * 8", VAS_ASSERT); } } while (0);
 do { if (!(foo.last > 0 && foo.last < foo.olen * 8)) { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 710, "foo.last > 0 && foo.last < foo.olen * 8", VAS_ASSERT); } } while (0);
 do { if (!(foo.stop > 0 && foo.stop < foo.olen * 8)) { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 711, "foo.stop > 0 && foo.stop < foo.olen * 8", VAS_ASSERT); } } while (0);
 do { if (!(foo.last >= foo.start)) { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 712, "foo.last >= foo.start", VAS_ASSERT); } } while (0);
 do { if (!(foo.last < foo.stop)) { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 713, "foo.last < foo.stop", VAS_ASSERT); } } while (0);


 do { do { if (!((foo.start & 7) == 0)) { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 716, "(foo.start & 7) == 0", VAS_ASSERT); } } while (0); } while (0);

 dbits = WS_Alloc(req->ws, 8);
 do { do { if (!((dbits) != 0)) { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 719, "(dbits) != 0", VAS_ASSERT); } } while (0); } while (0);
 foo.dbits = dbits;
 (void)ObjIterate(req->wrk, req->objcore, &foo, ved_objiterate);

 (void)ved_bytes(req, foo.preq, VDP_FLUSH, ((void *)0), 0);
    ...
    const void *ptr, ssize_t len)
{
 ...
 do { do { if (!((req) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 740, "(req) != NULL", VAS_ASSERT); } } while (0); do { if (!((req)->magic == 0x2751aaa1)) { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 740, "(req)->magic == 0x2751aaa1", VAS_ASSERT); } } while (0); } while (0);
 if (act == VDP_INIT)
  return (0);
 if (act == VDP_FINI) {
  *priv = ((void *)0);
 ...
 do { (preq) = (*priv); do { if (!((preq) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 747, "(preq) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((preq))->magic == (0x2751aaa1))) { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 747, "((preq))->magic == (0x2751aaa1)", VAS_ASSERT); } } while (0); } while (0); } while (0);
...
VED_Deliver(struct req *req, struct busyobj *bo, int wantbody)
{
 ...
 do { do { if (!((req) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 759, "(req) != NULL", VAS_ASSERT); } } while (0); do { if (!((req)->magic == 0x2751aaa1)) { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 759, "(req)->magic == 0x2751aaa1", VAS_ASSERT); } } while (0); } while (0);
 do { if ((bo) != ((void *)0)) do { if (!((bo)->magic == 0x23b95567)) { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 760, "(bo)->magic == 0x23b95567", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((req->objcore) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 761, "(req->objcore) != NULL", VAS_ASSERT); } } while (0); do { if (!((req->objcore)->magic == 0x4d301302)) { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 761, "(req->objcore)->magic == 0x4d301302", VAS_ASSERT); } } while (0); } while (0);

 do { (ecx) = (req->transport_priv); do { if (!((ecx) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 763, "(ecx) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((ecx))->magic == (0x0b0f9163))) { VAS_Fail(__func__, "cache/cache_esi_deliver.c", 763, "((ecx))->magic == (0x0b0f9163)", VAS_ASSERT); } } while (0); } while (0); } while (0);
 ...
 if (ecx->isgzip && i && !(req->res_mode & (1<<4))) {
