...
vcc_ErrToken(const struct vcc *tl, const struct token *t)
{
 ...
 if (t->tok == 131)
  ...
  VSB_printf(tl->sb, "'%.*s'", (int)((t)->e - (t)->b), (t)->b);
}
...
vcc_ErrWhere2(struct vcc *tl, const struct token *t, const struct token *t2)
{
 ...
 vcc_iline(t, &l1, 0);
 t2 = (*(((struct tokenhead *)((t2)->list.vtqe_prev))->vtqh_last));
 vcc_iline(t2, &l2, 1);
 ...
 if (l1 == l2) {
  ...
  l3 = (__extension__ (__builtin_constant_p ('\n') && !__builtin_constant_p (l1) && ('\n') == '\0' ? (char *) __rawmemchr (l1, '\n') : __builtin_strchr (l1, '\n')));
  do { do { if (!((l3) != 0)) { VAS_Fail(__func__, "vcc_token.c", 211, "(l3) != 0", VAS_ASSERT); } } while (0); } while (0);
...
vcc_IdIs(const struct token *t, const char *p)
{
 ...
 do { if (!(t->tok == 132)) { VAS_Fail(__func__, "vcc_token.c", 283, "t->tok == ID", VAS_ASSERT); } } while (0);
...
vcc_isCid(const struct token *t)
{
 ...
 do { if (!(t->tok == 132)) { VAS_Fail(__func__, "vcc_token.c", 301, "t->tok == ID", VAS_ASSERT); } } while (0);
 for (q = t->b; q < t->e; q++) {
...
vcc_ExpectCid(struct vcc *tl)
{
 ...
 do { vcc__Expect(tl, 132, 313); do { if ((tl)->err) return; } while (0);} while (0);
...
vcc_decstr(struct vcc *tl)
{
 ...
 do { if (!(tl->t->tok == 130)) { VAS_Fail(__func__, "vcc_token.c", 334, "tl->t->tok == CSTR", VAS_ASSERT); } } while (0);
 l = (tl->t->e - tl->t->b) - 2;
 tl->t->dec = TlAlloc(tl, l + 1);
 do { if (!(tl->t->dec != ((void *)0))) { VAS_Fail(__func__, "vcc_token.c", 337, "tl->t->dec != NULL", VAS_ASSERT); } } while (0);
 q = tl->t->dec;
 memcpy(q, tl->t->b + 1, l);
 q[l] = '\0';
 return (0);
...
vcc_AddToken(struct vcc *tl, unsigned tok, const char *b, const char *e)
{
 ...
 do { if (!(t != ((void *)0))) { VAS_Fail(__func__, "vcc_token.c", 354, "t != NULL", VAS_ASSERT); } } while (0);
 t->tok = tok;
 t->b = b;
 t->e = e;
 t->src = tl->src;
 if (tl->t != ((void *)0))
  do { if (((((t))->list.vtqe_next) = (((tl->t))->list.vtqe_next)) != ((void *)0)) (((t))->list.vtqe_next)->list.vtqe_prev = &(((t))->list.vtqe_next); else { (&tl->tokens)->vtqh_last = &(((t))->list.vtqe_next); } (((tl->t))->list.vtqe_next) = (t); (t)->list.vtqe_prev = &(((tl->t))->list.vtqe_next); } while (0);
 else
  do { (((t))->list.vtqe_next) = ((void *)0); (t)->list.vtqe_prev = (&tl->tokens)->vtqh_last; *(&tl->tokens)->vtqh_last = (t); (&tl->tokens)->vtqh_last = &(((t))->list.vtqe_next); } while (0);
 tl->t = t;
}
 ...
 for (p = sp->b; p < sp->e; ) {
  ...
  if (*p == '/' && p[1] == '*') {
   for (q = p + 2; q < sp->e; q++) {
    if (*q == '/' && q[1] == '*') {
     VSB_printf(tl->sb,
         "/* ... */ comment contains /*\n");
     vcc_AddToken(tl, 131, p, p + 2);
     vcc_ErrWhere(tl, tl->t);
     vcc_AddToken(tl, 131, q, q + 2);
     vcc_ErrWhere(tl, tl->t);
     return;
    }
    if (*q == '*' && q[1] == '/') {
  ...
  if (*p == '{' && p[1] == '"') {
   ...
   if (q < sp->e) {
    ...
    do { do { if (!((tl->t->dec) != 0)) { VAS_Fail(__func__, "vcc_token.c", 457, "(tl->t->dec) != 0", VAS_ASSERT); } } while (0); } while (0);
  ...
  if ((((*__ctype_b_loc ())[(int) ((*p))] & (unsigned short int) _ISalpha))) {
   for (q = p; q < sp->e; q++)
    if (!((((*__ctype_b_loc ())[(int) ((*q))] & (unsigned short int) _ISalpha) || ((*__ctype_b_loc ())[(int) ((*q))] & (unsigned short int) _ISdigit) || (*q) == '_' || (*q) == '-') || (*q) == '.'))
     break;
   vcc_AddToken(tl, 132, p, q);
   p = q;
   continue;
  }
  ...
  if (((*__ctype_b_loc ())[(int) ((*p))] & (unsigned short int) _ISdigit)) {
   for (q = p; q < sp->e; q++)
    if (!((*__ctype_b_loc ())[(int) ((*q))] & (unsigned short int) _ISdigit))
     break;
   vcc_AddToken(tl, 128, p, q);
   p = q;
   continue;
  }
  vcc_AddToken(tl, 131, p, p + 1);
