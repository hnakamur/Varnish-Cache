...
# 1 "<command-line>" 2
# 1 "cache/cache_req_body.c"
# 31 "cache/cache_req_body.c"
# 1 "../../config.h" 1
# 32 "cache/cache_req_body.c" 2
...
# 40 "cache/cache_req_body.c" 2
# 50 "cache/cache_req_body.c"
int
VRB_Iterate(struct req *req, objiterate_f *func, void *priv)
{
 ...
 do { do { if (!((req) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_req_body.c", 60, "(req) != NULL", VAS_ASSERT); } } while (0); do { if (!((req)->magic == 0x2751aaa1)) { VAS_Fail(__func__, "cache/cache_req_body.c", 60, "(req)->magic == 0x2751aaa1", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((func) != 0)) { VAS_Fail(__func__, "cache/cache_req_body.c", 61, "(func) != 0", VAS_ASSERT); } } while (0); } while (0);
 ...
 case REQ_BODY_FAIL:
  ...
  return (-1);
 default:
  do { VAS_Fail(__func__, "cache/cache_req_body.c", 83, "Wrong req_body_status in VRB_IterateReqBody()", VAS_WRONG); } while (0);
 }
 Lck__Lock(&req->sp->mtx, __func__, 85);
 if (req->req_body_status == REQ_BODY_WITH_LEN ||
  ...
  i = -1;
 Lck__Unlock(&req->sp->mtx, __func__, 92);
 if (i) {
  VSLb(req->vsl, SLT_VCL_Error,
 ...
 do { do { if (!((req->htc) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_req_body.c", 99, "(req->htc) != NULL", VAS_ASSERT); } } while (0); do { if (!((req->htc)->magic == 0x3e19edd1)) { VAS_Fail(__func__, "cache/cache_req_body.c", 99, "(req->htc)->magic == 0x3e19edd1", VAS_ASSERT); } } while (0); } while (0);
 vfc = req->htc->vfc;
 VFP_Setup(vfc);
 vfc->http = req->http;
 vfc->wrk = req->wrk;
...
VRB_Ignore(struct req *req)
{
 ...
 do { do { if (!((req) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_req_body.c", 155, "(req) != NULL", VAS_ASSERT); } } while (0); do { if (!((req)->magic == 0x2751aaa1)) { VAS_Fail(__func__, "cache/cache_req_body.c", 155, "(req)->magic == 0x2751aaa1", VAS_ASSERT); } } while (0); } while (0);

 if (req->req_body_status == REQ_BODY_WITH_LEN ||
     req->req_body_status == REQ_BODY_WITHOUT_LEN)
  (void)VRB_Iterate(req, httpq_req_body_discard, ((void *)0));
 return(0);
}
...
VRB_Free(struct req *req)
{
 ...
 do { do { if (!((req) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_req_body.c", 170, "(req) != NULL", VAS_ASSERT); } } while (0); do { if (!((req)->magic == 0x2751aaa1)) { VAS_Fail(__func__, "cache/cache_req_body.c", 170, "(req)->magic == 0x2751aaa1", VAS_ASSERT); } } while (0); } while (0);

 if (req->body_oc != ((void *)0))
  do { do { if (!((HSH_DerefObjCore(req->wrk, &req->body_oc)) == 0)) { VAS_Fail(__func__, "cache/cache_req_body.c", 173, "(HSH_DerefObjCore(req->wrk, &req->body_oc)) == 0", VAS_ASSERT); } } while (0); } while (0);
}
# 183 "cache/cache_req_body.c"
ssize_t
VRB_Cache(struct req *req, ssize_t maxsize)
{
 ...
 do { do { if (!((req) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_req_body.c", 191, "(req) != NULL", VAS_ASSERT); } } while (0); do { if (!((req)->magic == 0x2751aaa1)) { VAS_Fail(__func__, "cache/cache_req_body.c", 191, "(req)->magic == 0x2751aaa1", VAS_ASSERT); } } while (0); } while (0);

 do { if (!(req->req_step == R_STP_RECV)) { VAS_Fail(__func__, "cache/cache_req_body.c", 193, "req->req_step == R_STP_RECV", VAS_ASSERT); } } while (0);
 switch(req->req_body_status) {
 case REQ_BODY_CACHED:
 ...
 case REQ_BODY_WITH_LEN:
  break;
 default:
  do { VAS_Fail(__func__, "cache/cache_req_body.c", 205, "Wrong req_body_status in VRB_Cache()", VAS_WRONG); } while (0);
 }

 do { do { if (!((req->htc) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_req_body.c", 208, "(req->htc) != NULL", VAS_ASSERT); } } while (0); do { if (!((req->htc)->magic == 0x3e19edd1)) { VAS_Fail(__func__, "cache/cache_req_body.c", 208, "(req->htc)->magic == 0x3e19edd1", VAS_ASSERT); } } while (0); } while (0);
 vfc = req->htc->vfc;
 VFP_Setup(vfc);
 vfc->wrk = req->wrk;
 ...
 do { do { if (!((req->body_oc) != 0)) { VAS_Fail(__func__, "cache/cache_req_body.c", 220, "(req->body_oc) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((STV_NewObject(req->wrk, req->body_oc, "Transient", 8)) != 0)) { VAS_Fail(__func__, "cache/cache_req_body.c", 221, "(STV_NewObject(req->wrk, req->body_oc, \"Transient\", 8)) != 0", VAS_MISSING); } } while (0); } while (0);
 ...
 do { do { if (!((req->req_bodybytes) == 0)) { VAS_Fail(__func__, "cache/cache_req_body.c", 232, "(req->req_bodybytes) == 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((req->htc) != 0)) { VAS_Fail(__func__, "cache/cache_req_body.c", 233, "(req->htc) != 0", VAS_ASSERT); } } while (0); } while (0);
 yet = req->htc->content_length;
 if (yet < 0)
  yet = 0;
 do {
  do { do { if (!((vfc->failed) == 0)) { VAS_Fail(__func__, "cache/cache_req_body.c", 238, "(vfc->failed) == 0", VAS_ASSERT); } } while (0); } while (0);
  ...
  if (VFP_GetStorage(vfc, &l, &ptr) != VFP_OK)
   break;
  do { do { if (!((vfc->failed) == 0)) { VAS_Fail(__func__, "cache/cache_req_body.c", 248, "(vfc->failed) == 0", VAS_ASSERT); } } while (0); } while (0);
  do { do { if (!((ptr) != 0)) { VAS_Fail(__func__, "cache/cache_req_body.c", 249, "(ptr) != 0", VAS_ASSERT); } } while (0); } while (0);
  do { do { if (!((l) != 0)) { VAS_Fail(__func__, "cache/cache_req_body.c", 250, "(l) != 0", VAS_ASSERT); } } while (0); } while (0);
 ...
 if (vfps == VFP_END) {
  do { if (!(req->req_bodybytes >= 0)) { VAS_Fail(__func__, "cache/cache_req_body.c", 270, "req->req_bodybytes >= 0", VAS_ASSERT); } } while (0);
