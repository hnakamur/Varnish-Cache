...
# 24 "/usr/include/bits/syslog.h" 3 4
...
# 46 "vmod_std.c" 2
# 1 "../../bin/varnishd/cache/cache_director.h" 1
# 46 "../../bin/varnishd/cache/cache_director.h"
...
vmod_set_ip_tos(const struct vrt_ctx *ctx, VCL_INT tos)
{
 ...
 do { do { if (!((ctx) != ((void *)0))) { VAS_Fail(__func__, "vmod_std.c", 55, "(ctx) != NULL", VAS_ASSERT); } } while (0); do { if (!((ctx)->magic == 0x6bb8f0db)) { VAS_Fail(__func__, "vmod_std.c", 55, "(ctx)->magic == 0x6bb8f0db", VAS_ASSERT); } } while (0); } while (0);
 do { if (!(VTCP_Check(setsockopt(ctx->req->sp->fd, IPPROTO_IP, 1, &itos, sizeof(itos))))) { VAS_Fail(__func__,
 "vmod_std.c"
# 56 "vmod_std.c"
 ,
 57
# 56 "vmod_std.c"
 , "VTCP_Check(setsockopt(ctx->req->sp->fd, IPPROTO_IP, 1, &itos, sizeof(itos)))", VAS_ASSERT); } } while (0)
                                              ;
}
...
vmod_updown(const struct vrt_ctx *ctx, int up, const char *s, va_list ap)
{
 ...
 do { do { if (!((ctx) != ((void *)0))) { VAS_Fail(__func__, "vmod_std.c", 67, "(ctx) != NULL", VAS_ASSERT); } } while (0); do { if (!((ctx)->magic == 0x6bb8f0db)) { VAS_Fail(__func__, "vmod_std.c", 67, "(ctx)->magic == 0x6bb8f0db", VAS_ASSERT); } } while (0); } while (0);
 ...
 while (p != vrt_magic_string_end && b < e) {
  if (p != ((void *)0)) {
   for (; b < e && *p != '\0'; p++)
    if (up)
     *b++ = (char)(__extension__ ({ int __res; if (sizeof (*p) > 1) { if (__builtin_constant_p (*p)) { int __c = (*p); __res = __c < -128 || __c > 255 ? __c : (*__ctype_toupper_loc ())[__c]; } else __res = toupper (*p); } else __res = (*__ctype_toupper_loc ())[(int) (*p)]; __res; }));
    else
     *b++ = (char)(__extension__ ({ int __res; if (sizeof (*p) > 1) { if (__builtin_constant_p (*p)) { int __c = (*p); __res = __c < -128 || __c > 255 ? __c : (*__ctype_tolower_loc ())[__c]; } else __res = tolower (*p); } else __res = (*__ctype_tolower_loc ())[(int) (*p)]; __res; }));
  }
...
vmod_toupper(const struct vrt_ctx *ctx, const char *s, ...)
{
 ...
 do { do { if (!((ctx) != ((void *)0))) { VAS_Fail(__func__, "vmod_std.c", 102, "(ctx) != NULL", VAS_ASSERT); } } while (0); do { if (!((ctx)->magic == 0x6bb8f0db)) { VAS_Fail(__func__, "vmod_std.c", 102, "(ctx)->magic == 0x6bb8f0db", VAS_ASSERT); } } while (0); } while (0);
...
vmod_tolower(const struct vrt_ctx *ctx, const char *s, ...)
{
 ...
 do { do { if (!((ctx) != ((void *)0))) { VAS_Fail(__func__, "vmod_std.c", 115, "(ctx) != NULL", VAS_ASSERT); } } while (0); do { if (!((ctx)->magic == 0x6bb8f0db)) { VAS_Fail(__func__, "vmod_std.c", 115, "(ctx)->magic == 0x6bb8f0db", VAS_ASSERT); } } while (0); } while (0);
 __builtin_va_start(ap,s);
...
vmod_random(const struct vrt_ctx *ctx, VCL_REAL lo, VCL_REAL hi)
{
 ...
 do { do { if (!((ctx) != ((void *)0))) { VAS_Fail(__func__, "vmod_std.c", 127, "(ctx) != NULL", VAS_ASSERT); } } while (0); do { if (!((ctx)->magic == 0x6bb8f0db)) { VAS_Fail(__func__, "vmod_std.c", 127, "(ctx)->magic == 0x6bb8f0db", VAS_ASSERT); } } while (0); } while (0);
 a = drand48();
 a *= hi - lo;
 a += lo;
 return (a);
...
vmod_log(const struct vrt_ctx *ctx, const char *fmt, ...)
{
 ...
 do { do { if (!((ctx) != ((void *)0))) { VAS_Fail(__func__, "vmod_std.c", 141, "(ctx) != NULL", VAS_ASSERT); } } while (0); do { if (!((ctx)->magic == 0x6bb8f0db)) { VAS_Fail(__func__, "vmod_std.c", 141, "(ctx)->magic == 0x6bb8f0db", VAS_ASSERT); } } while (0); } while (0);
 u = WS_Reserve(ctx->ws, 0);
 t.b = ctx->ws->f;
 ...
 __builtin_va_end(ap);
 if (t.e != ((void *)0)) {
  do { if (!(t.e > t.b)) { VAS_Fail(__func__, "vmod_std.c", 148, "t.e > t.b", VAS_ASSERT); } } while (0);
  t.e--;
...
vmod_syslog(const struct vrt_ctx *ctx, VCL_INT fac, const char *fmt, ...)
{
 ...
 do { do { if (!((ctx) != ((void *)0))) { VAS_Fail(__func__, "vmod_std.c", 162, "(ctx) != NULL", VAS_ASSERT); } } while (0); do { if (!((ctx)->magic == 0x6bb8f0db)) { VAS_Fail(__func__, "vmod_std.c", 162, "(ctx)->magic == 0x6bb8f0db", VAS_ASSERT); } } while (0); } while (0);
 u = WS_Reserve(ctx->ws, 0);
 t.b = ctx->ws->f;
 __builtin_va_start(ap,fmt);
 t.e = VRT_StringList(ctx->ws->f, u, fmt, ap);
...
vmod_collect(const struct vrt_ctx *ctx, VCL_HEADER hdr)
{
 ...
 do { do { if (!((ctx) != ((void *)0))) { VAS_Fail(__func__, "vmod_std.c", 178, "(ctx) != NULL", VAS_ASSERT); } } while (0); do { if (!((ctx)->magic == 0x6bb8f0db)) { VAS_Fail(__func__, "vmod_std.c", 178, "(ctx)->magic == 0x6bb8f0db", VAS_ASSERT); } } while (0); } while (0);
...
{
 do { do { if (!((ctx) != ((void *)0))) { VAS_Fail(__func__, "vmod_std.c", 186, "(ctx) != NULL", VAS_ASSERT); } } while (0); do { if (!((ctx)->magic == 0x6bb8f0db)) { VAS_Fail(__func__, "vmod_std.c", 186, "(ctx)->magic == 0x6bb8f0db", VAS_ASSERT); } } while (0); } while (0);
 if (be == ((void *)0))
  return (0);
 do { do { if (!((be) != ((void *)0))) { VAS_Fail(__func__, "vmod_std.c", 189, "(be) != NULL", VAS_ASSERT); } } while (0); do { if (!((be)->magic == 0x3336351d)) { VAS_Fail(__func__, "vmod_std.c", 189, "(be)->magic == 0x3336351d", VAS_ASSERT); } } while (0); } while (0);
...
{
 do { do { if (!((ctx) != ((void *)0))) { VAS_Fail(__func__, "vmod_std.c", 196, "(ctx) != NULL", VAS_ASSERT); } } while (0); do { if (!((ctx)->magic == 0x6bb8f0db)) { VAS_Fail(__func__, "vmod_std.c", 196, "(ctx)->magic == 0x6bb8f0db", VAS_ASSERT); } } while (0); } while (0);
 if (ip == ((void *)0))
  return (0);
 return (VSA_Port(ip));
}
...
vmod_timestamp(const struct vrt_ctx *ctx, VCL_STRING label)
{
 ...
 do { do { if (!((ctx) != ((void *)0))) { VAS_Fail(__func__, "vmod_std.c", 212, "(ctx) != NULL", VAS_ASSERT); } } while (0); do { if (!((ctx)->magic == 0x6bb8f0db)) { VAS_Fail(__func__, "vmod_std.c", 212, "(ctx)->magic == 0x6bb8f0db", VAS_ASSERT); } } while (0); } while (0);
 if (label == ((void *)0))
  return;
 if (*label == '\0')
  return;
 if (ctx->bo != ((void *)0) && ctx->req == ((void *)0)) {

  do { do { if (!((ctx->bo) != ((void *)0))) { VAS_Fail(__func__, "vmod_std.c", 219, "(ctx->bo) != NULL", VAS_ASSERT); } } while (0); do { if (!((ctx->bo)->magic == 0x23b95567)) { VAS_Fail(__func__, "vmod_std.c", 219, "(ctx->bo)->magic == 0x23b95567", VAS_ASSERT); } } while (0); } while (0);
  VSLb_ts_busyobj(ctx->bo, label, VTIM_real());
 } else if (ctx->req != ((void *)0)) {

  do { do { if (!((ctx->req) != ((void *)0))) { VAS_Fail(__func__, "vmod_std.c", 223, "(ctx->req) != NULL", VAS_ASSERT); } } while (0); do { if (!((ctx->req)->magic == 0x2751aaa1)) { VAS_Fail(__func__, "vmod_std.c", 223, "(ctx->req)->magic == 0x2751aaa1", VAS_ASSERT); } } while (0); } while (0);
...
vmod_cache_req_body(const struct vrt_ctx *ctx, VCL_BYTES size)
{
 ...
 do { do { if (!((ctx) != ((void *)0))) { VAS_Fail(__func__, "vmod_std.c", 234, "(ctx) != NULL", VAS_ASSERT); } } while (0); do { if (!((ctx)->magic == 0x6bb8f0db)) { VAS_Fail(__func__, "vmod_std.c", 234, "(ctx)->magic == 0x6bb8f0db", VAS_ASSERT); } } while (0); } while (0);
 if (size < 0)
  size = 0;
 ss = (ssize_t)size;
...
VCL_STRING
vmod_strstr(const struct vrt_ctx *ctx, VCL_STRING s1, VCL_STRING s2)
{
 do { do { if (!((ctx) != ((void *)0))) { VAS_Fail(__func__, "vmod_std.c", 245, "(ctx) != NULL", VAS_ASSERT); } } while (0); do { if (!((ctx)->magic == 0x6bb8f0db)) { VAS_Fail(__func__, "vmod_std.c", 245, "(ctx)->magic == 0x6bb8f0db", VAS_ASSERT); } } while (0); } while (0);
