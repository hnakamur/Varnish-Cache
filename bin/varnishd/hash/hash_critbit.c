...
# 1 "<command-line>" 2
# 1 "hash/hash_critbit.c"
# 33 "hash/hash_critbit.c"
# 1 "../../config.h" 1
# 34 "hash/hash_critbit.c" 2
...
# 41 "hash/hash_critbit.c" 2
# 1 "../../include/vmb.h" 1
# 42 "hash/hash_critbit.c" 2
# 1 "../../include/vtim.h" 1
# 33 "../../include/vtim.h"
...
# 43 "hash/hash_critbit.c" 2

static struct lock hcb_mtx;
# 55 "hash/hash_critbit.c"
...
hcb_build_bittbl(void)
{
 ...
 do { if (!(hcb_bits(0x34, 0x34) == 8)) { VAS_Fail(__func__, "hash/hash_critbit.c", 75, "hcb_bits(0x34, 0x34) == 8", VAS_ASSERT); } } while (0);
 do { do { if (!((hcb_bits(0xaa, 0x55)) == 0)) { VAS_Fail(__func__, "hash/hash_critbit.c", 76, "(hcb_bits(0xaa, 0x55)) == 0", VAS_ASSERT); } } while (0); } while (0);
 do { if (!(hcb_bits(0x01, 0x22) == 2)) { VAS_Fail(__func__, "hash/hash_critbit.c", 77, "hcb_bits(0x01, 0x22) == 2", VAS_ASSERT); } } while (0);
 do { if (!(hcb_bits(0x10, 0x0b) == 3)) { VAS_Fail(__func__, "hash/hash_critbit.c", 78, "hcb_bits(0x10, 0x0b) == 3", VAS_ASSERT); } } while (0);
}
# 90 "hash/hash_critbit.c"
struct hcb_y {
 unsigned magic;
 ...
 struct { struct hcb_y *vstqe_next; } list;
};
...
static struct { struct hcb_y *vstqh_first; struct hcb_y **vstqh_last; } cool_y = { ((void *)0), &(cool_y).vstqh_first };
static struct { struct hcb_y *vstqh_first; struct hcb_y **vstqh_last; } dead_y = { ((void *)0), &(dead_y).vstqh_first };
static struct { struct objhead *vtqh_first; struct objhead **vtqh_last; } cool_h = { ((void *)0), &(cool_h).vtqh_first, };
static struct { struct objhead *vtqh_first; struct objhead **vtqh_last; } dead_h = { ((void *)0), &(dead_h).vtqh_first, };
...
hcb_r_node(struct objhead *n)
{
 ...
 do { do { if (!(((uintptr_t)n & ((1<<0) | (1<<1))) == 0)) { VAS_Fail(__func__, "hash/hash_critbit.c", 135, "((uintptr_t)n & ((1<<0) | (1<<1))) == 0", VAS_ASSERT); } } while (0); } while (0);
 return ((1<<0) | (uintptr_t)n);
}
...
hcb_l_node(uintptr_t u)
{
 ...
 do { if (!(u & (1<<0))) { VAS_Fail(__func__, "hash/hash_critbit.c", 143, "u & HCB_BIT_NODE", VAS_ASSERT); } } while (0);
 do { do { if (!((u & (1<<1)) == 0)) { VAS_Fail(__func__, "hash/hash_critbit.c", 144, "(u & (1<<1)) == 0", VAS_ASSERT); } } while (0); } while (0);
 return ((struct objhead *)(u & ~(1<<0)));
}
...
hcb_r_y(struct hcb_y *y)
{
 ...
 do { do { if (!((y) != ((void *)0))) { VAS_Fail(__func__, "hash/hash_critbit.c", 152, "(y) != NULL", VAS_ASSERT); } } while (0); do { if (!((y)->magic == 0x125c4bd2)) { VAS_Fail(__func__, "hash/hash_critbit.c", 152, "(y)->magic == 0x125c4bd2", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!(((uintptr_t)y & ((1<<0) | (1<<1))) == 0)) { VAS_Fail(__func__, "hash/hash_critbit.c", 153, "((uintptr_t)y & ((1<<0) | (1<<1))) == 0", VAS_ASSERT); } } while (0); } while (0);
 return ((1<<1) | (uintptr_t)y);
}
...
hcb_l_y(uintptr_t u)
{
 ...
 do { do { if (!((u & (1<<0)) == 0)) { VAS_Fail(__func__, "hash/hash_critbit.c", 161, "(u & (1<<0)) == 0", VAS_ASSERT); } } while (0); } while (0);
 do { if (!(u & (1<<1))) { VAS_Fail(__func__, "hash/hash_critbit.c", 162, "u & HCB_BIT_Y", VAS_ASSERT); } } while (0);
 return ((struct hcb_y *)(u & ~(1<<1)));
}
...
hcb_crit_bit(const uint8_t *digest, const struct objhead *oh2, struct hcb_y *y)
{
 ...
 do { do { if (!((y) != ((void *)0))) { VAS_Fail(__func__, "hash/hash_critbit.c", 175, "(y) != NULL", VAS_ASSERT); } } while (0); do { if (!((y)->magic == 0x125c4bd2)) { VAS_Fail(__func__, "hash/hash_critbit.c", 175, "(y)->magic == 0x125c4bd2", VAS_ASSERT); } } while (0); } while (0);
 for (u = 0; u < 32 && digest[u] == oh2->digest[u]; u++)
  ;
 do { if (!(u < 32)) { VAS_Fail(__func__, "hash/hash_critbit.c", 178, "u < DIGEST_LEN", VAS_ASSERT); } } while (0);
    ...
    struct objhead **noh)
{
 ...
 while(hcb_is_y(pp)) {
  y = hcb_l_y(pp);
  do { do { if (!((y) != ((void *)0))) { VAS_Fail(__func__, "hash/hash_critbit.c", 216, "(y) != NULL", VAS_ASSERT); } } while (0); do { if (!((y)->magic == 0x125c4bd2)) { VAS_Fail(__func__, "hash/hash_critbit.c", 216, "(y)->magic == 0x125c4bd2", VAS_ASSERT); } } while (0); } while (0);
  do { if (!(y->ptr < 32)) { VAS_Fail(__func__, "hash/hash_critbit.c", 217, "y->ptr < DIGEST_LEN", VAS_ASSERT); } } while (0);
  s = (digest[y->ptr] & y->bitmask) != 0;
  do { if (!(s < 2)) { VAS_Fail(__func__, "hash/hash_critbit.c", 219, "s < 2", VAS_ASSERT); } } while (0);
  p = &y->leaf[s];
  pp = *p;
 }
 ...
 if (pp == 0) {
  ...
  do { if (!(noh == ((void *)0))) { VAS_Fail(__func__, "hash/hash_critbit.c", 226, "noh == NULL", VAS_ASSERT); } } while (0);
  return (((void *)0));
 }

 do { if (!(hcb_is_node(pp))) { VAS_Fail(__func__, "hash/hash_critbit.c", 230, "hcb_is_node(pp)", VAS_ASSERT); } } while (0);


 oh2 = hcb_l_node(pp);
 do { do { if (!((oh2) != ((void *)0))) { VAS_Fail(__func__, "hash/hash_critbit.c", 234, "(oh2) != NULL", VAS_ASSERT); } } while (0); do { if (!((oh2)->magic == 0x1b96615d)) { VAS_Fail(__func__, "hash/hash_critbit.c", 234, "(oh2)->magic == 0x1b96615d", VAS_ASSERT); } } while (0); } while (0);
 if (!memcmp(oh2->digest, digest, 32))
  return (oh2);
 ...
 do { (y2) = (wrk->nhashpriv); do { if (!((y2) != ((void *)0))) { VAS_Fail(__func__, "hash/hash_critbit.c", 243, "(y2) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((y2))->magic == (0x125c4bd2))) { VAS_Fail(__func__, "hash/hash_critbit.c", 243, "((y2))->magic == (0x125c4bd2)", VAS_ASSERT); } } while (0); } while (0); } while (0);
 wrk->nhashpriv = ((void *)0);
 (void)hcb_crit_bit(digest, oh2, y2);
 s2 = (digest[y2->ptr] & y2->bitmask) != 0;
 do { if (!(s2 < 2)) { VAS_Fail(__func__, "hash/hash_critbit.c", 247, "s2 < 2", VAS_ASSERT); } } while (0);
 oh2 = *noh;
 *noh = ((void *)0);
 memcpy(oh2->digest, digest, sizeof oh2->digest);
 ...
 p = &root->origo;
 do { do { if (!((*p) != 0)) { VAS_Fail(__func__, "hash/hash_critbit.c", 255, "(*p) != 0", VAS_ASSERT); } } while (0); } while (0);

 while(hcb_is_y(*p)) {
  y = hcb_l_y(*p);
  do { do { if (!((y) != ((void *)0))) { VAS_Fail(__func__, "hash/hash_critbit.c", 259, "(y) != NULL", VAS_ASSERT); } } while (0); do { if (!((y)->magic == 0x125c4bd2)) { VAS_Fail(__func__, "hash/hash_critbit.c", 259, "(y)->magic == 0x125c4bd2", VAS_ASSERT); } } while (0); } while (0);
  do { if (!(y->critbit != y2->critbit)) { VAS_Fail(__func__, "hash/hash_critbit.c", 260, "y->critbit != y2->critbit", VAS_ASSERT); } } while (0);
  if (y->critbit > y2->critbit)
   break;
  do { if (!(y->ptr < 32)) { VAS_Fail(__func__, "hash/hash_critbit.c", 263, "y->ptr < DIGEST_LEN", VAS_ASSERT); } } while (0);
  s = (digest[y->ptr] & y->bitmask) != 0;
  do { if (!(s < 2)) { VAS_Fail(__func__, "hash/hash_critbit.c", 265, "s < 2", VAS_ASSERT); } } while (0);
  p = &y->leaf[s];
 }
 y2->leaf[s2] = *p;
...
hcb_delete(struct hcb_root *r, struct objhead *oh)
{
 ...
 p = &r->origo;
 do { if (!(hcb_is_y(*p))) { VAS_Fail(__func__, "hash/hash_critbit.c", 288, "hcb_is_y(*p)", VAS_ASSERT); } } while (0);

 y = ((void *)0);
 while(1) {
  do { if (!(hcb_is_y(*p))) { VAS_Fail(__func__, "hash/hash_critbit.c", 292, "hcb_is_y(*p)", VAS_ASSERT); } } while (0);
  y = hcb_l_y(*p);
  do { if (!(y->ptr < 32)) { VAS_Fail(__func__, "hash/hash_critbit.c", 294, "y->ptr < DIGEST_LEN", VAS_ASSERT); } } while (0);
  s = (oh->digest[y->ptr] & y->bitmask) != 0;
  do { if (!(s < 2)) { VAS_Fail(__func__, "hash/hash_critbit.c", 296, "s < 2", VAS_ASSERT); } } while (0);
  if (y->leaf[s] == hcb_r_node(oh)) {
   *p = y->leaf[1 - s];
   do { (((y))->list.vstqe_next) = ((void *)0); *(&cool_y)->vstqh_last = (y); (&cool_y)->vstqh_last = &(((y))->list.vstqe_next); } while (0);
   return;
  }
  p = &y->leaf[s];
 }
...
dumptree(struct cli *cli, uintptr_t p, int indent)
{
 ...
 do { if (!(hcb_is_y(p))) { VAS_Fail(__func__, "hash/hash_critbit.c", 324, "hcb_is_y(p)", VAS_ASSERT); } } while (0);
 y = hcb_l_y(p);
...
hcb_cleaner(struct worker *wrk, void *priv)
{
 ...
 (void)priv;
 while (1) {
  for ((y) = (((&dead_y))->vstqh_first); (y) && ((y2) = (((y))->list.vstqe_next), 1); (y) = (y2)) {
   do { if (((((&dead_y))->vstqh_first) = (((((&dead_y))->vstqh_first))->list.vstqe_next)) == ((void *)0)) (&dead_y)->vstqh_last = &(((&dead_y))->vstqh_first); } while (0);
   do { (y)->magic = (0); free(y); y = ((void *)0); } while (0);
  }
  for ((oh) = (((&dead_h))->vtqh_first); (oh) && ((oh2) = (((oh))->_u.n.u_n_hoh_list.vtqe_next), 1); (oh) = (oh2)) {
   do { if (((((oh))->_u.n.u_n_hoh_list.vtqe_next)) != ((void *)0)) (((oh))->_u.n.u_n_hoh_list.vtqe_next)->_u.n.u_n_hoh_list.vtqe_prev = (oh)->_u.n.u_n_hoh_list.vtqe_prev; else { (&dead_h)->vtqh_last = (oh)->_u.n.u_n_hoh_list.vtqe_prev; } *(oh)->_u.n.u_n_hoh_list.vtqe_prev = (((oh))->_u.n.u_n_hoh_list.vtqe_next); ; ; } while (0);
   HSH_DeleteObjHead(wrk, oh);
  }
  Lck__Lock(&hcb_mtx, __func__, 368);
  do { if (!(((&cool_y))->vstqh_first == ((void *)0))) { *(&dead_y)->vstqh_last = (&cool_y)->vstqh_first; (&dead_y)->vstqh_last = (&cool_y)->vstqh_last; do { ((((&cool_y)))->vstqh_first) = ((void *)0); ((&cool_y))->vstqh_last = &((((&cool_y)))->vstqh_first); } while (0); } } while (0);
  do { if (!((&cool_h)->vtqh_first == ((void *)0))) { *(&dead_h)->vtqh_last = (&cool_h)->vtqh_first; (&cool_h)->vtqh_first->_u.n.u_n_hoh_list.vtqe_prev = (&dead_h)->vtqh_last; (&dead_h)->vtqh_last = (&cool_h)->vtqh_last; do { ((((&cool_h)))->vtqh_first) = ((void *)0); ((&cool_h))->vtqh_last = &((((&cool_h)))->vtqh_first); } while (0); } } while (0);
  Lck__Unlock(&hcb_mtx, __func__, 371);
  Pool_Sumstat(wrk);
...
hcb_start(void)
{
 struct objhead *oh = ((void *)0);
 pthread_t tp;

 (void)oh;
 CLI_AddFuncs(hcb_cmds);
 Lck__New(&hcb_mtx, lck_hcb, "lck_hcb");
 WRK_BgThread(&tp, "hcb-cleaner", hcb_cleaner, ((void *)0));
...
hcb_deref(struct objhead *oh)
{
 ...
 r = 1;
 do { do { if (!((oh) != ((void *)0))) { VAS_Fail(__func__, "hash/hash_critbit.c", 400, "(oh) != NULL", VAS_ASSERT); } } while (0); do { if (!((oh)->magic == 0x1b96615d)) { VAS_Fail(__func__, "hash/hash_critbit.c", 400, "(oh)->magic == 0x1b96615d", VAS_ASSERT); } } while (0); } while (0);
 Lck__Lock(&oh->mtx, __func__, 401);
 do { if (!(oh->refcnt > 0)) { VAS_Fail(__func__, "hash/hash_critbit.c", 402, "oh->refcnt > 0", VAS_ASSERT); } } while (0);
 oh->refcnt--;
 if (oh->refcnt == 0) {
  Lck__Lock(&hcb_mtx, __func__, 405);
  hcb_delete(&hcb_root, oh);
  do { (((oh))->_u.n.u_n_hoh_list.vtqe_next) = ((void *)0); (oh)->_u.n.u_n_hoh_list.vtqe_prev = (&cool_h)->vtqh_last; *(&cool_h)->vtqh_last = (oh); (&cool_h)->vtqh_last = &(((oh))->_u.n.u_n_hoh_list.vtqe_next); } while (0);
  Lck__Unlock(&hcb_mtx, __func__, 408);
  do { if (!(((&oh->objcs)->vtqh_first == ((void *)0)))) { VAS_Fail(__func__, "hash/hash_critbit.c", 409, "VTAILQ_EMPTY(&oh->objcs)", VAS_ASSERT); } } while (0);
  do { do { if (!((oh->waitinglist) == 0)) { VAS_Fail(__func__, "hash/hash_critbit.c", 410, "(oh->waitinglist) == 0", VAS_ASSERT); } } while (0); } while (0);
 }
 Lck__Unlock(&oh->mtx, __func__, 412);
...
hcb_lookup(struct worker *wrk, const void *digest, struct objhead **noh)
{
 ...
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "hash/hash_critbit.c", 426, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "hash/hash_critbit.c", 426, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((digest) != 0)) { VAS_Fail(__func__, "hash/hash_critbit.c", 427, "(digest) != 0", VAS_ASSERT); } } while (0); } while (0);
 if (noh != ((void *)0)) {
  do { do { if (!((*noh) != ((void *)0))) { VAS_Fail(__func__, "hash/hash_critbit.c", 429, "(*noh) != NULL", VAS_ASSERT); } } while (0); do { if (!((*noh)->magic == 0x1b96615d)) { VAS_Fail(__func__, "hash/hash_critbit.c", 429, "(*noh)->magic == 0x1b96615d", VAS_ASSERT); } } while (0); } while (0);
  do { if (!((*noh)->refcnt == 1)) { VAS_Fail(__func__, "hash/hash_critbit.c", 430, "(*noh)->refcnt == 1", VAS_ASSERT); } } while (0);
 }



 wrk->stats->hcb_nolock++;
 oh = hcb_insert(wrk, &hcb_root, digest, ((void *)0));
 if (oh != ((void *)0)) {
  Lck__Lock(&oh->mtx, __func__, 438);
  ...
  Lck__Unlock(&oh->mtx, __func__, 448);
 }

 while (1) {

  do { (y) = (wrk->nhashpriv); do { if (!((y) != ((void *)0))) { VAS_Fail(__func__, "hash/hash_critbit.c", 453, "(y) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((y))->magic == (0x125c4bd2))) { VAS_Fail(__func__, "hash/hash_critbit.c", 453, "((y))->magic == (0x125c4bd2)", VAS_ASSERT); } } while (0); } while (0); } while (0);
  Lck__Lock(&hcb_mtx, __func__, 454);
  VSC_C_main->hcb_lock++;
  oh = hcb_insert(wrk, &hcb_root, digest, noh);
  Lck__Unlock(&hcb_mtx, __func__, 457);

  if (oh == ((void *)0))
   return (((void *)0));

  Lck__Lock(&oh->mtx, __func__, 462);

  do { do { if (!((oh) != ((void *)0))) { VAS_Fail(__func__, "hash/hash_critbit.c", 464, "(oh) != NULL", VAS_ASSERT); } } while (0); do { if (!((oh)->magic == 0x1b96615d)) { VAS_Fail(__func__, "hash/hash_critbit.c", 464, "(oh)->magic == 0x1b96615d", VAS_ASSERT); } } while (0); } while (0);
  if (noh != ((void *)0) && *noh == ((void *)0)) {
   do { if (!(oh->refcnt > 0)) { VAS_Fail(__func__, "hash/hash_critbit.c", 466, "oh->refcnt > 0", VAS_ASSERT); } } while (0);
  ...
  Lck__Unlock(&oh->mtx, __func__, 479);
 }
}
...
hcb_prep(struct worker *wrk)
{
 ...
 if (wrk->nhashpriv == ((void *)0)) {
  do { (y) = calloc(sizeof *(y), 1); if ((y) != ((void *)0)) (y)->magic = (0x125c4bd2); } while (0);
  do { do { if (!((y) != 0)) { VAS_Fail(__func__, "hash/hash_critbit.c", 490, "(y) != 0", VAS_ASSERT); } } while (0); } while (0);
  wrk->nhashpriv = y;
 }
}
