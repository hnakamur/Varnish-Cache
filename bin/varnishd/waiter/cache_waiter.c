...
# 1 "<command-line>" 2
# 1 "waiter/cache_waiter.c"
# 31 "waiter/cache_waiter.c"
# 1 "../../config.h" 1
# 32 "waiter/cache_waiter.c" 2
...
# 40 "waiter/cache_waiter.c" 2

# 1 "./waiter/waiter_priv.h" 1
# 32 "./waiter/waiter_priv.h"
struct waited;
struct binheap;
...
struct waiter {
 ...
 struct { struct waiter *vtqe_next; struct waiter **vtqe_prev; } list;
 struct { struct waited *vtqh_first; struct waited **vtqh_last; } waithead;
...
{
 do { if ((wp) != ((void *)0)) do { if (!((wp)->magic == 0x1743992d)) { VAS_Fail(__func__, "./waiter/waiter_priv.h", 64, "(wp)->magic == 0x1743992d", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((wp->waitfor) != ((void *)0))) { VAS_Fail(__func__, "./waiter/waiter_priv.h", 65, "(wp->waitfor) != NULL", VAS_ASSERT); } } while (0); do { if (!((wp->waitfor)->magic == 0x16b79246)) { VAS_Fail(__func__, "./waiter/waiter_priv.h", 65, "(wp->waitfor)->magic == 0x16b79246", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((wp->waitfor->tmo) != 0)) { VAS_Fail(__func__, "./waiter/waiter_priv.h", 66, "(wp->waitfor->tmo) != 0", VAS_ASSERT); } } while (0); } while (0);
...
{
 do { if ((wp) != ((void *)0)) do { if (!((wp)->magic == 0x1743992d)) { VAS_Fail(__func__, "./waiter/waiter_priv.h", 73, "(wp)->magic == 0x1743992d", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((wp->waitfor) != ((void *)0))) { VAS_Fail(__func__, "./waiter/waiter_priv.h", 74, "(wp->waitfor) != NULL", VAS_ASSERT); } } while (0); do { if (!((wp->waitfor)->magic == 0x16b79246)) { VAS_Fail(__func__, "./waiter/waiter_priv.h", 74, "(wp->waitfor)->magic == 0x16b79246", VAS_ASSERT); } } while (0); } while (0);
...
# 42 "waiter/cache_waiter.c" 2
# 1 "./waiter/mgt_waiter.h" 1
# 32 "./waiter/mgt_waiter.h"
struct waiter_impl;
...
waited_cmp(void *priv, const void *a, const void *b)
{
 ...
 do { (ww) = (priv); do { if (!((ww) != ((void *)0))) { VAS_Fail(__func__, "waiter/cache_waiter.c", 50, "(ww) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((ww))->magic == (0x17c399db))) { VAS_Fail(__func__, "waiter/cache_waiter.c", 50, "((ww))->magic == (0x17c399db)", VAS_ASSERT); } } while (0); } while (0); } while (0);
 do { (aa) = (a); do { if (!((aa) != ((void *)0))) { VAS_Fail(__func__, "waiter/cache_waiter.c", 51, "(aa) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((aa))->magic == (0x1743992d))) { VAS_Fail(__func__, "waiter/cache_waiter.c", 51, "((aa))->magic == (0x1743992d)", VAS_ASSERT); } } while (0); } while (0); } while (0);
 do { (bb) = (b); do { if (!((bb) != ((void *)0))) { VAS_Fail(__func__, "waiter/cache_waiter.c", 52, "(bb) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((bb))->magic == (0x1743992d))) { VAS_Fail(__func__, "waiter/cache_waiter.c", 52, "((bb))->magic == (0x1743992d)", VAS_ASSERT); } } while (0); } while (0); } while (0);
...
waited_update(void *priv, void *p, unsigned u)
{
 ...
 (void)priv;
 do { (pp) = (p); do { if (!((pp) != ((void *)0))) { VAS_Fail(__func__, "waiter/cache_waiter.c", 63, "(pp) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((pp))->magic == (0x1743992d))) { VAS_Fail(__func__, "waiter/cache_waiter.c", 63, "((pp))->magic == (0x1743992d)", VAS_ASSERT); } } while (0); } while (0); } while (0);
 pp->idx = u;
}
...
Wait_Call(const struct waiter *w, struct waited *wp,
    enum wait_event ev, double now)
{
 do { do { if (!((w) != ((void *)0))) { VAS_Fail(__func__, "waiter/cache_waiter.c", 73, "(w) != NULL", VAS_ASSERT); } } while (0); do { if (!((w)->magic == 0x17c399db)) { VAS_Fail(__func__, "waiter/cache_waiter.c", 73, "(w)->magic == 0x17c399db", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((wp) != ((void *)0))) { VAS_Fail(__func__, "waiter/cache_waiter.c", 74, "(wp) != NULL", VAS_ASSERT); } } while (0); do { if (!((wp)->magic == 0x1743992d)) { VAS_Fail(__func__, "waiter/cache_waiter.c", 74, "(wp)->magic == 0x1743992d", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((wp->waitfor) != ((void *)0))) { VAS_Fail(__func__, "waiter/cache_waiter.c", 75, "(wp->waitfor) != NULL", VAS_ASSERT); } } while (0); do { if (!((wp->waitfor)->magic == 0x16b79246)) { VAS_Fail(__func__, "waiter/cache_waiter.c", 75, "(wp->waitfor)->magic == 0x16b79246", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((wp->waitfor->func) != 0)) { VAS_Fail(__func__, "waiter/cache_waiter.c", 76, "(wp->waitfor->func) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { if (!(wp->idx == 0)) { VAS_Fail(__func__, "waiter/cache_waiter.c", 77, "wp->idx == BINHEAP_NOIDX", VAS_ASSERT); } } while (0);
...
{
 do { do { if (!((w) != ((void *)0))) { VAS_Fail(__func__, "waiter/cache_waiter.c", 86, "(w) != NULL", VAS_ASSERT); } } while (0); do { if (!((w)->magic == 0x17c399db)) { VAS_Fail(__func__, "waiter/cache_waiter.c", 86, "(w)->magic == 0x17c399db", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((wp) != ((void *)0))) { VAS_Fail(__func__, "waiter/cache_waiter.c", 87, "(wp) != NULL", VAS_ASSERT); } } while (0); do { if (!((wp)->magic == 0x1743992d)) { VAS_Fail(__func__, "waiter/cache_waiter.c", 87, "(wp)->magic == 0x1743992d", VAS_ASSERT); } } while (0); } while (0);
 do { if (!(wp->idx == 0)) { VAS_Fail(__func__, "waiter/cache_waiter.c", 88, "wp->idx == BINHEAP_NOIDX", VAS_ASSERT); } } while (0);
 binheap_insert(w->heap, wp);
}
# 100 "waiter/cache_waiter.c"
void
Wait_HeapDelete(const struct waiter *w, const struct waited *wp)
{
 do { do { if (!((w) != ((void *)0))) { VAS_Fail(__func__, "waiter/cache_waiter.c", 103, "(w) != NULL", VAS_ASSERT); } } while (0); do { if (!((w)->magic == 0x17c399db)) { VAS_Fail(__func__, "waiter/cache_waiter.c", 103, "(w)->magic == 0x17c399db", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((wp) != ((void *)0))) { VAS_Fail(__func__, "waiter/cache_waiter.c", 104, "(wp) != NULL", VAS_ASSERT); } } while (0); do { if (!((wp)->magic == 0x1743992d)) { VAS_Fail(__func__, "waiter/cache_waiter.c", 104, "(wp)->magic == 0x1743992d", VAS_ASSERT); } } while (0); } while (0);
 if (wp->idx != 0)
...
Wait_HeapDue(const struct waiter *w, struct waited **wpp)
{
 ...
 do { if ((wp) != ((void *)0)) do { if (!((wp)->magic == 0x1743992d)) { VAS_Fail(__func__, "waiter/cache_waiter.c", 115, "(wp)->magic == 0x1743992d", VAS_ASSERT); } } while (0); } while (0);
 if (wp == ((void *)0)) {
  if (wpp != ((void *)0))
   *wpp = ((void *)0);
  return (0);
...
Wait_Enter(const struct waiter *w, struct waited *wp)
{
 ...
 do { do { if (!((w) != ((void *)0))) { VAS_Fail(__func__, "waiter/cache_waiter.c", 132, "(w) != NULL", VAS_ASSERT); } } while (0); do { if (!((w)->magic == 0x17c399db)) { VAS_Fail(__func__, "waiter/cache_waiter.c", 132, "(w)->magic == 0x17c399db", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((wp) != ((void *)0))) { VAS_Fail(__func__, "waiter/cache_waiter.c", 133, "(wp) != NULL", VAS_ASSERT); } } while (0); do { if (!((wp)->magic == 0x1743992d)) { VAS_Fail(__func__, "waiter/cache_waiter.c", 133, "(wp)->magic == 0x1743992d", VAS_ASSERT); } } while (0); } while (0);
 do { if (!(wp->fd > 0)) { VAS_Fail(__func__, "waiter/cache_waiter.c", 134, "wp->fd > 0", VAS_ASSERT); } } while (0);
 do { do { if (!((wp->waitfor) != ((void *)0))) { VAS_Fail(__func__, "waiter/cache_waiter.c", 135, "(wp->waitfor) != NULL", VAS_ASSERT); } } while (0); do { if (!((wp->waitfor)->magic == 0x16b79246)) { VAS_Fail(__func__, "waiter/cache_waiter.c", 135, "(wp->waitfor)->magic == 0x16b79246", VAS_ASSERT); } } while (0); } while (0);
 wp->idx = 0;
...
Waiter_New(void)
{
 ...
 do { do { if (!((waiter) != 0)) { VAS_Fail(__func__, "waiter/cache_waiter.c", 157, "(waiter) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((waiter->name) != 0)) { VAS_Fail(__func__, "waiter/cache_waiter.c", 158, "(waiter->name) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((waiter->init) != 0)) { VAS_Fail(__func__, "waiter/cache_waiter.c", 159, "(waiter->init) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((waiter->enter) != 0)) { VAS_Fail(__func__, "waiter/cache_waiter.c", 160, "(waiter->enter) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((waiter->fini) != 0)) { VAS_Fail(__func__, "waiter/cache_waiter.c", 161, "(waiter->fini) != 0", VAS_ASSERT); } } while (0); } while (0);

 w = calloc(1, sizeof (struct waiter) + waiter->size);
 do { do { if (!((w) != 0)) { VAS_Fail(__func__, "waiter/cache_waiter.c", 164, "(w) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { (void)memset(w, 0, sizeof *w); (w)->magic = (0x17c399db); } while (0);
 w->priv = (void*)(w + 1);
 w->impl = waiter;
 do { (((&w->waithead))->vtqh_first) = ((void *)0); (&w->waithead)->vtqh_last = &(((&w->waithead))->vtqh_first); } while (0);
...
Waiter_Destroy(struct waiter **wp)
{
 ...
 do { do { if (!((wp) != 0)) { VAS_Fail(__func__, "waiter/cache_waiter.c", 181, "(wp) != 0", VAS_ASSERT); } } while (0); } while (0);
 w = *wp;
 *wp = ((void *)0);
 do { do { if (!((w) != ((void *)0))) { VAS_Fail(__func__, "waiter/cache_waiter.c", 184, "(w) != NULL", VAS_ASSERT); } } while (0); do { if (!((w)->magic == 0x17c399db)) { VAS_Fail(__func__, "waiter/cache_waiter.c", 184, "(w)->magic == 0x17c399db", VAS_ASSERT); } } while (0); } while (0);

 do { do { if (!((binheap_root(w->heap)) == 0)) { VAS_Fail(__func__, "waiter/cache_waiter.c", 186, "(binheap_root(w->heap)) == 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((w->impl->fini) != 0)) { VAS_Fail(__func__, "waiter/cache_waiter.c", 187, "(w->impl->fini) != 0", VAS_ASSERT); } } while (0); } while (0);
 w->impl->fini(w);
 do { (w)->magic = (0); free(w); w = ((void *)0); } while (0);
}
