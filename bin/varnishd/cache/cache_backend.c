...
# 1 "<command-line>" 2
# 1 "cache/cache_backend.c"
# 33 "cache/cache_backend.c"
# 1 "../../config.h" 1
# 34 "cache/cache_backend.c" 2
...
# 46 "cache/cache_backend.c" 2
# 61 "cache/cache_backend.c"
static struct vbc *
vbe_dir_getfd(struct worker *wrk, struct backend *bp, struct busyobj *bo)
{
 ...
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend.c", 69, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "cache/cache_backend.c", 69, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((bo) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend.c", 70, "(bo) != NULL", VAS_ASSERT); } } while (0); do { if (!((bo)->magic == 0x23b95567)) { VAS_Fail(__func__, "cache/cache_backend.c", 70, "(bo)->magic == 0x23b95567", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((bp) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend.c", 71, "(bp) != NULL", VAS_ASSERT); } } while (0); do { if (!((bp)->magic == 0x64c4c7c6)) { VAS_Fail(__func__, "cache/cache_backend.c", 71, "(bp)->magic == 0x64c4c7c6", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((bp->vsc) != 0)) { VAS_Fail(__func__, "cache/cache_backend.c", 72, "(bp->vsc) != 0", VAS_ASSERT); } } while (0); } while (0);

 if (!VBE_Healthy(bp, ((void *)0))) {
 ...
 do { do { if (!((bo->htc) == 0)) { VAS_Fail(__func__, "cache/cache_backend.c", 86, "(bo->htc) == 0", VAS_ASSERT); } } while (0); } while (0);
 ...
 do { do { do { if (!((bo) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend.c", 93, "(bo) != NULL", VAS_ASSERT); } } while (0); do { if (!((bo)->magic == 0x23b95567)) { VAS_Fail(__func__, "cache/cache_backend.c", 93, "(bo)->magic == 0x23b95567", VAS_ASSERT); } } while (0); } while (0); tmod = bo->connect_timeout; if (tmod == 0.0) tmod = bp->connect_timeout; if (tmod == 0.0) tmod = cache_param->connect_timeout; } while (0);
 ...
 do { if (!(vc->fd >= 0)) { VAS_Fail(__func__, "cache/cache_backend.c", 102, "vc->fd >= 0", VAS_ASSERT); } } while (0);
 do { do { if (!((vc->addr) != 0)) { VAS_Fail(__func__, "cache/cache_backend.c", 103, "(vc->addr) != 0", VAS_ASSERT); } } while (0); } while (0);

 Lck__Lock(&bp->mtx, __func__, 105);
 bp->n_conn++;
 bp->vsc->conn++;
 bp->vsc->req++;
 Lck__Unlock(&bp->mtx, __func__, 109);
 ...
 do { (void)memset(bo->htc, 0, sizeof *bo->htc); (bo->htc)->magic = (0x3e19edd1); } while (0);
 bo->htc->priv = vc;
 bo->htc->fd = vc->fd;
 do { do { do { if (!((bo) != ((void *)0))) { VAS_Fail(__func__,
 "cache/cache_backend.c"
# 119 "cache/cache_backend.c"
 ,
 120
# 119 "cache/cache_backend.c"
 , "(bo) != NULL", VAS_ASSERT); } } while (0); do { if (!((bo)->magic == 0x23b95567)) { VAS_Fail(__func__,
 "cache/cache_backend.c"
# 119 "cache/cache_backend.c"
 ,
 120
# 119 "cache/cache_backend.c"
 , "(bo)->magic == 0x23b95567", VAS_ASSERT); } } while (0); } while (0); bo->htc->first_byte_timeout = bo->first_byte_timeout; if (bo->htc->first_byte_timeout == 0.0) bo->htc->first_byte_timeout = bp->first_byte_timeout; if (bo->htc->first_byte_timeout == 0.0) bo->htc->first_byte_timeout = cache_param->first_byte_timeout; } while (0)
                                         ;
 do { do { do { if (!((bo) != ((void *)0))) { VAS_Fail(__func__,
 "cache/cache_backend.c"
# 121 "cache/cache_backend.c"
 ,
 122
# 121 "cache/cache_backend.c"
 , "(bo) != NULL", VAS_ASSERT); } } while (0); do { if (!((bo)->magic == 0x23b95567)) { VAS_Fail(__func__,
...
# 121 "cache/cache_backend.c"
 ...
 122
# 121 "cache/cache_backend.c"
 , "(bo)->magic == 0x23b95567", VAS_ASSERT); } } while (0); } while (0); bo->htc->between_bytes_timeout = bo->between_bytes_timeout; if (bo->htc->between_bytes_timeout == 0.0) bo->htc->between_bytes_timeout = bp->between_bytes_timeout; if (bo->htc->between_bytes_timeout == 0.0) bo->htc->between_bytes_timeout = cache_param->between_bytes_timeout; } while (0)
                                            ;
 return (vc);
}
    ...
    double *changed)
{
 ...
 do { do { if (!((d) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend.c", 132, "(d) != NULL", VAS_ASSERT); } } while (0); do { if (!((d)->magic == 0x3336351d)) { VAS_Fail(__func__, "cache/cache_backend.c", 132, "(d)->magic == 0x3336351d", VAS_ASSERT); } } while (0); } while (0);
 do { if ((bo) != ((void *)0)) do { if (!((bo)->magic == 0x23b95567)) { VAS_Fail(__func__, "cache/cache_backend.c", 133, "(bo)->magic == 0x23b95567", VAS_ASSERT); } } while (0); } while (0);
 do { (be) = (d->priv); do { if (!((be) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend.c", 134, "(be) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((be))->magic == (0x64c4c7c6))) { VAS_Fail(__func__, "cache/cache_backend.c", 134, "((be))->magic == (0x64c4c7c6)", VAS_ASSERT); } } while (0); } while (0); } while (0);
    ...
    struct busyobj *bo)
{
 ...
 do { do { if (!((d) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend.c", 145, "(d) != NULL", VAS_ASSERT); } } while (0); do { if (!((d)->magic == 0x3336351d)) { VAS_Fail(__func__, "cache/cache_backend.c", 145, "(d)->magic == 0x3336351d", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend.c", 146, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "cache/cache_backend.c", 146, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((bo) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend.c", 147, "(bo) != NULL", VAS_ASSERT); } } while (0); do { if (!((bo)->magic == 0x23b95567)) { VAS_Fail(__func__, "cache/cache_backend.c", 147, "(bo)->magic == 0x23b95567", VAS_ASSERT); } } while (0); } while (0);
 do { (bp) = (d->priv); do { if (!((bp) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend.c", 148, "(bp) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((bp))->magic == (0x64c4c7c6))) { VAS_Fail(__func__, "cache/cache_backend.c", 148, "((bp))->magic == (0x64c4c7c6)", VAS_ASSERT); } } while (0); } while (0); } while (0);

 do { do { if (!((bo->htc) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend.c", 150, "(bo->htc) != NULL", VAS_ASSERT); } } while (0); do { if (!((bo->htc)->magic == 0x3e19edd1)) { VAS_Fail(__func__, "cache/cache_backend.c", 150, "(bo->htc)->magic == 0x3e19edd1", VAS_ASSERT); } } while (0); } while (0);
 do { (vbc) = (bo->htc->priv); do { if (!((vbc) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend.c", 151, "(vbc) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((vbc))->magic == (0x0c5e6592))) { VAS_Fail(__func__, "cache/cache_backend.c", 151, "((vbc))->magic == (0x0c5e6592)", VAS_ASSERT); } } while (0); } while (0); } while (0);
 bo->htc->priv = ((void *)0);
 if (vbc->state != (1<<1))
  VBT_Wait(wrk, vbc);
 if (bo->htc->doclose != SC_NULL) {
  ...
  Lck__Lock(&bp->mtx, __func__, 159);
 } else {
  VSLb(bo->vsl, SLT_BackendReuse, "%d %s", vbc->fd,
      bp->display_name);
  Lck__Lock(&bp->mtx, __func__, 163);
  VSC_C_main->backend_recycle++;
  VBT_Recycle(wrk, bp->tcp_pool, &vbc);
 }
 do { if (!(bp->n_conn > 0)) { VAS_Fail(__func__, "cache/cache_backend.c", 167, "bp->n_conn > 0", VAS_ASSERT); } } while (0);
 bp->n_conn--;

# 1 "../../include/tbl/acct_fields_bereq.h" 1
# 33 "../../include/tbl/acct_fields_bereq.h"
bp->vsc->bereq_hdrbytes += bo->acct.bereq_hdrbytes;
bp->vsc->bereq_bodybytes += bo->acct.bereq_bodybytes;
bp->vsc->beresp_hdrbytes += bo->acct.beresp_hdrbytes;
bp->vsc->beresp_bodybytes += bo->acct.beresp_bodybytes;
# 171 "cache/cache_backend.c" 2

 Lck__Unlock(&bp->mtx, __func__, 172);
 bo->htc = ((void *)0);
}
    ...
    struct busyobj *bo)
{
 ...
 do { do { if (!((d) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend.c", 184, "(d) != NULL", VAS_ASSERT); } } while (0); do { if (!((d)->magic == 0x3336351d)) { VAS_Fail(__func__, "cache/cache_backend.c", 184, "(d)->magic == 0x3336351d", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend.c", 185, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "cache/cache_backend.c", 185, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((bo) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend.c", 186, "(bo) != NULL", VAS_ASSERT); } } while (0); do { if (!((bo)->magic == 0x23b95567)) { VAS_Fail(__func__, "cache/cache_backend.c", 186, "(bo)->magic == 0x23b95567", VAS_ASSERT); } } while (0); } while (0);
 do { (bp) = (d->priv); do { if (!((bp) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend.c", 187, "(bp) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((bp))->magic == (0x64c4c7c6))) { VAS_Fail(__func__, "cache/cache_backend.c", 187, "((bp))->magic == (0x64c4c7c6)", VAS_ASSERT); } } while (0); } while (0); } while (0);
 ...
 if (!http_GetHdr(bo->bereq, H_Host, ((void *)0)) && bp->hosthdr != ((void *)0))
 ...
 do {
  ...
  do { do { if (!((bo->htc) != 0)) { VAS_Fail(__func__, "cache/cache_backend.c", 203, "(bo->htc) != 0", VAS_ASSERT); } } while (0); } while (0);
  if (vbc->state != (1<<2))
   extrachance = 0;
  ...
  do { if (!(vbc->state == (1<<1))) { VAS_Fail(__func__, "cache/cache_backend.c", 212, "vbc->state == VBC_STATE_USED", VAS_ASSERT); } } while (0);

  if (i == 0)
   i = V1F_FetchRespHdr(bo);
  if (i == 0) {
   do { do { if (!((bo->htc->priv) != 0)) { VAS_Fail(__func__, "cache/cache_backend.c", 217, "(bo->htc->priv) != 0", VAS_ASSERT); } } while (0); } while (0);
   return (0);
  }
  ...
  do { do { if (!((bo->htc) == 0)) { VAS_Fail(__func__, "cache/cache_backend.c", 227, "(bo->htc) == 0", VAS_ASSERT); } } while (0); } while (0);
  if (i < 0)
   break;
  if (bo->req != ((void *)0) &&
    ...
    struct busyobj *bo)
{
 ...
 do { do { if (!((d) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend.c", 244, "(d) != NULL", VAS_ASSERT); } } while (0); do { if (!((d)->magic == 0x3336351d)) { VAS_Fail(__func__, "cache/cache_backend.c", 244, "(d)->magic == 0x3336351d", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend.c", 245, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "cache/cache_backend.c", 245, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((bo) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend.c", 246, "(bo) != NULL", VAS_ASSERT); } } while (0); do { if (!((bo)->magic == 0x23b95567)) { VAS_Fail(__func__, "cache/cache_backend.c", 246, "(bo)->magic == 0x23b95567", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((bo->vfc) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend.c", 247, "(bo->vfc) != NULL", VAS_ASSERT); } } while (0); do { if (!((bo->vfc)->magic == 0x61d9d3e5)) { VAS_Fail(__func__, "cache/cache_backend.c", 247, "(bo->vfc)->magic == 0x61d9d3e5", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((bo->htc) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend.c", 248, "(bo->htc) != NULL", VAS_ASSERT); } } while (0); do { if (!((bo->htc)->magic == 0x3e19edd1)) { VAS_Fail(__func__, "cache/cache_backend.c", 248, "(bo->htc)->magic == 0x3e19edd1", VAS_ASSERT); } } while (0); } while (0);
    ...
    struct busyobj *bo)
{
 ...
 do { do { if (!((d) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend.c", 260, "(d) != NULL", VAS_ASSERT); } } while (0); do { if (!((d)->magic == 0x3336351d)) { VAS_Fail(__func__, "cache/cache_backend.c", 260, "(d)->magic == 0x3336351d", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend.c", 261, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "cache/cache_backend.c", 261, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((bo) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend.c", 262, "(bo) != NULL", VAS_ASSERT); } } while (0); do { if (!((bo)->magic == 0x23b95567)) { VAS_Fail(__func__, "cache/cache_backend.c", 262, "(bo)->magic == 0x23b95567", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((bo->htc) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend.c", 263, "(bo->htc) != NULL", VAS_ASSERT); } } while (0); do { if (!((bo->htc)->magic == 0x3e19edd1)) { VAS_Fail(__func__, "cache/cache_backend.c", 263, "(bo->htc)->magic == 0x3e19edd1", VAS_ASSERT); } } while (0); } while (0);
 do { (vbc) = (bo->htc->priv); do { if (!((vbc) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend.c", 264, "(vbc) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((vbc))->magic == (0x0c5e6592))) { VAS_Fail(__func__, "cache/cache_backend.c", 264, "((vbc))->magic == (0x0c5e6592)", VAS_ASSERT); } } while (0); } while (0); } while (0);
...
vbe_dir_http1pipe(const struct director *d, struct req *req, struct busyobj *bo)
{
 ...
 do { do { if (!((d) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend.c", 279, "(d) != NULL", VAS_ASSERT); } } while (0); do { if (!((d)->magic == 0x3336351d)) { VAS_Fail(__func__, "cache/cache_backend.c", 279, "(d)->magic == 0x3336351d", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((req) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend.c", 280, "(req) != NULL", VAS_ASSERT); } } while (0); do { if (!((req)->magic == 0x2751aaa1)) { VAS_Fail(__func__, "cache/cache_backend.c", 280, "(req)->magic == 0x2751aaa1", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((bo) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend.c", 281, "(bo) != NULL", VAS_ASSERT); } } while (0); do { if (!((bo)->magic == 0x23b95567)) { VAS_Fail(__func__, "cache/cache_backend.c", 281, "(bo)->magic == 0x23b95567", VAS_ASSERT); } } while (0); } while (0);
 do { (bp) = (d->priv); do { if (!((bp) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend.c", 282, "(bp) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((bp))->magic == (0x64c4c7c6))) { VAS_Fail(__func__, "cache/cache_backend.c", 282, "((bp))->magic == (0x64c4c7c6)", VAS_ASSERT); } } while (0); } while (0); } while (0);
 ...
 if (vbc == ((void *)0)) {
  ...
  VSLb_ts_req(req, "Pipe", ((req->wrk)->lastused = VTIM_real()));
  if (vbc->state == (1<<2))
   VBT_Wait(req->wrk, vbc);
  if (i == 0)
   V1P_Process(req, vbc->fd, &v1a);
  VSLb_ts_req(req, "PipeSess", ((req->wrk)->lastused = VTIM_real()));
...
vbe_panic(const struct director *d, struct vsb *vsb)
{
 ...
 do { do { if (!((d) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend.c", 319, "(d) != NULL", VAS_ASSERT); } } while (0); do { if (!((d)->magic == 0x3336351d)) { VAS_Fail(__func__, "cache/cache_backend.c", 319, "(d)->magic == 0x3336351d", VAS_ASSERT); } } while (0); } while (0);
 do { (bp) = (d->priv); do { if (!((bp) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend.c", 320, "(bp) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((bp))->magic == (0x64c4c7c6))) { VAS_Fail(__func__, "cache/cache_backend.c", 320, "((bp))->magic == (0x64c4c7c6)", VAS_ASSERT); } } while (0); } while (0); } while (0);

 VSB_printf(vsb, "display_name = %s,\n", bp->display_name);
 if (bp->ipv4_addr != ((void *)0))
  VSB_printf(vsb, "ipv4 = %s,\n", bp->ipv4_addr);
 if (bp->ipv6_addr != ((void *)0))
...
VBE_fill_director(struct backend *be)
{
 ...
 do { do { if (!((be) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_backend.c", 342, "(be) != NULL", VAS_ASSERT); } } while (0); do { if (!((be)->magic == 0x64c4c7c6)) { VAS_Fail(__func__, "cache/cache_backend.c", 342, "(be)->magic == 0x64c4c7c6", VAS_ASSERT); } } while (0); } while (0);

 do { (void)memset(be->director, 0, sizeof *be->director); (be->director)->magic = (0x3336351d); } while (0);
 d = be->director;
 d->priv = be;
 d->name = "backend";
