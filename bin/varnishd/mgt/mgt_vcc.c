...
run_vcc(void *priv)
{
 ...
 do { (vp) = (priv); do { if (!((vp) != ((void *)0))) { VAS_Fail(__func__, "mgt/mgt_vcc.c", 91, "(vp) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((vp))->magic == (0x70080cb8))) { VAS_Fail(__func__, "mgt/mgt_vcc.c", 91, "((vp))->magic == (0x70080cb8)", VAS_ASSERT); } } while (0); } while (0); } while (0);

 do { do { if (!((chdir(vp->dir)) == 0)) { VAS_Fail(__func__, "mgt/mgt_vcc.c", 93, "(chdir(vp->dir)) == 0", VAS_ASSERT); } } while (0); } while (0);

 sb = VSB_new(((void *)0), ((void *)0), 0, 0x00000001);
 do { do { if (!((sb) != 0)) { VAS_Fail(__func__, "mgt/mgt_vcc.c", 96, "(sb) != 0", VAS_MISSING); } } while (0); } while (0);
 ...
 do { do { if (!((VSB_finish(sb)) == 0)) { VAS_Fail(__func__, "mgt/mgt_vcc.c", 103, "(VSB_finish(sb)) == 0", VAS_ASSERT); } } while (0); } while (0);
 if (VSB_len(sb))
 ...
 fd = open("vgc.c", 01|01000|0100, 0600);
 if (fd < 0) {
 ...
 do { do { if (!((close(fd)) == 0)) { VAS_Fail(__func__, "mgt/mgt_vcc.c", 121, "(close(fd)) == 0", VAS_ASSERT); } } while (0); } while (0);
 free(csrc);
 exit(0);
}
...
run_cc(void *priv)
{
 ...
 do { (vp) = (priv); do { if (!((vp) != ((void *)0))) { VAS_Fail(__func__, "mgt/mgt_vcc.c", 139, "(vp) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((vp))->magic == (0x70080cb8))) { VAS_Fail(__func__, "mgt/mgt_vcc.c", 139, "((vp))->magic == (0x70080cb8)", VAS_ASSERT); } } while (0); } while (0); } while (0);

 do { do { if (!((chdir(vp->dir)) == 0)) { VAS_Fail(__func__, "mgt/mgt_vcc.c", 141, "(chdir(vp->dir)) == 0", VAS_ASSERT); } } while (0); } while (0);

 sb = VSB_new(((void *)0), ((void *)0), 0, 0x00000001);
 do { do { if (!((sb) != 0)) { VAS_Fail(__func__, "mgt/mgt_vcc.c", 144, "(sb) != 0", VAS_ASSERT); } } while (0); } while (0);
 ...
 if (pct)
  VSB_putc(sb, '%');
 do { do { if (!((VSB_finish(sb)) == 0)) { VAS_Fail(__func__, "mgt/mgt_vcc.c", 171, "(VSB_finish(sb)) == 0", VAS_ASSERT); } } while (0); } while (0);
...
run_dlopen(void *priv)
{
 ...
 do { (vp) = (priv); do { if (!((vp) != ((void *)0))) { VAS_Fail(__func__, "mgt/mgt_vcc.c", 188, "(vp) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((vp))->magic == (0x70080cb8))) { VAS_Fail(__func__, "mgt/mgt_vcc.c", 188, "((vp))->magic == (0x70080cb8)", VAS_ASSERT); } } while (0); } while (0); } while (0);
...
mgt_vcc_touchfile(const char *fn, struct vsb *sb)
{
 ...
 i = open(fn, 01|0100|01000, 0640);
 if (i < 0) {
  VSB_printf(sb, "Failed to create %s: %s", fn, strerror((*__errno_location ())));
  return (2);
 }
 ...
 do { do { if (!((close(i)) == 0)) { VAS_Fail(__func__, "mgt/mgt_vcc.c", 212, "(close(i)) == 0", VAS_ASSERT); } } while (0); } while (0);
 return (0);
}
...
mgt_vcc_compile(struct vcc_priv *vp, struct vsb *sb, int C_flag)
{
 ...
 if (C_flag) {
  csrc = VFIL_readfile(((void *)0), vp->srcfile, ((void *)0));
  do { do { if (!((csrc) != 0)) { VAS_Fail(__func__, "mgt/mgt_vcc.c", 237, "(csrc) != 0", VAS_ASSERT); } } while (0); } while (0);
  VSB_cat(sb, csrc);
  free(csrc);
 }
    ...
    int C_flag)
{
 ...
 do { do { if (!((cli) != 0)) { VAS_Fail(__func__, "mgt/mgt_vcc.c", 260, "(cli) != 0", VAS_ASSERT); } } while (0); } while (0);

 sb = VSB_new(((void *)0), ((void *)0), 0, 0x00000001);
 do { do { if (!((sb) != 0)) { VAS_Fail(__func__, "mgt/mgt_vcc.c", 263, "(sb) != 0", VAS_MISSING); } } while (0); } while (0);

 do { (void)memset(&vp, 0, sizeof *&vp); (&vp)->magic = (0x70080cb8); } while (0);
 vp.src = vclsrc;

 VSB_printf(sb, "vcl_%s", vclname);
 do { do { if (!((VSB_finish(sb)) == 0)) { VAS_Fail(__func__, "mgt/mgt_vcc.c", 269, "(VSB_finish(sb)) == 0", VAS_ASSERT); } } while (0); } while (0);
 vp.dir = (__extension__ (__builtin_constant_p (VSB_data(sb)) && ((size_t)(const void *)((VSB_data(sb)) + 1) - (size_t)(const void *)(VSB_data(sb)) == 1) ? (((const char *) (VSB_data(sb)))[0] == '\0' ? (char *) calloc ((size_t) 1, (size_t) 1) : ({ size_t __len = strlen (VSB_data(sb)) + 1; char *__retval = (char *) malloc (__len); if (__retval != ((void *)0)) __retval = (char *) memcpy (__retval, VSB_data(sb), __len); __retval; })) : __strdup (VSB_data(sb))));
 do { do { if (!((vp.dir) != 0)) { VAS_Fail(__func__, "mgt/mgt_vcc.c", 271, "(vp.dir) != 0", VAS_ASSERT); } } while (0); } while (0);
 VJ_make_vcldir(vp.dir);


 VSB_clear(sb);
 VSB_printf(sb, "%s/%s", vp.dir, "vgc.c");
 do { do { if (!((VSB_finish(sb)) == 0)) { VAS_Fail(__func__, "mgt/mgt_vcc.c", 277, "(VSB_finish(sb)) == 0", VAS_ASSERT); } } while (0); } while (0);
 vp.srcfile = (__extension__ (__builtin_constant_p (VSB_data(sb)) && ((size_t)(const void *)((VSB_data(sb)) + 1) - (size_t)(const void *)(VSB_data(sb)) == 1) ? (((const char *) (VSB_data(sb)))[0] == '\0' ? (char *) calloc ((size_t) 1, (size_t) 1) : ({ size_t __len = strlen (VSB_data(sb)) + 1; char *__retval = (char *) malloc (__len); if (__retval != ((void *)0)) __retval = (char *) memcpy (__retval, VSB_data(sb), __len); __retval; })) : __strdup (VSB_data(sb))));
 do { do { if (!((vp.srcfile) != 0)) { VAS_Fail(__func__, "mgt/mgt_vcc.c", 279, "(vp.srcfile) != 0", VAS_ASSERT); } } while (0); } while (0);
 VSB_clear(sb);

 VSB_printf(sb, "%s/%s", vp.dir, "vgc.so");
 do { do { if (!((VSB_finish(sb)) == 0)) { VAS_Fail(__func__, "mgt/mgt_vcc.c", 283, "(VSB_finish(sb)) == 0", VAS_ASSERT); } } while (0); } while (0);
 vp.libfile = (__extension__ (__builtin_constant_p (VSB_data(sb)) && ((size_t)(const void *)((VSB_data(sb)) + 1) - (size_t)(const void *)(VSB_data(sb)) == 1) ? (((const char *) (VSB_data(sb)))[0] == '\0' ? (char *) calloc ((size_t) 1, (size_t) 1) : ({ size_t __len = strlen (VSB_data(sb)) + 1; char *__retval = (char *) malloc (__len); if (__retval != ((void *)0)) __retval = (char *) memcpy (__retval, VSB_data(sb), __len); __retval; })) : __strdup (VSB_data(sb))));
 do { do { if (!((vp.srcfile) != 0)) { VAS_Fail(__func__, "mgt/mgt_vcc.c", 285, "(vp.srcfile) != 0", VAS_ASSERT); } } while (0); } while (0);
 VSB_clear(sb);

 status = mgt_vcc_compile(&vp, sb, C_flag);

 do { do { if (!((VSB_finish(sb)) == 0)) { VAS_Fail(__func__, "mgt/mgt_vcc.c", 290, "(VSB_finish(sb)) == 0", VAS_ASSERT); } } while (0); } while (0);
 if (VSB_len(sb) > 0)
...
mgt_vcc_init(void)
{
 ...
 vcc = VCC_New();
 do { do { if (!((vcc) != 0)) { VAS_Fail(__func__, "mgt/mgt_vcc.c", 322, "(vcc) != 0", VAS_ASSERT); } } while (0); } while (0);
