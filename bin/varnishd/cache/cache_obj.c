...
# 1 "<command-line>" 2
# 1 "cache/cache_obj.c"
# 42 "cache/cache_obj.c"
# 1 "../../config.h" 1
# 43 "cache/cache_obj.c" 2
...
# 51 "cache/cache_obj.c" 2

static const struct obj_methods *
obj_getmethods(const struct objcore *oc)
{

 do { do { if (!((oc) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_obj.c", 56, "(oc) != NULL", VAS_ASSERT); } } while (0); do { if (!((oc)->magic == 0x4d301302)) { VAS_Fail(__func__, "cache/cache_obj.c", 56, "(oc)->magic == 0x4d301302", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((oc->stobj->stevedore) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_obj.c", 57, "(oc->stobj->stevedore) != NULL", VAS_ASSERT); } } while (0); do { if (!((oc->stobj->stevedore)->magic == 0x4baf43db)) { VAS_Fail(__func__, "cache/cache_obj.c", 57, "(oc->stobj->stevedore)->magic == 0x4baf43db", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((oc->stobj->stevedore->methods) != 0)) { VAS_Fail(__func__, "cache/cache_obj.c", 58, "(oc->stobj->stevedore->methods) != 0", VAS_ASSERT); } } while (0); } while (0);
    ...
    void *priv, objiterate_f *func)
{
 ...
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_obj.c", 73, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "cache/cache_obj.c", 73, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((func) != 0)) { VAS_Fail(__func__, "cache/cache_obj.c", 74, "(func) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((om->objiterator) != 0)) { VAS_Fail(__func__, "cache/cache_obj.c", 75, "(om->objiterator) != 0", VAS_ASSERT); } } while (0); } while (0);
 return (om->objiterator(wrk, oc, priv, func));
}
# 88 "cache/cache_obj.c"
int
ObjGetSpace(struct worker *wrk, struct objcore *oc, ssize_t *sz, uint8_t **ptr)
{
 const struct obj_methods *om = obj_getmethods(oc);

 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_obj.c", 93, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "cache/cache_obj.c", 93, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((sz) != 0)) { VAS_Fail(__func__, "cache/cache_obj.c", 94, "(sz) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((ptr) != 0)) { VAS_Fail(__func__, "cache/cache_obj.c", 95, "(ptr) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { if (!(*sz > 0)) { VAS_Fail(__func__, "cache/cache_obj.c", 96, "*sz > 0", VAS_ASSERT); } } while (0);

 do { do { if (!((om->objgetspace) != 0)) { VAS_Fail(__func__, "cache/cache_obj.c", 98, "(om->objgetspace) != 0", VAS_ASSERT); } } while (0); } while (0);
 return (om->objgetspace(wrk, oc, sz, ptr));
}
# 109 "cache/cache_obj.c"
void
ObjExtend(struct worker *wrk, struct objcore *oc, ssize_t l)
{
 const struct obj_methods *om = obj_getmethods(oc);

 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_obj.c", 114, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "cache/cache_obj.c", 114, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);
 do { if (!(l > 0)) { VAS_Fail(__func__, "cache/cache_obj.c", 115, "l > 0", VAS_ASSERT); } } while (0);

 do { do { if (!((om->objextend) != 0)) { VAS_Fail(__func__, "cache/cache_obj.c", 117, "(om->objextend) != 0", VAS_ASSERT); } } while (0); } while (0);
...
ObjGetLen(struct worker *wrk, struct objcore *oc)
{
 ...
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_obj.c", 132, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "cache/cache_obj.c", 132, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);

 do { do { if (!((om->objgetlen) != 0)) { VAS_Fail(__func__, "cache/cache_obj.c", 134, "(om->objgetlen) != 0", VAS_ASSERT); } } while (0); } while (0);
 return (om->objgetlen(wrk, oc));
}
# 145 "cache/cache_obj.c"
void
ObjTrimStore(struct worker *wrk, struct objcore *oc)
{
 const struct obj_methods *om = obj_getmethods(oc);

 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_obj.c", 150, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "cache/cache_obj.c", 150, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);

 if (om->objtrimstore != ((void *)0))
  om->objtrimstore(wrk, oc);
 return;
}
# 164 "cache/cache_obj.c"
void
ObjSlim(struct worker *wrk, struct objcore *oc)
{
 const struct obj_methods *om = obj_getmethods(oc);

 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_obj.c", 169, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "cache/cache_obj.c", 169, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);

 if (om->objslim != ((void *)0))
  om->objslim(wrk, oc);
}
...
ObjUpdateMeta(struct worker *wrk, struct objcore *oc)
{
 ...
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_obj.c", 182, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "cache/cache_obj.c", 182, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);

 if (m->objupdatemeta != ((void *)0))
...
ObjFreeObj(struct worker *wrk, struct objcore *oc)
{
 ...
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_obj.c", 195, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "cache/cache_obj.c", 195, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);

 do { do { if (!((m->objfree) != 0)) { VAS_Fail(__func__, "cache/cache_obj.c", 197, "(m->objfree) != 0", VAS_ASSERT); } } while (0); } while (0);
 m->objfree(wrk, oc);
 do { do { if (!((oc->stobj->stevedore) == 0)) { VAS_Fail(__func__, "cache/cache_obj.c", 199, "(oc->stobj->stevedore) == 0", VAS_ASSERT); } } while (0); } while (0);
}
...
ObjGetLRU(const struct objcore *oc)
{
 ...
 do { do { if (!((m->objgetlru) != 0)) { VAS_Fail(__func__, "cache/cache_obj.c", 209, "(m->objgetlru) != 0", VAS_ASSERT); } } while (0); } while (0);
   ...
   ssize_t *len)
{
 ...
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_obj.c", 225, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "cache/cache_obj.c", 225, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);

 do { do { if (!((om->objgetattr) != 0)) { VAS_Fail(__func__, "cache/cache_obj.c", 227, "(om->objgetattr) != 0", VAS_ASSERT); } } while (0); } while (0);
 return (om->objgetattr(wrk, oc, attr, len));
}
# 238 "cache/cache_obj.c"
void *
    ...
    ssize_t len, const void *ptr)
{
 ...
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_obj.c", 244, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "cache/cache_obj.c", 244, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);

 do { do { if (!((om->objsetattr) != 0)) { VAS_Fail(__func__, "cache/cache_obj.c", 246, "(om->objsetattr) != 0", VAS_ASSERT); } } while (0); } while (0);
...
ObjTouch(struct worker *wrk, struct objcore *oc, double now)
{
 ...
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_obj.c", 259, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "cache/cache_obj.c", 259, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);
 if (om->objtouch != ((void *)0))
    ...
    enum obj_attr attr)
{
 ...
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_obj.c", 275, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "cache/cache_obj.c", 275, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((oc) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_obj.c", 276, "(oc) != NULL", VAS_ASSERT); } } while (0); do { if (!((oc)->magic == 0x4d301302)) { VAS_Fail(__func__, "cache/cache_obj.c", 276, "(oc)->magic == 0x4d301302", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((ocs) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_obj.c", 277, "(ocs) != NULL", VAS_ASSERT); } } while (0); do { if (!((ocs)->magic == 0x4d301302)) { VAS_Fail(__func__, "cache/cache_obj.c", 277, "(ocs)->magic == 0x4d301302", VAS_ASSERT); } } while (0); } while (0);
...
ObjGetXID(struct worker *wrk, struct objcore *oc)
{
 ...
 do { do { if (!((ObjGetU32(wrk, oc, OA_VXID, &u)) == 0)) { VAS_Fail(__func__, "cache/cache_obj.c", 294, "(ObjGetU32(wrk, oc, OA_VXID, &u)) == 0", VAS_ASSERT); } } while (0); } while (0);
 return (u);
}
# 306 "cache/cache_obj.c"
int
ObjSetDouble(struct worker *wrk, struct objcore *oc, enum obj_attr a, double t)
{
 ...
 do { if (!(sizeof t == sizeof u)) { VAS_Fail(__func__, "cache/cache_obj.c", 312, "sizeof t == sizeof u", VAS_ASSERT); } } while (0);
 memcpy(&u, &t, sizeof u);
 vp = ObjSetattr(wrk, oc, a, sizeof u, ((void *)0));
 if (vp == ((void *)0))
  return (-1);
 vbe64enc(vp, u);
 return (0);
...
ObjGetDouble(struct worker *wrk, struct objcore *oc, enum obj_attr a, double *d)
{
 ...
 do { if (!(sizeof *d == sizeof u)) { VAS_Fail(__func__, "cache/cache_obj.c", 328, "sizeof *d == sizeof u", VAS_ASSERT); } } while (0);
 vp = ObjGetattr(wrk, oc, a, &l);
 if (vp == ((void *)0))
  return (-1);
 if (d != ((void *)0)) {
  do { if (!(l == sizeof u)) { VAS_Fail(__func__, "cache/cache_obj.c", 333, "l == sizeof u", VAS_ASSERT); } } while (0);
  u = vbe64dec(vp);
  memcpy(d, &u, sizeof *d);
 }
 return (0);
...
ObjSetU64(struct worker *wrk, struct objcore *oc, enum obj_attr a, uint64_t t)
{
 ...
 vp = ObjSetattr(wrk, oc, a, sizeof t, ((void *)0));
 if (vp == ((void *)0))
  return (-1);
 vbe64enc(vp, t);
 return (0);
...
ObjCheckFlag(struct worker *wrk, struct objcore *oc, enum obj_flags of)
{
 ...
 fp = ObjGetattr(wrk, oc, OA_FLAGS, ((void *)0));
 do { do { if (!((fp) != 0)) { VAS_Fail(__func__, "cache/cache_obj.c", 404, "(fp) != 0", VAS_ASSERT); } } while (0); } while (0);
 return ((*fp) & of);
}
...
ObjSetFlag(struct worker *wrk, struct objcore *oc, enum obj_flags of, int val)
{
 ...
 fp = ObjSetattr(wrk, oc, OA_FLAGS, 1, ((void *)0));
 do { do { if (!((fp) != 0)) { VAS_Fail(__func__, "cache/cache_obj.c", 414, "(fp) != 0", VAS_ASSERT); } } while (0); } while (0);
 if (val)
  (*fp) |= of;
 else
  (*fp) &= ~of;
