...
# 1 "<command-line>" 2
# 1 "cache/cache_fetch_proc.c"
# 30 "cache/cache_fetch_proc.c"
# 1 "../../config.h" 1
# 31 "cache/cache_fetch_proc.c" 2
...
# 38 "cache/cache_fetch_proc.c" 2

static unsigned fetchfrag;
# 50 "cache/cache_fetch_proc.c"
enum vfp_status
VFP_Error(struct vfp_ctx *vc, const char *fmt, ...)
{
 va_list ap;

 do { do { if (!((vc) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_fetch_proc.c", 55, "(vc) != NULL", VAS_ASSERT); } } while (0); do { if (!((vc)->magic == 0x61d9d3e5)) { VAS_Fail(__func__, "cache/cache_fetch_proc.c", 55, "(vc)->magic == 0x61d9d3e5", VAS_ASSERT); } } while (0); } while (0);
 if (!vc->failed) {
...
VFP_GetStorage(struct vfp_ctx *vc, ssize_t *sz, uint8_t **ptr)
{
 ...
 do { do { if (!((vc) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_fetch_proc.c", 76, "(vc) != NULL", VAS_ASSERT); } } while (0); do { if (!((vc)->magic == 0x61d9d3e5)) { VAS_Fail(__func__, "cache/cache_fetch_proc.c", 76, "(vc)->magic == 0x61d9d3e5", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((sz) != 0)) { VAS_Fail(__func__, "cache/cache_fetch_proc.c", 77, "(sz) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { if (!(*sz >= 0)) { VAS_Fail(__func__, "cache/cache_fetch_proc.c", 78, "*sz >= 0", VAS_ASSERT); } } while (0);
 do { do { if (!((ptr) != 0)) { VAS_Fail(__func__, "cache/cache_fetch_proc.c", 79, "(ptr) != 0", VAS_ASSERT); } } while (0); } while (0);
 ...
 *sz = l;
 ...
 do { if (!(*sz > 0)) { VAS_Fail(__func__, "cache/cache_fetch_proc.c", 92, "*sz > 0", VAS_ASSERT); } } while (0);
 do { do { if (!((*ptr) != 0)) { VAS_Fail(__func__, "cache/cache_fetch_proc.c", 93, "(*ptr) != 0", VAS_ASSERT); } } while (0); } while (0);
 return (VFP_OK);
}
...
VFP_Setup(struct vfp_ctx *vc)
{
 ...
 do { (void)memset(vc, 0, sizeof *vc); (vc)->magic = (0x61d9d3e5); } while (0);
 do { (((&vc->vfp))->vtqh_first) = ((void *)0); (&vc->vfp)->vtqh_last = &(((&vc->vfp))->vtqh_first); } while (0);
}
...
VFP_Close(struct vfp_ctx *vc)
{
 ...
 for ((vfe) = (((&vc->vfp))->vtqh_first); (vfe); (vfe) = (((vfe))->list.vtqe_next)) {
  if(vfe->vfp->fini != ((void *)0))
   vfe->vfp->fini(vc, vfe);
...
VFP_Open(struct vfp_ctx *vc)
{
 ...
 do { do { if (!((vc) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_fetch_proc.c", 129, "(vc) != NULL", VAS_ASSERT); } } while (0); do { if (!((vc)->magic == 0x61d9d3e5)) { VAS_Fail(__func__, "cache/cache_fetch_proc.c", 129, "(vc)->magic == 0x61d9d3e5", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((vc->http) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_fetch_proc.c", 130, "(vc->http) != NULL", VAS_ASSERT); } } while (0); do { if (!((vc->http)->magic == 0x6428b5c9)) { VAS_Fail(__func__, "cache/cache_fetch_proc.c", 130, "(vc->http)->magic == 0x6428b5c9", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((vc->wrk) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_fetch_proc.c", 131, "(vc->wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((vc->wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "cache/cache_fetch_proc.c", 131, "(vc->wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((vc->wrk->vsl) != 0)) { VAS_Fail(__func__, "cache/cache_fetch_proc.c", 132, "(vc->wrk->vsl) != 0", VAS_ASSERT); } } while (0); } while (0);

 for ((vfe) = (*(((struct vfp_entry_s *)(((&vc->vfp))->vtqh_last))->vtqh_last)); (vfe); (vfe) = (*(((struct vfp_entry_s *)(((vfe))->list.vtqe_prev))->vtqh_last))) {
  if (vfe->vfp->init == ((void *)0))
   continue;
...
VFP_Suck(struct vfp_ctx *vc, void *p, ssize_t *lp)
{
 ...
 do { do { if (!((vc) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_fetch_proc.c", 161, "(vc) != NULL", VAS_ASSERT); } } while (0); do { if (!((vc)->magic == 0x61d9d3e5)) { VAS_Fail(__func__, "cache/cache_fetch_proc.c", 161, "(vc)->magic == 0x61d9d3e5", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((p) != 0)) { VAS_Fail(__func__, "cache/cache_fetch_proc.c", 162, "(p) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((lp) != 0)) { VAS_Fail(__func__, "cache/cache_fetch_proc.c", 163, "(lp) != 0", VAS_ASSERT); } } while (0); } while (0);
 vfe = vc->vfp_nxt;
 do { do { if (!((vfe) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_fetch_proc.c", 165, "(vfe) != NULL", VAS_ASSERT); } } while (0); do { if (!((vfe)->magic == 0xbe32a027)) { VAS_Fail(__func__, "cache/cache_fetch_proc.c", 165, "(vfe)->magic == 0xbe32a027", VAS_ASSERT); } } while (0); } while (0);
 vc->vfp_nxt = ((vfe)->list.vtqe_next);
...
VFP_Push(struct vfp_ctx *vc, const struct vfp *vfp, int top)
{
 ...
 do { do { if (!((vc) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_fetch_proc.c", 197, "(vc) != NULL", VAS_ASSERT); } } while (0); do { if (!((vc)->magic == 0x61d9d3e5)) { VAS_Fail(__func__, "cache/cache_fetch_proc.c", 197, "(vc)->magic == 0x61d9d3e5", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((vc->http) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_fetch_proc.c", 198, "(vc->http) != NULL", VAS_ASSERT); } } while (0); do { if (!((vc->http)->magic == 0x6428b5c9)) { VAS_Fail(__func__, "cache/cache_fetch_proc.c", 198, "(vc->http)->magic == 0x6428b5c9", VAS_ASSERT); } } while (0); } while (0);
 vfe = WS_Alloc(vc->http->ws, sizeof *vfe);
 do { do { if (!((vfe) != 0)) { VAS_Fail(__func__, "cache/cache_fetch_proc.c", 200, "(vfe) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { (void)memset(vfe, 0, sizeof *vfe); (vfe)->magic = (0xbe32a027); } while (0);
 vfe->vfp = vfp;
 vfe->closed = VFP_OK;
 if (top)
  do { if (((((vfe))->list.vtqe_next) = (((&vc->vfp))->vtqh_first)) != ((void *)0)) (((&vc->vfp))->vtqh_first)->list.vtqe_prev = &(((vfe))->list.vtqe_next); else (&vc->vfp)->vtqh_last = &(((vfe))->list.vtqe_next); (((&vc->vfp))->vtqh_first) = (vfe); (vfe)->list.vtqe_prev = &(((&vc->vfp))->vtqh_first); } while (0);
 else
  do { (((vfe))->list.vtqe_next) = ((void *)0); (vfe)->list.vtqe_prev = (&vc->vfp)->vtqh_last; *(&vc->vfp)->vtqh_last = (vfe); (&vc->vfp)->vtqh_last = &(((vfe))->list.vtqe_next); } while (0);
 if (((&vc->vfp)->vtqh_first) == vfe)
  vc->vfp_nxt = vfe;
 return (vfe);
}
...
debug_fragfetch(struct cli *cli, const char * const *av, void *priv)
{
 (void)priv;
 (void)cli;
 fetchfrag = strtoul(av[2], ((void *)0), 0);
}
