...
# 1 "<command-line>" 2
# 1 "cache/cache_vary.c"
# 57 "cache/cache_vary.c"
# 1 "../../config.h" 1
# 58 "cache/cache_vary.c" 2
...
VRY_Create(struct busyobj *bo, struct vsb **psb)
{
 ...
 do { do { if (!((bo) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_vary.c", 85, "(bo) != NULL", VAS_ASSERT); } } while (0); do { if (!((bo)->magic == 0x23b95567)) { VAS_Fail(__func__, "cache/cache_vary.c", 85, "(bo)->magic == 0x23b95567", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((bo->bereq) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_vary.c", 86, "(bo->bereq) != NULL", VAS_ASSERT); } } while (0); do { if (!((bo->bereq)->magic == 0x6428b5c9)) { VAS_Fail(__func__, "cache/cache_vary.c", 86, "(bo->bereq)->magic == 0x6428b5c9", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((bo->beresp) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_vary.c", 87, "(bo->beresp) != NULL", VAS_ASSERT); } } while (0); do { if (!((bo->beresp)->magic == 0x6428b5c9)) { VAS_Fail(__func__, "cache/cache_vary.c", 87, "(bo->beresp)->magic == 0x6428b5c9", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((psb) != 0)) { VAS_Fail(__func__, "cache/cache_vary.c", 88, "(psb) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((*psb) == 0)) { VAS_Fail(__func__, "cache/cache_vary.c", 89, "(*psb) == 0", VAS_ASSERT); } } while (0); } while (0);
 ...
 do { do { if (!((sb) != 0)) { VAS_Fail(__func__, "cache/cache_vary.c", 97, "(sb) != 0", VAS_ASSERT); } } while (0); } while (0);


 sbh = VSB_new(((void *)0), ((void *)0), 0, 0x00000001);
 do { do { if (!((sbh) != 0)) { VAS_Fail(__func__, "cache/cache_vary.c", 101, "(sbh) != 0", VAS_ASSERT); } } while (0); } while (0);
 ...
 for (p = v; *p; p++) {
  ...
  do { do { if (!((VSB_finish(sbh)) == 0)) { VAS_Fail(__func__, "cache/cache_vary.c", 122, "(VSB_finish(sbh)) == 0", VAS_ASSERT); } } while (0); } while (0);

  if (http_GetHdr(bo->bereq, VSB_data(sbh), &h)) {
   do { do { if (!((vct_is(*h, (1<<0))) == 0)) { VAS_Fail(__func__, "cache/cache_vary.c", 125, "(vct_is(*h, (1<<0))) == 0", VAS_ASSERT); } } while (0); } while (0);

   e = (__extension__ (__builtin_constant_p ('\0') && !__builtin_constant_p (h) && ('\0') == '\0' ? (char *) __rawmemchr (h, '\0') : __builtin_strchr (h, '\0')));
   while (e > h && vct_is(e[-1], (1<<0)))
    e--;
 ...
 VSB_delete(sbh);
 do { do { if (!((VSB_finish(sb)) == 0)) { VAS_Fail(__func__, "cache/cache_vary.c", 170, "(VSB_finish(sb)) == 0", VAS_ASSERT); } } while (0); } while (0);
 *psb = sb;
 return (VSB_len(sb));
}
...
# 225 "cache/cache_vary.c"
void
VRY_Prep(struct req *req)
{
 if (req->hash_objhead == ((void *)0)) {

  do { do { if (!((req->vary_b) == 0)) { VAS_Fail(__func__, "cache/cache_vary.c", 230, "(req->vary_b) == 0", VAS_ASSERT); } } while (0); } while (0);
  do { do { if (!((req->vary_l) == 0)) { VAS_Fail(__func__, "cache/cache_vary.c", 231, "(req->vary_l) == 0", VAS_ASSERT); } } while (0); } while (0);
  do { do { if (!((req->vary_e) == 0)) { VAS_Fail(__func__, "cache/cache_vary.c", 232, "(req->vary_e) == 0", VAS_ASSERT); } } while (0); } while (0);
  (void)WS_Reserve(req->ws, 0);
 } else {
  do { do { if (!((req->ws->r) != 0)) { VAS_Fail(__func__, "cache/cache_vary.c", 235, "(req->ws->r) != 0", VAS_ASSERT); } } while (0); } while (0);
 }
...
VRY_Clear(struct req *req)
{
 ...
 do { do { if (!((req) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_vary.c", 247, "(req) != NULL", VAS_ASSERT); } } while (0); do { if (!((req)->magic == 0x2751aaa1)) { VAS_Fail(__func__, "cache/cache_vary.c", 247, "(req)->magic == 0x2751aaa1", VAS_ASSERT); } } while (0); } while (0);
 if (req->vary_b != ((void *)0))
  free(req->vary_b);
 req->vary_b = ((void *)0);
 do { do { if (!((req->vary_e) == 0)) { VAS_Fail(__func__, "cache/cache_vary.c", 251, "(req->vary_e) == 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((req->vary_l) == 0)) { VAS_Fail(__func__, "cache/cache_vary.c", 252, "(req->vary_l) == 0", VAS_ASSERT); } } while (0); } while (0);
}
...
VRY_Match(struct req *req, const uint8_t *vary)
{
 ...
 do { do { if (!((vsp) != 0)) { VAS_Fail(__func__, "cache/cache_vary.c", 293, "(vsp) != 0", VAS_ASSERT); } } while (0); } while (0);
 while (vary[2]) {
  if (vsp + 2 >= req->vary_e) {
  ...
  if (i == 1) {
   ...
   if (i) {
    ...
    while (e > h && vct_is(e[-1], (1<<0)))
     e--;
    lh = e - h;
    do { if (!(lh < 0xffff)) { VAS_Fail(__func__, "cache/cache_vary.c", 317, "lh < 0xffff", VAS_ASSERT); } } while (0);
    ln += lh;
   } else {
    e = h = ((void *)0);
    lh = 0xffff;
   ...
   i = vry_cmp(vary, vsp);
   do { if (!(i == 0 || i == 2)) { VAS_Fail(__func__, "cache/cache_vary.c", 344, "i == 0 || i == 2", VAS_ASSERT); } } while (0);
  }
  if (i == 0) {
...
VRY_Validate(const uint8_t *vary)
{
 ...
 while (vary[2] != 0) {
  do { if (!(strlen((const char*)vary+3) == vary[2])) { VAS_Fail(__func__, "cache/cache_vary.c", 379, "strlen((const char*)vary+3) == vary[2]", VAS_ASSERT); } } while (0);
  retval += VRY_Len(vary);
  vary += VRY_Len(vary);
 }
 return (retval + 3);
