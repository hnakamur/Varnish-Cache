...
# 1 "<command-line>" 2
# 1 "http1/cache_http1_fsm.c"
# 34 "http1/cache_http1_fsm.c"
# 1 "../../config.h" 1
# 35 "http1/cache_http1_fsm.c" 2
...
http1_dissect(struct worker *wrk, struct req *req)
{
 ...
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "http1/cache_http1_fsm.c", 63, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "http1/cache_http1_fsm.c", 63, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((req) != ((void *)0))) { VAS_Fail(__func__, "http1/cache_http1_fsm.c", 64, "(req) != NULL", VAS_ASSERT); } } while (0); do { if (!((req)->magic == 0x2751aaa1)) { VAS_Fail(__func__, "http1/cache_http1_fsm.c", 64, "(req)->magic == 0x2751aaa1", VAS_ASSERT); } } while (0); } while (0);


 do { do { if (!((req->vsl->wid) == 0)) { VAS_Fail(__func__, "http1/cache_http1_fsm.c", 67, "(req->vsl->wid) == 0", VAS_ASSERT); } } while (0); } while (0);
 req->vsl->wid = VXID_Get(wrk, (1U<<30));

 VSLb(req->vsl, SLT_Begin, "req %u rxreq", ((req->sp->vxid) & (~(3U<<30))));
 VSL(SLT_Link, req->sp->vxid, "req %u rxreq", ((req->vsl->wid) & (~(3U<<30))));
 do { do { if (!(((sizeof (req->t_first) == sizeof (float) ? __isnanf (req->t_first) : sizeof (req->t_first) == sizeof (double) ? __isnan (req->t_first) : __isnanl (req->t_first))) == 0)) { VAS_Fail(__func__, "http1/cache_http1_fsm.c", 72, "((sizeof (req->t_first) == sizeof (float) ? __isnanf (req->t_first) : sizeof (req->t_first) == sizeof (double) ? __isnan (req->t_first) : __isnanl (req->t_first))) == 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!(((sizeof (req->t_req) == sizeof (float) ? __isnanf (req->t_req) : sizeof (req->t_req) == sizeof (double) ? __isnan (req->t_req) : __isnanl (req->t_req))) == 0)) { VAS_Fail(__func__, "http1/cache_http1_fsm.c", 73, "((sizeof (req->t_req) == sizeof (float) ? __isnanf (req->t_req) : sizeof (req->t_req) == sizeof (double) ? __isnan (req->t_req) : __isnanl (req->t_req))) == 0", VAS_ASSERT); } } while (0); } while (0);
 ...
 do { if (!(req->req_body_status == REQ_BODY_INIT)) { VAS_Fail(__func__, "http1/cache_http1_fsm.c", 99, "req->req_body_status == REQ_BODY_INIT", VAS_ASSERT); } } while (0);
 ...
 if (req->htc->body_status == BS_CHUNKED) {
  ...
  do { VAS_Fail(__func__, "http1/cache_http1_fsm.c", 110, "Unknown req.body_length situation", VAS_WRONG); } while (0);
 }
 ...
 do { do { if (!((req->err_code) == 0)) { VAS_Fail(__func__, "http1/cache_http1_fsm.c", 136, "(req->err_code) == 0", VAS_ASSERT); } } while (0); } while (0);
 ...
 do { if (!(req->req_body_status != REQ_BODY_INIT)) { VAS_Fail(__func__, "http1/cache_http1_fsm.c", 147, "req->req_body_status != REQ_BODY_INIT", VAS_ASSERT); } } while (0);
...
HTTP1_Session(struct worker *wrk, struct req *req)
{
 ...
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "http1/cache_http1_fsm.c", 164, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "http1/cache_http1_fsm.c", 164, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((req) != ((void *)0))) { VAS_Fail(__func__, "http1/cache_http1_fsm.c", 165, "(req) != NULL", VAS_ASSERT); } } while (0); do { if (!((req)->magic == 0x2751aaa1)) { VAS_Fail(__func__, "http1/cache_http1_fsm.c", 165, "(req)->magic == 0x2751aaa1", VAS_ASSERT); } } while (0); } while (0);
 sp = req->sp;
 do { do { if (!((sp) != ((void *)0))) { VAS_Fail(__func__, "http1/cache_http1_fsm.c", 167, "(sp) != NULL", VAS_ASSERT); } } while (0); do { if (!((sp)->magic == 0x2c2f9c5a)) { VAS_Fail(__func__, "http1/cache_http1_fsm.c", 167, "(sp)->magic == 0x2c2f9c5a", VAS_ASSERT); } } while (0); } while (0);
 ...
 if (sp->sess_step == S_STP_H1NEWREQ && VTCP_blocking(sp->fd)) {
  ...
  do { do { if (!((Req_Cleanup(sp, wrk, req)) != 0)) { VAS_Fail(__func__, "http1/cache_http1_fsm.c", 180, "(Req_Cleanup(sp, wrk, req)) != 0", VAS_ASSERT); } } while (0); } while (0);
  return;
 }
 ...
 while (1) {
  ...
  case S_STP_H1NEWSESS:
   if (VTCP_blocking(sp->fd)) {
    if ((*__errno_location ()) == 104)
     ...
     SES_Close(sp, SC_TX_ERROR);
    do { do { if (!((Req_Cleanup(sp, wrk, req)) != 0)) { VAS_Fail(__func__, "http1/cache_http1_fsm.c", 192, "(Req_Cleanup(sp, wrk, req)) != 0", VAS_ASSERT); } } while (0); } while (0);
    return;
   }
   sp->sess_step = S_STP_H1NEWREQ;
   break;
  case S_STP_H1NEWREQ:
   do { if (!((sizeof (req->t_prev) == sizeof (float) ? __isnanf (req->t_prev) : sizeof (req->t_prev) == sizeof (double) ? __isnan (req->t_prev) : __isnanl (req->t_prev)))) { VAS_Fail(__func__, "http1/cache_http1_fsm.c", 198, "isnan(req->t_prev)", VAS_ASSERT); } } while (0);
   do { if (!((sizeof (req->t_req) == sizeof (float) ? __isnanf (req->t_req) : sizeof (req->t_req) == sizeof (double) ? __isnan (req->t_req) : __isnanl (req->t_req)))) { VAS_Fail(__func__, "http1/cache_http1_fsm.c", 199, "isnan(req->t_req)", VAS_ASSERT); } } while (0);
   do { do { if (!((req->vcl) == 0)) { VAS_Fail(__func__, "http1/cache_http1_fsm.c", 200, "(req->vcl) == 0", VAS_ASSERT); } } while (0); } while (0);
   do { do { if (!((req->esi_level) == 0)) { VAS_Fail(__func__, "http1/cache_http1_fsm.c", 201, "(req->esi_level) == 0", VAS_ASSERT); } } while (0); } while (0);

   hs = SES_RxStuff(req->htc, HTTP1_Complete,
       &req->t_first, &req->t_req,
       sp->t_idle + cache_param->timeout_linger,
       sp->t_idle + cache_param->timeout_idle);
   do { do { if (!((req->htc->ws->r) == 0)) { VAS_Fail(__func__, "http1/cache_http1_fsm.c", 207, "(req->htc->ws->r) == 0", VAS_MISSING); } } while (0); } while (0);
   if (hs < HTC_S_EMPTY) {
    ...
    case HTC_S_CLOSE:
     ...
     return;
    case HTC_S_TIMEOUT:
     SES_Delete(sp, SC_RX_TIMEOUT, (__builtin_nanf ("")));
     return;
    case HTC_S_OVERFLOW:
     SES_Delete(sp, SC_RX_OVERFLOW, (__builtin_nanf ("")));
     return;
    case HTC_S_EOF:
     SES_Delete(sp, SC_REM_CLOSE, (__builtin_nanf ("")));
     return;
    default:
     do { VAS_Fail(__func__, "http1/cache_http1_fsm.c", 227, "htc_status (bad)", VAS_WRONG); } while (0);
    }
   }
   if (hs == HTC_S_IDLE) {
    wrk->stats->sess_herd++;
   ...
   if (hs != HTC_S_COMPLETE)
    do { VAS_Fail(__func__, "http1/cache_http1_fsm.c", 237, "htc_status (nonbad)", VAS_WRONG); } while (0);
  ...
  case S_STP_H1BUSY:
   ...
   if (VTCP_check_hup(sp->fd)) {
    do { do { if (!((req->hash_objhead) != 0)) { VAS_Fail(__func__, "http1/cache_http1_fsm.c", 256, "(req->hash_objhead) != 0", VAS_ASSERT); } } while (0); } while (0);
    (void)HSH_DerefObjHead(wrk, &req->hash_objhead);
    do { do { if (!((req->hash_objhead) == 0)) { VAS_Fail(__func__, "http1/cache_http1_fsm.c", 258, "(req->hash_objhead) == 0", VAS_ASSERT); } } while (0); } while (0);
    SES_Close(sp, SC_REM_CLOSE);
    do { do { if (!((Req_Cleanup(sp, wrk, req)) != 0)) { VAS_Fail(__func__, "http1/cache_http1_fsm.c", 260, "(Req_Cleanup(sp, wrk, req)) != 0", VAS_ASSERT); } } while (0); } while (0);
    return;
   }
   sp->sess_step = S_STP_H1PROC;
   break;
  ...
  case S_STP_H1CLEANUP:
   ...
   break;
  default:
   do { VAS_Fail(__func__, "http1/cache_http1_fsm.c", 283, "Wrong H1 session state", VAS_WRONG); } while (0);
  }
