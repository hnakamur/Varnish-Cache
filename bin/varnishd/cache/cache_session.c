...
# 1 "<command-line>" 2
# 1 "cache/cache_session.c"
# 41 "cache/cache_session.c"
# 1 "../../config.h" 1
# 42 "cache/cache_session.c" 2
...
{
 do { do { if (!((sp) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_session.c", 60, "(sp) != NULL", VAS_ASSERT); } } while (0); do { if (!((sp)->magic == 0x2c2f9c5a)) { VAS_Fail(__func__, "cache/cache_session.c", 60, "(sp)->magic == 0x2c2f9c5a", VAS_ASSERT); } } while (0); } while (0);
 do { if (!(a < SA_LAST)) { VAS_Fail(__func__, "cache/cache_session.c", 61, "a < SA_LAST", VAS_ASSERT); } } while (0);
 do { do { if (!((dst) != 0)) { VAS_Fail(__func__, "cache/cache_session.c", 62, "(dst) != 0", VAS_ASSERT); } } while (0); } while (0);
...
ses_reserve_attr(struct sess *sp, enum sess_attr a, void **dst, int sz)
{
 ...
 do { do { if (!((sp) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_session.c", 78, "(sp) != NULL", VAS_ASSERT); } } while (0); do { if (!((sp)->magic == 0x2c2f9c5a)) { VAS_Fail(__func__, "cache/cache_session.c", 78, "(sp)->magic == 0x2c2f9c5a", VAS_ASSERT); } } while (0); } while (0);
 do { if (!(a < SA_LAST)) { VAS_Fail(__func__, "cache/cache_session.c", 79, "a < SA_LAST", VAS_ASSERT); } } while (0);
 do { if (!(sz >= 0)) { VAS_Fail(__func__, "cache/cache_session.c", 80, "sz >= 0", VAS_ASSERT); } } while (0);
 do { do { if (!((dst) != 0)) { VAS_Fail(__func__, "cache/cache_session.c", 81, "(dst) != 0", VAS_ASSERT); } } while (0); } while (0);
 o = WS_Reserve(sp->ws, sz);
 do { if (!(o >= sz)) { VAS_Fail(__func__, "cache/cache_session.c", 83, "o >= sz", VAS_ASSERT); } } while (0);
 *dst = sp->ws->f;
 o = sp->ws->f - sp->ws->s;
 WS_Release(sp->ws, sz);
 do { if (!(o >= 0 && o <= 0xffff)) { VAS_Fail(__func__, "cache/cache_session.c", 87, "o >= 0 && o <= 0xffff", VAS_ASSERT); } } while (0);
 sp->sattr[a] = (uint16_t)o;
}
# 105 "cache/cache_session.c"
# 1 "../../include/tbl/sess_attr.h" 1
# 36 "../../include/tbl/sess_attr.h"
int SES_Get_remote_addr(const struct sess *sp, struct suckaddr * *dst) { return (ses_get_attr(sp, SA_REMOTE_ADDR, (void**)dst)); } void SES_Reserve_remote_addr(struct sess *sp, struct suckaddr * *dst) { do { if (!(vsa_suckaddr_len >= 0)) { VAS_Fail(__func__, "../../include/tbl/sess_attr.h", 36, "vsa_suckaddr_len >= 0", VAS_ASSERT); } } while (0); ses_reserve_attr(sp, SA_REMOTE_ADDR, (void*)dst, vsa_suckaddr_len); }
int SES_Get_local_addr(const struct sess *sp, struct suckaddr * *dst) { return (ses_get_attr(sp, SA_LOCAL_ADDR, (void**)dst)); } void SES_Reserve_local_addr(struct sess *sp, struct suckaddr * *dst) { do { if (!(vsa_suckaddr_len >= 0)) { VAS_Fail(__func__, "../../include/tbl/sess_attr.h", 37, "vsa_suckaddr_len >= 0", VAS_ASSERT); } } while (0); ses_reserve_attr(sp, SA_LOCAL_ADDR, (void*)dst, vsa_suckaddr_len); }
int SES_Get_client_addr(const struct sess *sp, struct suckaddr * *dst) { return (ses_get_attr(sp, SA_CLIENT_ADDR, (void**)dst)); } void SES_Reserve_client_addr(struct sess *sp, struct suckaddr * *dst) { do { if (!(vsa_suckaddr_len >= 0)) { VAS_Fail(__func__, "../../include/tbl/sess_attr.h", 38, "vsa_suckaddr_len >= 0", VAS_ASSERT); } } while (0); ses_reserve_attr(sp, SA_CLIENT_ADDR, (void*)dst, vsa_suckaddr_len); }
int SES_Get_server_addr(const struct sess *sp, struct suckaddr * *dst) { return (ses_get_attr(sp, SA_SERVER_ADDR, (void**)dst)); } void SES_Reserve_server_addr(struct sess *sp, struct suckaddr * *dst) { do { if (!(vsa_suckaddr_len >= 0)) { VAS_Fail(__func__, "../../include/tbl/sess_attr.h", 39, "vsa_suckaddr_len >= 0", VAS_ASSERT); } } while (0); ses_reserve_attr(sp, SA_SERVER_ADDR, (void*)dst, vsa_suckaddr_len); }
int SES_Get_client_ip(const struct sess *sp, char * *dst) { return (ses_get_attr(sp, SA_CLIENT_IP, (void**)dst)); } void SES_Reserve_client_ip(struct sess *sp, char * *dst) { do { if (!(-1 >= 0)) { VAS_Fail(__func__, "../../include/tbl/sess_attr.h", 40, "-1 >= 0", VAS_ASSERT); } } while (0); ses_reserve_attr(sp, SA_CLIENT_IP, (void*)dst, -1); }
int SES_Get_client_port(const struct sess *sp, char * *dst) { return (ses_get_attr(sp, SA_CLIENT_PORT, (void**)dst)); } void SES_Reserve_client_port(struct sess *sp, char * *dst) { do { if (!(-1 >= 0)) { VAS_Fail(__func__, "../../include/tbl/sess_attr.h", 41, "-1 >= 0", VAS_ASSERT); } } while (0); ses_reserve_attr(sp, SA_CLIENT_PORT, (void*)dst, -1); }
# 106 "cache/cache_session.c" 2
...
SES_Set_String_Attr(struct sess *sp, enum sess_attr a, const char *src)
{
 ...
 do { do { if (!((sp) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_session.c", 113, "(sp) != NULL", VAS_ASSERT); } } while (0); do { if (!((sp)->magic == 0x2c2f9c5a)) { VAS_Fail(__func__, "cache/cache_session.c", 113, "(sp)->magic == 0x2c2f9c5a", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((src) != 0)) { VAS_Fail(__func__, "cache/cache_session.c", 114, "(src) != 0", VAS_ASSERT); } } while (0); } while (0);

 switch (a) {

# 1 "../../include/tbl/sess_attr.h" 1
# 36 "../../include/tbl/sess_attr.h"
case SA_REMOTE_ADDR: do { if (!(vsa_suckaddr_len < 0)) { VAS_Fail(__func__, "../../include/tbl/sess_attr.h", 36, "vsa_suckaddr_len < 0", VAS_ASSERT); } } while (0); break;
case SA_LOCAL_ADDR: do { if (!(vsa_suckaddr_len < 0)) { VAS_Fail(__func__, "../../include/tbl/sess_attr.h", 37, "vsa_suckaddr_len < 0", VAS_ASSERT); } } while (0); break;
case SA_CLIENT_ADDR: do { if (!(vsa_suckaddr_len < 0)) { VAS_Fail(__func__, "../../include/tbl/sess_attr.h", 38, "vsa_suckaddr_len < 0", VAS_ASSERT); } } while (0); break;
case SA_SERVER_ADDR: do { if (!(vsa_suckaddr_len < 0)) { VAS_Fail(__func__, "../../include/tbl/sess_attr.h", 39, "vsa_suckaddr_len < 0", VAS_ASSERT); } } while (0); break;
case SA_CLIENT_IP: do { if (!(-1 < 0)) { VAS_Fail(__func__, "../../include/tbl/sess_attr.h", 40, "-1 < 0", VAS_ASSERT); } } while (0); break;
case SA_CLIENT_PORT: do { if (!(-1 < 0)) { VAS_Fail(__func__, "../../include/tbl/sess_attr.h", 41, "-1 < 0", VAS_ASSERT); } } while (0); break;
# 119 "cache/cache_session.c" 2

 default: do { VAS_Fail(__func__, "cache/cache_session.c", 120, "wrong sess_attr", VAS_WRONG); } while (0);
 }
...
SES_Get_String_Attr(const struct sess *sp, enum sess_attr a)
{
 ...
 do { do { if (!((sp) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_session.c", 132, "(sp) != NULL", VAS_ASSERT); } } while (0); do { if (!((sp)->magic == 0x2c2f9c5a)) { VAS_Fail(__func__, "cache/cache_session.c", 132, "(sp)->magic == 0x2c2f9c5a", VAS_ASSERT); } } while (0); } while (0);
...
case SA_CLIENT_IP: do { if (!(-1 < 0)) { VAS_Fail(__func__, "../../include/tbl/sess_attr.h", 40, "-1 < 0", VAS_ASSERT); } } while (0); break;
case SA_CLIENT_PORT: do { if (!(-1 < 0)) { VAS_Fail(__func__, "../../include/tbl/sess_attr.h", 41, "-1 < 0", VAS_ASSERT); } } while (0); break;
# 137 "cache/cache_session.c" 2

 default: do { VAS_Fail(__func__, "cache/cache_session.c", 138, "wrong sess_attr", VAS_WRONG); } while (0);
 }
    ...
    unsigned maxhdr)
{
 ...
 htc->rxbuf_e = ws->f;
 *htc->rxbuf_e = '\0';
 htc->pipeline_b = ((void *)0);
 htc->pipeline_e = ((void *)0);
}
...
SES_RxReInit(struct http_conn *htc)
{
 ...
 do { do { if (!((htc) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_session.c", 177, "(htc) != NULL", VAS_ASSERT); } } while (0); do { if (!((htc)->magic == 0x3e19edd1)) { VAS_Fail(__func__, "cache/cache_session.c", 177, "(htc)->magic == 0x3e19edd1", VAS_ASSERT); } } while (0); } while (0);
 (void)WS_Reserve(htc->ws, htc->maxbytes);
 htc->rxbuf_b = htc->ws->f;
 htc->rxbuf_e = htc->ws->f;
 if (htc->pipeline_b != ((void *)0)) {
  l = htc->pipeline_e - htc->pipeline_b;
  do { if (!(l > 0)) { VAS_Fail(__func__, "cache/cache_session.c", 183, "l > 0", VAS_ASSERT); } } while (0);
    ...
    double *t1, double *t2, double ti, double tn)
{
 ...
 do { do { if (!((htc) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_session.c", 211, "(htc) != NULL", VAS_ASSERT); } } while (0); do { if (!((htc)->magic == 0x3e19edd1)) { VAS_Fail(__func__, "cache/cache_session.c", 211, "(htc)->magic == 0x3e19edd1", VAS_ASSERT); } } while (0); } while (0);

 do { do { if (!(((sizeof (tn) == sizeof (float) ? __isnanf (tn) : sizeof (tn) == sizeof (double) ? __isnan (tn) : __isnanl (tn))) == 0)) { VAS_Fail(__func__, "cache/cache_session.c", 213, "((sizeof (tn) == sizeof (float) ? __isnanf (tn) : sizeof (tn) == sizeof (double) ? __isnan (tn) : __isnanl (tn))) == 0", VAS_ASSERT); } } while (0); } while (0);
 if (t1 != ((void *)0))
  do { if (!((sizeof (*t1) == sizeof (float) ? __isnanf (*t1) : sizeof (*t1) == sizeof (double) ? __isnan (*t1) : __isnanl (*t1)))) { VAS_Fail(__func__, "cache/cache_session.c", 215, "isnan(*t1)", VAS_ASSERT); } } while (0);
 ...
 while (1) {
  ...
  if (hs == HTC_S_COMPLETE) {
   ...
   if (t1 != ((void *)0) && (sizeof (*t1) == sizeof (float) ? __isnanf (*t1) : sizeof (*t1) == sizeof (double) ? __isnan (*t1) : __isnanl (*t1)))
    *t1 = now;
   if (t2 != ((void *)0))
    *t2 = now;
  ...
  if (hs == HTC_S_MORE) {
   ...
   do { VAS_Fail(__func__, "cache/cache_session.c", 242, "htc_status_e", VAS_WRONG); } while (0);

  tmo = tn - now;
  if (!(sizeof (ti) == sizeof (float) ? __isnanf (ti) : sizeof (ti) == sizeof (double) ? __isnan (ti) : __isnanl (ti)) && ti < tn)
   tmo = ti - now;
  i = (htc->ws->r - htc->rxbuf_e) - 1;
  if (i <= 0) {
   WS_ReleaseP(htc->ws, htc->rxbuf_b);
...
SES_New(struct pool *pp)
{
 ...
 do { do { if (!((pp) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_session.c", 283, "(pp) != NULL", VAS_ASSERT); } } while (0); do { if (!((pp)->magic == 0x606658fa)) { VAS_Fail(__func__, "cache/cache_session.c", 283, "(pp)->magic == 0x606658fa", VAS_ASSERT); } } while (0); } while (0);
 ...
 e = (char*)sp + sz;
 p = (char*)(sp + 1);
 p = (void*)(((uintptr_t)(p) + (sizeof(void *) - 1)) & ~(sizeof(void *) - 1));
 do { if (!(p < e)) { VAS_Fail(__func__, "cache/cache_session.c", 292, "p < e", VAS_ASSERT); } } while (0);
 WS_Init(sp->ws, "ses", p, e - p);

 sp->t_open = (__builtin_nanf (""));
 sp->t_idle = (__builtin_nanf (""));
 VRTPRIV_init(sp->privs);
 Lck__New(&sp->mtx, lck_sess, "lck_sess");
 do { do { if (!((sp) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_session.c", 299, "(sp) != NULL", VAS_ASSERT); } } while (0); do { if (!((sp)->magic == 0x2c2f9c5a)) { VAS_Fail(__func__, "cache/cache_session.c", 299, "(sp)->magic == 0x2c2f9c5a", VAS_ASSERT); } } while (0); } while (0);
 return (sp);
}
...
SES_Proto_Req(struct worker *wrk, void *arg)
{
 ...
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_session.c", 312, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "cache/cache_session.c", 312, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);
 do { (req) = (arg); do { if (!((req) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_session.c", 313, "(req) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((req))->magic == (0x2751aaa1))) { VAS_Fail(__func__, "cache/cache_session.c", 313, "((req))->magic == (0x2751aaa1)", VAS_ASSERT); } } while (0); } while (0); } while (0);

 THR_SetRequest(req);
 do { do { if (!((wrk->aws->r) == 0)) { VAS_Fail(__func__, "cache/cache_session.c", 316, "(wrk->aws->r) == 0", VAS_ASSERT); } } while (0); } while (0);
 if (req->sp->sess_step < S_STP_H1_LAST) {
  HTTP1_Session(wrk, req);
  do { do { if (!((wrk->v1l) == 0)) { VAS_Fail(__func__, "cache/cache_session.c", 319, "(wrk->v1l) == 0", VAS_ASSERT); } } while (0); } while (0);
 } else {
  do { VAS_Fail(__func__, "cache/cache_session.c", 321, "Wrong session step", VAS_WRONG); } while (0);
 }
 WS_Assert(wrk->aws);
 if (DO_DEBUG(DBG_VCLREL) && wrk->vcl != ((void *)0))
  VCL_Rel(&wrk->vcl);
 THR_SetRequest(((void *)0));
}
# 339 "cache/cache_session.c"
void
SES_Proto_Sess(struct worker *wrk, void *arg)
{
 ...
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_session.c", 345, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "cache/cache_session.c", 345, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);
 do { (sp) = (arg); do { if (!((sp) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_session.c", 346, "(sp) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((sp))->magic == (0x2c2f9c5a))) { VAS_Fail(__func__, "cache/cache_session.c", 346, "((sp))->magic == (0x2c2f9c5a)", VAS_ASSERT); } } while (0); } while (0); } while (0);
 WS_Release(sp->ws, 0);
 ...
 req = Req_New(wrk, sp);
 do { do { if (!((req) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_session.c", 355, "(req) != NULL", VAS_ASSERT); } } while (0); do { if (!((req)->magic == 0x2751aaa1)) { VAS_Fail(__func__, "cache/cache_session.c", 355, "(req)->magic == 0x2751aaa1", VAS_ASSERT); } } while (0); } while (0);
 req->htc->fd = sp->fd;
 ...
 if (sp->sess_step < S_STP_H1_LAST) {
  ...
  do { VAS_Fail(__func__, "cache/cache_session.c", 367, "Wrong session step", VAS_WRONG); } while (0);
 }
}
...
SES_Reschedule_Req(struct req *req)
{
 ...
 do { do { if (!((req) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_session.c", 383, "(req) != NULL", VAS_ASSERT); } } while (0); do { if (!((req)->magic == 0x2751aaa1)) { VAS_Fail(__func__, "cache/cache_session.c", 383, "(req)->magic == 0x2751aaa1", VAS_ASSERT); } } while (0); } while (0);
 sp = req->sp;
 do { do { if (!((sp) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_session.c", 385, "(sp) != NULL", VAS_ASSERT); } } while (0); do { if (!((sp)->magic == 0x2c2f9c5a)) { VAS_Fail(__func__, "cache/cache_session.c", 385, "(sp)->magic == 0x2c2f9c5a", VAS_ASSERT); } } while (0); } while (0);
 pp = sp->pool;
 do { do { if (!((pp) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_session.c", 387, "(pp) != NULL", VAS_ASSERT); } } while (0); do { if (!((pp)->magic == 0x606658fa)) { VAS_Fail(__func__, "cache/cache_session.c", 387, "(pp)->magic == 0x606658fa", VAS_ASSERT); } } while (0); } while (0);
...
ses_handle(struct waited *wp, enum wait_event ev, double now)
{
 ...
 do { do { if (!((wp) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_session.c", 406, "(wp) != NULL", VAS_ASSERT); } } while (0); do { if (!((wp)->magic == 0x1743992d)) { VAS_Fail(__func__, "cache/cache_session.c", 406, "(wp)->magic == 0x1743992d", VAS_ASSERT); } } while (0); } while (0);
 do { (sp) = (wp->ptr); do { if (!((sp) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_session.c", 407, "(sp) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((sp))->magic == (0x2c2f9c5a))) { VAS_Fail(__func__, "cache/cache_session.c", 407, "((sp))->magic == (0x2c2f9c5a)", VAS_ASSERT); } } while (0); } while (0); } while (0);
 do { if (!((void *)sp->ws->f == wp)) { VAS_Fail(__func__, "cache/cache_session.c", 408, "(void *)sp->ws->f == wp", VAS_ASSERT); } } while (0);
 wp->magic = 0;
 wp = ((void *)0);
 ...
 case WAITER_ACTION:
  pp = sp->pool;
  do { do { if (!((pp) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_session.c", 423, "(pp) != NULL", VAS_ASSERT); } } while (0); do { if (!((pp)->magic == 0x606658fa)) { VAS_Fail(__func__, "cache/cache_session.c", 423, "(pp)->magic == 0x606658fa", VAS_ASSERT); } } while (0); } while (0);
  do { if (!(sizeof *tp <= WS_Reserve(sp->ws, sizeof *tp))) { VAS_Fail(__func__, "cache/cache_session.c", 424, "sizeof *tp <= WS_Reserve(sp->ws, sizeof *tp)", VAS_ASSERT); } } while (0);
  tp = (void*)sp->ws->f;
  ...
  break;
 case WAITER_CLOSE:
  do { VAS_Fail(__func__, "cache/cache_session.c", 432, "Should not see WAITER_CLOSE on client side", VAS_WRONG); } while (0);
  break;
 default:
  do { VAS_Fail(__func__, "cache/cache_session.c", 435, "Wrong event in ses_handle", VAS_WRONG); } while (0);
 }
}
...
SES_Wait(struct sess *sp)
{
 ...
 do { do { if (!((sp) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_session.c", 448, "(sp) != NULL", VAS_ASSERT); } } while (0); do { if (!((sp)->magic == 0x2c2f9c5a)) { VAS_Fail(__func__, "cache/cache_session.c", 448, "(sp)->magic == 0x2c2f9c5a", VAS_ASSERT); } } while (0); } while (0);
 pp = sp->pool;
 do { do { if (!((pp) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_session.c", 450, "(pp) != NULL", VAS_ASSERT); } } while (0); do { if (!((pp)->magic == 0x606658fa)) { VAS_Fail(__func__, "cache/cache_session.c", 450, "(pp)->magic == 0x606658fa", VAS_ASSERT); } } while (0); } while (0);




 if (VTCP_nonblocking(sp->fd)) {
  SES_Delete(sp, SC_REM_CLOSE, (__builtin_nanf ("")));
  return;
 }
 ...
 wp = (void*)sp->ws->f;
 do { (void)memset(wp, 0, sizeof *wp); (wp)->magic = (0x1743992d); } while (0);
 wp->fd = sp->fd;
 wp->ptr = sp;
 wp->idle = sp->t_idle;
 wp->waitfor = &pp->wf;
 if (Wait_Enter(pp->waiter, wp))
  SES_Delete(sp, SC_PIPE_OVERFLOW, (__builtin_nanf ("")));
}
# 484 "cache/cache_session.c"
static void
ses_close_acct(enum sess_close reason)
{
 int i = 0;

 do { if (!(reason != SC_NULL)) { VAS_Fail(__func__, "cache/cache_session.c", 489, "reason != SC_NULL", VAS_ASSERT); } } while (0);
 switch (reason) {
...
# 1 "../../include/tbl/sess_close.h" 1
# 33 "../../include/tbl/sess_close.h"
case SC_REM_CLOSE: VSC_C_main->sc_rem_close++; i = 0; break;
case SC_REQ_CLOSE: VSC_C_main->sc_req_close++; i = 0; break;
case SC_REQ_HTTP10: VSC_C_main->sc_req_http10++; i = 1; break;
case SC_RX_BAD: VSC_C_main->sc_rx_bad++; i = 1; break;
case SC_RX_BODY: VSC_C_main->sc_rx_body++; i = 1; break;
case SC_RX_JUNK: VSC_C_main->sc_rx_junk++; i = 1; break;
case SC_RX_OVERFLOW: VSC_C_main->sc_rx_overflow++; i = 1; break;
case SC_RX_TIMEOUT: VSC_C_main->sc_rx_timeout++; i = 1; break;
case SC_TX_PIPE: VSC_C_main->sc_tx_pipe++; i = 0; break;
case SC_TX_ERROR: VSC_C_main->sc_tx_error++; i = 1; break;
case SC_TX_EOF: VSC_C_main->sc_tx_eof++; i = 0; break;
case SC_RESP_CLOSE: VSC_C_main->sc_resp_close++; i = 0; break;
case SC_OVERLOAD: VSC_C_main->sc_overload++; i = 1; break;
case SC_PIPE_OVERFLOW: VSC_C_main->sc_pipe_overflow++; i = 1; break;
case SC_RANGE_SHORT: VSC_C_main->sc_range_short++; i = 1; break;
# 497 "cache/cache_session.c" 2

 default:
  do { VAS_Fail(__func__, "cache/cache_session.c", 499, "Wrong event in ses_close_acct", VAS_WRONG); } while (0);
 }
 if (i)
...
SES_Close(struct sess *sp, enum sess_close reason)
{
 ...
 do { if (!(sp->fd >= 0)) { VAS_Fail(__func__, "cache/cache_session.c", 516, "sp->fd >= 0", VAS_ASSERT); } } while (0);
 i = close(sp->fd);
 do { if (!(i == 0 || (*__errno_location ()) != 9)) { VAS_Fail(__func__, "cache/cache_session.c", 518, "i == 0 || errno != EBADF", VAS_ASSERT); } } while (0);
 sp->fd = -(int)reason;
 if (reason != SC_NULL)
...
SES_Delete(struct sess *sp, enum sess_close reason, double now)
{
 ...
 do { do { if (!((sp) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_session.c", 533, "(sp) != NULL", VAS_ASSERT); } } while (0); do { if (!((sp)->magic == 0x2c2f9c5a)) { VAS_Fail(__func__, "cache/cache_session.c", 533, "(sp)->magic == 0x2c2f9c5a", VAS_ASSERT); } } while (0); } while (0);
 pp = sp->pool;
 do { do { if (!((pp) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_session.c", 535, "(pp) != NULL", VAS_ASSERT); } } while (0); do { if (!((pp)->magic == 0x606658fa)) { VAS_Fail(__func__, "cache/cache_session.c", 535, "(pp)->magic == 0x606658fa", VAS_ASSERT); } } while (0); } while (0);

 if (reason != SC_NULL)
  SES_Close(sp, reason);
 do { if (!(sp->fd < 0)) { VAS_Fail(__func__, "cache/cache_session.c", 539, "sp->fd < 0", VAS_ASSERT); } } while (0);

 if ((sizeof (now) == sizeof (float) ? __isnanf (now) : sizeof (now) == sizeof (double) ? __isnan (now) : __isnanl (now)))
  now = VTIM_real();
 do { do { if (!(((sizeof (sp->t_open) == sizeof (float) ? __isnanf (sp->t_open) : sizeof (sp->t_open) == sizeof (double) ? __isnan (sp->t_open) : __isnanl (sp->t_open))) == 0)) { VAS_Fail(__func__, "cache/cache_session.c", 543, "((sizeof (sp->t_open) == sizeof (float) ? __isnanf (sp->t_open) : sizeof (sp->t_open) == sizeof (double) ? __isnan (sp->t_open) : __isnanl (sp->t_open))) == 0", VAS_ASSERT); } } while (0); } while (0);

 if (reason == SC_NULL)
  reason = (enum sess_close)-sp->fd;

 do { if (!(now >= sp->t_open)) { VAS_Fail(__func__, "cache/cache_session.c", 548, "now >= sp->t_open", VAS_ASSERT); } } while (0);
 do { if (!(((&sp->privs->privs)->vtqh_first == ((void *)0)))) { VAS_Fail(__func__, "cache/cache_session.c", 549, "VTAILQ_EMPTY(&sp->privs->privs)", VAS_ASSERT); } } while (0);
...
SES_NewPool(struct pool *pp, unsigned pool_no)
{
 ...
 do { do { if (!((pp) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_session.c", 567, "(pp) != NULL", VAS_ASSERT); } } while (0); do { if (!((pp)->magic == 0x606658fa)) { VAS_Fail(__func__, "cache/cache_session.c", 567, "(pp)->magic == 0x606658fa", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!(snprintf(nb, sizeof nb, "req%u", pool_no) < sizeof nb)) { VAS_Fail(__func__, "cache/cache_session.c", 568, "snprintf(nb, sizeof nb, \"req%u\", pool_no) < sizeof nb", VAS_ASSERT); } } while (0); } while (0);
 pp->mpl_req = MPL_New(nb, &cache_param->req_pool,
     &cache_param->workspace_client);
 do { do { if (!(snprintf(nb, sizeof nb, "sess%u", pool_no) < sizeof nb)) { VAS_Fail(__func__, "cache/cache_session.c", 571, "snprintf(nb, sizeof nb, \"sess%u\", pool_no) < sizeof nb", VAS_ASSERT); } } while (0); } while (0);
 pp->mpl_sess = MPL_New(nb, &cache_param->sess_pool,
     &cache_param->workspace_session);

 do { (void)memset(&pp->wf, 0, sizeof *&pp->wf); (&pp->wf)->magic = (0x16b79246); } while (0);
