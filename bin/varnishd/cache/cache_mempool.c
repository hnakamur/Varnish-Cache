...
# 1 "<command-line>" 2
# 1 "cache/cache_mempool.c"
# 31 "cache/cache_mempool.c"
# 1 "../../config.h" 1
# 32 "cache/cache_mempool.c" 2
...
# 39 "cache/cache_mempool.c" 2

struct memitem {
 unsigned magic;

 unsigned size;
 struct { struct memitem *vtqe_next; struct memitem **vtqe_prev; } list;
 double touched;
};

struct memhead_s { struct memitem *vtqh_first; struct memitem **vtqh_last; };
...
mpl_alloc(const struct mempool *mpl)
{
 ...
 do { do { if (!((mpl) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_mempool.c", 76, "(mpl) != NULL", VAS_ASSERT); } } while (0); do { if (!((mpl)->magic == 0x37a75a8d)) { VAS_Fail(__func__, "cache/cache_mempool.c", 76, "(mpl)->magic == 0x37a75a8d", VAS_ASSERT); } } while (0); } while (0);
 tsz = *mpl->cur_size;
 mi = calloc(tsz, 1);
 do { do { if (!((mi) != 0)) { VAS_Fail(__func__, "cache/cache_mempool.c", 79, "(mi) != 0", VAS_ASSERT); } } while (0); } while (0);
 mi->magic = 0x42e55401;
 mi->size = tsz;
...
# 94 "cache/cache_mempool.c"
static void *
mpl_guard(void *priv)
{
 struct mempool *mpl;
 struct memitem *mi = ((void *)0);
 double mpl_slp ;
 double last = 0;

 do { (mpl) = (priv); do { if (!((mpl) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_mempool.c", 102, "(mpl) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((mpl))->magic == (0x37a75a8d))) { VAS_Fail(__func__, "cache/cache_mempool.c", 102, "((mpl))->magic == (0x37a75a8d)", VAS_ASSERT); } } while (0); } while (0); } while (0);
 ...
 while (1) {
  ...
  if (mi != ((void *)0) && (mpl->n_pool > mpl->param->max_pool ||
      mi->size < *mpl->cur_size)) {
   do { (mi)->magic = (0); free(mi); mi = ((void *)0); } while (0);
   mi = ((void *)0);
  }

  if (mi == ((void *)0) && mpl->n_pool < mpl->param->min_pool)
   mi = mpl_alloc(mpl);

  if (mpl->n_pool < mpl->param->min_pool && mi != ((void *)0)) {

  } else if (mpl->n_pool > mpl->param->max_pool && mi == ((void *)0)) {

  } else if (!((&mpl->surplus)->vtqh_first == ((void *)0))) {
  ...
  if (Lck__Trylock(&mpl->mtx, __func__, 135))
   continue;

  if (mpl->self_destruct) {
   do { do { if (!((mpl->live) == 0)) { VAS_Fail(__func__, "cache/cache_mempool.c", 139, "(mpl->live) == 0", VAS_ASSERT); } } while (0); } while (0);
   while (1) {
    if (mi == ((void *)0)) {
     mi = ((&mpl->list)->vtqh_first);
     if (mi != ((void *)0)) {
      mpl->vsc->pool = --mpl->n_pool;
      do { if (((((mi))->list.vtqe_next)) != ((void *)0)) (((mi))->list.vtqe_next)->list.vtqe_prev = (mi)->list.vtqe_prev; else { (&mpl->list)->vtqh_last = (mi)->list.vtqe_prev; } *(mi)->list.vtqe_prev = (((mi))->list.vtqe_next); ; ; } while (0)
                   ;
     }
    }
    if (mi == ((void *)0)) {
     mi = ((&mpl->surplus)->vtqh_first);
     if (mi != ((void *)0))
      do { if (((((mi))->list.vtqe_next)) != ((void *)0)) (((mi))->list.vtqe_next)->list.vtqe_prev = (mi)->list.vtqe_prev; else { (&mpl->surplus)->vtqh_last = (mi)->list.vtqe_prev; } *(mi)->list.vtqe_prev = (((mi))->list.vtqe_next); ; ; } while (0)
                   ;
    }
    if (mi == ((void *)0))
     break;
   ...
   VSM_Free(mpl->vsc);
   Lck__Unlock(&mpl->mtx, __func__, 161);
   Lck_Delete(&mpl->mtx);
   do { (mpl)->magic = (0); free(mpl); mpl = ((void *)0); } while (0);
   break;
  }

  if (mpl->n_pool < mpl->param->min_pool &&
      mi != ((void *)0) && mi->size >= *mpl->cur_size) {
   do { do { if (!((mi) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_mempool.c", 169, "(mi) != NULL", VAS_ASSERT); } } while (0); do { if (!((mi)->magic == 0x42e55401)) { VAS_Fail(__func__, "cache/cache_mempool.c", 169, "(mi)->magic == 0x42e55401", VAS_ASSERT); } } while (0); } while (0);
   mpl->vsc->pool = ++mpl->n_pool;
   mi->touched = mpl->t_now;
   do { if (((((mi))->list.vtqe_next) = (((&mpl->list))->vtqh_first)) != ((void *)0)) (((&mpl->list))->vtqh_first)->list.vtqe_prev = &(((mi))->list.vtqe_next); else (&mpl->list)->vtqh_last = &(((mi))->list.vtqe_next); (((&mpl->list))->vtqh_first) = (mi); (mi)->list.vtqe_prev = &(((&mpl->list))->vtqh_first); } while (0);
   mi = ((void *)0);
   mpl_slp = .01;

  }
  if (mpl->n_pool > mpl->param->max_pool && mi == ((void *)0)) {
   mi = ((&mpl->list)->vtqh_first);
   do { do { if (!((mi) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_mempool.c", 179, "(mi) != NULL", VAS_ASSERT); } } while (0); do { if (!((mi)->magic == 0x42e55401)) { VAS_Fail(__func__, "cache/cache_mempool.c", 179, "(mi)->magic == 0x42e55401", VAS_ASSERT); } } while (0); } while (0);
   mpl->vsc->pool = --mpl->n_pool;
   mpl->vsc->surplus++;
   do { if (((((mi))->list.vtqe_next)) != ((void *)0)) (((mi))->list.vtqe_next)->list.vtqe_prev = (mi)->list.vtqe_prev; else { (&mpl->list)->vtqh_last = (mi)->list.vtqe_prev; } *(mi)->list.vtqe_prev = (((mi))->list.vtqe_next); ; ; } while (0);
   mpl_slp = .01;
  ...
  if (mi == ((void *)0)) {
   mi = ((&mpl->surplus)->vtqh_first);
   if (mi != ((void *)0)) {
    do { do { if (!((mi) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_mempool.c", 188, "(mi) != NULL", VAS_ASSERT); } } while (0); do { if (!((mi)->magic == 0x42e55401)) { VAS_Fail(__func__, "cache/cache_mempool.c", 188, "(mi)->magic == 0x42e55401", VAS_ASSERT); } } while (0); } while (0);
    do { if (((((mi))->list.vtqe_next)) != ((void *)0)) (((mi))->list.vtqe_next)->list.vtqe_prev = (mi)->list.vtqe_prev; else { (&mpl->surplus)->vtqh_last = (mi)->list.vtqe_prev; } *(mi)->list.vtqe_prev = (((mi))->list.vtqe_next); ; ; } while (0);
    mpl_slp = .01;
   }
  }
  if (mi == ((void *)0) && mpl->n_pool > mpl->param->min_pool) {
   mi = (*(((struct memhead_s *)((&mpl->list)->vtqh_last))->vtqh_last));
   do { do { if (!((mi) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_mempool.c", 195, "(mi) != NULL", VAS_ASSERT); } } while (0); do { if (!((mi)->magic == 0x42e55401)) { VAS_Fail(__func__, "cache/cache_mempool.c", 195, "(mi)->magic == 0x42e55401", VAS_ASSERT); } } while (0); } while (0);
  ...
  Lck__Unlock(&mpl->mtx, __func__, 209);
    ...
    volatile struct poolparam *pp, volatile unsigned *cur_size)
{
 ...
 do { (mpl) = calloc(sizeof *(mpl), 1); if ((mpl) != ((void *)0)) (mpl)->magic = (0x37a75a8d); } while (0);
 do { do { if (!((mpl) != 0)) { VAS_Fail(__func__, "cache/cache_mempool.c", 230, "(mpl) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!(snprintf(mpl->name, sizeof mpl->name, "MPL_%s", name) < sizeof mpl->name)) { VAS_Fail(__func__, "cache/cache_mempool.c", 231, "snprintf(mpl->name, sizeof mpl->name, \"MPL_%s\", name) < sizeof mpl->name", VAS_ASSERT); } } while (0); } while (0);
 mpl->param = pp;
 mpl->cur_size = cur_size;
 do { (((&mpl->list))->vtqh_first) = ((void *)0); (&mpl->list)->vtqh_last = &(((&mpl->list))->vtqh_first); } while (0);
 do { (((&mpl->surplus))->vtqh_first) = ((void *)0); (&mpl->surplus)->vtqh_last = &(((&mpl->surplus))->vtqh_first); } while (0);
 Lck__New(&mpl->mtx, lck_mempool, "lck_mempool");

 mpl->vsc = VSM_Alloc(sizeof *mpl->vsc,
     "Stat", VSC_type_mempool, mpl->name + 4);
 do { do { if (!((mpl->vsc) != 0)) { VAS_Fail(__func__, "cache/cache_mempool.c", 240, "(mpl->vsc) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((pthread_create(&mpl->thread, ((void *)0), mpl_guard, mpl)) == 0)) { VAS_Fail(__func__, "cache/cache_mempool.c", 241, "(pthread_create(&mpl->thread, ((void *)0), mpl_guard, mpl)) == 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((pthread_detach(mpl->thread)) == 0)) { VAS_Fail(__func__, "cache/cache_mempool.c", 242, "(pthread_detach(mpl->thread)) == 0", VAS_ASSERT); } } while (0); } while (0);
 return (mpl);
}
...
MPL_Destroy(struct mempool **mpp)
{
 ...
 do { do { if (!((mpp) != 0)) { VAS_Fail(__func__, "cache/cache_mempool.c", 256, "(mpp) != 0", VAS_ASSERT); } } while (0); } while (0);
 mpl = *mpp;
 *mpp = ((void *)0);
 do { do { if (!((mpl) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_mempool.c", 259, "(mpl) != NULL", VAS_ASSERT); } } while (0); do { if (!((mpl)->magic == 0x37a75a8d)) { VAS_Fail(__func__, "cache/cache_mempool.c", 259, "(mpl)->magic == 0x37a75a8d", VAS_ASSERT); } } while (0); } while (0);
 Lck__Lock(&mpl->mtx, __func__, 260);
 do { do { if (!((mpl->live) == 0)) { VAS_Fail(__func__, "cache/cache_mempool.c", 261, "(mpl->live) == 0", VAS_ASSERT); } } while (0); } while (0);
 mpl->self_destruct = 1;
 Lck__Unlock(&mpl->mtx, __func__, 263);
}
...
MPL_Get(struct mempool *mpl, unsigned *size)
{
 ...
 do { do { if (!((mpl) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_mempool.c", 274, "(mpl) != NULL", VAS_ASSERT); } } while (0); do { if (!((mpl)->magic == 0x37a75a8d)) { VAS_Fail(__func__, "cache/cache_mempool.c", 274, "(mpl)->magic == 0x37a75a8d", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((size) != 0)) { VAS_Fail(__func__, "cache/cache_mempool.c", 275, "(size) != 0", VAS_ASSERT); } } while (0); } while (0);

 Lck__Lock(&mpl->mtx, __func__, 277);
 ...
 do {
  ...
  mpl->vsc->pool = --mpl->n_pool;
  do { do { if (!((mi) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_mempool.c", 289, "(mi) != NULL", VAS_ASSERT); } } while (0); do { if (!((mi)->magic == 0x42e55401)) { VAS_Fail(__func__, "cache/cache_mempool.c", 289, "(mi)->magic == 0x42e55401", VAS_ASSERT); } } while (0); } while (0);
  do { if (((((mi))->list.vtqe_next)) != ((void *)0)) (((mi))->list.vtqe_next)->list.vtqe_prev = (mi)->list.vtqe_prev; else { (&mpl->list)->vtqh_last = (mi)->list.vtqe_prev; } *(mi)->list.vtqe_prev = (((mi))->list.vtqe_next); ; ; } while (0);
  if (mi->size < *mpl->cur_size) {
   mpl->vsc->toosmall++;
   do { if (((((mi))->list.vtqe_next) = (((&mpl->surplus))->vtqh_first)) != ((void *)0)) (((&mpl->surplus))->vtqh_first)->list.vtqe_prev = &(((mi))->list.vtqe_next); else (&mpl->surplus)->vtqh_last = &(((mi))->list.vtqe_next); (((&mpl->surplus))->vtqh_first) = (mi); (mi)->list.vtqe_prev = &(((&mpl->surplus))->vtqh_first); } while (0);
   mi = ((void *)0);
  } else {
   mpl->vsc->recycle++;
  }
 ...
 Lck__Unlock(&mpl->mtx, __func__, 300);

 if (mi == ((void *)0))
  mi = mpl_alloc(mpl);
 *size = mi->size - sizeof *mi;

 do { do { if (!((mi) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_mempool.c", 306, "(mi) != NULL", VAS_ASSERT); } } while (0); do { if (!((mi)->magic == 0x42e55401)) { VAS_Fail(__func__, "cache/cache_mempool.c", 306, "(mi)->magic == 0x42e55401", VAS_ASSERT); } } while (0); } while (0);
...
MPL_Free(struct mempool *mpl, void *item)
{
 ...
 do { do { if (!((mpl) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_mempool.c", 316, "(mpl) != NULL", VAS_ASSERT); } } while (0); do { if (!((mpl)->magic == 0x37a75a8d)) { VAS_Fail(__func__, "cache/cache_mempool.c", 316, "(mpl)->magic == 0x37a75a8d", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((item) != 0)) { VAS_Fail(__func__, "cache/cache_mempool.c", 317, "(item) != 0", VAS_ASSERT); } } while (0); } while (0);

 mi = (void*)((uintptr_t)item - sizeof(*mi));
 do { do { if (!((mi) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_mempool.c", 320, "(mi) != NULL", VAS_ASSERT); } } while (0); do { if (!((mi)->magic == 0x42e55401)) { VAS_Fail(__func__, "cache/cache_mempool.c", 320, "(mi)->magic == 0x42e55401", VAS_ASSERT); } } while (0); } while (0);
 memset(item, 0, mi->size - sizeof *mi);

 Lck__Lock(&mpl->mtx, __func__, 323);
 ...
 Lck__Unlock(&mpl->mtx, __func__, 337);
}
...
MPL_AssertSane(void *item)
{
 struct memitem *mi;
 mi = (void*)((uintptr_t)item - sizeof(*mi));
 do { do { if (!((mi) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_mempool.c", 345, "(mi) != NULL", VAS_ASSERT); } } while (0); do { if (!((mi)->magic == 0x42e55401)) { VAS_Fail(__func__, "cache/cache_mempool.c", 345, "(mi)->magic == 0x42e55401", VAS_ASSERT); } } while (0); } while (0);
}
