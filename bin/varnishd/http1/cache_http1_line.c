...
# 1 "<command-line>" 2
# 1 "http1/cache_http1_line.c"
# 35 "http1/cache_http1_line.c"
# 1 "../../config.h" 1
# 36 "http1/cache_http1_line.c" 2
    ...
    double t0)
{
 ...
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "http1/cache_http1_line.c", 78, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "http1/cache_http1_line.c", 78, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((wrk->v1l) == 0)) { VAS_Fail(__func__, "http1/cache_http1_line.c", 79, "(wrk->v1l) == 0", VAS_ASSERT); } } while (0); } while (0);
 ...
 if (v1l == ((void *)0))
  return;
 do { (void)memset(v1l, 0, sizeof *v1l); (v1l)->magic = (0x2f2142e5); } while (0);

 v1l->ws = ws;
 v1l->res = res;

 u = WS_Reserve(ws, 0);
 u = ((uintptr_t)(u) & ~(sizeof(void *) - 1));
 ...
 if (u == 0) {
  ...
  u = 1024;
 v1l->iov = (void*)(((uintptr_t)(ws->f) + (sizeof(void *) - 1)) & ~(sizeof(void *) - 1));
 v1l->siov = u;
 v1l->ciov = u;
 v1l->werr = 0;
 v1l->liov = 0;
...
V1L_FlushRelease(struct worker *wrk)
{
 ...
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "http1/cache_http1_line.c", 119, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "http1/cache_http1_line.c", 119, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);
 u = V1L_Flush(wrk);
 v1l = wrk->v1l;
 wrk->v1l = ((void *)0);
 do { do { if (!((v1l) != ((void *)0))) { VAS_Fail(__func__, "http1/cache_http1_line.c", 123, "(v1l) != NULL", VAS_ASSERT); } } while (0); do { if (!((v1l)->magic == 0x2f2142e5)) { VAS_Fail(__func__, "http1/cache_http1_line.c", 123, "(v1l)->magic == 0x2f2142e5", VAS_ASSERT); } } while (0); } while (0);
 WS_Release(v1l->ws, 0);
...
v1l_prune(struct v1l *v1l, ssize_t bytes)
{
 ...
 do { do { if (!((v1l->liov) == 0)) { VAS_Fail(__func__, "http1/cache_http1_line.c", 150, "(v1l->liov) == 0", VAS_ASSERT); } } while (0); } while (0);
}
...
V1L_Flush(const struct worker *wrk)
{
 ...
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "http1/cache_http1_line.c", 160, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "http1/cache_http1_line.c", 160, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);
 v1l = wrk->v1l;
 do { do { if (!((v1l) != ((void *)0))) { VAS_Fail(__func__, "http1/cache_http1_line.c", 162, "(v1l) != NULL", VAS_ASSERT); } } while (0); do { if (!((v1l)->magic == 0x2f2142e5)) { VAS_Fail(__func__, "http1/cache_http1_line.c", 162, "(v1l)->magic == 0x2f2142e5", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((v1l->wfd) != 0)) { VAS_Fail(__func__, "http1/cache_http1_line.c", 163, "(v1l->wfd) != 0", VAS_ASSERT); } } while (0); } while (0);


 if (v1l->ciov < v1l->siov)
  do { if (!(v1l->niov < v1l->siov)) { VAS_Fail(__func__, "http1/cache_http1_line.c", 167, "v1l->niov < v1l->siov", VAS_ASSERT); } } while (0);

 if (*v1l->wfd >= 0 && v1l->liov > 0 && v1l->werr == 0) {
  if (v1l->ciov < v1l->siov && v1l->cliov > 0) {

   do { do { if (!(snprintf(cbuf, sizeof cbuf, "00%zx\r\n", v1l->cliov) < sizeof cbuf)) { VAS_Fail(__func__, "http1/cache_http1_line.c", 172, "snprintf(cbuf, sizeof cbuf, \"00%zx\\r\\n\", v1l->cliov) < sizeof cbuf", VAS_ASSERT); } } while (0); } while (0);
   i = strlen(cbuf);
...
# 198 "http1/cache_http1_line.c"
  ...
  if (i <= 0) {
   ...
   VSLb(v1l->vsl, SLT_Debug,
       ...
       i, v1l->liov, strerror((*__errno_location ())));
  }
 }
 v1l->liov = 0;
 v1l->cliov = 0;
...
V1L_Write(const struct worker *wrk, const void *ptr, ssize_t len)
{
 ...
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "http1/cache_http1_line.c", 236, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "http1/cache_http1_line.c", 236, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);
 v1l = wrk->v1l;
 do { do { if (!((v1l) != ((void *)0))) { VAS_Fail(__func__, "http1/cache_http1_line.c", 238, "(v1l) != NULL", VAS_ASSERT); } } while (0); do { if (!((v1l)->magic == 0x2f2142e5)) { VAS_Fail(__func__, "http1/cache_http1_line.c", 238, "(v1l)->magic == 0x2f2142e5", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((v1l->wfd) != 0)) { VAS_Fail(__func__, "http1/cache_http1_line.c", 239, "(v1l->wfd) != 0", VAS_ASSERT); } } while (0); } while (0);
 if (len == 0 || *v1l->wfd < 0)
  return (0);
 if (len == -1)
  len = strlen(ptr);
 if (v1l->niov >= v1l->siov - (v1l->ciov < v1l->siov ? 1 : 0))
  (void)V1L_Flush(wrk);
 v1l->iov[v1l->niov].iov_base = ((void*)(uintptr_t)(ptr));
 v1l->iov[v1l->niov].iov_len = len;
 v1l->liov += len;
 v1l->niov++;
 if (v1l->ciov < v1l->siov) {
  do { if (!(v1l->niov < v1l->siov)) { VAS_Fail(__func__, "http1/cache_http1_line.c", 251, "v1l->niov < v1l->siov", VAS_ASSERT); } } while (0);
  v1l->cliov += len;
 }
 return (len);
}
...
V1L_Chunked(const struct worker *wrk)
{
 ...
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "http1/cache_http1_line.c", 262, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "http1/cache_http1_line.c", 262, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);
 v1l = wrk->v1l;
 do { do { if (!((v1l) != ((void *)0))) { VAS_Fail(__func__, "http1/cache_http1_line.c", 264, "(v1l) != NULL", VAS_ASSERT); } } while (0); do { if (!((v1l)->magic == 0x2f2142e5)) { VAS_Fail(__func__, "http1/cache_http1_line.c", 264, "(v1l)->magic == 0x2f2142e5", VAS_ASSERT); } } while (0); } while (0);

 do { if (!(v1l->ciov == v1l->siov)) { VAS_Fail(__func__, "http1/cache_http1_line.c", 266, "v1l->ciov == v1l->siov", VAS_ASSERT); } } while (0);
 ...
 v1l->ciov = v1l->niov++;
 v1l->cliov = 0;
 do { if (!(v1l->ciov < v1l->siov)) { VAS_Fail(__func__, "http1/cache_http1_line.c", 275, "v1l->ciov < v1l->siov", VAS_ASSERT); } } while (0);
 do { if (!(v1l->niov < v1l->siov)) { VAS_Fail(__func__, "http1/cache_http1_line.c", 276, "v1l->niov < v1l->siov", VAS_ASSERT); } } while (0);
}
# 286 "http1/cache_http1_line.c"
void
V1L_EndChunk(const struct worker *wrk)
{
 struct v1l *v1l;

 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "http1/cache_http1_line.c", 291, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "http1/cache_http1_line.c", 291, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);
 v1l = wrk->v1l;
 do { do { if (!((v1l) != ((void *)0))) { VAS_Fail(__func__, "http1/cache_http1_line.c", 293, "(v1l) != NULL", VAS_ASSERT); } } while (0); do { if (!((v1l)->magic == 0x2f2142e5)) { VAS_Fail(__func__, "http1/cache_http1_line.c", 293, "(v1l)->magic == 0x2f2142e5", VAS_ASSERT); } } while (0); } while (0);

 do { if (!(v1l->ciov < v1l->siov)) { VAS_Fail(__func__, "http1/cache_http1_line.c", 295, "v1l->ciov < v1l->siov", VAS_ASSERT); } } while (0);
 (void)V1L_Flush(wrk);
 v1l->ciov = v1l->siov;
 v1l->niov = 0;
 v1l->cliov = 0;
