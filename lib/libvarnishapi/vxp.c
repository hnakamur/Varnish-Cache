...
vxp_ErrToken(const struct vxp *vxp, const struct token *t)
{
 ...
 if (t->tok == 128)
  ...
  VSB_printf(vxp->sb, "'%.*s'", (int)((t)->e - (t)->b), (t)->b);
}
    ...
    int tokoff)
{
 ...
 do { do { if (!((vxp) != 0)) { VAS_Fail(__func__, "vxp.c", 64, "(vxp) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((vsb) != 0)) { VAS_Fail(__func__, "vxp.c", 65, "(vsb) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((t) != 0)) { VAS_Fail(__func__, "vxp.c", 66, "(t) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { if (!(t->b >= vxp->b)) { VAS_Fail(__func__, "vxp.c", 67, "t->b >= vxp->b", VAS_ASSERT); } } while (0);
...
vxp_quote(const struct vxp *vxp, const char *b, const char *e, int tokoff)
{
 ...
 do { if (!(b <= e)) { VAS_Fail(__func__, "vxp.c", 80, "b <= e", VAS_ASSERT); } } while (0);
 do { if (!(b >= vxp->b)) { VAS_Fail(__func__, "vxp.c", 81, "b >= vxp->b", VAS_ASSERT); } } while (0);
 do { if (!(e <= vxp->e)) { VAS_Fail(__func__, "vxp.c", 82, "e <= vxp->e", VAS_ASSERT); } } while (0);
...
vxp_ErrWhere(struct vxp *vxp, const struct token *t, int tokoff)
{
 ...
 do { do { if (!((vxp) != 0)) { VAS_Fail(__func__, "vxp.c", 107, "(vxp) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((t) != 0)) { VAS_Fail(__func__, "vxp.c", 108, "(t) != 0", VAS_ASSERT); } } while (0); } while (0);
...
vxp_NextToken(struct vxp *vxp)
{
 ...
 do { do { if (!((vxp->t) != 0)) { VAS_Fail(__func__, "vxp.c", 120, "(vxp->t) != 0", VAS_ASSERT); } } while (0); } while (0);
...
vxp_DoFree(struct vxp *vxp, void *p)
{
 ...
 do { do { if (!((mb) != 0)) { VAS_Fail(__func__, "vxp.c", 148, "(mb) != 0", VAS_ASSERT); } } while (0); } while (0);
 mb->ptr = p;
 do { (((mb))->list.vtqe_next) = ((void *)0); (mb)->list.vtqe_prev = (&vxp->membits)->vtqh_last; *(&vxp->membits)->vtqh_last = (mb); (&vxp->membits)->vtqh_last = &(((mb))->list.vtqe_next); } while (0);
}
...
vxp_Alloc(struct vxp *vxp, unsigned len)
{
 ...
 p = calloc(len, 1);
 do { do { if (!((p) != 0)) { VAS_Fail(__func__, "vxp.c", 159, "(p) != 0", VAS_ASSERT); } } while (0); } while (0);
 vxp_DoFree(vxp, p);
 return (p);
}
...
vxp_New(struct vsb *sb)
{
 ...
 do { do { if (!((sb) != 0)) { VAS_Fail(__func__, "vxp.c", 169, "(sb) != 0", VAS_ASSERT); } } while (0); } while (0);

 do { (vxp) = calloc(sizeof *(vxp), 1); if ((vxp) != ((void *)0)) (vxp)->magic = (0x59C7F6AC); } while (0);
 do { do { if (!((vxp) != 0)) { VAS_Fail(__func__, "vxp.c", 172, "(vxp) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { (((&vxp->membits))->vtqh_first) = ((void *)0); (&vxp->membits)->vtqh_last = &(((&vxp->membits))->vtqh_first); } while (0);
 do { (((&vxp->tokens))->vtqh_first) = ((void *)0); (&vxp->tokens)->vtqh_last = &(((&vxp->tokens))->vtqh_first); } while (0);
 vxp->sb = sb;
...
vxp_Delete(struct vxp **pvxp)
{
 ...
 do { do { if (!((pvxp) != 0)) { VAS_Fail(__func__, "vxp.c", 186, "(pvxp) != 0", VAS_ASSERT); } } while (0); } while (0);
 vxp = *pvxp;
 *pvxp = ((void *)0);
 do { do { if (!((vxp) != ((void *)0))) { VAS_Fail(__func__, "vxp.c", 189, "(vxp) != NULL", VAS_ASSERT); } } while (0); do { if (!((vxp)->magic == 0x59C7F6AC)) { VAS_Fail(__func__, "vxp.c", 189, "(vxp)->magic == 0x59C7F6AC", VAS_ASSERT); } } while (0); } while (0);

 while (!((&vxp->membits)->vtqh_first == ((void *)0))) {
  mb = ((&vxp->membits)->vtqh_first);
  do { if (((((mb))->list.vtqe_next)) != ((void *)0)) (((mb))->list.vtqe_next)->list.vtqe_prev = (mb)->list.vtqe_prev; else { (&vxp->membits)->vtqh_last = (mb)->list.vtqe_prev; } *(mb)->list.vtqe_prev = (((mb))->list.vtqe_next); ; ; } while (0);
  free(mb->ptr);
  free(mb);
 }

 do { (vxp)->magic = (0); free(vxp); vxp = ((void *)0); } while (0);
}
...
vex_New(const char *query, struct vsb *sb, unsigned options)
{
 ...
 do { do { if (!((query) != 0)) { VAS_Fail(__func__, "vxp.c", 207, "(query) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((sb) != 0)) { VAS_Fail(__func__, "vxp.c", 208, "(sb) != 0", VAS_ASSERT); } } while (0); } while (0);
 vxp = vxp_New(sb);
 vxp->b = query;
 ...
 if (vxp->err) {
  vxp_Delete(&vxp);
  do { do { if (!((vxp) == 0)) { VAS_Fail(__func__, "vxp.c", 224, "(vxp) == 0", VAS_ASSERT); } } while (0); } while (0);
  return (((void *)0));
 }
 ...
 vxp_Delete(&vxp);
 do { do { if (!((vxp) == 0)) { VAS_Fail(__func__, "vxp.c", 236, "(vxp) == 0", VAS_ASSERT); } } while (0); } while (0);
