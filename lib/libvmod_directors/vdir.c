# 1 "vdir.c"
# 1 "/builddir/build/BUILD/Varnish-Cache-37d738ea4c04629766e510daf3d440ac621d8156/lib/libvmod_directors//"
# 1 "<built-in>"
# 1 "<command-line>"
...
{
 do { do { if (!((vd) != ((void *)0))) { VAS_Fail(__func__, "vdir.c", 44, "(vd) != NULL", VAS_ASSERT); } } while (0); do { if (!((vd)->magic == 0x99f4b726)) { VAS_Fail(__func__, "vdir.c", 44, "(vd)->magic == 0x99f4b726", VAS_ASSERT); } } while (0); } while (0);

 vd->backend = realloc(vd->backend, n * sizeof *vd->backend);
 do { do { if (!((vd->backend) != 0)) { VAS_Fail(__func__, "vdir.c", 47, "(vd->backend) != 0", VAS_ASSERT); } } while (0); } while (0);
 vd->weight = realloc(vd->weight, n * sizeof *vd->weight);
 do { do { if (!((vd->weight) != 0)) { VAS_Fail(__func__, "vdir.c", 49, "(vd->weight) != 0", VAS_ASSERT); } } while (0); } while (0);
 vd->l_backend = n;
}
    ...
    vdi_healthy_f *healthy, vdi_resolve_f *resolve, void *priv)
{
 ...
 do { do { if (!((name) != 0)) { VAS_Fail(__func__, "vdir.c", 59, "(name) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((vcl_name) != 0)) { VAS_Fail(__func__, "vdir.c", 60, "(vcl_name) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((vdp) != 0)) { VAS_Fail(__func__, "vdir.c", 61, "(vdp) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((*vdp) == 0)) { VAS_Fail(__func__, "vdir.c", 62, "(*vdp) == 0", VAS_ASSERT); } } while (0); } while (0);
 do { (vd) = calloc(sizeof *(vd), 1); if ((vd) != ((void *)0)) (vd)->magic = (0x99f4b726); } while (0);
 do { do { if (!((vd) != 0)) { VAS_Fail(__func__, "vdir.c", 64, "(vd) != 0", VAS_ASSERT); } } while (0); } while (0);
 *vdp = vd;
 do { do { if (!((pthread_mutex_init(&vd->mtx, ((void *)0))) == 0)) { VAS_Fail(__func__, "vdir.c", 66, "(pthread_mutex_init(&vd->mtx, ((void *)0))) == 0", VAS_ASSERT); } } while (0); } while (0);

 do { (vd->dir) = calloc(sizeof *(vd->dir), 1); if ((vd->dir) != ((void *)0)) (vd->dir)->magic = (0x3336351d); } while (0);
 do { do { if (!((vd->dir) != 0)) { VAS_Fail(__func__, "vdir.c", 69, "(vd->dir) != 0", VAS_ASSERT); } } while (0); } while (0);
 vd->dir->name = name;
 do { free(vd->dir->vcl_name); if ((vcl_name) != ((void *)0)) { vd->dir->vcl_name = (__extension__ (__builtin_constant_p (vcl_name) && ((size_t)(const void *)((vcl_name) + 1) - (size_t)(const void *)(vcl_name) == 1) ? (((const char *) (vcl_name))[0] == '\0' ? (char *) calloc ((size_t) 1, (size_t) 1) : ({ size_t __len = strlen (vcl_name) + 1; char *__retval = (char *) malloc (__len); if (__retval != ((void *)0)) __retval = (char *) memcpy (__retval, vcl_name, __len); __retval; })) : __strdup (vcl_name))); do { do { if (!(((vd->dir->vcl_name)) != 0)) { VAS_Fail(__func__, "vdir.c", 71, "((vd->dir->vcl_name)) != 0", VAS_ASSERT); } } while (0); } while (0); } else { vd->dir->vcl_name = ((void *)0); } } while (0);
 vd->dir->priv = priv;
 vd->dir->healthy = healthy;
 vd->dir->resolve = resolve;
 vd->vbm = vbit_init(8);
 do { do { if (!((vd->vbm) != 0)) { VAS_Fail(__func__, "vdir.c", 76, "(vd->vbm) != 0", VAS_ASSERT); } } while (0); } while (0);
}
...
vdir_delete(struct vdir **vdp)
{
 ...
 do { do { if (!((vdp) != 0)) { VAS_Fail(__func__, "vdir.c", 84, "(vdp) != 0", VAS_ASSERT); } } while (0); } while (0);
 vd = *vdp;
 *vdp = ((void *)0);

 do { do { if (!((vd) != ((void *)0))) { VAS_Fail(__func__, "vdir.c", 88, "(vd) != NULL", VAS_ASSERT); } } while (0); do { if (!((vd)->magic == 0x99f4b726)) { VAS_Fail(__func__, "vdir.c", 88, "(vd)->magic == 0x99f4b726", VAS_ASSERT); } } while (0); } while (0);

 free(vd->backend);
 free(vd->weight);
 do { do { if (!((pthread_mutex_destroy(&vd->mtx)) == 0)) { VAS_Fail(__func__, "vdir.c", 92, "(pthread_mutex_destroy(&vd->mtx)) == 0", VAS_ASSERT); } } while (0); } while (0);
 free(vd->dir->vcl_name);
 do { (vd->dir)->magic = (0); free(vd->dir); vd->dir = ((void *)0); } while (0);
 vbit_destroy(vd->vbm);
...
{
 do { do { if (!((vd) != ((void *)0))) { VAS_Fail(__func__, "vdir.c", 102, "(vd) != NULL", VAS_ASSERT); } } while (0); do { if (!((vd)->magic == 0x99f4b726)) { VAS_Fail(__func__, "vdir.c", 102, "(vd)->magic == 0x99f4b726", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((pthread_mutex_lock(&vd->mtx)) == 0)) { VAS_Fail(__func__, "vdir.c", 103, "(pthread_mutex_lock(&vd->mtx)) == 0", VAS_ASSERT); } } while (0); } while (0);
}

void
vdir_unlock(struct vdir *vd)
{
 do { do { if (!((vd) != ((void *)0))) { VAS_Fail(__func__, "vdir.c", 109, "(vd) != NULL", VAS_ASSERT); } } while (0); do { if (!((vd)->magic == 0x99f4b726)) { VAS_Fail(__func__, "vdir.c", 109, "(vd)->magic == 0x99f4b726", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((pthread_mutex_unlock(&vd->mtx)) == 0)) { VAS_Fail(__func__, "vdir.c", 110, "(pthread_mutex_unlock(&vd->mtx)) == 0", VAS_ASSERT); } } while (0); } while (0);
}
...
vdir_add_backend(struct vdir *vd, VCL_BACKEND be, double weight)
{
 ...
 do { do { if (!((vd) != ((void *)0))) { VAS_Fail(__func__, "vdir.c", 119, "(vd) != NULL", VAS_ASSERT); } } while (0); do { if (!((vd)->magic == 0x99f4b726)) { VAS_Fail(__func__, "vdir.c", 119, "(vd)->magic == 0x99f4b726", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((be) != 0)) { VAS_Fail(__func__, "vdir.c", 120, "(be) != 0", VAS_ASSERT); } } while (0); } while (0);
 vdir_lock(vd);
 if (vd->n_backend >= vd->l_backend)
  vdir_expand(vd, vd->l_backend + 16);
 do { if (!(vd->n_backend < vd->l_backend)) { VAS_Fail(__func__, "vdir.c", 124, "vd->n_backend < vd->l_backend", VAS_ASSERT); } } while (0);
 u = vd->n_backend++;
 vd->backend[u] = be;
 vd->weight[u] = weight;
...
vdir_any_healthy(struct vdir *vd, const struct busyobj *bo, double *changed)
{
 ...
 do { do { if (!((vd) != ((void *)0))) { VAS_Fail(__func__, "vdir.c", 141, "(vd) != NULL", VAS_ASSERT); } } while (0); do { if (!((vd)->magic == 0x99f4b726)) { VAS_Fail(__func__, "vdir.c", 141, "(vd)->magic == 0x99f4b726", VAS_ASSERT); } } while (0); } while (0);
 do { if ((bo) != ((void *)0)) do { if (!((bo)->magic == 0x23b95567)) { VAS_Fail(__func__, "vdir.c", 142, "(bo)->magic == 0x23b95567", VAS_ASSERT); } } while (0); } while (0);
 vdir_lock(vd);
 if (changed != ((void *)0))
  *changed = 0;
 for (u = 0; u < vd->n_backend; u++) {
  be = vd->backend[u];
  do { do { if (!((be) != ((void *)0))) { VAS_Fail(__func__, "vdir.c", 148, "(be) != NULL", VAS_ASSERT); } } while (0); do { if (!((be)->magic == 0x3336351d)) { VAS_Fail(__func__, "vdir.c", 148, "(be)->magic == 0x3336351d", VAS_ASSERT); } } while (0); } while (0);
  retval = be->healthy(be, bo, &c);
  if (changed != ((void *)0) && c > *changed)
   *changed = c;
  if (retval)
   break;
 }
...
{
 double a = 0.0;
 VCL_BACKEND be = ((void *)0);
 unsigned u;

 for (u = 0; u < vd->n_backend; u++) {
  be = vd->backend[u];
  do { do { if (!((be) != ((void *)0))) { VAS_Fail(__func__, "vdir.c", 169, "(be) != NULL", VAS_ASSERT); } } while (0); do { if (!((be)->magic == 0x3336351d)) { VAS_Fail(__func__, "vdir.c", 169, "(be)->magic == 0x3336351d", VAS_ASSERT); } } while (0); } while (0);
  if (blacklist != ((void *)0) && vbit_test(blacklist, u))
   continue;
  a += vd->weight[u];
  if (w < a)
   return (u);
 }
 do { VAS_Fail(__func__, "vdir.c", 176, "", VAS_WRONG); } while (0);
}
...
vdir_pick_be(struct vdir *vd, double w, const struct busyobj *bo)
{
 ...
 vdir_lock(vd);
 for (u = 0; u < vd->n_backend; u++) {
  if (vd->backend[u]->healthy(vd->backend[u], bo, ((void *)0))) {
   vbit_clr(vd->vbm, u);
   tw += vd->weight[u];
  } else
   vbit_set(vd->vbm, u);
 ...
 if (tw > 0.0) {
  ...
  do { if (!(u < vd->n_backend)) { VAS_Fail(__func__, "vdir.c", 196, "u < vd->n_backend", VAS_ASSERT); } } while (0);
  be = vd->backend[u];
  do { do { if (!((be) != ((void *)0))) { VAS_Fail(__func__, "vdir.c", 198, "(be) != NULL", VAS_ASSERT); } } while (0); do { if (!((be)->magic == 0x3336351d)) { VAS_Fail(__func__, "vdir.c", 198, "(be)->magic == 0x3336351d", VAS_ASSERT); } } while (0); } while (0);
 }
 vdir_unlock(vd);
 return (be);
}
