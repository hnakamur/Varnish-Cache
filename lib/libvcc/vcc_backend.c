    ...
    const struct token *t_port)
{
 ...
 do { do { if (!((t_host->dec) != 0)) { VAS_Fail(__func__, "vcc_backend.c", 51, "(t_host->dec) != 0", VAS_ASSERT); } } while (0); } while (0);

 if (t_port != ((void *)0))
  do { do { if (!(snprintf(buf, sizeof buf, "%s %s", t_host->dec, t_port->dec) < sizeof buf)) { VAS_Fail(__func__, "vcc_backend.c", 54, "snprintf(buf, sizeof buf, \"%s %s\", t_host->dec, t_port->dec) < sizeof buf", VAS_ASSERT); } } while (0); } while (0);
 else
  do { do { if (!(snprintf(buf, sizeof buf, "%s", t_host->dec) < sizeof buf)) { VAS_Fail(__func__, "vcc_backend.c", 56, "snprintf(buf, sizeof buf, \"%s\", t_host->dec) < sizeof buf", VAS_ASSERT); } } while (0); } while (0);
...
vcc_ParseProbeSpec(struct vcc *tl, const struct token *nm, char **name)
{
 struct fld_spec *fs;
 struct token *t_field;
 struct token *t_did = ((void *)0), *t_window = ((void *)0), *t_threshold = ((void *)0);
 struct token *t_initial = ((void *)0);
 struct vsb *vsb;
 char *retval;
 ...
 do { vcc__Expect(tl, '{', 116); do { if ((tl)->err) return; } while (0); vcc_NextToken(tl); } while (0);

 vsb = VSB_new(((void *)0), ((void *)0), 0, 0x00000001);
 do { do { if (!((vsb) != 0)) { VAS_Fail(__func__, "vcc_backend.c", 119, "(vsb) != 0", VAS_ASSERT); } } while (0); } while (0);
 if (nm != ((void *)0))
  VSB_printf(vsb, "vgc_probe_%.*s", (int)((nm)->e - (nm)->b), (nm)->b);
 else
  VSB_printf(vsb, "vgc_probe__%d", tl->nprobe++);
 do { do { if (!((VSB_finish(vsb)) == 0)) { VAS_Fail(__func__, "vcc_backend.c", 124, "(VSB_finish(vsb)) == 0", VAS_ASSERT); } } while (0); } while (0);
 ...
 while (tl->t->tok != '}') {
  ...
  if (vcc_IdIs(t_field, "url")) {
   ...
   do { if ((tl)->err) return; } while (0);
   do { vcc__Expect(tl, 130, 143); do { if ((tl)->err) return; } while (0);} while (0);
   Fh(tl, 0, "\t.url = ");
   EncToken(tl->fh, tl->t);
   Fh(tl, 0, ",\n");
   vcc_NextToken(tl);
   ...
   vcc_ProbeRedef(tl, &t_did, t_field);
   do { if ((tl)->err) return; } while (0);
   do { vcc__Expect(tl, 130, 151); do { if ((tl)->err) return; } while (0);} while (0);
   Fh(tl, 0, "\t.request =\n");
   while (tl->t->tok == 130) {
    Fh(tl, 0, "\t\t");
    EncToken(tl->fh, tl->t);
   ...
   vcc_ErrWhere(tl, t_field);
   vcc__ErrInternal(tl, __func__, 196);
   return;
  }

  do { vcc__Expect(tl, ';', 200); do { if ((tl)->err) return; } while (0); vcc_NextToken(tl); } while (0);
 }

 if (t_threshold != ((void *)0) || t_window != ((void *)0)) {
  if (t_threshold == ((void *)0) && t_window != ((void *)0)) {
   VSB_printf(tl->sb,
       "Must specify .threshold with .window\n");
   vcc_ErrWhere(tl, t_window);
   return;
  } else if (t_threshold != ((void *)0) && t_window == ((void *)0)) {
   if (threshold > 64) {
    VSB_printf(tl->sb,
   ...
   do { do { if (!((t_window) != 0)) { VAS_Fail(__func__, "vcc_backend.c", 218, "(t_window) != 0", VAS_ASSERT); } } while (0); } while (0);
  ...
  if (threshold > window ) {
   ...
   do { do { if (!((t_threshold) != 0)) { VAS_Fail(__func__, "vcc_backend.c", 226, "(t_threshold) != 0", VAS_ASSERT); } } while (0); } while (0);
   vcc_ErrWhere(tl, t_threshold);
   do { do { if (!((t_window) != 0)) { VAS_Fail(__func__, "vcc_backend.c", 228, "(t_window) != 0", VAS_ASSERT); } } while (0); } while (0);
   vcc_ErrWhere(tl, t_window);
  }
  Fh(tl, 0, "\t.window = %u,\n", window);
  Fh(tl, 0, "\t.threshold = %u,\n", threshold);
 ...
 Fh(tl, 0, "};\n");
 do { vcc__Expect(tl, '}', 241); do { if ((tl)->err) return; } while (0); vcc_NextToken(tl); } while (0);
}
...
vcc_ParseProbe(struct vcc *tl)
{
 ...
 do { do { if (!((sym) != 0)) { VAS_Fail(__func__, "vcc_backend.c", 263, "(sym) != 0", VAS_ASSERT); } } while (0); } while (0);
 if (sym->ndef > 0) {
  VSB_printf(tl->sb, "Probe %.*s redefined\n", (int)((t_probe)->e - (t_probe)->b), (t_probe)->b);
...
{
 struct token *t_field;
 struct token *t_host = ((void *)0);
 struct token *t_port = ((void *)0);
 struct token *t_hosthdr = ((void *)0);
 struct fld_spec *fs;
 struct inifin *ifp;
 struct vsb *vsb;
 char *p;
 ...
 do { vcc__Expect(tl, '{', 312); do { if ((tl)->err) return; } while (0); vcc_NextToken(tl); } while (0);

 vsb = VSB_new(((void *)0), ((void *)0), 0, 0x00000001);
 do { do { if (!((vsb) != 0)) { VAS_Fail(__func__, "vcc_backend.c", 315, "(vsb) != 0", VAS_ASSERT); } } while (0); } while (0);
 tl->fb = vsb;
 ...
 Fb(tl, 0, "\t.vcl_name = \"%.*s", (int)((t_be)->e - (t_be)->b), (t_be)->b);
 Fb(tl, 0, "\",\n");


 if (tl->t->tok == 132 && vcc_IdIs(tl->t, "set")) {
  VSB_printf(tl->sb,
 ...
 while (tl->t->tok != '}') {
  ...
  if (vcc_IdIs(t_field, "host")) {
   do { vcc__Expect(tl, 130, 342); do { if ((tl)->err) return; } while (0);} while (0);
   do { if (!(tl->t->dec != ((void *)0))) { VAS_Fail(__func__, "vcc_backend.c", 343, "tl->t->dec != NULL", VAS_ASSERT); } } while (0);
   t_host = tl->t;
   vcc_NextToken(tl);
   do { vcc__Expect(tl, ';', 346); do { if ((tl)->err) return; } while (0); vcc_NextToken(tl); } while (0);
  } else if (vcc_IdIs(t_field, "port")) {
   do { vcc__Expect(tl, 130, 348); do { if ((tl)->err) return; } while (0);} while (0);
   do { if (!(tl->t->dec != ((void *)0))) { VAS_Fail(__func__, "vcc_backend.c", 349, "tl->t->dec != NULL", VAS_ASSERT); } } while (0);
   t_port = tl->t;
   vcc_NextToken(tl);
   do { vcc__Expect(tl, ';', 352); do { if ((tl)->err) return; } while (0); vcc_NextToken(tl); } while (0);
  } else if (vcc_IdIs(t_field, "host_header")) {
   do { vcc__Expect(tl, 130, 354); do { if ((tl)->err) return; } while (0);} while (0);
   do { if (!(tl->t->dec != ((void *)0))) { VAS_Fail(__func__, "vcc_backend.c", 355, "tl->t->dec != NULL", VAS_ASSERT); } } while (0);
   t_hosthdr = tl->t;
   vcc_NextToken(tl);
   do { vcc__Expect(tl, ';', 358); do { if ((tl)->err) return; } while (0); vcc_NextToken(tl); } while (0);
  } else if (vcc_IdIs(t_field, "connect_timeout")) {
   Fb(tl, 0, "\t.connect_timeout = ");
   vcc_Duration(tl, &t);
   do { if ((tl)->err) return; } while (0);
   Fb(tl, 0, "%g,\n", t);
   do { vcc__Expect(tl, ';', 364); do { if ((tl)->err) return; } while (0); vcc_NextToken(tl); } while (0);
  } else if (vcc_IdIs(t_field, "first_byte_timeout")) {
   Fb(tl, 0, "\t.first_byte_timeout = ");
   vcc_Duration(tl, &t);
   do { if ((tl)->err) return; } while (0);
   Fb(tl, 0, "%g,\n", t);
   do { vcc__Expect(tl, ';', 370); do { if ((tl)->err) return; } while (0); vcc_NextToken(tl); } while (0);
  } else if (vcc_IdIs(t_field, "between_bytes_timeout")) {
   Fb(tl, 0, "\t.between_bytes_timeout = ");
   vcc_Duration(tl, &t);
   do { if ((tl)->err) return; } while (0);
   Fb(tl, 0, "%g,\n", t);
   do { vcc__Expect(tl, ';', 376); do { if ((tl)->err) return; } while (0); vcc_NextToken(tl); } while (0);
  } else if (vcc_IdIs(t_field, "max_connections")) {
   u = vcc_UintVal(tl);
   do { if ((tl)->err) return; } while (0);
   do { vcc__Expect(tl, ';', 380); do { if ((tl)->err) return; } while (0); vcc_NextToken(tl); } while (0);
   Fb(tl, 0, "\t.max_connections = %u,\n", u);
  } else if (vcc_IdIs(t_field, "probe") && tl->t->tok == '{') {
   vcc_ParseProbeSpec(tl, ((void *)0), &p);
   Fb(tl, 0, "\t.probe = &%s,\n", p);
   do { if ((tl)->err) return; } while (0);
  } else if (vcc_IdIs(t_field, "probe") && tl->t->tok == 132) {
   Fb(tl, 0, "\t.probe = &vgc_probe_%.*s,\n", (int)((tl->t)->e - (tl->t)->b), (tl->t)->b);
   vcc_AddRef(tl, tl->t, SYM_PROBE);
   vcc_NextToken(tl);
   do { vcc__Expect(tl, ';', 390); do { if ((tl)->err) return; } while (0); vcc_NextToken(tl); } while (0);
   ...
   vcc__ErrInternal(tl, __func__, 399);
   return;
  }
 ...
 do { if (!(t_host != ((void *)0))) { VAS_Fail(__func__, "vcc_backend.c", 409, "t_host != NULL", VAS_ASSERT); } } while (0);
 Emit_Sockaddr(tl, t_host, t_port);
 do { if ((tl)->err) return; } while (0);

 do { vcc__Expect(tl, '}', 413); do { if ((tl)->err) return; } while (0);} while (0);
 ...
 tl->fb = ((void *)0);
 do { do { if (!((VSB_finish(vsb)) == 0)) { VAS_Fail(__func__, "vcc_backend.c", 431, "(VSB_finish(vsb)) == 0", VAS_ASSERT); } } while (0); } while (0);
...
vcc_ParseBackend(struct vcc *tl)
{
 ...
 if (tl->t->e - tl->t->b > 64) {
  VSB_printf(tl->sb,
      ...
      (int)((t_first)->e - (t_first)->b), (t_first)->b, 64,
 ...
 sprintf(vgcname, "vgc_backend_%.*s", (int)((t_be)->e - (t_be)->b), (t_be)->b);
 Fh(tl, 0, "\nstatic struct director *%s;\n", vgcname);

 sym = VCC_GetSymbolTok(tl, t_be, SYM_BACKEND);
 do { do { if (!((sym) != 0)) { VAS_Fail(__func__, "vcc_backend.c", 474, "(sym) != 0", VAS_ASSERT); } } while (0); } while (0);
 if (sym->ndef > 0) {
  VSB_printf(tl->sb, "Backend %.*s redefined\n", (int)((t_be)->e - (t_be)->b), (t_be)->b);
 ...
 if (tl->err) {
  VSB_printf(tl->sb,
      "\nIn %.*s specification starting at:\n", (int)((t_first)->e - (t_first)->b), (t_first)->b);
  vcc_ErrWhere(tl, t_first);
  return;
 }

 if (tl->default_director == ((void *)0) || vcc_IdIs(t_be, "default")) {
