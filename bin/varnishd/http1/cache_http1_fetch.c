...
# 1 "<command-line>" 2
# 1 "http1/cache_http1_fetch.c"
# 30 "http1/cache_http1_fetch.c"
# 1 "../../config.h" 1
# 31 "http1/cache_http1_fetch.c" 2
...
typedef int error_t;
# 33 "http1/cache_http1_fetch.c" 2
...
# 34 "http1/cache_http1_fetch.c" 2
...
# 35 "http1/cache_http1_fetch.c" 2
...
# 37 "http1/cache_http1_fetch.c" 2
...
# 39 "http1/cache_http1_fetch.c" 2
# 1 "../../include/vrt.h" 1
# 55 "../../include/vrt.h"
struct VCL_conf;
struct busyobj;
...
# 40 "http1/cache_http1_fetch.c" 2
# 1 "../../include/vtcp.h" 1
# 31 "../../include/vtcp.h"
struct suckaddr;
...
# 41 "http1/cache_http1_fetch.c" 2
# 1 "../../include/vtim.h" 1
# 33 "../../include/vtim.h"
...
# 42 "http1/cache_http1_fetch.c" 2
...
# 44 "http1/cache_http1_fetch.c" 2
...
# 46 "http1/cache_http1_fetch.c" 2
...
vbf_iter_req_body(void *priv, int flush, const void *ptr, ssize_t l)
{
 ...
 do { (bo) = (priv); do { if (!((bo) != ((void *)0))) { VAS_Fail(__func__, "http1/cache_http1_fetch.c", 56, "(bo) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((bo))->magic == (0x23b95567))) { VAS_Fail(__func__, "http1/cache_http1_fetch.c", 56, "((bo))->magic == (0x23b95567)", VAS_ASSERT); } } while (0); } while (0); } while (0);
    ...
    int onlycached)
{
 ...
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "http1/cache_http1_fetch.c", 84, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "http1/cache_http1_fetch.c", 84, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((bo) != ((void *)0))) { VAS_Fail(__func__, "http1/cache_http1_fetch.c", 85, "(bo) != NULL", VAS_ASSERT); } } while (0); do { if (!((bo)->magic == 0x23b95567)) { VAS_Fail(__func__, "http1/cache_http1_fetch.c", 85, "(bo)->magic == 0x23b95567", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((bo->htc) != ((void *)0))) { VAS_Fail(__func__, "http1/cache_http1_fetch.c", 86, "(bo->htc) != NULL", VAS_ASSERT); } } while (0); do { if (!((bo->htc)->magic == 0x3e19edd1)) { VAS_Fail(__func__, "http1/cache_http1_fetch.c", 86, "(bo->htc)->magic == 0x3e19edd1", VAS_ASSERT); } } while (0); } while (0);
 do { if ((bo->req) != ((void *)0)) do { if (!((bo->req)->magic == 0x2751aaa1)) { VAS_Fail(__func__, "http1/cache_http1_fetch.c", 87, "(bo->req)->magic == 0x2751aaa1", VAS_ASSERT); } } while (0); } while (0);
 ...
 *ctr += HTTP1_Write(wrk, hp, HTTP1_Req);
 ...
 if (bo->req != ((void *)0) &&
  ...
  if (bo->req->req_body_status == REQ_BODY_FAIL) {
   do { if (!(i < 0)) { VAS_Fail(__func__, "http1/cache_http1_fetch.c", 112, "i < 0", VAS_ASSERT); } } while (0);
 ...
 if (j != 0 || i < 0) {
  VSLb(bo->vsl, SLT_FetchError, "backend write error: %d (%s)",
      (*__errno_location ()), strerror((*__errno_location ())));
  VSLb_ts_busyobj(bo, "Bereq", ((wrk)->lastused = VTIM_real()));
...
V1F_FetchRespHdr(struct busyobj *bo)
{
 ...
 do { do { if (!((bo) != ((void *)0))) { VAS_Fail(__func__, "http1/cache_http1_fetch.c", 142, "(bo) != NULL", VAS_ASSERT); } } while (0); do { if (!((bo)->magic == 0x23b95567)) { VAS_Fail(__func__, "http1/cache_http1_fetch.c", 142, "(bo)->magic == 0x23b95567", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((bo->htc) != ((void *)0))) { VAS_Fail(__func__, "http1/cache_http1_fetch.c", 143, "(bo->htc) != NULL", VAS_ASSERT); } } while (0); do { if (!((bo->htc)->magic == 0x3e19edd1)) { VAS_Fail(__func__, "http1/cache_http1_fetch.c", 143, "(bo->htc)->magic == 0x3e19edd1", VAS_ASSERT); } } while (0); } while (0);
 do { if ((bo->req) != ((void *)0)) do { if (!((bo->req)->magic == 0x2751aaa1)) { VAS_Fail(__func__, "http1/cache_http1_fetch.c", 144, "(bo->req)->magic == 0x2751aaa1", VAS_ASSERT); } } while (0); } while (0);
 ...
 do { do { if (!((htc) != ((void *)0))) { VAS_Fail(__func__, "http1/cache_http1_fetch.c", 154, "(htc) != NULL", VAS_ASSERT); } } while (0); do { if (!((htc)->magic == 0x3e19edd1)) { VAS_Fail(__func__, "http1/cache_http1_fetch.c", 154, "(htc)->magic == 0x3e19edd1", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((bo->htc) != ((void *)0))) { VAS_Fail(__func__, "http1/cache_http1_fetch.c", 155, "(bo->htc) != NULL", VAS_ASSERT); } } while (0); do { if (!((bo->htc)->magic == 0x3e19edd1)) { VAS_Fail(__func__, "http1/cache_http1_fetch.c", 155, "(bo->htc)->magic == 0x3e19edd1", VAS_ASSERT); } } while (0); } while (0);
