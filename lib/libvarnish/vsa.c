...
# 1 "<command-line>" 2
# 1 "../../lib/libvarnish/vsa.c"
# 34 "../../lib/libvarnish/vsa.c"
# 1 "../../config.h" 1
# 35 "../../lib/libvarnish/vsa.c" 2
...
# 44 "../../lib/libvarnish/vsa.c" 2
# 1 "../../include/miniobj.h" 1
# 45 "../../lib/libvarnish/vsa.c" 2
# 164 "../../lib/libvarnish/vsa.c"
struct suckaddr {
 unsigned magic;
...
VRT_VSA_GetPtr(const struct suckaddr *sua, const unsigned char ** dst)
{
 ...
 do { do { if (!((dst) != 0)) { VAS_Fail(__func__, "../../lib/libvarnish/vsa.c", 185, "(dst) != 0", VAS_ASSERT); } } while (0); } while (0);
 if (sua == ((void *)0))
  return (-1);
 do { do { if (!((sua) != ((void *)0))) { VAS_Fail(__func__, "../../lib/libvarnish/vsa.c", 188, "(sua) != NULL", VAS_ASSERT); } } while (0); do { if (!((sua)->magic == 0x4b1e9335)) { VAS_Fail(__func__, "../../lib/libvarnish/vsa.c", 188, "(sua)->magic == 0x4b1e9335", VAS_ASSERT); } } while (0); } while (0);

 switch(sua->sa.sa_family) {
  case 2:
   do { if (!(sua->sa.sa_family == sua->sa4.sin_family)) { VAS_Fail(__func__, "../../lib/libvarnish/vsa.c", 192, "sua->sa.sa_family == sua->sa4.sin_family", VAS_ASSERT); } } while (0);
   *dst = (const unsigned char *)&sua->sa4.sin_addr;
   return (sua->sa4.sin_family);
  case 10:
   do { if (!(sua->sa.sa_family == sua->sa6.sin6_family)) { VAS_Fail(__func__, "../../lib/libvarnish/vsa.c", 196, "sua->sa.sa_family == sua->sa6.sin6_family", VAS_ASSERT); } } while (0);
...
{
 struct suckaddr *sua = ((void *)0);
 const struct sockaddr *sa = s;
 unsigned l = 0;

 do { do { if (!((s) != 0)) { VAS_Fail(__func__, "../../lib/libvarnish/vsa.c", 216, "(s) != 0", VAS_ASSERT); } } while (0); } while (0);
 switch(sa->sa_family) {
  case 2:
 ...
 if (l != 0) {
  do { (sua) = calloc(sizeof *(sua), 1); if ((sua) != ((void *)0)) (sua)->magic = (0x4b1e9335); } while (0);
  if (sua != ((void *)0))
   memcpy(&sua->sa, s, l);
 }
 return (sua);
...
VSA_Build(void *d, const void *s, unsigned sal)
{
 ...
 do { do { if (!((d) != 0)) { VAS_Fail(__func__, "../../lib/libvarnish/vsa.c", 245, "(d) != 0", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((s) != 0)) { VAS_Fail(__func__, "../../lib/libvarnish/vsa.c", 246, "(s) != 0", VAS_ASSERT); } } while (0); } while (0);
 switch(sa->sa_family) {
  case 2:
   if (sal == sizeof sua->sa4)
    l = sal;
...
VSA_Get_Sockaddr(const struct suckaddr *sua, socklen_t *sl)
{
 ...
 do { do { if (!((sua) != ((void *)0))) { VAS_Fail(__func__, "../../lib/libvarnish/vsa.c", 272, "(sua) != NULL", VAS_ASSERT); } } while (0); do { if (!((sua)->magic == 0x4b1e9335)) { VAS_Fail(__func__, "../../lib/libvarnish/vsa.c", 272, "(sua)->magic == 0x4b1e9335", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((sl) != 0)) { VAS_Fail(__func__, "../../lib/libvarnish/vsa.c", 273, "(sl) != 0", VAS_ASSERT); } } while (0); } while (0);
 switch(sua->sa.sa_family) {
  case 2:
   *sl = sizeof sua->sa4;
   break;
...
VSA_Get_Proto(const struct suckaddr *sua)
{
 ...
 do { do { if (!((sua) != ((void *)0))) { VAS_Fail(__func__, "../../lib/libvarnish/vsa.c", 291, "(sua) != NULL", VAS_ASSERT); } } while (0); do { if (!((sua)->magic == 0x4b1e9335)) { VAS_Fail(__func__, "../../lib/libvarnish/vsa.c", 291, "(sua)->magic == 0x4b1e9335", VAS_ASSERT); } } while (0); } while (0);
...
{
 do { do { if (!((sua) != ((void *)0))) { VAS_Fail(__func__, "../../lib/libvarnish/vsa.c", 298, "(sua) != NULL", VAS_ASSERT); } } while (0); do { if (!((sua)->magic == 0x4b1e9335)) { VAS_Fail(__func__, "../../lib/libvarnish/vsa.c", 298, "(sua)->magic == 0x4b1e9335", VAS_ASSERT); } } while (0); } while (0);
...
VSA_Compare(const struct suckaddr *sua1, const struct suckaddr *sua2)
{
 ...
 do { do { if (!((sua1) != ((void *)0))) { VAS_Fail(__func__, "../../lib/libvarnish/vsa.c", 313, "(sua1) != NULL", VAS_ASSERT); } } while (0); do { if (!((sua1)->magic == 0x4b1e9335)) { VAS_Fail(__func__, "../../lib/libvarnish/vsa.c", 313, "(sua1)->magic == 0x4b1e9335", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((sua2) != ((void *)0))) { VAS_Fail(__func__, "../../lib/libvarnish/vsa.c", 314, "(sua2) != NULL", VAS_ASSERT); } } while (0); do { if (!((sua2)->magic == 0x4b1e9335)) { VAS_Fail(__func__, "../../lib/libvarnish/vsa.c", 314, "(sua2)->magic == 0x4b1e9335", VAS_ASSERT); } } while (0); } while (0);
...
VSA_Clone(const struct suckaddr *sua)
{
 ...
 do { if (!(VSA_Sane(sua))) { VAS_Fail(__func__, "../../lib/libvarnish/vsa.c", 323, "VSA_Sane(sua)", VAS_ASSERT); } } while (0);
 sua2 = calloc(1, vsa_suckaddr_len);
 do { do { if (!((sua2) != 0)) { VAS_Fail(__func__, "../../lib/libvarnish/vsa.c", 325, "(sua2) != 0", VAS_MISSING); } } while (0); } while (0);
...
VSA_Port(const struct suckaddr *sua)
{
 ...
 do { do { if (!((sua) != ((void *)0))) { VAS_Fail(__func__, "../../lib/libvarnish/vsa.c", 334, "(sua) != NULL", VAS_ASSERT); } } while (0); do { if (!((sua)->magic == 0x4b1e9335)) { VAS_Fail(__func__, "../../lib/libvarnish/vsa.c", 334, "(sua)->magic == 0x4b1e9335", VAS_ASSERT); } } while (0); } while (0);
 switch(sua->sa.sa_family) {
  case 2:
   return ((__extension__ ({ register unsigned short int __v, __x = (unsigned short int) (sua->sa4.sin_port); if (__builtin_constant_p (__x)) __v = ((unsigned short int) ((((__x) >> 8) & 0xff) | (((__x) & 0xff) << 8))); else __asm__ ("rorw $8, %w0" : "=r" (__v) : "0" (__x) : "cc"); __v; })));
  case 10:
   return ((__extension__ ({ register unsigned short int __v, __x = (unsigned short int) (sua->sa6.sin6_port); if (__builtin_constant_p (__x)) __v = ((unsigned short int) ((((__x) >> 8) & 0xff) | (((__x) & 0xff) << 8))); else __asm__ ("rorw $8, %w0" : "=r" (__v) : "0" (__x) : "cc"); __v; })));
  default:
   return (0);
 }
}
