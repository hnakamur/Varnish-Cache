...
# 33 "../libvarnish/vre.c" 2

# 1 "../../include/miniobj.h" 1
# 35 "../libvarnish/vre.c" 2
# 1 "../../include/vas.h" 1
# 41 "../../include/vas.h"
enum vas_e {
 VAS_WRONG,
...
const unsigned VRE_has_jit = 0x0001;
...
const unsigned VRE_CASELESS = 0x00000001;
const unsigned VRE_NOTEMPTY = 0x00000400;
...
{
 vre_t *v;
 *errptr = ((void *)0); *erroffset = 0;

 do { (v) = calloc(sizeof *(v), 1); if ((v) != ((void *)0)) (v)->magic = (0xe83097dc); } while (0);
 if (v == ((void *)0)) {
  *errptr = "Out of memory for VRE";
  return (((void *)0));
 }
 v->re = pcre_compile(pattern, options, errptr, erroffset, ((void *)0));
 if (v->re == ((void *)0)) {
  VRE_free(&v);
  return (((void *)0));
 }
 v->re_extra = pcre_study(v->re, 0x0001, errptr);
 if (*errptr != ((void *)0)) {
  VRE_free(&v);
  return (((void *)0));
 }
 if (v->re_extra == ((void *)0)) {
...
VRE_exec(const vre_t *code, const char *subject, int length,
    ...
    const volatile struct vre_limits *lim)
{
 do { do { if (!((code) != ((void *)0))) { VAS_Fail(__func__, "../libvarnish/vre.c", 107, "(code) != NULL", VAS_ASSERT); } } while (0); do { if (!((code)->magic == 0xe83097dc)) { VAS_Fail(__func__, "../libvarnish/vre.c", 107, "(code)->magic == 0xe83097dc", VAS_ASSERT); } } while (0); } while (0);
 int ov[30];
 ...
 *vv = ((void *)0);
 do { do { if (!((v)->magic == 0xe83097dc)) { VAS_Fail(__func__, "../libvarnish/vre.c", 135, "(v)->magic == 0xe83097dc", VAS_ASSERT); } } while (0); } while (0);
 if (v->re_extra != ((void *)0)) {
  if (v->my_extra)
   free(v->re_extra);
  else
