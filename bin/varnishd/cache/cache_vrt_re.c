...
# 1 "<command-line>" 2
# 1 "cache/cache_vrt_re.c"
# 32 "cache/cache_vrt_re.c"
# 1 "../../config.h" 1
# 33 "cache/cache_vrt_re.c" 2
...
# 39 "cache/cache_vrt_re.c" 2

static void
Tadd(char **b, char *e, const char *p, int l)
{
 do { if (!((*b) <= e)) { VAS_Fail(__func__, "cache/cache_vrt_re.c", 43, "(*b) <= e", VAS_ASSERT); } } while (0);
...
VRT_re_init(void **rep, const char *re)
{
 ...
 do { do { if (!((t) != 0)) { VAS_Fail(__func__, "cache/cache_vrt_re.c", 63, "(t) != 0", VAS_ASSERT); } } while (0); } while (0);
 *rep = t;
}
...
VRT_re_match(const struct vrt_ctx *ctx, const char *s, void *re)
{
 ...
 do { do { if (!((ctx) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_vrt_re.c", 83, "(ctx) != NULL", VAS_ASSERT); } } while (0); do { if (!((ctx)->magic == 0x6bb8f0db)) { VAS_Fail(__func__, "cache/cache_vrt_re.c", 83, "(ctx)->magic == 0x6bb8f0db", VAS_ASSERT); } } while (0); } while (0);
 if (s == ((void *)0))
  s = "";
 do { do { if (!((re) != 0)) { VAS_Fail(__func__, "cache/cache_vrt_re.c", 86, "(re) != 0", VAS_ASSERT); } } while (0); } while (0);
 t = re;
 i = VRE_exec(t, s, strlen(s), 0, 0, ((void *)0), 0, &cache_param->vre_limits);
 if (i >= 0)
  return (1);
 if (i < (-1) )
    ...
    const char *sub)
{
 ...
 do { do { if (!((ctx) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_vrt_re.c", 112, "(ctx) != NULL", VAS_ASSERT); } } while (0); do { if (!((ctx)->magic == 0x6bb8f0db)) { VAS_Fail(__func__, "cache/cache_vrt_re.c", 112, "(ctx)->magic == 0x6bb8f0db", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((re) != 0)) { VAS_Fail(__func__, "cache/cache_vrt_re.c", 113, "(re) != 0", VAS_ASSERT); } } while (0); } while (0);
 if (str == ((void *)0))
  str = "";
 if (sub == ((void *)0))
  sub = "";
 ...
 do { if (!(res_b <= res_e)) { VAS_Fail(__func__, "cache/cache_vrt_re.c", 178, "res_b <= res_e", VAS_ASSERT); } } while (0);
