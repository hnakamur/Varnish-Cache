...
# 1 "<command-line>" 2
# 1 "../libvarnish/version.c"
# 32 "../libvarnish/version.c"
# 1 "../../config.h" 1
# 33 "../libvarnish/version.c" 2
...
# 35 "../libvarnish/version.c" 2

# 1 "../../include/vcs.h" 1
# 32 "../../include/vcs.h"
extern const char *VCS_version;
void VCS_Message(const char *);
# 37 "../libvarnish/version.c" 2
# 1 "../../include/vcs_version.h" 1
# 38 "../libvarnish/version.c" 2

const char *VCS_version =
    "varnish" "-" "trunk" " revision " "NOGIT";
