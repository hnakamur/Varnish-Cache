...
# 1 "<command-line>" 2
# 1 "cache/cache_vrt_priv.c"
# 32 "cache/cache_vrt_priv.c"
# 1 "../../config.h" 1
# 33 "cache/cache_vrt_priv.c" 2
...
# 40 "cache/cache_vrt_priv.c" 2

struct vrt_priv {
 unsigned magic;

 struct { struct vrt_priv *vtqe_next; struct vrt_priv **vtqe_prev; } list;
...
{
 privs->magic = 0x03ba7501;
 do { (((&privs->privs))->vtqh_first) = ((void *)0); (&privs->privs)->vtqh_last = &(((&privs->privs))->vtqh_first); } while (0);
}

static struct vmod_priv *
VRT_priv_dynamic(const struct vrt_ctx *ctx, uintptr_t id, uintptr_t vmod_id)
{
 struct vrt_privs *vps;
 struct vrt_priv *vp;

 do { do { if (!((ctx) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_vrt_priv.c", 67, "(ctx) != NULL", VAS_ASSERT); } } while (0); do { if (!((ctx)->magic == 0x6bb8f0db)) { VAS_Fail(__func__, "cache/cache_vrt_priv.c", 67, "(ctx)->magic == 0x6bb8f0db", VAS_ASSERT); } } while (0); } while (0);
 if (ctx->req) {
  do { do { if (!((ctx->req) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_vrt_priv.c", 69, "(ctx->req) != NULL", VAS_ASSERT); } } while (0); do { if (!((ctx->req)->magic == 0x2751aaa1)) { VAS_Fail(__func__, "cache/cache_vrt_priv.c", 69, "(ctx->req)->magic == 0x2751aaa1", VAS_ASSERT); } } while (0); } while (0);
  do { do { if (!((ctx->req->sp) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_vrt_priv.c", 70, "(ctx->req->sp) != NULL", VAS_ASSERT); } } while (0); do { if (!((ctx->req->sp)->magic == 0x2c2f9c5a)) { VAS_Fail(__func__, "cache/cache_vrt_priv.c", 70, "(ctx->req->sp)->magic == 0x2c2f9c5a", VAS_ASSERT); } } while (0); } while (0);
  do { (vps) = (ctx->req->sp->privs); do { if (!((vps) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_vrt_priv.c", 71, "(vps) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((vps))->magic == (0x03ba7501))) { VAS_Fail(__func__, "cache/cache_vrt_priv.c", 71, "((vps))->magic == (0x03ba7501)", VAS_ASSERT); } } while (0); } while (0); } while (0);
 } else {
  do { do { if (!((ctx->bo) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_vrt_priv.c", 73, "(ctx->bo) != NULL", VAS_ASSERT); } } while (0); do { if (!((ctx->bo)->magic == 0x23b95567)) { VAS_Fail(__func__, "cache/cache_vrt_priv.c", 73, "(ctx->bo)->magic == 0x23b95567", VAS_ASSERT); } } while (0); } while (0);
  do { (vps) = (ctx->bo->privs); do { if (!((vps) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_vrt_priv.c", 74, "(vps) != NULL", VAS_ASSERT); } } while (0); do { do { if (!(((vps))->magic == (0x03ba7501))) { VAS_Fail(__func__, "cache/cache_vrt_priv.c", 74, "((vps))->magic == (0x03ba7501)", VAS_ASSERT); } } while (0); } while (0); } while (0);
 }

 for ((vp) = (((&vps->privs))->vtqh_first); (vp); (vp) = (((vp))->list.vtqe_next)) {
  do { do { if (!((vp) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_vrt_priv.c", 78, "(vp) != NULL", VAS_ASSERT); } } while (0); do { if (!((vp)->magic == 0x24157a52)) { VAS_Fail(__func__, "cache/cache_vrt_priv.c", 78, "(vp)->magic == 0x24157a52", VAS_ASSERT); } } while (0); } while (0);
  if (vp->vcl == ctx->vcl && vp->id == id
      && vp->vmod_id == vmod_id)
   return (vp->priv);
 }
 do { (vp) = calloc(sizeof *(vp), 1); if ((vp) != ((void *)0)) (vp)->magic = (0x24157a52); } while (0);
 do { do { if (!((vp) != 0)) { VAS_Fail(__func__, "cache/cache_vrt_priv.c", 84, "(vp) != 0", VAS_ASSERT); } } while (0); } while (0);
 vp->vcl = ctx->vcl;
 vp->id = id;
 vp->vmod_id = vmod_id;
 do { (((vp))->list.vtqe_next) = ((void *)0); (vp)->list.vtqe_prev = (&vps->privs)->vtqh_last; *(&vps->privs)->vtqh_last = (vp); (&vps->privs)->vtqh_last = &(((vp))->list.vtqe_next); } while (0);
 return (vp->priv);
}
...
VRTPRIV_dynamic_kill(struct vrt_privs *privs, uintptr_t id)
{
 ...
 do { do { if (!((privs) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_vrt_priv.c", 97, "(privs) != NULL", VAS_ASSERT); } } while (0); do { if (!((privs)->magic == 0x03ba7501)) { VAS_Fail(__func__, "cache/cache_vrt_priv.c", 97, "(privs)->magic == 0x03ba7501", VAS_ASSERT); } } while (0); } while (0);

 for ((vp) = (((&privs->privs))->vtqh_first); (vp) && ((vp1) = (((vp))->list.vtqe_next), 1); (vp) = (vp1)) {
  do { do { if (!((vp) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_vrt_priv.c", 100, "(vp) != NULL", VAS_ASSERT); } } while (0); do { if (!((vp)->magic == 0x24157a52)) { VAS_Fail(__func__, "cache/cache_vrt_priv.c", 100, "(vp)->magic == 0x24157a52", VAS_ASSERT); } } while (0); } while (0);
  if (id == vp->id) {
   do { if (((((vp))->list.vtqe_next)) != ((void *)0)) (((vp))->list.vtqe_next)->list.vtqe_prev = (vp)->list.vtqe_prev; else { (&privs->privs)->vtqh_last = (vp)->list.vtqe_prev; } *(vp)->list.vtqe_prev = (((vp))->list.vtqe_next); ; ; } while (0);
   VRT_priv_fini(vp->priv);
   do { (vp)->magic = (0); free(vp); vp = ((void *)0); } while (0);
  }
 }
}

struct vmod_priv *
VRT_priv_task(const struct vrt_ctx *ctx, void *vmod_id)
{
 uintptr_t id;

 do { do { if (!((ctx) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_vrt_priv.c", 114, "(ctx) != NULL", VAS_ASSERT); } } while (0); do { if (!((ctx)->magic == 0x6bb8f0db)) { VAS_Fail(__func__, "cache/cache_vrt_priv.c", 114, "(ctx)->magic == 0x6bb8f0db", VAS_ASSERT); } } while (0); } while (0);
 if (ctx->req) {
  do { do { if (!((ctx->req) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_vrt_priv.c", 116, "(ctx->req) != NULL", VAS_ASSERT); } } while (0); do { if (!((ctx->req)->magic == 0x2751aaa1)) { VAS_Fail(__func__, "cache/cache_vrt_priv.c", 116, "(ctx->req)->magic == 0x2751aaa1", VAS_ASSERT); } } while (0); } while (0);
  id = (uintptr_t)ctx->req;
 } else {
  do { do { if (!((ctx->bo) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_vrt_priv.c", 119, "(ctx->bo) != NULL", VAS_ASSERT); } } while (0); do { if (!((ctx->bo)->magic == 0x23b95567)) { VAS_Fail(__func__, "cache/cache_vrt_priv.c", 119, "(ctx->bo)->magic == 0x23b95567", VAS_ASSERT); } } while (0); } while (0);
  id = (uintptr_t)ctx->bo;
 }
...
struct vmod_priv *
VRT_priv_top(const struct vrt_ctx *ctx, void *vmod_id)
{
 uintptr_t id;

 do { do { if (!((ctx) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_vrt_priv.c", 130, "(ctx) != NULL", VAS_ASSERT); } } while (0); do { if (!((ctx)->magic == 0x6bb8f0db)) { VAS_Fail(__func__, "cache/cache_vrt_priv.c", 130, "(ctx)->magic == 0x6bb8f0db", VAS_ASSERT); } } while (0); } while (0);
 if (ctx->req) {
  do { do { if (!((ctx->req) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_vrt_priv.c", 132, "(ctx->req) != NULL", VAS_ASSERT); } } while (0); do { if (!((ctx->req)->magic == 0x2751aaa1)) { VAS_Fail(__func__, "cache/cache_vrt_priv.c", 132, "(ctx->req)->magic == 0x2751aaa1", VAS_ASSERT); } } while (0); } while (0);
  do { do { if (!((ctx->req->top) != ((void *)0))) { VAS_Fail(__func__, "cache/cache_vrt_priv.c", 133, "(ctx->req->top) != NULL", VAS_ASSERT); } } while (0); do { if (!((ctx->req->top)->magic == 0x2751aaa1)) { VAS_Fail(__func__, "cache/cache_vrt_priv.c", 133, "(ctx->req->top)->magic == 0x2751aaa1", VAS_ASSERT); } } while (0); } while (0);
