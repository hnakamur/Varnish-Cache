...
# 1 "<command-line>" 2
# 1 "../libvarnish/vtim.c"
# 55 "../libvarnish/vtim.c"
# 1 "../../config.h" 1
# 56 "../libvarnish/vtim.c" 2
...
VTIM_mono(void)
{
 ...
 do { do { if (!((clock_gettime(1, &ts)) == 0)) { VAS_Fail(__func__, "../libvarnish/vtim.c", 104, "(clock_gettime(1, &ts)) == 0", VAS_ASSERT); } } while (0); } while (0);
...
VTIM_real(void)
{
 ...
 do { do { if (!((clock_gettime(0, &ts)) == 0)) { VAS_Fail(__func__, "../libvarnish/vtim.c", 120, "(clock_gettime(0, &ts)) == 0", VAS_ASSERT); } } while (0); } while (0);
 return (ts.tv_sec + 1e-9 * ts.tv_nsec);
...
VTIM_format(double t, char *p)
{
 ...
 tt = (time_t) t;
 (void)gmtime_r(&tt, &tm);
 do { do { if (!((snprintf(p, 30, "%s, %02d %s %4d %02d:%02d:%02d GMT", weekday_name[tm.tm_wday], tm.tm_mday, month_name[tm.tm_mon], tm.tm_year + 1900, tm.tm_hour, tm.tm_min, tm.tm_sec)) != 0)) { VAS_Fail(__func__,

 "../libvarnish/vtim.c"
# 138 "../libvarnish/vtim.c"
 ,

 140
# 138 "../libvarnish/vtim.c"
 , "(snprintf(p, 30, \"%s, %02d %s %4d %02d:%02d:%02d GMT\", weekday_name[tm.tm_wday], tm.tm_mday, month_name[tm.tm_mon], tm.tm_year + 1900, tm.tm_hour, tm.tm_min, tm.tm_sec)) != 0", VAS_ASSERT); } } while (0); } while (0)

                                                          ;
}
# 207 "../libvarnish/vtim.c"
double
VTIM_parse(const char *p)
{
 ...
 if (*p >= '0' && *p <= '9') {
  ...
  do { if (*p < '0' || *p > '9') do { return (0); } while (0); year += (*p - '0') * 1000; p++; } while(0);
  do { if (*p < '0' || *p > '9') do { return (0); } while (0); year += (*p - '0') * 100; p++; } while(0);
  do { if (*p < '0' || *p > '9') do { return (0); } while (0); year += (*p - '0') * 10; p++; } while(0);
  do { if (*p < '0' || *p > '9') do { return (0); } while (0); year += (*p - '0') * 1; p++; } while(0);
  do { if (*p != '-') do { return (0); } while (0); p++; } while(0);
  do { if (*p < '0' || *p > '9') do { return (0); } while (0); month += (*p - '0') * 10; p++; } while(0);
  do { if (*p < '0' || *p > '9') do { return (0); } while (0); month += (*p - '0') * 1; p++; } while(0);
  do { if (*p != '-') do { return (0); } while (0); p++; } while(0);
  do { if (*p < '0' || *p > '9') do { return (0); } while (0); mday += (*p - '0') * 10; p++; } while(0);
  do { if (*p < '0' || *p > '9') do { return (0); } while (0); mday += (*p - '0') * 1; p++; } while(0);
  do { if (*p != 'T') do { return (0); } while (0); p++; } while(0);
  do { do { if (*p < '0' || *p > '9') do { return (0); } while (0); hour += (*p - '0') * 10; p++; } while(0); do { if (*p < '0' || *p > '9') do { return (0); } while (0); hour += (*p - '0') * 1; p++; } while(0); do { if (*p != ':') do { return (0); } while (0); p++; } while(0); do { if (*p < '0' || *p > '9') do { return (0); } while (0); min += (*p - '0') * 10; p++; } while(0); do { if (*p < '0' || *p > '9') do { return (0); } while (0); min += (*p - '0') * 1; p++; } while(0); do { if (*p != ':') do { return (0); } while (0); p++; } while(0); do { if (*p < '0' || *p > '9') do { return (0); } while (0); sec += (*p - '0') * 10; p++; } while(0); do { if (*p < '0' || *p > '9') do { return (0); } while (0); sec += (*p - '0') * 1; p++; } while(0); } while(0);
 } else {
  do { int i; for(i = 0; i < 7; i++) { if (!memcmp(p, weekday_name[i], 3)) { weekday = i; break; } } if (i == 7) do { return (0); } while (0); p += 3; } while(0);
  do { if (!(weekday >= 0 && weekday <= 6)) { VAS_Fail(__func__, "../libvarnish/vtim.c", 234, "weekday >= 0 && weekday <= 6", VAS_ASSERT); } } while (0);
  if (*p == ',') {
   ...
   do { if (*p < '0' || *p > '9') do { return (0); } while (0); mday += (*p - '0') * 1; p++; } while(0);
   do { if (*p != ' ') do { return (0); } while (0); p++; } while(0);
   do { int i; for(i = 0; i < 12; i++) { if (!memcmp(p, month_name[i], 3)) { month = i + 1; break; } } if (i == 12) do { return (0); } while (0); p += 3; } while(0);
   do { if (*p != ' ') do { return (0); } while (0); p++; } while(0);
   do { if (*p < '0' || *p > '9') do { return (0); } while (0); year += (*p - '0') * 1000; p++; } while(0);
   do { if (*p < '0' || *p > '9') do { return (0); } while (0); year += (*p - '0') * 100; p++; } while(0);
   do { if (*p < '0' || *p > '9') do { return (0); } while (0); year += (*p - '0') * 10; p++; } while(0);
   ...
   do { do { if (*p < '0' || *p > '9') do { return (0); } while (0); hour += (*p - '0') * 10; p++; } while(0); do { if (*p < '0' || *p > '9') do { return (0); } while (0); hour += (*p - '0') * 1; p++; } while(0); do { if (*p != ':') do { return (0); } while (0); p++; } while(0); do { if (*p < '0' || *p > '9') do { return (0); } while (0); min += (*p - '0') * 10; p++; } while(0); do { if (*p < '0' || *p > '9') do { return (0); } while (0); min += (*p - '0') * 1; p++; } while(0); do { if (*p != ':') do { return (0); } while (0); p++; } while(0); do { if (*p < '0' || *p > '9') do { return (0); } while (0); sec += (*p - '0') * 10; p++; } while(0); do { if (*p < '0' || *p > '9') do { return (0); } while (0); sec += (*p - '0') * 1; p++; } while(0); } while(0);
   do { if (*p != ' ') do { return (0); } while (0); p++; } while(0);
   do { if (*p != 'G') do { return (0); } while (0); p++; } while(0);
   do { if (*p != 'M') do { return (0); } while (0); p++; } while(0);
   do { if (*p != 'T') do { return (0); } while (0); p++; } while(0);
  } else if (*p == ' ') {
