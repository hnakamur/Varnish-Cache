...
# 1 "<command-line>" 2
# 1 "hash/hash_simple_list.c"
# 32 "hash/hash_simple_list.c"
# 1 "../../config.h" 1
# 33 "hash/hash_simple_list.c" 2
...
# 37 "hash/hash_simple_list.c" 2

static struct VSC_C_lck *lck_hsl;



static struct { struct objhead *vtqh_first; struct objhead **vtqh_last; } hsl_head = { ((void *)0), &(hsl_head).vtqh_first, };
...
hsl_start(void)
{
 ...
 Lck__New(&hsl_mtx, lck_hsl, "lck_hsl");
}
# 65 "hash/hash_simple_list.c"
...
hsl_lookup(struct worker *wrk, const void *digest, struct objhead **noh)
{
 ...
 do { do { if (!((wrk) != ((void *)0))) { VAS_Fail(__func__, "hash/hash_simple_list.c", 71, "(wrk) != NULL", VAS_ASSERT); } } while (0); do { if (!((wrk)->magic == 0x6391adcf)) { VAS_Fail(__func__, "hash/hash_simple_list.c", 71, "(wrk)->magic == 0x6391adcf", VAS_ASSERT); } } while (0); } while (0);
 do { do { if (!((digest) != 0)) { VAS_Fail(__func__, "hash/hash_simple_list.c", 72, "(digest) != 0", VAS_ASSERT); } } while (0); } while (0);
 if (noh != ((void *)0))
  do { do { if (!((*noh) != ((void *)0))) { VAS_Fail(__func__, "hash/hash_simple_list.c", 74, "(*noh) != NULL", VAS_ASSERT); } } while (0); do { if (!((*noh)->magic == 0x1b96615d)) { VAS_Fail(__func__, "hash/hash_simple_list.c", 74, "(*noh)->magic == 0x1b96615d", VAS_ASSERT); } } while (0); } while (0);

 Lck__Lock(&hsl_mtx, __func__, 76);
 for ((oh) = (((&hsl_head))->vtqh_first); (oh); (oh) = (((oh))->_u.n.u_n_hoh_list.vtqe_next)) {
  ...
  if (i > 0)
   break;
  oh->refcnt++;
  Lck__Unlock(&hsl_mtx, __func__, 84);
  Lck__Lock(&oh->mtx, __func__, 85);
  return (oh);
 }
 ...
 if (oh != ((void *)0))
  ...
  do { (((*noh))->_u.n.u_n_hoh_list.vtqe_next) = ((void *)0); (*noh)->_u.n.u_n_hoh_list.vtqe_prev = (&hsl_head)->vtqh_last; *(&hsl_head)->vtqh_last = (*noh); (&hsl_head)->vtqh_last = &(((*noh))->_u.n.u_n_hoh_list.vtqe_next); } while (0);

 oh = *noh;
 *noh = ((void *)0);
 memcpy(oh->digest, digest, sizeof oh->digest);
 Lck__Unlock(&hsl_mtx, __func__, 100);
 Lck__Lock(&oh->mtx, __func__, 101);
 return (oh);
}
...
hsl_deref(struct objhead *oh)
{
 ...
 Lck__Lock(&hsl_mtx, __func__, 114);
 if (--oh->refcnt == 0) {
  do { if (((((oh))->_u.n.u_n_hoh_list.vtqe_next)) != ((void *)0)) (((oh))->_u.n.u_n_hoh_list.vtqe_next)->_u.n.u_n_hoh_list.vtqe_prev = (oh)->_u.n.u_n_hoh_list.vtqe_prev; else { (&hsl_head)->vtqh_last = (oh)->_u.n.u_n_hoh_list.vtqe_prev; } *(oh)->_u.n.u_n_hoh_list.vtqe_prev = (((oh))->_u.n.u_n_hoh_list.vtqe_next); ; ; } while (0);
  ret = 0;
 } else
  ret = 1;
 Lck__Unlock(&hsl_mtx, __func__, 120);
 return (ret);
}
